...
(function (global, factory) { if (typeof module === 'object' && typeof module.exports === 'object') { var wrapper = function (w) { if (!w.document) { throw Error('AnyChart requires a window with a document'); } factory.call(w, w, w.document); w.acgraph.isNodeJS = true; return w.anychart; }; module.exports = global.document ? wrapper(global) : wrapper; } else { factory.call(global, window, document) } })(typeof window !== 'undefined' ? window : this, function (window, document, opt_noGlobal) {
    var $, _, $_ = this.anychart; if ($_ && (_ = $_._)) { $ = $_.$ } else { $ = {}; _ = {} } if (!_.core) {
        _.core = 1; (function ($) {
            ...
            $b = function (a) {
                function b(a, b, c, d, e) { var f = 1 - e; return f * f * f * a + 3 * f * f * e * b + 3 * f * e * e * c + e * e * e * d } for (var c = [[arguments[0]], [arguments[1]]], d = 2, e = arguments.length; d < e; d += 6) {
                    var f = [arguments[d - 2], arguments[d - 1]], h = [arguments[d], arguments[d + 1]], k = [arguments[d + 2], arguments[d + 3]], l = [arguments[d + 4], arguments[d + 5]]; c[0].push(l[0]); c[1].push(l[1]); for (var m, p = 0; 2 > p; p++) {
                        var q = -3 * f[p] + 9 * h[p] - 9 * k[p] + 3 * l[p], r = 6 * f[p] - 12 * h[p] + 6 * k[p]; m = 3 * h[p] - 3 * f[p]; if (q) {
                            var t = r * r - 4 * m * q; 0 < t ? (m = (-r + Math.sqrt(t)) / (2 * q), 0 < m && 1 > m && c[p].push(b(f[p],
                                h[p], k[p], l[p], m)), m = (-r - Math.sqrt(t)) / (2 * q), 0 < m && 1 > m && c[p].push(b(f[p], h[p], k[p], l[p], m))) : t || (m = -r / (2 * q), 0 < m && 1 > m && c[p].push(b(f[p], h[p], k[p], l[p], m)))
                        } else r && (m = -m / r, 0 < m && 1 > m && c[p].push(b(f[p], h[p], k[p], l[p], m)))
                    }
                } d = new $.I(Math.min.apply(null, c[0]), Math.min.apply(null, c[1]), 0, 0); d.width = Math.max.apply(null, c[0]) - d.left; d.height = Math.max.apply(null, c[1]) - d.top; return d
            };
            ...
            $.oc = function (a) {
                var b, c, d, e = a.trim().replace(/\(\s+/gi, "(").replace(/\s+\)/gi, ")").replace(/(\s+,\s+)|(\s+)/gi, ",").replace(/(\)),*(\w)/gi, "$1 $2").split(" "), f = new $.hc; a = 0; for (d = e.length; a < d; a++) {
                    b = /^(matrix|translate|rotate|scale|skewX|skewY)\(([e\d.,-]+)\)/i.exec(e[a]); var h = b[1], k = b[2].split(","); b = 0; for (c = k.length; b < c; b++)k[b] = (0, window.parseFloat)(k[b]); switch (h) {
                        case "matrix": h = new $.hc(k[0], k[1], k[2], k[3], k[4], k[5]); $.ac(f, h); break; case "translate": ic(f, k[0], k[1] || 0); break; case "rotate": f.rotate($.H(k[0]),
                            k[1] || 0, k[2] || 0); break; case "scale": f.scale(k[0], k[1] || 0); break; case "skewX": jc(f, Math.tan($.H(k[0])), 0); break; case "skewY": jc(f, 0, Math.tan($.H(k[0])))
                    }
                } return f
            };
            $.wc = function (a, b, c, d, e, f, h) {
                var k, l, m, p, q, r; if ($.B(a)) k = $.pc(a, !1), $.B(k) && $.n(b) && (d = (0, window.parseFloat)(b), k = { color: a, opacity: (0, window.isNaN)(d) ? 1 : $.Hb(d, 0, 1) }); else if ($.y(a)) {
                    l = $.pb(a, 0); for (p = l.length; p--;)m = l[p], $.B(m) && (m = qc(m)), (0, window.isNaN)(m.offset) && (m.offset = p / (l.length - 1 || 1)), l[p] = m; m = $.pb(l, 0); m.sort(function (a, b) { return a.offset - b.offset }); 0 != m[0].offset && (r = { offset: 0, color: l[0].color }, $.n(l[0].opacity) && !(0, window.isNaN)(l[0].opacity) && (r.opacity = $.Hb(l[0].opacity, 0, 1)), l.unshift(r));
                    1 != m[m.length - 1].offset && (r = { offset: 1, color: l[l.length - 1].color }, $.n(l[l.length - 1].opacity) && !(0, window.isNaN)(l[l.length - 1].opacity) && (r.opacity = $.Hb(l[l.length - 1].opacity, 0, 1)), l.push(r)); $.C(b) && !(0, window.isNaN)(b) && $.C(c) && !(0, window.isNaN)(c) ? (b = b || 0, c = c || 0, k = { keys: l, cx: b, cy: c, mode: rc(d), fx: (0, window.isNaN)(f) ? b : +f, fy: (0, window.isNaN)(h) ? c : +h, opacity: $.Hb($.n(e) ? e : 1, 0, 1) }) : k = { keys: l, angle: +b || 0, mode: rc(c) || !!c, opacity: $.Hb((0, window.isNaN)(+d) ? 1 : +d, 0, 1) }
                } else if ($.A(a)) if ($.J(a, $.sc)) k = a; else if ("pattern" ==
                    a.type) delete a.id, k = a.bounds, k = new $.I(k.left, k.top, k.width, k.height), k = $.tc(k), k.jd(a); else if ("keys" in a) {
                        l = $.pb(a.keys, 0); for (p = l.length; p--;)m = l[p], $.B(m) ? r = qc(m) : ($.B(m.color) ? q = m.color : q = $.y(m.color) ? $.uc(m.color) : "black", r = { offset: m.offset, color: q }, (0, window.isNaN)(m.opacity) || (r.opacity = $.Hb(m.opacity, 0, 1))), (0, window.isNaN)(r.offset) && (r.offset = p / (l.length - 1 || 1)), l[p] = r; m = $.pb(l, 0); m.sort(function (a, b) { return a.offset - b.offset }); 0 != m[0].offset && (r = { offset: 0, color: l[0].color }, $.n(l[0].opacity) &&
                            !(0, window.isNaN)(l[0].opacity) && (r.opacity = $.Hb(l[0].opacity, 0, 1)), l.unshift(r)); 1 != m[m.length - 1].offset && (r = { offset: 1, color: l[l.length - 1].color }, $.n(l[l.length - 1].opacity) && !(0, window.isNaN)(l[l.length - 1].opacity) && (r.opacity = $.Hb(l[l.length - 1].opacity, 0, 1)), l.push(r)); d = $.Hb($.n(a.opacity) ? a.opacity : 1, 0, 1); e = rc(a.mode); b = a.cx; c = a.cy; $.C(b) && !(0, window.isNaN)(b) && $.C(c) && !(0, window.isNaN)(c) ? k = {
                                keys: l, cx: +b, cy: +c, mode: e, fx: (0, window.isNaN)(a.fx) ? +a.cx : +a.fx, fy: (0, window.isNaN)(a.fy) ? +a.cy : +a.fy,
                                opacity: d
                            } : k = { keys: l, angle: +a.angle || 0, mode: e || !!a.mode, opacity: d }; a = a.transform; null != a && ($.J(a, $.hc) ? k.transform = a : $.A(a) ? (k.transform = new $.hc, k.transform.setTransform(a.m00, a.m10, a.m01, a.m11, a.m02, a.m12)) : $.B(a) && (k.transform = $.oc(a)))
                    } else "src" in a ? k = { src: a.src, mode: $.n(a.mode) ? a.mode : "stretch", opacity: $.Hb($.n(a.opacity) ? a.opacity : 1, 0, 1) } : (q = $.B(a.color) ? a.color : "black", (0, window.isNaN)(a.opacity) ? k = q : k = { color: q, opacity: $.Hb(a.opacity, 0, 1) }); else k = "none"; return k
            };
            $.xc = function (a, b, c, d, e) {
                var f; if (null === a) f = "none"; else {
                    if ($.B(a)) { f = Wa(a, 1); var h = (0, window.parseFloat)(f[0]); (0, window.isNaN)(h) || (a = f[1], b = h) } f = $.A(a); b = (0, window.parseFloat)(f && "thickness" in a ? a.thickness : b); if (!(0, window.isNaN)(b) && !b) return "none"; var h = f && "dash" in a, k = f && "lineJoin" in a, l = f && "lineCap" in a; f = $.wc(a); if ("none" == f) return f; f = $.J(f, $.sc) ? "black" : f; if (!(0, window.isNaN)(b) || h || k || l || $.n(c) || $.n(d) || $.n(e)) $.B(f) && (f = { color: f }), (0, window.isNaN)(b) || (f.thickness = b), h ? f.dash = a.dash ||
                        "none" : null != c && (f.dash = c || "none"), k ? f.lineJoin = a.lineJoin || "none" : null != d && (f.lineJoin = d || "none"), l ? f.lineCap = a.lineCap || "none" : null != e && (f.lineCap = e || "none")
                } return f
            };
            ...
            $.td = function (a, b) {
                $.pd.call(this, a ? a.type : ""); this.g = this.b = this.target = null; this.o = this.keyCode = this.ma = this.K = this.clientY = this.clientX = this.offsetY = this.offsetX = 0; this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1; this.state = null; this.F = !1; this.ph = null; if (a) {
                    var c = this.type = a.type, d = a.changedTouches ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.b = b; var e = a.relatedTarget; e ? $.gd && ($.Wc(e, "nodeName") || (e = null)) : "mouseover" == c ? e = a.fromElement : "mouseout" == c && (e = a.toElement);
                    ...
                    this.altKey = a.altKey; this.shiftKey = a.shiftKey; this.metaKey = a.metaKey; this.F = $.sd ? a.metaKey : a.ctrlKey; this.state = a.state; this.ph = a; a.defaultPrevented && this.preventDefault()
                }
            }; wd = function (a, b) { return ud ? a.ph.button == b : "click" == a.type ? 0 == b : !!(a.ph.button & vd[b]) }; $.Bd = function (a) { return !(!a || !a[Ad]) }; Dd = function (a, b, c, d, e) { this.listener = a; this.b = null; this.src = b; this.type = c; this.HC = !!d; this.kr = e; this.key = ++Cd; this.pw = this.GC = !1 }; Fd = function (a) { a.pw = !0; a.listener = null; a.b = null; a.src = null; a.kr = null };
            ...
            $.Je = function (a, b, c) {
                var d = String(a); if (!Ce.test(d)) throw Error("Invalid tag name <" + d + ">."); if (d.toUpperCase() in De) throw Error("Tag name <" + d + "> is not allowed for SafeHtml."); a = String(a); var d = null, e, f = "<" + a, h = ""; if (b) for (e in b) {
                    if (!Ce.test(e)) throw Error('Invalid attribute name "' + e + '".'); var k = b[e]; if (null != k) {
                        var l, m = a; l = e; if (k instanceof ge) k = $.he(k); else if ("style" == l.toLowerCase()) {
                            ...
                            if (/^on/i.test(l)) throw Error('Attribute "' +
                                l + '" requires goog.string.Const value, "' + k + '" given.'); if (l.toLowerCase() in Ge) if (k instanceof ue) k instanceof ue && k.constructor === ue && k.b === te ? k = "" : ($.la(k), k = "type_error:TrustedResourceUrl"); else if (k instanceof oe) k = $.pe(k); else if ($.B(k)) k = $.se(k).er(); else throw Error('Attribute "' + l + '" on tag "' + m + '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + k + '" given.');
                        } k.yt && (k = k.er()); l = l + '="' + $.Ma(String(k)) + '"'; h += " " + l
                    }
                } e = f + h; null != c ? $.y(c) || (c = [c]) : c = []; !0 === He[a.toLowerCase()] ?
                    e += ">" : (c = $.Ie(c), e += ">" + $.ze(c) + "</" + a + ">", d = c.Jv()); (b = b && b.dir) && (/^(ltr|rtl|auto)$/i.test(b) ? d = 0 : d = null); return $.Ae(e, d)
            ...
            jh = function (a, b) {
                function c(a) { var b = a.ja(); b && ($.lf(b), q++); Ig(a, !1); v.push(m) } function d(a) { var b = a.ja(); b ? (e.appendChild(b), q++, u.push(k), Ig(a, !0)) : t = !1; return !!e } var e = a.ja(), f, h, k, l, m, p, q = 0; if (!a.j) for (a.j = {}, k = 0, l = a.children.length; k < l; k++)a.j[$.ra(a.children[k])] = !0; var r = !1, t = !0, u = [], v = []; f = !0; k = 0; for (l = a.children.length - 1; k < l; k++)if (a.children[k + 1].zIndex() < a.children[k].zIndex()) { f = !1; break } var w; f ? w = a.children : (w = $.nb(a.children), $.xb(w, function (a, b) { return a.zIndex() - b.zIndex() })); k = 0;
                l = w.length; m = 0; for (p = a.b.length; k < l && m < p && q < b; m++)if (f = w[k], h = a.b[m], $.ra(h) in a.j) { if (h != f || r) { if (!d(f)) break; r = !0 } k++ } else c(h); q >= b && (t = !1); if (t) { for (; k < l && q < b && d(w[k]); k++); for (; m < p && q < b; m++)c(a.b[m]); if (k < l || m < p) t = !1 } if (t) a.b = $.pb(w, 0), a.j = null, $.Hg(a, 128); else { for (k = v.length; k--;)$.gb(a.b, v[k], 1); for (k = 0; k < u.length; k++)a.b.push(w[u[k]]) } return q
            }; kh = function (a) { for (var b = a.children.length; b--;)a.children[b].xr() }; $.sc = function (a) { this.Jb = a; this.ek = !1; $.gh.call(this) };
            ...
            Gh = function (a) {
                var b = !a.Ca() || a.Ca().Od(); b || a.Ca().te(); bh(a); var c = a.K[0]; a.XE(a.b.left + c, a.b.top); c = a.K[1]; a.$m(a.b.left + a.b.width - a.K[1], a.b.top); if (a.o[1]) switch (a.o[1]) { case "round": dh(a, a.b.left + a.b.width, a.b.top + c, c, c, !1, !0); break; case "round-inner": dh(a, a.b.left + a.b.width, a.b.top + c, c, c, !1, !1); break; case "cut": a.$m(a.b.left + a.b.width, a.b.top + c) }c = a.K[2]; a.$m(a.b.left + a.b.width, a.b.top + a.b.height - c); if (a.o[2]) switch (a.o[2]) {
                    case "round": dh(a, a.b.left + a.b.width - c, a.b.top + a.b.height, c, c, !1, !0);
                        break; case "round-inner": dh(a, a.b.left + a.b.width - c, a.b.top + a.b.height, c, c, !1, !1); break; case "cut": a.$m(a.b.left + a.b.width - c, a.b.top + a.b.height)
                }c = a.K[3]; a.$m(a.b.left + c, a.b.top + a.b.height); if (a.o[3]) switch (a.o[3]) { case "round": dh(a, a.b.left, a.b.top + a.b.height - c, c, c, !1, !0); break; case "round-inner": dh(a, a.b.left, a.b.top + a.b.height - c, c, c, !1, !1); break; case "cut": a.$m(a.b.left, a.b.top + a.b.height - c) }c = a.K[0]; a.$m(a.b.left, a.b.top + c); if (a.o[0]) switch (a.o[0]) {
                    case "round": dh(a, a.b.left + c, a.b.top, c, c, !1, !0);
                        break; case "round-inner": dh(a, a.b.left + c, a.b.top, c, c, !1, !1)
                }a.zJ(); b || a.Ca().me()
            }; $.Ih = function (a) { $.Lf.call(this); this.g = {}; this.b = {}; this.j = new $.Gf(this); this.na = a }; $.Jh = function (a, b, c) { (c = $.B(c) ? c : c.src) && (a.g[b] = { src: c, RR: $.n(void 0) ? void 0 : null }) }; Lh = function (a, b) { delete a.g[b]; var c = a.b[b]; c && (delete a.b[b], a.j.tc(c, Kh, a.J), $.Nc(a.b) && $.Nc(a.g) && a.dispatchEvent("complete")) }; $.Mh = function () { this.o = {}; this.J = "fontStyle fontVariant fontFamily fontSize fontWeight letterSpacing decoration".split(" ") };
            ...
            di = function (a, b, c) {
                switch (b) {
                    case "font-style": bi(a); a.style.fontStyle = c || "normal"; break; case "font-variant": bi(a); a.style.fontVariant = c || "normal"; break; case "font-family": bi(a); a.style.fontFamily = c || $.fa.acgraph.fontFamily; break; case "font-size": bi(a); a.style.fontSize = c || $.fa.acgraph.fontSize; break; case "font-weight": bi(a); a.style.fontWeight = c || "normal"; break; case "color": bi(a); a.style.color = c || $.fa.acgraph.color; break; case "letter-spacing": bi(a); a.style.letterSpacing = c || "normal"; break; case "text-decoration": bi(a);
                        a.style.np = c || "none"; break; case "opacity": bi(a), a.style.opacity = null != c ? (0, window.parseFloat)(c) : 1
                }
            }; fi = function (a) { "" != a.b && (ei(a.F, a.b, a.o.length ? a.o[a.o.length - 1] : null), a.b = "", a.aa = !1) }; gi = function (a) { a.K == (a.ma.length ? a.ma[a.ma.length - 1] : null) && (fi(a), a.o.pop(), a.ma.pop(), a.tagName = ""); a.K = ""; a.state = 1 }; hi = function (a, b) { ci(a, a.tagName); a.ma.push(a.tagName); a.o.push(a.style); b && (a.g = ""); a.tagName = ""; a.style = null; a.state = 1 };
            ...
            yi = function (a, b) {
                var c, d, e, f, h = b || Xa(a.Y), k = Xa(h), l = a.hj(a.qa, k.b), m = a.qa, p = 1 < h.length && h[h.length - 2]; if (p && p.Z8) d = (0, $.cb)(a.g, k) + 1, $.gb(a.g, d, a.g.length - d); else {
                    l.width > a.fa && (e = wi(a, a.qa, k.b, 0, a.fa, l, !0), m = a.qa.substring(0, e)); e = a.Lc; var q = a.fa; if ("" == m) d = (0, $.cb)(a.g, k) + 1, $.gb(a.g, d, a.g.length - d); else if (q - e >= l.width) a.j = h, d = (0, $.cb)(a.g, k) + 1, $.gb(a.g, d, a.g.length - d), f = xi(a, m, k.b, l), 2 == a.j.length && "" == a.j[0].text && (f.g = a.ha - a.j[0].height, f.o = !0); else {
                        for (p = h.length - 1; !c && 0 <= p;)k = h[p], l = a.hj(m,
                            k.b), d = a.hj(k.text, k.b), e - d.width + l.width <= a.fa && (c = k), e -= d.width, p--; c || 1 != a.Y.length || (c = h[0], e -= d.width); c && (a.j = h, p = a.j[0].g, q -= l.width, d = (0, $.cb)(h, c), $.gb(h, d, h.length - d), d = (0, $.cb)(a.g, c), $.gb(a.g, d, a.g.length - d), a.P = 0, a.F = 0, a.R = 0, d = a.hj(c.text, c.b), e = wi(a, c.text, c.b, e, q, d, !0), 1 > e && (e = 1), d = c.text.substring(0, e), h = a.hj(d, c.b), d = xi(a, d, c.b, h, l.width), d.x = c.x, d.y = c.y, d.Z8 = !0, h.width + l.width > a.fa && (e = wi(a, a.qa, k.b, h.width, a.fa, l, !0), m = a.qa.substring(0, e)), 0 < e && (f = xi(a, m, c.b, l), f.x = d.x + h.width,
                                f.y = d.y), a.j[0].o = !0, a.j[0].g = p)
                    } a.B && f && (c = a.j[0], f.o = c.o, f.x = c.x, f.g = c.g, c.g = 0, c.x = 0, c.o = !1, $.jb(a.g, f), d = (0, $.cb)(a.g, c), $.hb(a.g, f, d))
                }
            }; Ai = function (a) { zi(a); a.Sb++; ei(a, "", null, !0); var b = a.j[0] ? a.j[0].height : 0; a.ha += $.B(a.aa) ? (0, window.parseInt)(a.aa, 0) + b : a.aa * b };
            ...
            zi = function (a) {
                if (!a.Ha && a.j.length) {
                    var b = !a.Y.length; if (a.kc && a.o + a.P > a.kc && a.Y.length) yi(a), a.Ha = !0; else {
                        a.P = $.B(a.aa) ? (0, window.parseInt)(a.aa, 0) + a.P : a.aa * a.P; if ($.Jg().YU()) {
                            var c, d, e, f; f = a.B && a.Qb.hAlign == $.qi || !a.B && "end" == a.Qb.hAlign || "right" == a.Qb.hAlign; c = "center" == a.Qb.hAlign; if (a.B && "end" == a.Qb.hAlign || !a.B && a.Qb.hAlign == $.qi || "left" == a.Qb.hAlign) for (c = a.B ? 0 : a.J && b ? a.J : 0, d = 0, e = a.j.length; d < e; d++)f = a.j[d], f.x = c, f.y = a.o + a.R + f.height - 1.5 * f.j, c += f.width; else if (c) for (c = -a.F / 2, !a.B && a.J && b ?
                                c += a.J : a.B && a.J && b && (c -= 0), d = 0, e = a.j.length; d < e; d++)f = a.j[d], f.x = c + f.width / 2, f.y = a.o + a.R + f.height - 1.5 * f.j, c += f.width; else if (f) for (c = a.B ? a.J && b ? -a.J : 0 : 0, d = a.j.length - 1; 0 <= d; d--)f = a.j[d], f.x = c, f.y = a.o + a.R + f.height - 1.5 * f.j, c -= f.width
                        } var h; if (b) h = a.j[0], h.j = a.R, h.o = !0, a.J && "center" == a.Qb.hAlign && (h.J = a.B ? -a.J / 2 : a.J / 2); else { for (d = 0; d < a.j.length; d++)if ("" != a.j[d].text) { h = a.j[d]; break } h && (h.o = !0, a.Gb || (h.g = a.ha && 1 < a.Sb ? a.ha : a.td + a.R)) } a.ud && a.Qb.wordWrap == pi && a.F > a.fa && (1 < a.j.length && !a.j[0].text.length &&
            ...
            Hi = function (a, b, c, d, e, f, h, k) {
                a = a.path ? a.path() : a; if (2 > f) return a; h = h || 0; var l = $.Lb(h, d), m = $.Mb(h, d), p = 360 / (2 * f), q; a.moveTo(l + b, m + c); if (k) for (q = 0; q < f; q++) {
                    var r = h; h += p; var t = l, u = m, v = $.Lb(r, e), w = $.Mb(r, e), x = $.Lb(h, d), z = $.Mb(h, d), l = $.Lb(h, e), m = $.Mb(h, e), E = (x - v) * (u - w) - (z - w) * (t - v), E = E / ((z - w) * (l - t) - (x - v) * (m - u)), t = Fi(e, d, r, h, k, 1 - E), r = Gi(e, d, r, h, k, 1 - E); a.um(b + t, c + r, b + l, c + m); r = h; h += p; t = l; u = m; v = $.Lb(h, e); w = $.Mb(h, e); x = $.Lb(r, d); z = $.Mb(r, d); l = $.Lb(h, d); m = $.Mb(h, d); E = (x - v) * (u - w) - (z - w) * (t - v); E /= (z - w) * (l - t) - (x -
                        v) * (m - u); t = Fi(e, d, h, r, k, E); r = Gi(e, d, h, r, k, E); a.um(b + t, c + r, b + l, c + m)
                } else for (q = 0; q < f; q++)h += p, l = $.Lb(h, e), m = $.Mb(h, e), a.lineTo(b + l, c + m), h += p, l = $.Lb(h, d), m = $.Mb(h, d), a.lineTo(b + l, c + m); a.close(); return a
            }; Ii = function (a, b, c, d) { return Hi(a, b, c, d, d / 2, 4) }; Ji = function (a, b, c, d) { return Hi(a, b, c, d, d / 2, 5, -90) }; Ki = function (a, b, c, d) { return Hi(a, b, c, d, .5773502691896258 * d, 6, -90) }; Li = function (a, b, c, d) { return Hi(a, b, c, d, d / 2, 7, -90) }; Mi = function (a, b, c, d) { return Hi(a, b, c, d, .8506508083520399 * d, 10) };
            ...
            cj = function (a, b, c) {
                var d = a.path ? a.path() : a, e, f, h, k; 6 == arguments.length ? (e = arguments[2], f = arguments[3], h = arguments[4], k = arguments[5], d.moveTo(b.left + e, b.top).lineTo(b.left + b.width - f, b.top).ie(b.left + b.width, b.top + f, f, f, !1, !1).lineTo(b.left + b.width, b.top + b.height - h).ie(b.left + b.width - h, b.top + b.height, h, h, !1, !1).lineTo(b.left + k, b.top + b.height).ie(b.left, b.top + b.height - k, k, k, !1, !1), 0 != e && d.lineTo(b.left, b.top + e).ie(b.left + e, b.top, e, e, !1, !1), d.close()) : (k = $.pb(arguments, 2, 6), $i(k), e = k[0], f = k[1], h = k[2],
                    k = k[3], cj(d, b, e, f, h, k)); return d
            }; dj = function (a, b, c, d) { this.Co = a; this.Vi = b; this.rn = c; this.Mj = d }; ej = function () { $.Mh.call(this) }; fj = function (a) { return $.fa.document.createElementNS("http://www.w3.org/2000/svg", a) }; gj = function (a) { var b = $.H(a), c = Math.tan(b); a = 1 / (2 * c); c /= 2; .5 >= Math.abs(c) ? (a = -.5, b = 0 > Math.cos(b)) : (c = -.5, b = 0 < Math.sin(b)); b && (a = -a, c = -c); return new dj(.5 + a, .5 + c, .5 - a, .5 - c) };
            ...
            jj = function (a, b, c) {
                var d = ij(c, b.keys, b.cx, b.cy, b.fx, b.fy, b.opacity, b.mode, b.transform); if (!d.ek) {
                    var e = fj("radialGradient"); $.Xh(a, e, d.id()); $.gf(c.ja(), e); d.$w = c; d.ek = !0; (0, $.Za)(d.keys, function (a) { var b = fj("stop"); $.Vh(this, b, { offset: a.offset, style: "stop-color:" + a.color + ";stop-opacity:" + ((0, window.isNaN)(a.opacity) ? d.opacity : a.opacity) }); e.appendChild(b) }, a); d.Jb ? $.Vh(a, e, {
                        cx: d.Dd * d.Jb.width + d.Jb.left, cy: d.Ed * d.Jb.height + d.Jb.top, fx: d.yd * d.Jb.width + d.Jb.left, fy: d.b * d.Jb.height + d.Jb.top, r: Math.min(d.Jb.width,
                            d.Jb.height) / 2, spreadMethod: "pad", gradientUnits: "userSpaceOnUse"
                    }) : $.Vh(a, e, { cx: d.Dd, cy: d.Ed, fx: d.yd, fy: d.b, gradientUnits: "objectBoundingBox" }); d.transform && a.Nb(e, "gradientTransform", d.transform.toString())
                } return d.id()
            };
            lj = function (a, b, c, d) {
                var e = $.kj(c, b.keys, b.opacity, !0 === b.mode ? $.Sh(b.angle, d) : b.angle, b.mode, b.transform); if (!e.ek) {
                    var f = a.ZR(); $.Xh(a, f, e.id()); $.gf(c.ja(), f); e.Zw = c; e.ek = !0; (0, $.Za)(e.keys, function (a) { var b = fj("stop"); $.Vh(this, b, { offset: a.offset, style: "stop-color:" + a.color + ";stop-opacity:" + ((0, window.isNaN)(a.opacity) ? e.opacity : a.opacity) }); f.appendChild(b) }, a); e.Jb ? (b = hj(e.angle, e.Jb), $.Vh(a, f, { x1: b.Co, y1: b.Vi, x2: b.rn, y2: b.Mj, spreadMethod: "pad", gradientUnits: "userSpaceOnUse" })) : (b = gj(e.angle),
                        $.Vh(a, f, { x1: b.Co, y1: b.Vi, x2: b.rn, y2: b.Mj, gradientUnits: "objectBoundingBox" })); e.transform && a.Nb(f, "gradientTransform", e.transform.toString())
                } return e.id()
            };
            pj = function (a, b) {
                var c = b.fill(), d = b.Ca().j, e = "url(" + mj() + "#"; if ($.B(c)) a.Nb(b.ja(), "fill", c), Wh(b.ja()); else if ($.y(c.keys) && c.cx && c.cy) a.Nb(b.ja(), "fill", e + jj(a, c, d) + ")"), Wh(b.ja()); else if ($.y(c.keys)) b.sb() && (a.Nb(b.ja(), "fill", e + lj(a, c, d, b.sb()) + ")"), Wh(b.ja())); else if (c.src) {
                    var f = b.Ig(); f ? (f.width = f.width || 0, f.height = f.height || 0, f.left = f.left || 0, f.top = f.top || 0) : f = new $.I(0, 0, 0, 0); "tile" == c.mode ? nj(d, c.src, f, c.mode, c.opacity, function (a) {
                        a.id(); a.parent(b.Ca()).Vb(); $.Jg().Nb(b.ja(), "fill", e +
                            a.id() + ")")
                    }) : (d = nj(d, c.src, f, c.mode, c.opacity), d.id(), d.parent(b.Ca()).Vb(), a.Nb(b.ja(), "fill", e + d.id() + ")"), a.Nb(b.ja(), "fill-opacity", $.n(c.opacity) ? c.opacity : 1))
                } else $.J(c, nh) ? (c = oj(d, c.type, c.color, c.Xe, c.size), c.id(), c.parent(b.Ca()).Vb(), a.Nb(b.ja(), "fill", e + c.id() + ")")) : $.J(c, $.sc) ? (c.id(), c.parent(b.Ca()).Vb(), a.Nb(b.ja(), "fill", e + c.id() + ")")) : (1E-4 >= c.opacity && $.hd && $.cd("9") && (c.opacity = 1E-4), $.Vh(a, b.ja(), { fill: c.color, "fill-opacity": c.opacity }))
            };
            qj = function (a, b) {
                var c = b.stroke(), d = b.Ca().j, e = b.ja(), f = "url(" + mj() + "#"; if ($.B(c)) a.Nb(e, "stroke", c); else if ($.y(c.keys) && c.cx && c.cy) a.Nb(e, "stroke", f + jj(a, c, d) + ")"); else if ($.y(c.keys)) { if (!b.sb()) return; a.Nb(e, "stroke", f + lj(a, c, d, b.sb()) + ")") } else a.Nb(e, "stroke", c.color); c.lineJoin ? a.Nb(e, "stroke-linejoin", c.lineJoin) : e.removeAttribute("stroke-linejoin"); c.lineCap ? a.Nb(e, "stroke-linecap", c.lineCap) : e.removeAttribute("stroke-linecap"); c.opacity ? a.Nb(e, "stroke-opacity", c.opacity) : e.removeAttribute("stroke-opacity");
                c.thickness ? a.Nb(e, "stroke-width", c.thickness) : e.removeAttribute("stroke-width"); c.dash ? a.Nb(e, "stroke-dasharray", c.dash) : e.removeAttribute("stroke-dasharray")
            }; rj = function (a) { a.ja().removeAttribute("clip-path"); a.ja().removeAttribute("clipPathUnits") };
            ...
            nj = function (a, b, c, d, e, f) {
                e = $.n(e) ? e : 1; d = null != d ? d : "stretch"; var h = [b, c.left, c.top, c.width, c.height, d, e].join(), k = null, l = $.ia; if ("tile" == d) l = function (d, k) { var l; $.Lc(a.b, h) ? l = a.b[h] : (l = new $.sc(new $.I(c.left, c.top, d, k)), l.pc().src(b).opacity(e).width(d).height(k), a.b[h] = l); f && f.call(this, l) }; else {
                    if ($.Lc(a.b, h)) return a.b[h]; k = new $.sc(c); switch (d) {
                        case "stretch": k.pc().src(b).opacity(e).width(c.width).height(c.height); break; case "fit-max": k.pc().src(b).opacity(e).width(c.width).height(c.height).align("x-mid-y-mid").Av("slice");
                            break; case "fit": k.pc().src(b).opacity(e).width(c.width).height(c.height).align("x-mid-y-mid")
                    }a.b[h] = k
                } $.Jg().TE(b, l); l = null; return a.b[h]
            }; oj = function (a, b, c, d, e) { b = null != b ? b : "backward-diagonal"; c = null != c ? c : "black"; d = null != d ? d : 1; e = null != e ? e : 10; var f = [b, c, d, e].join(); return $.Lc(a.o, f) ? a.o[f] : a.o[f] = new nh(b, c, d, e) }; $.kj = function (a, b, c, d, e, f) { var h = $.Gj(b, c, d, e, f); return $.Lc(a.j, h) ? a.j[h] : a.j[h] = new $.Fj(b, c, d, e, f) };
            ...
            $.Sj = function (a, b, c) {
                $.Lf.call(this); this.yF = (0, $.ua)(this.yF, this); this.Kn = (0, $.ua)(this.Kn, this); var d = $.fa.document; $.fa.acgraph.SM || ($.fa.acgraph.SM = {}); var e = $.Ec($.Bc.uc(), this, "stage"); $.fa.acgraph.SM[e] = this; this.R = {}; this.J = new $.Gf(this); this.b = d.createElement("DIV"); $.Of(this.b, { position: "relative", left: 0, top: 0, overflow: "hidden" }); this.Vc = $.Jg().eS(); Ng(this); $.Jg().RF(this.Vc, "100%", "100%"); $.Of(this.Vc, "display", "block"); $.Mj(this.Vc, "anychart-ui-support"); this.b.appendChild(this.Vc);
            ...
            $.Zk = function (a, b, c) {
                a = String(a).toLowerCase(); switch (a) {
                    case "years": case "year": case "yyyy": case "yy": case "y": return "year"; case "semesters": case "semester": case "sem": return "semester"; case "quarters": case "quarter": case "q": return "quarter"; case "months": case "month": case "mm": case "m": return "month"; case "thirdofmonths": case "thirdofmonth": case "decades": case "decade": case "tom": case "dec": return "third-of-month"; case "weeks": case "week": case "w": return "week"; case "days": case "day": case "dd": case "d": return "day";
                    case "hours": case "hour": case "hh": case "h": return c ? "day" : "hour"; case "minutes": case "minute": case "min": case "n": return c ? "day" : "minute"; case "seconds": case "second": case "secs": case "sec": case "s": return c ? "day" : "second"; case "milliseconds": case "millisecond": case "millis": case "milli": case "ms": return c ? "day" : "millisecond"
                }return $.n(b) ? b : "year"
            }; caa = function (a) { $.A(a) && (a = a.mode); return $.wk(baa, a, "csv") }; $.$k = function (a) { return $.wk(daa, a, "start") }; $.al = function (a) { return $.wk(eaa, a, "top") };
            ...
            }; gl = function (a, b, c) { var d = $.kl.console; d && (a = d[a] || d.log, "object" != typeof a && a.call(d, b, c)) };
            ...
            Ml = function (a, b, c, d) {
                ...
                h = []; d = c < d ? 1 : -1; for (k = 0; k < b; k++) { l = c + d * f * k; p = a / 360; if (e) { var q, r; r = .5 > l ? l * (1 + e) : l + e - e * l; q = 2 * l - r; l = 255 * Gl(q, r, p + 1 / 3); m = 255 * Gl(q, r, p); p = 255 * Gl(q, r, p - 1 / 3) } else l = m = p = 255 * l; h.push($.uc([Math.round(l), Math.round(m), Math.round(p)])) } return h
            }; $.Nl = function (a, b, c) { c = $.n(c) ? c : 7; a = $.Ll(a || "yellow").Qf; b = $.Ll(b || "brown").Qf; for (var d = [a], e = 1 / c, f = 1; f < c - 1; f++) { var h = $.Kl(b, a, e * f); d.push(h.color) } d.push(b); return d }; Ol = function (a) { if ($.A(a)) if (a.color) a = a.color; else return null; if ($.B(a)) try { return $.Dl(a).Qf } catch (b) { } return null };
            ...
            $.um = function (a, b) {
                var c = a = pm(a, b), d, e, f; for (f in qm) { var h = f.split("."), k = $.im(c, h); if ($.y(k)) { e = k.length; var l = $.im(b, h), m = $.im(b, qm[f].split(".")), p = !0, q, r = $.y(l) ? l.length : 0; if (r == e) for (d = 0; d < e; d++) { if (q = $.Sl(l[d]), q = hm(q, m), !rm(k[d], q)) { p = !1; break } } else p = !1; if (p) c = nm(c, h); else for (d = 0; d < e; d++)d < r ? (q = $.Sl(l[d]), q = hm(q, m)) : q = m, k[d] = pm(k[d], q) || {} } } for (f = 0; f < sm.length; f++)if (h = sm[f].split("."), k = $.im(c, h), $.y(k)) {
                    l = $.im(b, h); e = l.length; for (d = 0; d < e; d++)m = l[d].type, m = $.im($.jm("defaultScaleSettings"),
                        [m]), l[d] = hm(l[d], m); e = k.length; m = !0; if ($.y(l) && l.length == e) for (d = 0; d < e; d++) { if (!rm(k[d], l[d])) { m = !1; break } } else m = !1; if (m) c = nm(c, h); else for (d = 0; d < e; d++)k[d] = pm(k[d], l[d]) || {}
                } a: { if (c) { d = c.chart || c.gauge || c.gantt || c.map; if (!d) { a = c; break a } e = $.la(d.credits); f = $.la($.jm("stageCredits")); "object" == e && "object" == f && (e = $.jm("stageCredits"), e = pm(d.credits, e), $.n(e) && (d.credits = e)) } a = c } var c = a, t; for (t in tm) if (d = tm[t], e = t.split("."), h = $.im(c, e), k = $.im(b, d.jD.split(".")), $.y(h) && $.n(k)) for (f = h.length, e = 0; e <
                    f; e++)l = $.im(h, [e, d.pG]), $.n(l) && (h[e] = pm(h[e], $.im(k, [l])) || {}); return c
            };
            pm = function (a, b, c) {
                var d = $.la(a), e = $.la(b), f; if ("object" == d && "object" == e) { var d = !0, h; for (h in a) if (h in b) { var e = b[h], k; if (h in om) switch (k = om[h], k) { case vm: e = $.D(e) ? void 0 : $.wc(e); break; case wm: e = $.D(e) ? void 0 : $.Rl($.zc(e)); break; case xm: e = $.D(e) ? void 0 : $.xc(e); break; case ym: e = $.zm(e) } else k = Am; k != Am ? f = rm(a[h], e, k) ? void 0 : a[h] : f = pm(a[h], e, k || c); $.n(f) ? (a[h] = f, d = !1) : "xScale" == h || "yScale" == h || "colorScale" == h ? d = !1 : "enabled" != h && delete a[h] } else $.n(a[h]) && (d = !1); if (d) return } else {
                    if ($.n(c) && "array" ==
                        d && "array" == e) return rm(a, b, c) ? void 0 : a; if (a == b) return
                } return a
            }; rm = function (a, b, c) { var d = $.la(a), e = $.la(b); if (d == e) { if ("object" == d) for (var f in a) { d = b[f]; if (f in om) switch (om[f]) { case vm: d = $.D(d) ? void 0 : $.wc(d); break; case wm: d = $.D(d) ? void 0 : $.Rl($.zc(d)); break; case xm: d = $.D(d) ? void 0 : $.xc(d) }if (!rm(a[f], d, c)) return !1 } else if ("array" == d) { f = a.length; if (f != b.length) return !1; for (e = 0; e < f; e++) { d = b[e]; switch (c) { case Bm: d = $.wc(d); break; case Cm: d = $.Rl($.zc(d)) }if (!rm(a[e], d)) return !1 } } else return a === b; return !0 } return !1 };
            ...
            Mm = function (a) {
                if (a.FD) return !1; var b = 0, c = a.Pe - 1, d; a.vk = -1; a.uk = -1; for (var e = 0, f = "", h = 0; ++c < a.Us;)switch (d = a.b.charAt(c), e) {
                    case 0: if ('"' == d) { ++c < a.Us ? d = a.b.charAt(c) : c--; a.Pe = c; '"' == d ? e = 1 : (e = 2, c--); break } if (Jm(a, d)) { a.g(b++, null); f = ""; a.uk = -1; a.vk = -1; a.Pe = c + 1; break } if (Km(a, d)) { a.uk = -1; a.vk = -1; a.Pe = c + 1; if (0 < b) return a.g(b, null), !0; f = ""; break } if (!a.Hp || " " != d && "\t" != d) a.Pe = c, e = 1; break; case 1: if (Jm(a, d)) {
                        d = c - a.Pe - a.zy; 0 < a.zy && a.Hp ? (f = Lm(a.b.substr(a.Pe, d))) || (f = null) : (a.Hp && (d -= h), f = 0 < d ? a.b.substr(a.Pe,
                            d) : null); a.g(b++, f); f = ""; a.uk = -1; a.vk = -1; a.Pe = c + 1; e = h = 0; break
                    } if (Km(a, d)) if (d = c - a.Pe - a.uA, !b && 0 >= d) { f = ""; e = 0; a.uk = -1; a.vk = -1; a.Pe = c + 1; h = 0; break } else return 0 < a.uA && a.Hp ? (f = Lm(a.b.substr(a.Pe, d))) || (f = null) : (a.Hp && (d -= h), f = 0 < d ? a.b.substr(a.Pe, d) : null), a.g(b, f), a.Pe = c + 1, !0; !a.Hp || " " != d && "\t" != d ? h = 0 : h++; break; case 2: if ('"' == d) {
                        if (++c < a.Us) d = a.b.charAt(c); else return d = c - a.Pe - 1, a.g(b, 0 < d ? a.b.substr(a.Pe, d) : null), a.Pe = c, a.FD = !0; '"' == d ? (f += a.b.substr(a.Pe, c - a.Pe), a.Pe = c + 1) : (a.uk = -1, a.vk = -1, e = 3, f += a.b.substr(a.Pe,
                            c - a.Pe - 1), a.g(b++, f ? f : null), f = "", c--)
                    } break; case 3: if (Jm(a, d)) f = "", a.uk = -1, a.vk = -1, a.Pe = c + 1, e = h = 0; else if (Km(a, d)) return a.Pe = c + 1, !0
                }d = a.Us - a.Pe; 2 != e && 1 != e || !d || (f += a.b.substr(a.Pe, d), a.Hp && (f = Lm(a.b.substr(a.Pe, d))), a.g(b++, f ? f : null), a.Pe = a.Us); a.FD = !0; return 0 < b
            }; $.Nm = function (a) { return $.J(a, $.Pb) ? a : $.y(a) ? new $.Pb(a[0], a[1]) : $.A(a) ? new $.Pb(a.x, a.y) : new $.Pb(0, 0) }; $.Om = function (a, b) { var c = Math.pow(10, b || 0); return Math.round(a * c) / c || 0 };
            ...
            vaa = function (a, b, c, d, e, f) {
                var h = b.length; switch (b.charAt(0)) {
                    ...
                    case "E": return c = d.getDay(), 4 <= h ? a.b.XG[c] : a.b.RG[c]; case "a": return Gn(e), h = Dn(e), a.b.BG[12 <= h && 24 > h ? 1 : 0]; case "h": return Gn(e), c = Dn(e) % 12 || 12, Fn(a, $.Sa(c, h)); case "K": return Gn(e), c = Dn(e) % 12, Fn(a, $.Sa(c, h)); case "H": return Gn(e), c = Dn(e), Fn(a, $.Sa(c, h)); case "c": a: switch (c = d.getDay(), h) { case 5: h = a.b.DN[c]; break a; case 4: h = a.b.FN[c]; break a; case 3: h = a.b.EN[c]; break a; default: h = Fn(a, $.Sa(c, 1)) }return h; case "L": a: switch (c = d.getMonth(), h) {
                        case 5: h = a.b.CN[c]; break a; case 4: h = a.b.TG[c]; break a; case 3: h =
                            a.b.UG[c]; break a; default: h = Fn(a, $.Sa(c + 1, h))
            ...
            }; Ln = function (a, b) { b.push('"', a.replace(xaa, function (a) { var b = Mn[a]; b || (b = "\\u" + (a.charCodeAt(0) | 65536).toString(16).substr(1), Mn[a] = b); return b }), '"') }; $.Nn = function (a) { if ($.fa.JSON) try { return $.fa.JSON.stringify(a) } catch (b) { } return $.Jn(a) };
            ...
            $.Co = function (a) {
                var b; if ($.B(a)) if ("undefined" != typeof window.DOMParser) a = (new window.DOMParser).parseFromString(a, "application/xml"); else if (Ao) { var c = un(); c.loadXML(a); a = c } else throw Error("Your browser does not support loading xml documents"); if (!a) return null; switch (a.nodeType) {
                    case 1: var c = {}, d = !!a.getAttribute(Bo); d && (c = []); var e = {}, f, h, k, l = !0; k = a.childNodes.length; var m = ""; for (f = 0; f < k; f++)if (h = a.childNodes[f], b = $.Co(h), h = h.nodeName, "#" == h.charAt(0)) m += b; else if (d && "item" == h) l = !1, "" == b ? c.push(b) :
            ...
            $.Eo = function (a, b, c) {
                $.B(a) && (a = $.On(a)); var d; a: if (window.document.implementation && window.document.implementation.createDocument) d = window.document.implementation.createDocument("", "", null); else { if (Ao && (d = un())) break a; throw Error("Your browser does not support creating new documents"); } if (a = Do(a, b || "anychart", d)) b || a.setAttribute("xmlns", "http://anychart.com/schemas/8.0.1/xml-schema.xsd"), d.appendChild(a); if (c) b = d; else if (b = d, c = b.xml) b = c; else if ("undefined" != typeof window.XMLSerializer) b = (new window.XMLSerializer).serializeToString(b);
                else throw Error("Your browser does not support serializing XML documents"); return b
            };
            Do = function (a, b, c) {
                b = String(b).replace(/([A-Z])/g, "_$1").toLowerCase(); b = c.createElement(b); var d, e; if ($.B(a) || $.C(a)) b.appendChild(c.createCDATASection(Pa(String(a)))); else if ($.y(a)) for (b.setAttribute(Bo, "true"), d = 0; d < a.length; d++)$.n(a[d]) && b.appendChild(Do(a[d], "item", c)); else if (a) for (d in a) if (a.hasOwnProperty(d)) {
                    var f = a[d], h, k, l; if ($.y(f) && (h = Baa(d))) for (k = c.createElement(h[0]), b.appendChild(k), l = h[1], e = 0; e < f.length; e++)k.appendChild(Do(f[e], l, c)); else $.n(f) && ($.A(f) || !Caa.test(f) ? b.appendChild(Do(f,
                        d, c)) : b.setAttribute(String(d).replace(/([A-Z])/g, "_$1").toLowerCase(), f))
                } return b
            };
            ...
            Baa = function (a) {
                switch (a) {
                    ...
                    case "inverted": return ["inverted_list", "inverted"]; case "drillTo": return ["drill_to", "item"]; case "extraClassNames": return ["extra_class_names", "class_name"]; case "dependsOn": return ["depends_on", "item"]; case "precision": return ["precision_list", "precision"]; case "labels": return ["quarter_labels", "label"]; case "weights": return ["weights", "weight"]; case "angles": return ["angles", "angle"]
                }return null
            };
            zaa = function (a) {
                switch (a) {
                    ...
                    case "colorScales": return ["colorScales", "scale"]; case "drillTo": return ["drillTo", "item"]; case "extraClassNames": return ["extraClassNames", "className"]; case "dependsOn": return ["dependsOn", "item"]; case "precisionList": return ["precision", "precision"]; case "quarterLabels": return ["labels", "label"]; case "weights": return ["weights", "weight"]; case "angles": return ["angles", "angle"]
                }return null
            }; $.lm = function (a, b) { return String(a).replace(b ? /[_]([a-z])/g : /[-_]([a-z|\d])/g, function (a, b) { return b.toUpperCase() }) };
                ...
                a = String(a).toLowerCase(); switch (a) {
                    case "arrowhead": return function (a, c, d, e) { var b = c - e / 2, h = d - e / 3, k = c - e / 2, l = d + e / 3; a.moveTo(c + e / 2, d).lineTo(b, h).lineTo(k, l).close(); return a }; case "star4": return Ii; case "star6": return Ki; case "star7": return Li; case "star10": return Mi; case "diamond": return Ri; case "triangle-up": return Ni; case "triangle-down": return Oi; case "triangle-right": return Pi; case "triangle-left": return Qi; case "cross": return Si; case "diagonal-cross": return Ti; case "circle": return function (a,
                        c, d, e) { return Yi(a, c, d, e, 0, 360) }; case "trapezium": return function (a, c, d, e) { var b = e / 3; c -= e / 2; d -= e / 2; a.moveTo(c + b, d + e); a.lineTo(c + e - b, d + e); a.lineTo(c + e, d); a.lineTo(c, d); a.close(); return a }; case "pentagon": return function (a, c, d, e) { c -= e; d -= e; a.moveTo(c + e * Io[0], d + e * Jo[0]); for (var b = 1; 5 > b; b++)a.lineTo(c + e * Io[b], d + e * Jo[b]); a.lineTo(c + e * Io[0], d + e * Jo[0]); a.close(); return a }; case "square": return function (a, c, d, e, f) {
                            var b = c - e, k = d - e; c += e; d += e; $.n(f) && (f = f || 0, b = $.qo(b, f), k = $.qo(k, f), c = $.qo(c, f), d = $.qo(d, f)); a.moveTo(b,
                                k).lineTo(c, k).lineTo(c, d).lineTo(b, d).lineTo(b, k).close(); return a
                        }; case "v-line": case "line": return function (a, c, d, e, f) { f = f || 0; e *= 2; var b = e / 2; c -= b / 2; d -= e / 2; b = c + b; e = d + e; $.n(f) && (f = f || 0, c = $.qo(c, f), d = $.qo(d, f), b = $.qo(b, f), e = $.qo(e, f)); a.moveTo(c, d).lineTo(b, d).lineTo(b, e).lineTo(c, e).lineTo(c, d).close(); return a }; case "arrow-up": return function (a, c, d, e, f) {
                            var b = e / 2, k = b / 2; e = c + b; var l = c - b, m = d + b, b = d - b, p = c + k, k = c - k; $.n(f) && (f = f || 0, e = $.qo(e, f), l = $.qo(l, f), m = $.qo(m, f), b = $.qo(b, f), p = $.qo(p, f), k = $.qo(k, f),
                                c = $.qo(c, f), d = $.qo(d, f)); a.moveTo(c, b); a.lineTo(e, d, p, d, p, m, k, m, k, d, l, d); a.close(); return a
                        }; case "arrow-down": return function (a, c, d, e, f) { var b = e / 2, k = b / 2; e = c + b; var l = c - b, m = d + b, b = d - b, p = c + k, k = c - k; $.n(f) && (f = f || 0, e = $.qo(e, f), l = $.qo(l, f), m = $.qo(m, f), b = $.qo(b, f), p = $.qo(p, f), k = $.qo(k, f), c = $.qo(c, f), d = $.qo(d, f)); a.moveTo(c, m); a.lineTo(e, d, p, d, p, b, k, b, k, d, l, d); a.close(); return a }; case "arrow-left": return function (a, c, d, e, f) {
                            var b = e / 2, k = b / 2; e = c + b; var l = c - b, m = d + b, b = d - b, p = d + k, k = d - k; $.n(f) && (f = f || 0, e = $.qo(e,
                                f), l = $.qo(l, f), m = $.qo(m, f), b = $.qo(b, f), p = $.qo(p, f), k = $.qo(k, f), c = $.qo(c, f), d = $.qo(d, f)); a.moveTo(l, d); a.lineTo(c, m, c, p, e, p, e, k, c, k, c, b); a.close(); return a
                        }; case "arrow-right": return function (a, c, d, e, f) { var b = e / 2, k = b / 2; e = c + b; var l = c - b, m = d + b, b = d - b, p = d + k, k = d - k; $.n(f) && (f = f || 0, e = $.qo(e, f), l = $.qo(l, f), m = $.qo(m, f), b = $.qo(b, f), p = $.qo(p, f), k = $.qo(k, f), c = $.qo(c, f), d = $.qo(d, f)); a.moveTo(e, d); a.lineTo(c, m, c, p, l, p, l, k, c, k, c, b); a.close(); return a }; default: return Ji
                }
            };
            Lo = function (a, b, c, d) {
                var e = new $.Hm; c = !0; $.A(d) && (e.vA(d.rowsSeparator), e.Ay(d.columnsSeparator), e.Fz(d.ignoreTrailingSpaces), c = !d.ignoreFirstRow, e.Dz(c)); if (a = e.Jx(a)) {
                    d = $.bf("table"); b && (e = $.bf("caption"), $.hf(e, b), d.appendChild(e)); var f, h; c && (f = $.bf("thead"), h = $.bf("tr"), f.appendChild(h)); b = $.bf("tbody"); for (e = 0; e < a.length; e++) {
                        var k = a[e], l, m; if (e || !c) { var p = $.bf("tr"); for (l = 0; l < k.length; l++) { m = k[l]; var q = $.bf(l ? "td" : "th"); $.hf(q, m); p.appendChild(q) } b.appendChild(p) } else if (c) for (l = 0; l < k.length; l++)m =
                            k[l], p = $.bf("th"), $.hf(p, m), h.appendChild(p)
            ...
            $.bp = function (a) {
                ...
                } a ? a.va(!1, c || d || e || f) : $.hl(7); return a
            }; dp = function (a) { var b = $.cp; if (b.addEventListener || "load" === $.kl.event.type || "complete" === b.readyState) b = $.kl, $.Wd($.cp, ["DOMContentLoaded", "readystatechange"], dp, !1), $.Wd(b, "load", dp, !1), ep(a) };
            ...
            $.jm = function (a) {
                a = $.lm(a); var b; kp.length || (kp.push($.kl.anychart.themes.defaultTheme || {}), lp.push(kp[0])); for (b = kp.length - 1; b < mp.length; b++) { var c = mp[b], c = $.Sl($.B(c) ? $.kl.anychart.themes[c] : c); kp.push($.A(c) ? c : {}); lp.push({}) } c = window.Infinity; for (b = 0; b < kp.length; b++)fm(kp[b], a, b) && (c = Math.min(c, b)); for (b = Math.max(1, c); b < lp.length; b++) {
                    c = a.split("."); gm(lp[b], [c[0]], hm($.Sl($.im(kp[b], c[0].split("."))), $.im(lp[b - 1], c[0].split(".")))); var c = b, d = a.split("."), e = em[d[0]]; e || (em[d[0]] = { qw: [], hA: 0, ru: 0 });
                    e.hA = c
                } return $.im(lp[lp.length - 1], a.split("."))
            ...
            $.Ep = function (a, b, c, d, e) {
                $.vp(a, [["minFontSize", b, d, void 0, e], ["maxFontSize", b, d, void 0, e], ["adjustFontSize", b, d, void 0, e], ["fontSize", b, d, void 0, e], ["fontFamily", b, d, void 0, e], ["fontColor", c, 1], ["fontOpacity", c, 1], ["fontDecoration", b, d, void 0, e], ["fontStyle", b, d, void 0, e], ["fontVariant", b, d, void 0, e], ["fontWeight", b, d, void 0, e], ["letterSpacing", b, d, void 0, e], ["textDirection", b, d, void 0, e], ["lineHeight", b, d, void 0, e], ["textIndent", b, d, void 0, e], ["vAlign", b, d, void 0, e], ["hAlign", b, d, void 0, e], ["wordWrap",
                    b, d, void 0, e], ["wordBreak", b, d, void 0, e], ["textOverflow", b, d, void 0, e], ["selectable", c, 1], ["disablePointerEvents", c, 1], ["useHtml", b, d, void 0, e]])
            }; $.Gp = function (a, b) { for (var c in b) { var d = b[c]; a.prototype[c] = $.va(Fp[d.kr], d.kM, d.s8, d.im) } }; $.Hp = function (a, b) { for (var c = 0; c < b.length; c++) { var d = b[c]; a.prototype[d] = function (a) { return function (b) { var c = this.normal(); return $.n(arguments[0]) ? (c[a].apply(c, arguments), this) : c[a]() } }(d) } };
            ...
            uq = function (a, b) {
                var c, d, e, f, h, k; d = a.Ff(b); if ($.y(d)) if (e = a.ci(b), e.ma) for (h in c = {}, e = e.Zl(), e) for (f = e[h], k = 0; k < f.length; k++) { if (f[k] in d) { f = a.MF(d[f[k]]); c[h] = f; break } } else c = (0, $.Eb)(d, a.MF); else if ($.A(d)) if (e = a.ci(b), e.ma) { c = {}; e = e.Zl(); for (h in e) for (f = e[h], k = 0; k < f.length; k++)if (f[k] in d) { f = d[f[k]]; $.J(f, Date) && (f = f.getTime()); if (!$.n(f) || $.C(f) && (0, window.isNaN)(f)) f = null; c[h] = f; break } for (h in d) !d.hasOwnProperty(h) || h in e && h in c || (f = a.MF(d[h]), c[h] = f) } else {
                    h = a.MF; e = {}; for (c in d) e[c] = h.call(void 0,
                        d[c], c, d); c = e
                } else { if (!$.n(d) || $.C(d) && (0, window.isNaN)(d)) d = null; c = d } return c
            }; vq = function (a, b) { $.rq.call(this, a); this.g = b; b.pa("signal", this.jA, !1, this) }; wq = function (a, b, c) { $.rq.call(this, a); this.g = b; this.j = c }; $.yq = function (a, b) { $.rq.call(this, a); $.xq(this, b) };
            ...
            Iq = function (a, b) {
                var c = caa(b), d; if ("csv" == c) try { var e = new $.Hm; $.A(b) && (e.vA(b.rowsSeparator), e.Ay(b.columnsSeparator), e.Fz(b.ignoreTrailingSpaces), e.Dz(b.ignoreFirstRow)); d = e.Jx(a) } catch (r) { d = null, $.hl(101) } else {
                    var f = {}, h = 0, k = window.NaN, l = window.NaN, e = window.NaN, m; b && ((m = b.ignoreItems) && (m = new RegExp("^(" + m.join("|") + ")$")), b.minLength && (h = b.minLength), b.maxLength && (k = b.maxLength), b.cutLength && (l = b.cutLength), b.maxItems && (e = b.maxItems)); if ("by-word" == c) a.split(Hq).forEach(function (a) {
                        a = a.replace(Haa,
                            ""); var b = a.length; m && m.test(a.toLowerCase()) || b > k || b < h || ((0, window.isNaN)(l) || (a = a.substr(0, l)), f[a = a.toLowerCase()] = (f[a] || 0) + 1)
                    }); else { a = a.replace(Hq, ""); for (var c = 0, p = a.length; c < p; c++) { var q = a[c]; m && m.test(q.toLowerCase()) || (f[q = q.toLowerCase()] = (f[q] || 0) + 1) } } d = []; $.Hc(f, function (a, b) { d.push([b, a]) }); d = d.sort(function (a, b) { return b[1] - a[1] }); d.length = Math.min(d.length, e || window.Infinity)
                } return d
            };
            ...
            Jq = function (a, b) {
                for (var c = !1, d = "", e = 0; e < b.length; e++) {
                    var f = b.charAt(e); if (" " == f) for (0 < d.length && (a.b.push({ text: d, count: 0, Bu: !1 }), d = ""), a.b.push({ text: " ", count: 0, Bu: !1 }); e < b.length - 1 && " " == b.charAt(e + 1);)e++; else if (c) "'" == f ? e + 1 < b.length && "'" == b.charAt(e + 1) ? (d += "'", e++) : c = !1 : d += f; else if (0 <= Jaa.indexOf(f)) { 0 < d.length && (a.b.push({ text: d, count: 0, Bu: !1 }), d = ""); var h; h = b.charAt(e); for (var k = e + 1; k < b.length && b.charAt(k) == h;)k++; h = k - e; a.b.push({ text: f, count: h, Bu: !1 }); e += h - 1 } else "'" == f ? e + 1 < b.length &&
                        "'" == b.charAt(e + 1) ? (d += "'", e++) : c = !0 : d += f
                } 0 < d.length && a.b.push({ text: d, count: 0, Bu: !1 }); c = !1; for (d = 0; d < a.b.length; d++)Kq(a.b[d]) ? !c && d + 1 < a.b.length && Kq(a.b[d + 1]) && (c = !0, a.b[d].Bu = !0) : c = !1
            }; Kq = function (a) { if (0 >= a.count) return !1; var b = "MydhHmsSDkK".indexOf(a.text.charAt(0)); return 0 < b || !b && 3 > a.count }; Lq = function (a, b) { var c = a.substring(b[0]).match(/^\s+/); c && (b[0] += c[0].length) };
            Oq = function (a, b, c, d, e, f) {
                Lq(b, c); var h = c[0], k = d.text.charAt(0), l = -1; if (Kq(d)) if (0 < e) { if (h + e > b.length) return !1; l = Mq(a, b.substring(0, h + e), c) } else l = Mq(a, b, c); switch (k) {
                    case "G": return l = Nq(b, c, a.g.FG), 0 <= l && (f.era = l), !0; case "M": case "L": a: { d = l; if (0 > d) { a = a.g.LG.concat(a.g.TG).concat(a.g.PG).concat(a.g.UG); d = Nq(b, c, a); if (0 > d) { f = !1; break a } f.month = d % 12 } else f.month = d - 1; f = !0 } return f; case "E": return d = Nq(b, c, a.g.XG), 0 > d && (d = Nq(b, c, a.g.RG)), 0 > d ? f = !1 : (f.g = d, f = !0), f; case "a": return l = Nq(b, c, a.g.BG), 0 <= l &&
            ...
            }; Mq = function (a, b, c) { if (a.g.YG) { for (var d = [], e = c[0]; e < b.length; e++) { var f = b.charCodeAt(e) - a.g.YG; d.push(0 <= f && 9 >= f ? String.fromCharCode(f + 48) : b.charAt(e)) } b = d.join("") } else b = b.substring(c[0]); a = b.match(/^\d+/); if (!a) return -1; c[0] += a[0].length; return (0, window.parseInt)(a[0], 10) }; Nq = function (a, b, c) { var d = 0, e = -1; a = a.substring(b[0]).toLowerCase(); for (var f = 0; f < c.length; f++) { var h = c[f].length; h > d && !a.indexOf(c[f].toLowerCase()) && (e = f, d = h) } 0 <= e && (b[0] += d); return e }; Kaa = function () { };
            ...
            Tq = function (a) {
                if (!a) return zn; var b = $.ra(a); b in Sq || (Sq[b] = {
            ...
            $.hr = function (a, b, c, d) {
                if ($.na(a)) return a; if ($.C(a)) return (0, window.isNaN)(a) ? null : new Date(a); if ($.B(a)) {
                    if (b = ($.n(b) ? b : er) || null) {
                        d = $.mo(d) || $.mo(fr) || $.mo("default"); var e = $.ra(d), e = b + e, f; e in gr || (d = Tq(d), gr[e] = new Iaa(b, d)); f = gr[e]; c = $.na(c) ? c : Vq(); (b = -1 == b.replace(/'.+?'/g, "").search(/z+/i)) && c.setTime(c.getTime() + 6E4 * c.getTimezoneOffset()); d = a.length; a: {
                            for (var h = new Kaa, e = [0], k = -1, l = 0, m = 0, p = 0; p < f.b.length; p++)if (0 < f.b[p].count) if (0 > k && f.b[p].Bu && (k = p, m = l = 0), 0 <= k) {
                                var q = f.b[p].count; if (p ==
                                    k && (q -= m, m++, 0 == q)) { a = 0; break a } Oq(f, a, e, f.b[p], q, h) || (p = k - 1, e[0] = l)
                            } else { if (k = -1, !Oq(f, a, e, f.b[p], 0, h)) { a = 0; break a } } else { k = -1; if (" " == f.b[p].text.charAt(0)) { if (q = e[0], Lq(a, e), e[0] > q) continue } else if (a.indexOf(f.b[p].text, e[0]) == e[0]) { e[0] += f.b[p].text.length; continue } a = 0; break a } b: {
                                void 0 != h.era && void 0 != h.year && !h.era && 0 < h.year && (h.year = -(h.year - 1)); void 0 != h.year && c.setFullYear(h.year); a = c.getDate(); c.setDate(1); void 0 != h.month && c.setMonth(h.month); void 0 != h.day ? c.setDate(h.day) : (f = cn(c.getFullYear(),
                                    c.getMonth()), c.setDate(a > f ? f : a)); $.D(c.setHours) && (void 0 == h.b && (h.b = c.getHours()), void 0 != h.J && 0 < h.J && 12 > h.b && (h.b += 12), c.setHours(h.b)); $.D(c.setMinutes) && void 0 != h.o && c.setMinutes(h.o); $.D(c.setSeconds) && void 0 != h.B && c.setSeconds(h.B); $.D(c.setMilliseconds) && void 0 != h.F && c.setMilliseconds(h.F); void 0 != h.j && c.setTime(c.getTime() + 6E4 * (h.j - c.getTimezoneOffset())); h.K && (a = new Date, a.setFullYear(a.getFullYear() - 80), c.getTime() < a.getTime() && c.setFullYear(a.getFullYear() + 100)); if (void 0 != h.g) if (void 0 ==
                                        h.day) a = (7 + h.g - c.getDay()) % 7, 3 < a && (a -= 7), h = c.getMonth(), c.setDate(c.getDate() + a), c.getMonth() != h && c.setDate(c.getDate() + (0 < a ? -7 : 7)); else if (h.g != c.getDay()) { a = !1; break b } a = !0
                            } a = a ? e[0] - 0 : 0
                        } return d == a ? (b && c.setTime(c.getTime() - 6E4 * c.getTimezoneOffset()), c) : null
                    } c = +a; a = new Date((0, window.isNaN)(c) ? a : c); return (0, window.isNaN)(a.getTime()) ? null : a
                } return null
            };
            jr = function (a, b) {
                var c = Qq(b) || Qq(fr) || Qq("default"), d = 1; if ($.B(a)) {
                    c.useBracketsForNegative && "(" == a.charAt(0) && ")" == a.charAt(a.length - 1) && (d = -1, a = a.substring(1, a.length - 1)); a = a.replace(c.decimalPoint, "."); a = a.replace(new RegExp(Qa(c.groupsSeparator), "g"), ""); var e = c.scale; !0 === e && (e = ir); if ($.A(e) && $.y(e.factors) && $.y(e.suffixes)) {
                        a = a.replace(new RegExp(Qa(c.scaleSuffixSeparator), "g"), ""); var f = a.match(Laa); if (!f) return window.NaN; var h = 1; a = +f[1]; if (f = f[2]) for (var k = e.factors, e = e.suffixes, l = Math.min(k.length,
                            e.length), m = 0; m < l; m++)if (f == e[m]) { h = k[m]; break } a *= h
                    }
                } d *= +a; return (0, window.isNaN)(d) ? d : $.Om(d, c.decimalsCount)
            }; $.kr = function (a) { var b = Pq(Wq); return (b = b && b.messages) && a in b ? b[a] : a }; $.lr = function (a, b, c) { b = $.Zk(b); a = $.Zk(a); return (c ? c + "_" : "") + (a == b ? a : b + "_" + a) }; $.mr = function (a, b, c) { a = (c = $.mo(c) || $.mo(Wq) || $.mo("default")) && c.formats && c.formats[a]; return ($.y(a) ? a[Math.min(a.length - 1, b || 0)] : $.B(a) ? a : "") || "yyyy/MM/dd'T'HH:mm:ss.SSS" };
            ...
            $.sr = function (a, b, c, d, e, f, h, k) {
                var l; $.B(b) ? l = Qq(b) : $.A(b) && (l = b); var m = Qq(Wq) || Qq("default"); b = $.C(b) ? b : l && $.C(l.decimalsCount) ? l.decimalsCount : m.decimalsCount; c = $.B(c) ? c : l && $.B(l.decimalPoint) ? l.decimalPoint : m.decimalPoint; d = $.B(d) ? d : l && $.B(l.groupsSeparator) ? l.groupsSeparator : m.groupsSeparator; e = $.A(e) || $.oa(e) ? e : l && ($.A(l.scale) || $.oa(l.scale)) ? l.scale : m.scale; f = $.oa(f) ? f : l && $.oa(l.zeroFillDecimals) ? l.zeroFillDecimals : m.zeroFillDecimals; h = $.B(h) ? h : l && $.B(l.scaleSuffixSeparator) ? l.scaleSuffixSeparator :
                    m.scaleSuffixSeparator; k = $.oa(k) ? k : l && $.oa(l.useBracketsForNegative) ? l.useBracketsForNegative : m.useBracketsForNegative; !0 === e && (e = ir); (l = 0 > a) && (a = -a); m = ""; if ($.A(e) && $.y(e.factors) && $.y(e.suffixes)) { var p = 1, q = e.factors; e = e.suffixes; for (var r = Math.min(q.length, e.length), t = 0; t < r; t++)if (p = q[t], a >= p || 1 >= p && a > .1 * p) { m = e[t]; break } m ? m = h + m : p = 1; a /= p } f = f ? a.toFixed(b) : $.Om(a, b).toString(); a = ""; /(e+|e-)/.test(f) && (b = f.split("e"), f = b[0], a = "e" + b[1]); b = f.split("."); if (d) {
                        f = b[0]; for (h = []; 0 < (e = f.substr(0, f.length -
                            3)).length;)h.unshift(f.substr(-3)), f = e; f && h.unshift(f); b[0] = h.join(d)
                    } d = l ? "-" : ""; c = b.join(c) + a + m; l && k && (c = ["(", c, ")"].join(""), d = ""); return d + c
            }; $.tr = function () { $.hq.call(this); this.j = null; this.j = $.nb($.jm("palette.items")); this.wa(2) }; $.ur = function () { $.hq.call(this); this.b = []; for (var a in lh) this.b.push($.zc(lh[a])) }; $.vr = function () { $.hq.call(this); this.g = []; for (var a in Nk) this.g.push(Nk[a]) };
            ...
            wr = function (a) {
                if (a.j && a.b) {
                    var b = [], c = $.y(a.j) ? a.j : a.j.keys; if ($.y(c) && c.length) {
                        (0, window.isNaN)(a.b) && (a.b = c.length); for (var d = 1 / (c.length - 1), e, f = 0; f < c.length; f++) { var h = c[f]; $.B(h) ? (e = $.Ll(h), b.push({ color: e ? e.Qf : "#000000", offset: f * d })) : (e = $.Ll(h.color), b.push({ color: e ? e.Qf : "#000000", offset: $.n(h.offset) ? h.offset : f * d })) } $.zb(b); a.g = []; if (1 == b.length) for (f = 0; f < a.b; f++)a.g[f] = { color: b[0].color }; else for (f = 0; f < a.b; f++) {
                            e = 1 == a.b ? 0 : f / (a.b - 1); d = c = null; for (h = 0; h < b.length; h++)e >= b[h].offset && (c = b[h]),
                                e <= b[h].offset && null == d && (d = b[h]); c || (c = b[0]); d || (d = b[b.length - 1]); d.offset == c.offset ? a.g[f] = { color: c.color } : (e = 1 - (e - c.offset) / (d.offset - c.offset), a.g[f] = { color: $.uc($.Hl($.El(c.color), $.El(d.color), e)) })
                        }
                    }
                }
            }; yr = function (a) { $.hq.call(this); this.scale = a; this.j = Maa; this.g = Naa; this.b = Oaa }; zr = function (a, b, c, d) { b = Math.abs(c - b) / a.wj; c = a.b.length; for (var e = 0; e < c; e++)if (b <= a.b[e]) return d ? a.j[e].clone() : a.g[e].clone(); return d ? new $.kn(dn, Math.ceil(b / 31536E6) / 4) : new $.kn(dn, Math.ceil(b / 31536E6)) };
            ...
            $.Vr = function (a, b, c, d, e, f) {
                if ("logarithmic" == a.iv) {
                    f = f || 10; a.zh = null; var h = [b, c]; if (a.Fg) d && (h[0] = Math.min(b, a.Fg[0] || 0)), e && (h[1] = Math.max(c, a.Fg[a.Fg.length - 1] || 0)); else {
                        b = $.Rm(b, f); c = $.Rm(c, f); var k = [], l = a.ih, m = a.Se, p = a.Th; !(0, window.isNaN)(l) && (c - b) / l > a.ta.Rq() && ($.jl(20, null, [c - b, l]), l = window.NaN, m = 4, p = 6); if ((0, window.isNaN)(l)) for (var q = window.NaN, r = m; r <= p; r++) {
                            var m = (c - b) / (r - 1), t = Math.log(m), u = Math.ceil(Math.pow(10, Math.floor(t * Math.LOG10E))), m = Math.min($.lo(m, u), $.lo(m, Math.ceil(Math.pow(10,
                                Math.ceil(t * Math.LOG10E)))), $.lo(m, Math.ceil(Math.pow(2, Math.floor(t * Math.LOG2E)))), $.lo(m, Math.ceil(Math.pow(2, Math.ceil(t * Math.LOG2E)))), $.lo(m, Math.ceil(u / 2)), $.lo(m, Math.ceil(u / 4)), $.lo(m, Math.ceil(u / 8))), m = Math.max(m, 1E-7), t = $.Pm($.ko(b, m, a.rk)) - b, t = t * t, u = $.Pm($.lo(c, m, a.rk)) - c, u = u * u, t = t + u; if ((0, window.isNaN)(q) || t < q) q = t, l = m
                        } l = Math.max(l, 1E-7); p = $.Pm($.ko(b, l, a.rk)); d ? (b = p, h[0] = Sm(f, p)) : 1E-7 < b - p && (k.push(Sm(f, b)), h[2] = Sm(f, p)); d = $.Pm($.lo(c, l, a.rk)); e ? (c = d, h[1] = Sm(f, d)) : 1E-7 < d - c && (h[3] = Sm(f,
                            d)); for (e = $.Pm($.lo(b, l, a.rk)); e <= c; e = $.Pm(e + l))k.push(Sm(f, e)); 3 in h && k.push(Sm(f, c)); a.zh = k
                    } a = h
                } else {
                    a.zh = null; f = [b, c]; if (a.Fg) d && (f[0] = Math.min(b, a.Fg[0] || 0)), e && (f[1] = Math.max(c, a.Fg[a.Fg.length - 1] || 0)); else {
                        h = []; k = a.ih; q = a.Se; l = a.Th; !(0, window.isNaN)(k) && (c - b) / k > a.ta.Rq() && ($.jl(20, null, [c - b, k]), k = window.NaN, q = 4, l = 6); if ((0, window.isNaN)(k)) for (p = window.NaN, m = q; m <= l; m++) {
                            var q = (c - b) / (m - 1), r = Math.log(q), t = Math.pow(10, Math.floor(r * Math.LOG10E)), u = Math.pow(10, Math.ceil(r * Math.LOG10E)), v = q < t + t ? t /
                                2 : Number.POSITIVE_INFINITY, r = $.Rm(q / u, 2), q = Math.min($.lo(q, t), $.lo(q, u), $.lo(q, v), $.lo(q, Math.pow(2, Math.floor(r)) * u), $.lo(q, Math.pow(2, Math.ceil(r)) * u)), r = $.Pm($.ko(b, q, a.rk)) - b, r = r * r, t = $.Pm($.lo(c, q, a.rk)) - c, t = t * t, r = r + t; if ((0, window.isNaN)(p) || r < p) p = r, k = q
                        } k = Math.max(k, 1E-7); if ((0, window.isFinite)(k)) { l = 1; for (p = 0; Math.round(k * l) / l !== k;)l *= 10, p++; l = p } else l = 0; p = $.Pm($.ko(b, k, a.rk), l); d ? f[0] = b = p : 1E-7 < b - p && (h.push(b), f[2] = p); d = $.Pm($.lo(c, k, a.rk), l); e ? f[1] = c = d : 1E-7 < d - c && (f[3] = d); for (e = $.Pm($.lo(b, k,
                            a.rk), l); e <= c; e = $.Pm(e + k, l))h.push(e); 3 in f && h.push(c); a.zh = h
                    } a = f
                } return a
            };
            ...
            Fs = function (a) {
                var b = a.oa(), c, d, e; d = a.N("width"); var f = a.N("height"); b ? (c = b.width, b = b.height, null != d ? (a.Y = d = $.M(d, c), c = !1) : (d = 0, c = !0), null != f ? (a.P = e = $.M(f, b), b = !1) : (e = 0, b = !0)) : ($.ao(d) ? (c = !0, d = 0) : (c = !1, a.Y = d = $.O(d)), $.ao(f) ? (b = !0, e = 0) : (b = !1, a.P = e = $.O(f))); f = a.padding(); a.b.width(null); a.b.height(null); c ? (d += a.b.sb().width, a.ca = d, a.Y = f.vi(d)) : d = a.ca = f.mg(d); a.b.width(a.ca); b ? (e += a.b.sb().height, a.ba = e, a.P = f.xh(e)) : e = a.ba = f.Bg(e); a.b.height(a.ba); var h = !c, k = !b, l = a.N("adjustFontSize"), h = l && h && l.width ||
                    k && l.height; $.T(a); if (h) {
                        var h = a.N("minFontSize"), m = a.N("maxFontSize"), l = Math.round((m + h) / 2), k = m, p = mk(); p.nd("aria-hidden", "true"); a.Gg(p, !0); p.fontSize(m); if (0 >= Es(a, p.sb().width, p.sb().height, d, e)) d = m; else {
                            p.fontSize(l); for (var q = m = Es(a, p.sb().width, p.sb().height, d, e); h != k;) { if (0 > m) h = Math.min(l + 1, k), l += Math.floor((k - l) / 2); else if (0 < m) k = Math.max(l - 1, h), l -= Math.ceil((l - h) / 2); else break; p.fontSize(l); m = Es(a, p.sb().width, p.sb().height, d, e); if (0 >= q * m) break } if (m) {
                                do l += q, p.fontSize(l), m = Es(a, p.sb().width,
                                    p.sb().height, d, e); while (0 > q * m); $.K(p); 0 < q && (l -= q)
                            } else $.K(p); d = l
                        } a.fontSize(d); a.b.fontSize(d); c && (a.b.width(null), a.ca = a.b.sb().width, a.b.width(a.ca), a.Y = f.vi(a.ca)); b && (a.b.height(null), a.ba = a.b.sb().height, a.b.height(a.ba), a.P = f.xh(a.ba))
                    } else l && (l.width || l.height) && (a.fontSize(a.N("minFontSize")), a.b.fontSize(a.N("minFontSize")), c && (a.b.width(null), a.ca = a.b.sb().width, a.b.width(a.ca), a.Y = f.vi(a.ca)), b && (a.b.height(null), a.ba = a.b.sb().height, a.b.height(a.ba), a.P = f.xh(a.ba))); a.ka(!1); a.F = $.M(f.N("left"),
                        a.Y); a.R = $.M(f.N("top"), a.P)
            }; Gs = function (a) { var b; if (b = !a.b) a.b = mk(), a.b.nd("aria-hidden", "true"); return b }; $.Hs = function () { Cs.call(this); $.vp(this.J, [["visible", 128, 1]]); this.Pa.visible = !0 }; Is = function () { $.Hs.call(this) };
            ...
            Qaa = function (a) {
                var b; switch (a) {
                    case "step-area": a = function (a, b) { a.moveTo(0, .6 * b).lineTo(.5 * b, .6 * b).lineTo(.5 * b, .1 * b).lineTo(b, .1 * b).lineTo(b, b).lineTo(0, b).lineTo(0, .6 * b).close() }; break; case "area": a = function (a, b) { a.moveTo(0, .7 * b).lineTo(.35 * b, .3 * b).lineTo(.5 * b, .5 * b).lineTo(b, 0).lineTo(b, b).lineTo(0, b).lineTo(0, .7 * b).close() }; break; case "range-step-area": case "range-spline-area": case "range-area": a = function (a, b) {
                        a.moveTo(0, .2 * b).lineTo(.5 * b, .4 * b).lineTo(b, .2 * b).lineTo(b, .8 * b).lineTo(.5 * b, .6 * b).lineTo(0,
                            .8 * b).close()
                    }; break; case "spline-area": a = function (a, b) { var c = b / 2; a.moveTo(b, .6 * c).lineTo(b, b).lineTo(0, b).lineTo(0, 1.3 * c).Wc(0, c, c, .3 * c, 90, -90).Wc(b, c, c, .4 * c, 180, 90).moveTo(0, 0).close() }; break; case "range-bar": a = function (a, b) { a.moveTo(.35 * b, 0).lineTo(.65 * b, 0).lineTo(.65 * b, .15 * b).lineTo(.35 * b, .15 * b).close().moveTo(.1 * b, .4 * b).lineTo(.9 * b, .4 * b).lineTo(.9 * b, .55 * b).lineTo(.1 * b, .55 * b).close().moveTo(.25 * b, .8 * b).lineTo(.75 * b, .8 * b).lineTo(.75 * b, .95 * b).lineTo(.25 * b, .95 * b).close() }; break; case "range-column": a =
                        function (a, b) { a.moveTo(0, .6 * b).lineTo(0, .4 * b).lineTo(.15 * b, .4 * b).lineTo(.15 * b, .6 * b).lineTo(0, .6 * b).close().moveTo(.4 * b, .9 * b).lineTo(.4 * b, .1 * b).lineTo(.55 * b, .1 * b).lineTo(.55 * b, .9 * b).lineTo(.4 * b, .9 * b).close().moveTo(.8 * b, .7 * b).lineTo(.8 * b, .3 * b).lineTo(.95 * b, .3 * b).lineTo(.95 * b, .7 * b).lineTo(.8 * b, .7 * b).close() }; break; case "bar": a = function (a, b) {
            ...
            Ts = function (a) {
                var b = a.oa(), c, d, e = a.b.sb(), f = a.B + $.Ac(a.aa); b ? (c = b.width, d = b.height) : c = d = void 0; var h = $.M(a.hg, c), k = $.M(a.df, d), l = c ? $.M(a.Ha, c) : 0; d = d ? $.M(a.Wa, d) : 0; h ? a.b.width(h - (a.R ? f + a.ca : 0)) : "..." == a.b.vm() && (c = c ? Math.min(c - (a.R ? f + a.ca : 0), e.width) : e.width, c = Math.max(c, 1E-5), a.b.width(c), a.b.height(k ? k : e.height)); e = a.b.sb(); k = (a.R ? f + a.ca : 0) + e.width; c = a.b.Y; if (1 < c.length) { f = 0; c = c[0]; for (var h = 0, m = c.length; h < m; h++)f = Math.max(f, c[h].height); e = Math.max(f / 2, a.B / 2) + Math.max(e.height - f / 2, a.B / 2) } else e =
                    Math.max(a.R ? f : 0, e.height); a.tb = b ? new $.I(b.gb() + l, b.Hb() + d, k, e) : new $.I(l, d, k, e)
            }; Js = function (a) { a.Ha = 0; a.Wa = 0; a.R = !0; a.j = !1; a.o = "square"; a.fa = "black"; a.aa = "none"; a.ba = null; a.qa = null; a.ha = "none"; a.za = "none"; a.ca = 5 }; Raa = function (a, b) { return a.j ? a.Ia.iconStroke : $.to(a.aa) && a.o in a.Ja ? a.Ja[a.o] : b ? $.Pl(a.aa) : a.aa }; Saa = function (a, b) { return a.o in a.Sb ? null : a.j ? a.Ia.iconFill : b ? $.Pl(a.fa) : a.fa }; Uaa = function (a, b) { return a.j ? a.Ia.iconMarkerStroke : b ? $.Pl(a.za) : a.za };
            ...
            Xs = function (a) {
                var b = a.oa(), c, d; b ? (c = b.width, d = b.height) : c = d = void 0; var e = !!a.Yf, f, h, k; e && (f = a.Yf.sb(), h = f.width, k = f.height); var l = null != a.Pb, m = null != a.kc; f = a.padding(); l ? (h = $.Vn(a.Pb) && !$.n(c) ? e ? h : 0 : $.M(a.Pb, c), e && (a.F = $.M(f.N("left"), h))) : (h = e ? h : 0, e && (a.F = $.M(f.N("left"), h)), h = f.vi(h)); b && c < h && (h = c); m ? (k = $.Vn(a.kc) && !$.n(d) ? e ? k : 0 : $.M(a.kc, d), e && (a.R = $.M(f.N("top"), k))) : (k = e ? k : 0, e && (a.R = $.M(f.N("top"), k)), k = f.xh(k)); b && d < k && (k = d); e && (a.Yf.width(h), a.Yf.height(k)); b = $.Nm(a.o); b.x = c ? $.M(b.x, c) : 0; b.y =
                    d ? $.M(b.y, d) : 0; a.g = new $.I(b.x, b.y, h, k)
            }; $.Zs = function (a, b) { $.n(b) && (a.aa = b) }; $s = function () { $.Vs.call(this); this.B = $.ia; $.Ws(this, 16, !1) }; at = function (a, b) { $.n(b) && a.B != b && (a.B = b, a.D(64, 1)) }; $.bt = function (a, b, c, d) { ys.apply(this, arguments) };
            ...
            it = function (a, b) {
                var c = a.padding(), d = a.margin(), e, f, h = a.oa(); h && (e = h.width, f = h.height); var k, l; a.Y || (a.Y = {}); l = $.n(b) ? b : a.P; k = l + a.aa.substr(0, 1); if (a.Y[k]) l = a.Y[k]; else { var m = mk(); m.nd("aria-hidden", "true"); a.Gg(m, !0); m.text(l + " / " + l); l = m.sb(); $.K(m); var p = l.height; "horizontal" == a.aa ? (m = 2 * p + 20 + l.width, l = l.height) : (m = Math.max(p, l.width), l = 2 * p + 20 + l.height); l = a.Y[k] = [m, l] } k = l[0]; l = l[1]; a.g = c.vi(k); a.b = c.xh(l); h && e < a.g && (a.g = d.mg(a.g)); h && f < a.b && (a.b = d.Bg(a.b)); c = d.vi(a.g); k = d.xh(a.b); l = h ? $.M(d.N("left"),
                    a.g) : 0; d = h ? $.M(d.N("top"), a.b) : 0; if (h) { switch (a.fc) { case "top": a.F = h.gb() + (e - c) / 2 + l; a.R = h.Hb() + d; break; case "right": a.F = h.Ra() - c + l; a.R = h.Hb() + (f - k) / 2 + d; break; case "bottom": a.F = h.gb() + (e - c) / 2 + l; a.R = h.Ka() - k + d; break; case "left": a.F = h.gb() + l, a.R = h.Hb() + (f - k) / 2 + d }a.tb = new $.I(a.F - l, a.R - d, c, k) } else a.F = l, a.R = d, a.tb = new $.I(0, 0, c, k)
            }; jt = function (a, b) { a.tb && !a.W(4) || it(a, b); return a.tb }; et = function (a) { $.U(a, 1) && this.ea() };
            ...
            lt = function (a) {
                var b = a.margin(), c = a.oa(), d, e; c ? a.zb() ? (d = c.width, e = c.height) : (d = c.height, e = c.width) : d = e = void 0; var f = a.N("width"), h = a.N("height"), h = $.to(h) || !$.n(h) ? "100%" : h, f = $.M($.to(f) || !$.n(f) ? "100%" : f, d); c && d < b.vi(f) && (f = b.mg(d)); h = $.M(h, e); c && e < b.xh(h) && (h = b.Bg(e)); var k = b.vi(f), l = b.xh(h); d = $.M(b.N("left"), d); b = $.M(b.N("top"), e); e = a.N("orientation") || "top"; if (c) switch (e) {
                    case "top": a.F = c.gb() + d; a.R = c.Hb() + b; a.o = f; a.j = h; a.tb = new $.I(c.gb(), c.Hb(), k, l); break; case "bottom": a.F = c.gb() + d; a.R = c.Ka() -
                        l + b; a.o = f; a.j = h; a.tb = new $.I(c.gb(), c.Ka() - l, k, l); break; case "left": a.F = c.gb() + b; a.R = c.Ka() - d - f; a.o = h; a.j = f; a.tb = new $.I(c.gb(), c.Hb(), l, k); break; case "right": a.F = c.Ra() - b - h, a.R = c.Hb() + d, a.o = h, a.j = f, a.tb = new $.I(c.Ra() - l, c.Hb(), l, k)
                } else a.F = d, a.R = b, a.zb() ? a.tb = new $.I(0, 0, k, l) : a.tb = new $.I(0, 0, l, k)
            };
            ...
            st = function (a) {
                var b = a.padding(), c = a.margin(), d = a.oa(), e, f, h = a.N("orientation"), k = !(a.ot() % 180); f = !((a.ot() + 90) % 180); d ? f ? (e = d.height, f = d.width) : (e = d.width, f = d.height) : e = f = void 0; var l = rt(a); if (l || a.W(16)) a.Gg(l), a.U(16); a.ac.width(null); a.ac.height(null); a.ac.Wb(1, 0, 0, 1, 0, 0); var l = a.ac.sb(), m = a.kf("width") ? a.Zd("width") : a.Y || null; null === m ? (a.R = l.width, a.g = b.vi(a.R)) : (a.g = $.M(m, e), a.R = b.mg(a.g)); d && e < c.vi(a.g) ? (a.g = c.mg(e), a.R = b.mg(a.g), a.ac.width(a.R)) : null === m || a.ac.width(a.R); a.ac.Wb(1, 0, 0, 1, 0,
                    0); l = a.ac.sb(); e = a.kf("height") ? a.Zd("height") : a.P || null; null === e ? (a.F = l.height, a.b = b.xh(a.F)) : (a.b = $.M(e, f), a.F = b.Bg(a.b)); d && f < c.xh(a.b) ? (a.b = c.Bg(f), a.F = b.Bg(a.b), a.ac.height(a.F)) : null === e || a.ac.height(a.F); a.tb = new $.I(-a.g / 2, -a.b / 2, a.g, a.b); var b = $.mc($.H(a.ot()), 0, 0), p = $.ec(a.tb, b); f = $.M(c.N("left"), a.g); e = $.M(c.N("right"), a.g); var l = $.M(c.N("top"), a.b), c = $.M(c.N("bottom"), a.b), m = p.width / 2, p = p.height / 2, q = f + m, r = l + p, t = "top" == h || "bottom" == h; if (d) if (t || k) if (t) {
                        switch (a.N("align")) {
                            case "left": q =
                                d.gb() + f + m; break; case "right": q = d.Ra() - e - m; break; default: q = (d.gb() + d.Ra() + f - e) / 2
                        }"top" == h ? r = d.Hb() + l + p : "bottom" == h && (r = d.Ka() - c - p)
                    } else switch ("right" == h ? q = d.Ra() - e - m : "left" == h && (q = d.gb() + f + m), a.N("align")) { case "top": case "left": r = d.Hb() + l + p; break; case "bottom": case "right": r = d.Ka() - c - p; break; default: r = (d.Hb() + d.Ka() + l - c) / 2 } else if ("left" == h) { switch (a.N("align")) { case "top": case "right": r = d.Hb() + e + p; break; case "bottom": case "left": r = d.Ka() - f - p; break; default: r = (d.Hb() + d.Ka() - f + e) / 2 }q = d.gb() + l + m } else {
                        switch (a.N("align")) {
                            case "top": case "left": r =
                                d.Hb() + f + p; break; case "bottom": case "right": r = d.Ka() - e - p; break; default: r = (d.Hb() + d.Ka() + f - e) / 2
                        }q = d.Ra() - l - m
                    } d = [q, r, 0, 0]; $.lc(b).transform(d, 0, d, 0, 2); a.o = ic(b, d[0] - d[2], d[1] - d[3]); a.tb = $.ec(a.tb, a.o); ic(a.o, -a.g / 2, -a.b / 2); "top" == h || "bottom" == h || k ? (a.tb.left -= f, a.tb.top -= l, a.tb.width += f + e, a.tb.height += l + c) : (a.tb.left -= l, a.tb.top -= e, a.tb.width += l + c, a.tb.height += f + e)
            }; tt = function () { $.mt.call(this) };
            ...
            Zaa = function (a, b, c, d, e, f) {
                if (a.check(Ft | Gt) && (a.b = e ? e.Db() : a, Lt(a, [a.b]), a.b.enabled())) {
                    for (var h = { clientX: { value: c, type: "number" }, clientY: { value: d, type: "number" }, formattedValues: { value: [], type: "" }, points: { value: [], type: "" } }, k = [], l = 0; l < b.length; l++) {
                        var m = b[l]; if (m) {
                            var p = m.series, q = p.Db(); if (p.enabled() && q.enabled()) {
                                if (!$.n(p.Dh)) return; var r = p.Dh(); h.formattedValues.value.push(Mt(q, r)); h.points.value.push(r); l || (h.x = { value: r.Lu("x"), type: "string" }, h.name = { value: r.Lu("name"), type: "string" }); $.y(m.points) &&
                                    k.push({ series: p, points: (0, $.Eb)(m.points, function (a) { p.la().select(a); return p.Dh(!0) }) })
                            }
                        }
                    } k.length == b.length && (h.allPoints = { value: k, type: "" }); h.formattedValues.value.length && (f && $.Tc(h, f), k = e && e.Yb && e.Yb() || b[0] && b[0].series && b[0].series.Yb && b[0].series.Yb() || void 0, f = [], !e && b[0] && b[0].series && f.push(b[0].series), e && f.push(e), k && f.push(k), b = new $.Nt(h), b.vh(f), $.Ct(b), a.b.Ch().text(Mt(a, b, !0)), $.qt(a.b.title(), Ot(a, b)), Lt(a.b), Pt(a.b).parent() || a.b.D(2), Qt(a, a.b), Kt(a, a.b, c, d, e), Rt(a.b, c, d))
                }
            };
            $.Vt = function (a, b, c, d, e, f, h) {
                if ((!a.o || a.o.At() || !vt(a.o) || a.check(Ft)) && b.length) {
                    St(a); var k = a.N("displayMode"); if ("single" == k) b = b[0].series, a.b = f ? a : b.Db(), a.b.enabled() && $.n(b.Dh) && (f = b.Dh(), f.clientX = c, f.clientY = d, $.qt(a.b.title(), Ot(a.b, f)), a.b.Ch().text(Mt(a.b, f)), a.b == a ? Lt(a) : (Tt(a), Lt(a, [a.b])), Pt(a.b).parent() || a.b.D(2), Qt(a, a.b), Kt(a, a.b, c, d, b), Rt(a.b, c, d)); else if ("union" == k) Zaa(a, b, c, d, e, h); else if ("separated" == k) for (Tt(a), f = 0; f < b.length; f++) {
                        e = b[f].series; h = e.Db(); if (!h.enabled()) break;
            ...
            Rt = function (a, b, c) {
                if (a.enabled()) {
                    St(a); Pt(a).parent() || a.D(2); Qt(a, a); a.B && a.B.Fk() && a.B.stop(); a.ea(); var d = Pt(a), e = d.ja(); if (a.N("selectable") && e) {
                        d.Xc(!1); a: {
                            var d = a.hb(), f, h, k; if (b < d.gb()) c < d.Hb() ? (e = d.Ra(), f = d.gb(), h = d.Hb(), k = d.Ka(), c -= 2) : c > d.Ka() ? (e = d.gb(), f = d.Ra(), h = d.Hb(), k = d.Ka(), c += 2) : (e = f = d.gb() + 2, h = d.Hb(), k = d.Ka(), b -= 2); else if (b > d.Ra()) c < d.Hb() ? (e = d.Ra(), f = d.gb(), h = d.Ka(), k = d.Hb(), c -= 2) : c > d.Ka() ? (e = d.gb(), f = d.Ra(), h = d.Ka(), k = d.Hb(), c += 2) : (e = f = d.Ra() - 2, h = d.Hb(), k = d.Ka(), b += 2); else if (c <
                                d.Hb()) h = k = d.Hb() + 2, e = d.Ra(), f = d.gb(), c -= 2; else if (c > d.Ka()) h = k = d.Ka() - 2, e = d.gb(), f = d.Ra(), c += 2; else break a; a.R = [e, h, f, k, b, c]
                        } $.Wd(window.document, "mousemove", a.YE, !1, a)
                    } else e && d.Xc(!0)
                }
            }; $.Wt = function (a, b, c, d) { St(a); a.b = a; d && (d.clientX = b, d.clientY = c, $.qt(a.title(), Ot(a, d)), a.Ch().text(Mt(a, d))); Qt(a, a); Kt(a, a, b, c); Rt(a, b, c) };
            ...
            cu = function (a) {
                if (!a.Y) {
                    $.T(a.Ch()); a.Gg(); a.Ch().ka(!1); var b = a.N("width"), c = a.N("height"), d = (a.Oa || $.It(a)).hb(), b = $.M(b, d.width), c = $.M(c, d.height), d = !(0, window.isNaN)(b), e = !(0, window.isNaN)(c), f = new $.I(0, 0, 0, 0), h, k = null, l = null, m = a.title(), p = a.Bn(), q = a.Ch(); $.T(m); $.T(p); $.T(q); var r; if (!d || !e) {
                        if (m.enabled()) {
                            "svg" == $.ek ? m.oa(null) : m.oa(a.Oa && a.Oa.$() ? a.Oa.$().Ca().sb() : null); r = m.N("width"); var t = null != m.Zd("width"); h = m.N("height"); var u = null != m.Zd("height"); $.Vn(r) && (k = r, d ? (r = a.padding().mg(b),
                                m.width(r)) : m.width(null)); $.Vn(h) && (l = h, e ? (r = a.padding().Bg(c), m.height(r)) : m.height(null)); h = m.Of(); f.width = b || Math.max(f.width, h.width); t ? m.width(k) : delete m.ua.width; u ? m.height(l) : delete m.ua.height; l = k = null; e || (f.height += h.height)
                        } if (q.enabled()) {
                            var v = (t = a.na ? a.na.Ch() : null) ? t.width() : void 0, t = t ? t.height() : void 0; q.oa(null); v = q.width() || v; t = q.height() || t; $.Vn(v) && (k = v, d ? (r = a.padding().mg(b), q.width(r)) : q.width(null)); $.Vn(t) && (l = t, e ? (r = a.padding().Bg(c), q.height(r)) : q.height(null)); v = q.Of();
                            f.width = b || Math.max(f.width, v.width); k && q.width(k); l && q.height(l); e || (f.height += v.height)
                        } m.enabled() && m.oa(new $.I(0, 0, f.width, h.height)); q.enabled() && q.oa(new $.I(0, 0, f.width, v.height)); p.enabled() && (p.oa(m.enabled() || q.enabled() ? f : null), h = p.Of(), f.width = b || Math.max(f.width, h.width), e || (f.height += h.height))
                    } f = a.padding().jN(f); d && (f.width = b); e && (f.height = c); f.left = 0; f.top = 0; a.Y = f; m.ka(!1); p.ka(!1); q.ka(!1)
                }
            };
            ...
            Ut = function (a, b, c, d, e) {
                var f = c, h = d, k, l = a.N("positionMode") || "float", m = a.N("displayMode"), p = (a.ya() || $.It(a)).hb(), q = a.qa.$().Ca(), r = q.sb(); k = $.Tj(q); var t = Jt(b), q = b.N("allowLeaveStage"), u = b.N("allowLeaveScreen"), v = b.N("allowLeaveChart"), w = b.N("offsetX"), x = b.N("offsetY"); "float" == l ? (f = t ? c : c - k.x, h = t ? d : d - k.y) : "point" == l ? (h = "union" == m ? a.N("position") : b.N("position"), h = e.Vo(h, !0).value, f = t ? h.x + k.x : h.x, h = t ? h.y + k.y : h.y) : "chart" == l && (f = a.ya().hb(), h = "union" == m ? a.N("position") : b.N("position"), h = $.co(f, h),
                    f = h.x + (t ? k.x : 0), h = h.y + (t ? k.y : 0)); u || (b.x(f), b.y(h), u = t ? 0 : k.x, t = t ? 0 : k.y, k = b.hb(), a = $.Ve(), 0 > k.left - w + u && (f -= k.left - w + u), 0 > k.top - x + t && (h -= k.top - x + t), k.Ra() - w + u > a.width && (f -= k.Ra() - w + u - a.width), k.Ka() - x + t > a.height && (h -= k.Ka() - x + t - a.height)); q || (b.x(f), b.y(h), k = b.hb(), k.left < w && (f -= k.left - w), k.top < x && (h -= k.top - x), k.Ra() > r.width + w && (f -= k.Ra() - r.width - w), k.Ka() > r.height + x && (h -= k.Ka() - r.height - x)); v || (b.x(f), b.y(h), k = b.hb(), k.left < p.left + w && (f -= k.left - w - p.left), k.top < p.top + x && (h -= k.top - x - p.top), k.Ra() > p.Ra() +
                        w && (f -= k.Ra() - w - p.Ra()), k.Ka() > p.Ka() + x && (h -= k.Ka() - x - p.Ka())); b.x(f); b.y(h)
            }; eu = function (a) { var b = null; $.It(a) ? b = $.It(a).$() : a.ya() ? b = a.ya().$() : a.parent() && ($.It(a.parent()) ? b = $.It(a.parent()).$() : a.parent().ya() && (b = a.parent().ya().$())); return b };
            ...
            ku = function (a) {
                var b = a.oa(); b && 0 >= b.width && 0 >= b.height && (b = null); var c, d, e = a.margin(), f = a.padding(), h, k, l, m, p = 0, q = 0, r, t; b ? (c = b.width, d = b.height, null != a.Pb ? (l = Math.min(c, $.M(a.Pb, c), null != a.hg ? $.M(a.hg, c) : c), r = f.mg(e.mg(l))) : r = null != a.hg ? f.mg(e.mg($.M(a.hg, c))) : f.mg(e.mg(c)), null != a.kc ? (m = Math.min(d, $.M(a.kc, d), null != a.df ? $.M(a.df, d) : d), t = f.Bg(e.Bg(m))) : t = null != a.df ? f.Bg(e.Bg($.M(a.df, d))) : f.Bg(e.Bg(d))) : ($.C(a.Pb) && !(0, window.isNaN)(a.Pb) ? (l = a.Pb, r = f.mg(a.Pb)) : r = $.C(a.hg) && !(0, window.isNaN)(a.hg) ?
                    f.mg(a.hg) : window.Infinity, $.C(a.kc) && !(0, window.isNaN)(a.kc) ? (m = a.kc, t = f.Bg(a.kc)) : t = $.C(a.df) && !(0, window.isNaN)(a.df) ? f.Bg(a.df) : window.Infinity); var u, v, w, x = a.MA(), z = a.oo(), E = a.title(), N = z.orientation(), N = "bottom" == N || "top" == N, R = E.N("orientation") || $.pt(E), R = "bottom" == R || "top" == R, P = !(E.ot() % 180), aa = x.zb(); $.T(x); $.T(z); $.T(E); var X = v = null; do {
                        v && (X = v); var ba = v = 0, Y = 0, ja = 0; E.enabled() ? (E.oa(null), nt(E, null), ot(E, null), w = E.Of(), R ? (w.width > r && (P ? nt(E, r) : ot(E, r), w = E.Of()), ja = w.width, v += w.height) : (w.height >
                            t && (P ? ot(E, t) : nt(E, t), w = E.Of()), Y = w.height, ba += w.width)) : w = null; x.enabled() ? (x.oa(null), u = x.Of(), aa ? v += u.height : ba += u.width) : u = null; h = r - ba; k = aba(a, h, t - v); var Ja = k.width; k = k.height; v += k; ba += Ja; Y = Math.max(Y, k); ja = Math.max(ja, Ja); ba = Math.max(ja, ba); ja = Math.max(Y, v); Y = t; R && (Y -= w ? w.height : 0); aa && (Y -= u ? u.height : 0); z.oa(null); v = jt(z, 1); if ("horizontal" == a.P) Ja > h && a.b && 1 < a.b.length ? gt(z, !0) : gt(z, !1); else if ("vertical-expandable" == a.P) Ja > h && 1 < a.vc ? gt(z, !0) : gt(z, !1); else if ("vertical" == a.P || "horizontal-expandable" ==
                                a.P) k > Y && a.b && 1 < a.b.length ? gt(z, !0) : gt(z, !1); ht(z) && (N ? (ba = Math.max(ba, v.width), ja += v.height) : (ba += v.width, ja = Math.max(ja, v.height))); Y = Math.min(ba, r); ba = Math.min(ja, t); h = e.vi(f.vi(Y)); k = e.xh(f.xh(ba)); if (E.enabled()) {
                                    var ha = w.width; if (R || P) {
                                        if (P && !R) u = ht(z) ? v.width : 0, ja = (a.b && a.b.length ? a.b[0].hb().width : 0) + u, w = Ja + u >= r - w.width ? ja : Ja, w = Math.max(Math.min(E.text().length, 1), E.margin().mg(Y - ha <= w ? Y - w : ha)), nt(E, w); else if (!P && ja > t) {
                                            w = 0; u && aa && (w += u.height); if ("top" == z.orientation() || "bottom" == z.orientation()) w +=
                                                v.height; Ja = ht(z) && !N ? v.height : 0; Ja = Math.max(a.b && a.b.length ? a.b[0].hb().height : 0, Ja); w = Math.max(1, E.margin().Bg(t - w - Ja)); P ? ot(E, w) : nt(E, w)
                                        } w = E.Of(); x.width(h)
                                    } else w = E.Of(), x.width(k); u = x.Of(); R ? ba -= w.height : Y -= w.width
                                } x.enabled() && (aa ? ba -= u.height : Y -= u.width); Ja = Y; w = ba; ht(z) && (N ? w = ba - v.height : Ja = Y - v.width); v = a; u = w; var db; v.R = []; w = 0; ba = v.b && v.b.length; for (Y = 0; Y < ba && Y in v.za; Y++); if (0 < u && v.b && Y != ba) switch (v.R[w] = [], v.R[w][0] = v.b[Y], v.P) {
                                    case "horizontal": u = v.b[Y].hb().Ad(); for (Y += 1; Y < ba; Y++)Y in
                                ...
                                }ct(v.oo(), w + 1); z.oa(null); v = z.hb()
                    } while (!$.Ub(X,
                        v)); l || (l = h); m || (m = k); a.tb = new $.I(p, q, l, m); if (a.Sa) p = a.Kf < a.Xb ? Math.max(b.left, a.Kf * b.width + b.left) : Math.min(b.Ra(), b.Ra() - (a.Xb * b.width + l)), q = a.dc < a.Bf ? Math.max(b.top, a.dc * b.height + b.top) : Math.min(b.Ka(), b.Ka() - (a.Bf * b.height + m)), b.contains(a.tb) || (p < b.left && (p = b.left), p + l > b.Ra() && (p = b.Ra() - l), q < b.top && (q = b.top), q + m > b.Ka() && (q = b.Ka() - m)); else if (b) {
                            p = b.gb(); q = b.Hb(); switch (a.o) {
                                case "left": case "right": switch (a.F) { case "center": q += (d - m) / 2; break; case "right": case "bottom": q = b.Ka() - m }break; case "top": case "bottom": switch (a.F) {
                                    case "center": p +=
                                        (c - l) / 2; break; case "right": case "bottom": p = b.Ra() - l
                                }
                            }switch (a.o) { case "right": p = b.Ra() - l; break; case "bottom": q = b.Ka() - m }
                        } else p = $.M(e.N("left"), 0), q = $.M(e.N("top"), 0); a.tb.left = p; a.tb.top = q; a.Qg = a.padding().wh(a.margin().wh(a.tb)); b = a.tb.clone(); b.left = 0; b.top = 0; a.Ja = a.margin().wh(b); a.Uf = a.padding().wh(a.Ja); x.ka(!1); z.ka(!1); E.ka(!1); a.U(4)
            }; bba = function (a) { if ($.y(a.Sb)) return a.Sb; if (null != a.ba) { for (var b, c = [], d = 0; d < a.ba.length; d++)(b = a.ba[d]) && $.D(b.bj) && (c = $.lb(c, b.bj(a.Lc, a.Na))); return c } return [] };
            ...
            dba = function (a, b) {
                a.b || (a.fa = [], a.b = []); var c, d, e; a.za = {}; if (!a.Ua && a.b) for (d = 0, e = b.length; d < e; d++) { $.n(b[d].enabled) && !b[d].enabled && (a.za[d] = !0); for (var f = 0; f < a.b.length; f++) { c = a.b[f]; var h = c.BA(), k = c.Jf(); if ($.n(h) && $.n(k) && h == b[d].sourceUid && k == b[d].sourceKey) { c.clear(); c.X(b[d]); Rs(c, c.Fx, void 0); c.rb.tag = { index: a.Y ? b.length - 1 - d : d }; break } } } else if (b && 0 < b.length) for (lu(a), a.Ob = [], d = 0; d < b.length; d++) {
                    $.n(b[d].enabled) && !b[d].enabled && (a.za[d] = !0); a: {
                        c = a; e = b[d]; f = 0; for (h = c.fa.length; f < h; f++)if (k =
                            c.fa[f], k.Cca == e.sourceUid && k.Bca == e.sourceKey) { $.gb(c.fa, f, 1); c = k; break a } c = c.fa.pop() || new Ks
                    } c.$(a.ha); b[d].enabled = !1; c.X(b[d]); c.kf("text") || (c.ua.text = "Legend Item"); c.Gg(c.Bk(), !0); c.rb.tag = { index: a.Y ? b.length - 1 - d : d }; a.b.push(c); a.Ob.push(b[d].meta ? b[d].meta : {})
                } else lu(a); a.Ua = !1; a.D(4)
            }; lu = function (a) { for (var b = 0, c = a.b.length; b < c; b++)a.fa.push(a.b[b].clear()); a.b.length = 0 }; eba = function (a) { if (null != a.ec && !(0, window.isNaN)(a.ec) && (a = a.R[a.ec])) for (var b = 0; b < a.length; b++)a[b].enabled(!1).ea() };
            fba = function (a, b, c) {
                if (a.b) {
                    a.ha.Wb(1, 0, 0, 1, 0, 0); var d = 0, e = 0, f = 0, h = 0, k, l = a.R[b], m, p; if (l) switch (a.P) {
                        case "horizontal": for (k = 0; k < l.length; k++)m = l[k], m.D(4), $.T(m).oa(c).x(d).y(e).enabled(!0).ka(!1).ea(), d += l[k].hb().Ad() + a.g; break; case "vertical": for (k = 0; k < l.length; k++)m = l[k], m.D(4), $.T(m).oa(c).x(d).y(e).enabled(!0).ka(!1).ea(), e += l[k].hb().zd() + a.g; break; case "horizontal-expandable": for (k = 0; k < l.length; k++)m = l[k], p = m.hb(), d + p.Ad() > c.width && (e += f, f = d = 0), m.D(4), $.T(m).oa(c).x(d).y(e).enabled(!0).ka(!1).ea(),
                            d += m.hb().Ad() + a.g, f = Math.max(f, p.zd() + a.g); break; case "vertical-expandable": for (k = 0; k < l.length; k++)m = l[k], p = m.hb(), e + p.zd() > c.height && (d += h, h = e = 0), m.D(4), $.T(m).oa(c).x(d).y(e).enabled(!0).ka(!1).ea(), e += l[k].hb().zd() + a.g, h = Math.max(h, p.Ad() + a.g)
                    }if (a.title().enabled() && (c = a.title().N("orientation") || $.pt(a.title()), "top" != c && "bottom" != c)) {
                        d = c = 0; if (e = a.Ta.Pc) c = e.$c, d = e.ad; e = a.ha.el(); f = a.Xa.Of(); f.top += d; f.left += c; c = f.top + f.height / 2 - (e.top + e.height / 2); c = Math.min(a.Qg.height - e.height, Math.max(c,
                            0)); a.ha.Wb(1, 0, 0, 1, 0, c)
                    }
                } a.ec = b
            };
            mu = function (a, b) {
                var c = $.O(b.itemIndex); if ((0, window.isNaN)(c)) return null; var d = b.type; switch (d) { case "mouseout": d = "legenditemmouseout"; break; case "mouseover": d = "legenditemmouseover"; break; case "mousemove": d = "legenditemmousemove"; break; case "mousedown": d = "legenditemmousedown"; break; case "mouseup": d = "legenditemmouseup"; break; case "click": d = "legenditemclick"; break; case "dblclick": d = "legenditemdblclick"; break; default: return null }var c = a.Y ? a.b.length - 1 - c : c, e = null, f = window.NaN, h = a.b[c]; if (h && a.ba) for (var k =
                    0; k < a.ba.length; k++) { var l = a.ba[k]; if ($.ra(l) == h.BA() && $.D(l.Zm) && l.Zm(a.Lc)) { e = l; f = h.Jf(); break } } return { type: d, itemIndex: c, itemSource: e, itemIndexInSource: f, target: a, originalEvent: b }
            }; nu = function () { $.hu.call(this) }; $.ou = function () { $.hq.call(this); this.g = !1; this.b = 1E3 }; pu = function (a) { $.hq.call(this); this.ya = a; this.B = !0; this.j = ""; this.g = null }; qu = function (a, b) { return $.n(b) ? (a.g != b && (a.g && $.jq(a.g, a.YL, a), a.g = b, $.S(a.g, a.YL, a)), a) : a.g }; ru = function (a) { pu.call(this, a); this.o = "chart-elements"; this.b = null };
            ...
            $.Ku = function (a, b, c, d, e, f, h, k, l, m) {
                if (!a.Ta) return !1; Ju(a); a.uo = !!m; a.qq = !1; a.Cd = e ? $.lb(e) : [a.Ne()]; a.Vr = !1; a.Eo = b; a.wq = c; a.xq = d; a.Wr = !!h; a.Sb || (a.Sb = $.gk(0, 0, 0, 0), a.Sb.zIndex(10001), a.Sb.Xc(!0)); a.Sb.stroke(k || "3 red"); a.Sb.fill(l || "red 0.5"); b = a.Ta; a.tq = b; a.rq = f || null; a.Bf = new $.Gf(a); a.rq && (a.Bf.pa(b, "mouseover", a.yE, !0), a.Bf.pa(window.document, "mousemove", a.yE, !0), a.Bf.pa(window.document, "touchmove", a.yE, !0), a.Bf.pa(b, "mouseout", a.yE, !0)); a.Bf.pa(b, "touchstart", a.qU, !0); a.Bf.pa(b, "mousedown",
                    a.qU, !0); return !0
            ...
            iba = function (a) {
                function b(a) {
                    var b = [], c, d; for (d in a) if (a.hasOwnProperty(d)) {
                        var e = a[d]; if (d in l) {
                            var f = l[d]; "number" == f && (e = $.O(e)); "boolean" == f && (e = k[wo(e).toLowerCase()], e = "useNegativeSign" == d ? !e : e); if ("scale" == f) {
                                var h = wo(e); if (h in k) e = k[h]; else {
                                    var e = {}, h = h.split("|"), p = function (a, b) { return !!(b % 2) }, f = (0, $.sf)(h[0].split(/\(([ \w\+\-]*)\)/), p), h = (0, $.sf)(h[1].split(/\(([ \w]*)\)/), p), f = (0, $.Eb)(f, function (a) { return +a }), q = f[0], p = [q]; for (c = 1; c < f.length; c++)q *= f[c], p.push(q); p.length != h.length &&
                                        (f = Math.min(p.length, h.length), p.length = f, h.length = f); p.reverse(); h.reverse(); e.factors = p; e.suffixes = h
                                }
                            }
                        } f = d; d in m && m[d] && (f = m[d], f != d && b.push(d)); a[f] = e
                    } for (c = b.length; c--;)delete a[b[c]]
                } function c(a, b, c) {
                    var d; var e = "%" == a.charAt(0) ? a.substr(1) : a; d = e.toLowerCase(); var f = c.wd.pj[a], h = c.wd.Ti[f] || c.wd.values[f] || c.wd.Ti[a] || c.wd.values[a] || c.wd.Ti[e] || c.wd.values[e]; if (h) d = h.value; else {
                        b: {
                            for (var k in c.wd.Ti) if (c.wd.Ti.hasOwnProperty(k) && k.toLowerCase() == d) { h = c.wd.Ti[k].value; break b } for (k in c.wd.values) if (c.wd.values.hasOwnProperty(k) &&
                                k.toLowerCase() == d) { h = c.wd.values[k].value; break b } h = void 0
                        } $.n(h) ? d = h : (e = f ? c.Lu(f) || c.Lu(e) : c.Lu(e), d = $.n(e) ? e : c.af(d))
                    } if (!$.n(d)) return ""; f = "%" == a.charAt(0) ? a.substr(1) : a; e = f.toLowerCase(); h = c.wd.pj[a]; f = (a = c.wd.Ti[h] || c.wd.values[h] || c.wd.Ti[a] || c.wd.values[a] || c.wd.Ti[f] || c.wd.values[f] || c.wd.Ti[e] || c.wd.values[e]) && $.n(a.type) ? a.type : "string"; if (!a && c.wd.vh.length) switch (e) {
                        case Ru.ria: case Ru.sia: case Ru.WX: case Ru.XX: case Ru.YX: case Ru.gZ: case Ru.hZ: case Ru.iZ: case Ru.jZ: case Ru.rZ: case Ru.fZ: case Ru.nZ: case Ru.pZ: case Ru.aZ: case Ru.bZ: case Ru.mZ: case Ru.cZ: case Ru.uZ: case Ru.oZ: case Ru.dZ: case Ru.wZ: case Ru.qZ: case Ru.eZ: case Ru.xZ: case Ru.yZ: case Ru.zZ: case Ru.EX: case Ru.wX: case Ru.xX: case Ru.yX: case Ru.AX: case Ru.BX: case Ru.DX: case Ru.SX: case Ru.MX: case Ru.QX: case Ru.RX: case Ru.JX: case Ru.KX: case Ru.PX: case Ru.LX: case Ru.WG: case Ru.c_: case Ru.uY: case Ru.EY: case Ru.OPEN: case Ru.HX: case Ru.ZZ: case Ru.sX: case Ru.xY: case Ru.TY: case Ru.SY: case Ru.RY: case Ru.AZ: case Ru.tZ: case Ru.vZ: case Ru.sZ: case Ru.lZ: case Ru.kZ: case Ru.ZX: case Ru.UX: case Ru.VX: case Ru.TX: case Ru.NX: case Ru.OX: case Ru.tX: case Ru.uX: case Ru.vX: case Ru.zX: case Ru.CX: case Ru.$Z: case Ru.a_: case Ru.b_: case Ru.XZ: case Ru.YZ: case Ru.QY: f =
                            "number"
                    }switch (f) { case "": return ""; case "string": return String(d); case "date-time": return b = b || {}, $.or(d, b.dateTimeFormat, b.timeZone); case "number": return b = b || {}, $.sr(d, b.decimalsCount, b.decimalPoint, b.groupsSeparator, b.scale, b.zeroFillDecimals, b.scaleSuffixSeparator, b.useBracketsForNegative); case "percent": return $.Yn($.Om(100 * d, 2)) }
                } function d(a) { return a } function e(a, d) {
                    var e = x, f = [], k; for (k in e) if (e.hasOwnProperty(k)) { var l = wo(k); l != k && (e[l] = e[k], f.push(k)) } for (k = f.length; k--;)delete e[f[k]];
                    b(x); h.push($.va(c, a, d))
                } function f(a) { h.push($.va(d, a)) } for (var h = [], k = { "true": !0, "false": !1 }, l = { numDecimals: "number", decimalsCount: "number", useNegativeSign: "boolean", useBracketsForNegative: "boolean", leadingZeros: "number", trailingZeros: "boolean", zeroFillDecimals: "boolean", scale: "scale" }, m = { numDecimals: "decimalsCount", decimalSeparator: "decimalPoint", thousandsSeparator: "groupsSeparator", useNegativeSign: "useBracketsForNegative", trailingZeros: "zeroFillDecimals" }, p = a.length, q = 0, r, t = "", u, v, w, x, z = !1, E =
                    0; E < p; E++)switch (r = a.charAt(E), q) {
                        case 0: "{" == r ? q = 1 : t += r; break; case 1: "%" == r ? (0 < t.length && f(t), t = "%", q = 2) : (t += "{" + r, q = 0); break; case 2: "}" == r ? 1 < t.length ? (u = t, t = "", q = 3) : (t = "{%}", q = 0) : t += r; break; case 3: "{" == r ? q = 4 : (e(u, null), t = r, q = 0); break; case 4: "%" == r ? (e(u, null), t = "%", q = 2) : (v = "{" + r, t = r, q = w = "", x = {}, z = "\\" == r, q = 5); break; case 5: v += r; z ? (t += r, z = !1) : "\\" == r ? z = !0 : ":" == r ? (w = t, t = "", q = 6) : "}" == r ? (w = wo(t), x[w] = "", e(u, x), v = t = q = w = "", q = 0) : t += r; break; case 6: v += r, z ? (t += r, z = !1) : "\\" == r ? z = !0 : "," == r ? (q = t, x[w] = q, q = w = t =
                            "", q = 5) : "}" == r ? (q = t, x[w] = q, e(u, x), v = t = q = w = "", q = 0) : t += r
                    }switch (q) { case 0: 0 < t.length && f(t); break; case 1: f("{"); break; case 2: f("{" + t); break; case 3: e(u, null); break; case 4: e(u, null); f("{"); break; case 5: case 6: f(v) }return h
            }; $.Yt = function (a, b) { if (!a.b[b]) { var c = iba(b); a.b[b] = function (a) { return (0, $.Eb)(c, function (b) { return b(a) }).join("") } } return a.b[b] };
            $.Tu = function () {
                $.T(this); $.V.call(this); delete this.Pa.enabled; this.rb = this.bb = this.j = null; this.IM = "background padding height width offsetY offsetX position anchor rotation format positionFormatter minFontSize maxFontSize clip connectorStroke adjustFontSize useHtml fontSize fontWeight fontFamily fontColor textDirection wordWrap wordBreak fontOpacity fontDecoration fontStyle fontVariant letterSpacing lineHeight textIndent vAlign hAlign textOverflow selectable disablePointerEvents".split(" "); this.Uc =
                    {}; $.Su(this, "different"); this.ka(!1); $.Ep(this.J, 20, 20, 9); $.vp(this.J, [["format", 20, 9], ["positionFormatter", 4, 9], ["position", 4, 9], ["anchor", 4, 9], ["offsetX", 4, 9], ["offsetY", 4, 9], ["connectorStroke", 512, 1], ["rotation", 4, 9], ["width", 4, 9], ["height", 4, 9], ["clip", 256, 1]])
            }; Uu = function (a) { a = $.Ck(a, "auto"); "auto" == a && (a = void 0); return a }; $.Vu = function (a) { a = a.N("adjustFontSize"); return !!a && (a.width || a.height) };
            ...
            $.Cv = function (a) {
                var b = a.b, c = a.scale(); if (c) {
                    var d = $.Av(a); d.clear(); var e = b.ld, f = b.from, h = c.transform(f), k = c.transform(e); h > k && (e = b.from, f = b.ld); f = c.transform(f, 0); c = c.transform(e, 1); b = Math.min(c, f); f = Math.max(c, f); !(0, window.isNaN)(b) && !(0, window.isNaN)(f) && 0 <= f && 1 >= b && (b = $.Hb(b, 0, 1), f = $.Hb(f, 0, 1), c = a.oa(), e = a.Vj(), a.zb() ? (a = Math.floor(c.Ka() - c.height * f), b = Math.ceil(c.Ka() - c.height * b), f = c.gb(), h = c.Ra(), d.moveTo(f, a).lineTo(h, a).lineTo(h, b).lineTo(f, b).close()) : (a = c.Ka(), h = c.Hb(), b = Math.floor(c.gb() +
                        c.width * b), f = Math.ceil(c.gb() + c.width * f), d.moveTo(b, a).lineTo(b, h).lineTo(f, h).lineTo(f, a).close()), d.clip(e.wh(c)))
                } else $.hl(2)
            }; $.Av = function (a) { a.j || (a.j = $.kk(), $.L(a, a.j)); return a.j }; $.Dv = function () { $.V.call(this); this.path = $.kk(); $.hs(this, this.path); $.L(this, this.path) }; $.Ev = function () { $.T(this); $.V.call(this); this.oB = []; this.pB = []; this.Rd = 980; this.ka(!1) }; $.Fv = function (a, b) { var c = a.UJ != b && !a.fc; a.UJ = b; c && a.D(a.Rd) };
            Hv = function (a, b) {
                var c; if (a.hu()) if (a.K) c = a.K; else if ((c = a.scale()) && a.labels().enabled()) {
                    a.FA = 1; a.Y = 1; var d; c = c.Ga().get(); var e = c.length, f, h, k, l, m, p; if (null === a.Cw) { var q = !1; for (f = 1; !q && f <= e;)for (q = !0, k = 0; k < f; k++) { for (h = k; h < e - f; h += f)if (l = Gv(a, h, !0, c, b), d = Gv(a, h + f, !0, c, b), $.Wm(l, d)) { q = !1; f++; break } if (!q) break } a.FA = q ? f : e; a.Y = null !== a.Hr && a.FA > a.Hr ? a.Hr : a.FA } else a.Y = a.Cw; if ((null !== a.Cw || null !== a.Hr && a.FA > a.Hr) && "no-overlap" == a.qB()) {
                        p = []; for (h = 0; h < a.Y; h++)for (k = -1, f = h; f < e; f += a.Y)l = Gv(a, f, !0, c, b),
                            -1 != k ? d = Gv(a, k, !0, c, b) : d = null, f != e - 1 && a.Qj() ? m = Gv(a, e - 1, !0, c, b) : m = null, f ? f == e - 1 ? a.Qj() ? (k = f, p[f] = !0) : p[f] = !1 : $.Wm(l, d) || $.Wm(l, m) ? p[f] = !1 : (k = f, p[f] = !0) : a.Kl() ? (k = f, p[f] = !0) : p[f] = !1; a.Kl() || (p[0] = !1); a.Qj() || (p[p.length - 1] = !1); d = { labels: p, $a: !1 }
                    } else { if (!a.Kl() || !a.Qj()) for (p = [], f = 0; f < e; f++)f || a.Kl() ? f != e - 1 || a.Qj() ? p[f] = !0 : p[f] = !1 : p[f] = !1; d = { labels: p ? p : !0, $a: !1 } } a.ba = []; a.fa = []; a.P || (a.P = []); for (f = k = 0; f < e; f++)if (!p || p && p[f]) {
                        a.P[f] ? m = a.P[f] : (m = Gv(a, f, !0, c, b), a.P[f] = m = $.$m(m)); m = a.zb() ? m.height : m.width;
                        if (!a.ba[k] || a.ba[k] < m) a.ba[k] = m; a.fa[k] || (a.fa[k] = []); a.fa[k].push(f); (k + 1) % a.Y ? k++ : k = 0
                    } c = a.K = d
                } else c = a.K = { labels: !1, $a: !1 }; else a: {
                    if (!a.R || a.W(512)) {
                        if ("allow-overlap" == a.qx) { c = !1; break a } p = a.scale(); d = []; m = []; if (p) {
                            var r = q = -1, t = -1, u = p.Ga().get(), v = u.length, w, x, z, E; c = a.labels().enabled(); if ($.J(p, $.Pr)) {
                                var N = p.ib().get(); l = h = 0; for (var R = N.length, P, aa = a.$a().enabled(); h < v || l < R;) {
                                    f = u[h]; e = N[l]; w = p.transform(f); P = p.transform(e); e = f = k = x = null; if (-1 == r && c) for (E = h; -1 == r && E < v;)!E && a.Kl() || E == v - 1 && a.Qj() ||
                                        E && E != v - 1 ? e = Gv(a, E, !0, u, b) : e = null, -1 != q ? f = Gv(a, q, !0, u, b) : f = null, E != v - 1 && a.Qj() ? k = Gv(a, v - 1, !0, u, b) : k = null, !e || $.Wm(e, f) || $.Wm(e, k) || (z = p.transform(u[E]), 0 >= z && a.Kl() || 1 <= z && a.Qj() ? r = E : 0 < z && 1 > z && (r = E)), E++; w <= P && h < v || l == R ? (c && h == r ? (q = h, r = -1, d.push(!0)) : d.push(!1), h++, w == P && (a.labels().enabled() || a.Ga().enabled()) && (m.push(!1), l++)) : (aa ? (e = Gv(a, l, !1, N, b), -1 != q && (f = Gv(a, q, !0, u, b)), -1 != r && (k = Gv(a, r, !0, u, b)), -1 != t && (x = Gv(a, t, !1, N, b)), w = (w = a.$a().Yd(l)) ? $.n(w.enabled()) ? w.enabled() : !0 : !0, $.Wm(e, f) || $.Wm(e,
                                            k) || $.Wm(e, x) || !w ? m.push(!1) : (z = p.transform(N[l]), 0 >= z && a.Kl() || 1 <= z && a.Qj() ? (t = l, m.push(!0)) : 0 < z && 1 > z ? (t = l, m.push(!0)) : m.push(!1))) : m.push(!1), l++)
                                } aa || (m = !1)
                            } else if ($.J(p, $.Ar)) for (h = 0; h < v; h++)c ? (!h && a.Kl() || h == v - 1 && a.Qj() || h && h != v - 1 ? e = Gv(a, h, !0, u, b) : e = null, -1 != q ? f = Gv(a, q, !0, u, b) : f = null, h != v - 1 && a.Qj() ? k = Gv(a, v - 1, !0, u, b) : k = null, h ? h == v - 1 ? a.Qj() ? (q = h, d.push(!0)) : d.push(!1) : $.Wm(e, f) || $.Wm(e, k) ? d.push(!1) : (q = h, d.push(!0)) : a.Kl() ? (q = h, d.push(!0)) : d.push(!1)) : d.push(!1)
                        } c || (d = !1); a.R = { labels: d, $a: m };
                        a.U(512)
                    } c = a.R
                } return c
            };
            $.Iv = function (a, b, c) {
                var d, e, f, h = 0, k = 0, l = 0; f = a.title(); e = a.labels(); var m = a.$a(), p = a.orientation(); f.enabled() && (f.$() || f.$(a.$()), $.T(f), f.oa(b), $.pt(f, p), l = a.zb() ? f.Of().height : f.Of().width, f.ka(!1)); b = a.scale(); e = e.enabled() && $.n(b); m = m.enabled() && $.n(b) && $.J(b, $.Pr); f = a.zb() ? c : 0; c = a.zb() ? 0 : c; c = new $.I(0, 0, f, c); var p = Hv(a, c), q; if (e && b) {
                    q = b.Ga().get(); var r = $.A(p) ? p.labels : !p; if (a.hu()) for (e = 0; e < a.ba.length; e++)h += a.ba[e]; else for (e = 0, f = q.length; e < f; e++)if ($.y(r) ? r[e] : r) d = $.$m(Gv(a, e, !0, q, c)), d =
                        a.zb() ? d.height : d.width, d > h && (h = d)
                } if (m && !a.hu()) for (m = $.A(p) ? p.$a : !p, q = b.ib().get(), e = 0, f = m.length; e < f; e++)if ($.y(m) ? m[e] : m) d = $.$m(Gv(a, e, !1, q, c)), d = a.zb() ? d.height : d.width, d > k && (k = d); return a.CR(h, k) + l
            };
            Gv = function (a, b, c, d, e) {
                if (!c && a.scale() && !$.J(a.scale(), $.Pr)) return null; var f = c ? a.oB : a.pB; if ($.n(f[b])) return f[b]; var h = $.n(e) ? e : a.hb(); e = $.n(e) ? e : a.Zb.sb(); var k = c ? a.Ga() : a.ib(), l = k.length(), m = a.stroke(), m = !m || $.to(m) ? 0 : m.thickness ? (0, window.parseFloat)(a.stroke().thickness) : 1; c = c ? a.labels() : a.$a(); var p, q, r = a.scale(); d = d[b]; $.y(d) ? (r = (r.transform(d[0], 0) + r.transform(d[1], 1)) / 2, d = d[0]) : r = r.transform(d, .5); if (0 > r || 1 < r) return [0, 0]; var t = k.enabled(), k = k.position(); switch (a.orientation()) {
                    case "top": p =
                        Math.round(h.left + r * h.width); q = e.top - m / 2; "outside" == k && t && (q -= l); break; case "right": p = e.Ra() + m / 2; q = Math.round(h.top + r * h.height); "outside" == k && t && (p += l); break; case "bottom": p = Math.round(h.left + r * h.width); q = e.Ka() + m / 2; "outside" == k && t && (q += l); break; case "left": p = e.left - m / 2, q = Math.round(h.top + r * h.height), "outside" == k && t && (p -= l)
                }h = a.EH(b, d); p = c.add(h, { value: { x: p, y: q } }, b); q = {}; $.Tc(q, c.Pa, c.ua); $.fv(p, [p.ua, q]); p = c.measure(p, void 0, void 0, b); switch (a.orientation()) {
                    case "top": p.top += p.height / 2; break; case "right": p.left +=
                        p.width / 2; break; case "bottom": p.top += p.height / 2; break; case "left": p.left += p.width / 2
                }return f[b] = $.Zm(p)
            };
            Jv = function (a, b, c, d, e, f, h, k) {
                var l, m; f ? (m = a.Ga(), l = a.labels()) : (m = a.ib(), l = a.$a()); if (k) {
                    k = a.hb(); var p = a.Zb.sb(), q = a.stroke(), q = !q || $.to(q) ? 0 : q.thickness ? (0, window.parseFloat)(q.thickness) : 1; h = $.$m(Gv(a, d, f, h)); var r = a.orientation(), t = 0; if (f && (f = !0, 1 < a.Y && a.hu())) for (var u = 0, v = a.fa.length; u < v; u++) { for (var w = a.fa[u], x = 0, z = w.length; x < z; x++)if (d == w[x]) { f = !1; break } if (!f) break; t += a.ba[u] } var E, N; m = a.$q(m, -1); switch (r) {
                        case "top": E = Math.round(k.left + c * k.width) + e; N = p.top - q / 2 - h.height / 2 - t - m; break; case "right": E =
                            p.Ra() + q / 2 + h.width / 2 + t + m; N = Math.round(k.top + k.height - c * k.height) + e; break; case "bottom": E = Math.round(k.left + c * k.width) + e; N = p.Ka() + q / 2 + h.height / 2 + t + m; break; case "left": E = p.left - q / 2 - h.width / 2 - t - m, N = Math.round(k.top + k.height - c * k.height) + e
                    }c = { value: { x: E, y: N } }; e = l.Yd(d); e || (a = a.EH(d, b), e = l.add(a, c, d), d = {}, $.Tc(d, l.Pa, l.ua), $.fv(e, [e.ua, d])); e.rc(c)
                } else l.clear(d)
            }; Kv = function () { $.Ev.call(this) };
            ...
            $.zw = function (a) {
                var b, c = [Number.MAX_VALUE, -Number.MAX_VALUE]; for (b = a.Ya.length; b--;)if (a.Ya[b].Yg()) { var d = a.Ya[b], e = c; if (d.W(512)) { d.LF = Number.POSITIVE_INFINITY; d.KF = Number.NEGATIVE_INFINITY; for (var f = d.qf(); f.advance();) { var h = Number(f.get("size")); !(0, window.isNaN)(h) && (0 <= h || d.N("displayNegative")) && (h = Math.abs(h), h > d.KF && (d.KF = h), h < d.LF && (d.LF = h)) } } e[0] = Math.min(e[0], d.LF); e[1] = Math.max(e[1], d.KF) } for (b = a.Ya.length; b--;)a.Ya[b].Yg() && (d = a.Ya[b], e = c[1], f = a.Go, h = a.Fo, d.OL = c[0], d.LU = e, d.md = f, d.Rc =
                    h)
                        ...
                        if (1 < h.length) if (f = h[h.length - 1], $.J(d, $.cs)) for (e = f.xG, b = 0; b < h.length - 1; b++)for (f = h[b], c = f.data.length; c < e.length; c++)f.data.push(Gw(e[c])); else {
                            var e = [], t, u, v, w; p = h[0].data; f = h[1].data; c = p.length; l = f.length; t = q = 0; r = q < c ? p[q].data.x : window.NaN; for (u = t < l ? f[t].data.x : window.NaN; !(0, window.isNaN)(r) && !(0, window.isNaN)(u);)v = r <= u, w = r >= u, e.push(v ? r : u), v && (q++, r = q < c ? p[q].data.x : window.NaN), w && (t++, u = t < l ? f[t].data.x : window.NaN); for (; !(0, window.isNaN)(r);)e.push(r), q++, r = q < c ? p[q].data.x : window.NaN; for (; !(0, window.isNaN)(u);)e.push(u),
                                t++, u = t < l ? f[t].data.x : window.NaN; for (b = 2; b < h.length; b++) { var x = []; p = e; f = h[b].data; c = p.length; l = f.length; t = q = 0; r = q < c ? p[q] : window.NaN; for (u = t < l ? f[t].data.x : window.NaN; !(0, window.isNaN)(r) && !(0, window.isNaN)(u);)v = r <= u, w = r >= u, x.push(v ? r : u), v && (q++, r = q < c ? p[q] : window.NaN), w && (t++, u = t < l ? f[t].data.x : window.NaN); for (; !(0, window.isNaN)(r);)x.push(r), q++, r = q < c ? p[q] : window.NaN; for (; !(0, window.isNaN)(u);)x.push(u), t++, u = t < l ? f[t].data.x : window.NaN; e = x } for (b = 0; b < h.length; b++)if (f = h[b], p = f.data, c = p.length, c < e.length) {
                                    t =
                                    []; q = 0; r = (l = p[q]) ? l.data.x : window.NaN; for (c = 0; c < e.length; c++)u = e[c], r <= u ? (t.push(l), q++, r = (l = p[q]) ? l.data.x : window.NaN) : t.push(Gw(u)); f.data = t
                                }
                        } p = !1; e = {}; for (b = 0; b < h.length; b++)if (f = h[b], c = f.ia, q = c.fa || [], q.length) for (p = !0, c = 0; c < q.length; c++)r = q[c], e[r] = !0, f.data[r].G.missing = (Number(f.data[r].G.missing) || 0) | (Number(Hw) || 0); p && (e = Ic(e, function (a, b) { for (var c = 0; c < h.length; c++)if (!Iw(h[c].data[+b].G.missing, sba)) return !1; return !0 })); f = h[0]; if (d.Ve()) if ($.J(d, $.cs)) {
                            if (p) for (p = {}, q = [], b = 0; b < f.data.length; b++)b in
                                e || (c = f.data[b].data.x, p[$.Rn(c)] = q.length, q.push(c)); else p = f.pu, q = f.xG; Paa(d, p, q)
                        } else if (f.data.length) {
                            if (p) for (b = 0; b < f.data.length; b++)b in e || d.Nc(f.data[b].data.x); else d.Nc(f.data[0].data.x, f.data[f.data.length - 1].data.x); if (Jw(f.ia)) if (f.eU) for (b = f.ia.hc(); b.advance();)Iw(b.G("missing"), Kw) || (c = f.ia.error().Sm(!0), m = b.get("x"), d.Nc(m - c[0], m + c[1])); else Lw(f.ia.error()) && (b = f.ia.hc(), b.select(0), c = f.ia.error().Sm(!0), m = b.get("x"), d.Nc(m - c[0], m + c[1]), b.select(f.data.length - 1), c = f.ia.error().Sm(!0),
                                m = b.get("x"), d.Nc(m - c[0], m + c[1]))
                        } if ($.J(d, $.cs) && (f = $.fs(d))) { e = h[0].xG.length; p = Array(e); for (b = 0; b < h.length; b++)if (q = h[b].data, 0 < e) for (c = 0; c < q.length; c++)!$.n(p[c]) && $.n(m = q[c].data[f]) && (p[c] = m, e--); d.lh = p }
                    } for (k in a.qa) d = a.qa[k], d.Ve() && d.pf(); $.Nc(a.qa) && a.Qa().Ve() && (a.Qa().mf(), a.Qa().pf()); a.U(65536)
                }
            };
            tba = function (a) {
                if (a.W(262144)) {
                    var b, c, d, e, f, h, k, l, m, p; a.Cg = !1; for (k in a.Sa) d = a.Sa[k], d.Ve() && d.mf(); for (var q in a.tl) {
                        var r, t; m = a.Ja[q][0].data; d = m.length; f = a.qa[q]; $.J(f, $.cs) ? d ? (r = $.Hb(Math.floor(a.JT() * d - 1), 0, d - 1), t = $.Hb(Math.ceil(a.IT() * d + 1), 0, d - 1)) : t = r = window.NaN : (r = f.Ic(0), t = f.Ic(1), d ? (h = function (a, b) { return a - b.data.x }, r = $.ub(m, r, h), 0 > r && (r = ~r - 1), r = $.Hb(r, 0, d - 1), t = $.ub(m, t, h), 0 > t && (t = ~t), t = $.Hb(t, 0, d - 1), f.inverted() && (m = r, r = t, t = m)) : t = r = window.NaN); h = a.tl[q]; for (var u in h) {
                            f = h[u]; d = a.Sa[u];
                            m = a.nz(d); b = a.ab().gq(); var v = "none" != m, w = "direct" == b, x = "percent" == m, z; if (v) for (z = [], c = r; c <= t; c++)z.push({ Vp: 0, ul: 0, Qp: 0, Tp: 0, rl: 0, Pp: 0, ow: !1, hw: !1, an: !1, XF: { Rt: window.NaN, Ot: window.NaN } }); for (b = 0; b < f.length; b++)if (e = f[w ? f.length - b - 1 : b], c = e.ia, e.Vg = r, e.lastIndex = t, e.EA = v && c.check(32), a.Cg = a.Cg || e.EA, m = e.data, e.EA || x) for (c = r; c <= t; c++)if (l = m[c], e = z[c - r], l.G.shared = e.XF, l.G.stackedMissing = e.an, Iw(l.G.missing, Kw)) e.an = !0; else {
                                p = a.ET(l); 0 <= p ? (l.G.stackedZero = e.ul, e.ul += p, l.G.stackedValue = e.ul, x || (e.ow ?
                                ...
                                if (!x) { a.Mm(d, l.G.stackedValuePrev); a.Mm(d, l.G.stackedValue); a.Mm(d, l.G.stackedValueNext); if (l = m[c - 1]) Iw(l.G.missing, Kw) ? e.ow = !0 : 0 <= p ? e.Vp += p : e.Tp += p; if (l = m[c + 1]) Iw(l.G.missing, Kw) ? e.hw = !0 : 0 <= p ? e.Qp += p : e.Pp += p } e.an = !1
                            } else {
                                var E = c.Wg(); for (c = r; c <= t; c++)if (l = m[c], !Iw(l.G.missing, Kw)) for (p = 0; p < E.length; p++)a.Mm(d, l.data[E[p]]); if (e.ia.nn()) for (c = r; c <= t; c++)if (l = m[c], E = l.data.outliers, !Iw(l.G.missing, Kw) && $.y(E)) for (p = 0; p < E.length; p++)a.Mm(d, E[p]); if (Jw(e.ia) && (Lw(e.ia.error()) || e.baa)) for (m = e.ia.hc(); m.advance();)Iw(m.G("missing"),
                                    Kw) || (c = e.ia.error().Sm(!1), p = $.O(m.get("value")), a.Mm(d, p - c[0]), a.Mm(d, p + c[1]))
                            } if (x) for (a.Mm(d, 0), b = 0; b < f.length; b++)for (e = f[b], m = e.data, c = r; c <= t; c++)l = m[c], e = z[c - r], Iw(l.G.missing, Kw) ? (l.G.stackedPositiveZero = l.G.stackedPositiveZero / e.ul * 100 || 0, l.G.stackedNegativeZero = l.G.stackedNegativeZero / e.rl * 100 || 0) : (p = l.G.stackedValue, 0 <= p ? (w = e.ul, a.Mm(d, 100)) : (w = -e.rl, a.Mm(d, -100)), l.G.stackedZero = l.G.stackedZero / w * 100 || 0, l.G.stackedValue = l.G.stackedValue / w * 100 || 0); v && a.AV(f, r, t, d)
                        }
                    } for (k in a.Sa) d = a.Sa[k],
                        d.Ve() && d.pf(); $.Nc(a.Sa) && a.ab().Ve() && (a.ab().mf(), a.ab().pf()); a.D(1572864); a.U(262144)
                }
            }; Nw = function (a) { var b = [], c; for (c in a) b.push(a[c]); return b }; uba = function (a) { return (0, $.hh)((0, $.Eb)(a.Ya, function (a) { return a.lP() }), function (a, c) { return mb(a, c) }, []) };
            Pw = function (a, b, c) {
                var d = a.g || $.bn(0, 0, 0, 0), e = d.left, f = d.top, h = d.width, k = d.height, d = $.Tj(a.$().Ca()); b -= d.x; c -= d.y; d = a.ba ? (k - (c - f)) / k : (b - e) / h; if (b < e || b > e + h || c < f || c > f + k) return null; for (var e = [], l, m, p, f = 0, h = a.Ya.length; f < h; f++)if ((k = a.Ya[f]) && k.enabled()) {
                    l = k.Qa().Ic(d); a.Ha ? (l = $.Ow(k, l), p = 0 <= l ? [l] : []) : p = $.tq(k.data(), l, $.J(k.Qa(), $.cs)); l = k.la(); var q = window.Infinity, r; if (p.length) {
                        for (var t = 0; t < p.length; t++)if (l.select(p[t])) {
                            var u = l.G("x"); m = k.Wg(); for (var v = 0; v < m.length; v++) {
                                var w = l.G(m[v]), w = $.Ym(u,
                                    w, b, c); w < q && (q = w, r = p[t])
                            }
                        } e.push({ ia: k, qc: p, Kj: p[p.length - 1], fd: { index: r, Le: q } })
                    }
                } return e
            ...
            $.mx = function (a, b, c, d, e) {
                var f = b == a.B, h = f ? a.j : a.F; if (f ? h.kf("enabled") && h.ua.enabled || h.enabled() && a.ba : h.enabled()) {
                    var k = a.oa(), f = k.Ra() - k.gb(), l = k.Ka() - k.Hb(), m = b.zb(), f = m ? f : l, l = b.scale(); $.n(e) ? d = e : (c -= k.gb(), d -= k.Hb(), d = (m ? c : d) / f); d = l.transform(l.Ic(d), .5); m = a.RH(b, m ? d : 1 - d); c = h.format() || $.vo; h.text(c.call(m, m)); c = a.oa(); e = m = 0; if (b) {
                        var p = b.hb(), q = b.enabled(), k = q ? p.gb() : c.Ra(), l = q ? p.Hb() : c.Ka(), r = q ? p.Ra() : c.gb(), p = q ? p.Ka() : c.Hb(); switch (b.orientation()) {
                            case "left": m = kx(h) ? r - 1 : r + 1; e = Math.round(c.top +
                                d * f); break; case "top": m = Math.round(c.left + d * f); e = lx(h) ? p - 1 : p + 1; break; case "right": m = kx(h) ? k - 1 : k + 1; e = Math.round(c.top + d * f); break; case "bottom": m = Math.round(c.left + d * f), e = lx(h) ? l - 1 : l + 1
                        }
                    } b = e; h.x(m).y(b); h.$(a.$()).ea()
                }
            }; kx = function (a) { a = Ds(a); return "left-top" == a || "left-center" == a || "left-bottom" == a }; lx = function (a) { a = Ds(a); return "left-top" == a || "center-top" == a || "right-top" == a }; nx = function () { $.hq.call(this) }; ox = function () { $.ps.call(this); this.bb = this.Ec = this.Xa = null; this.Fa = [] };
            ...
            $.Mx = function (a, b, c, d, e) {
                $.nd.call(this); this.F = d || "shapes"; this.qb = e || $.ia; this.ia = a; this.pe = null; this.K = c; this.g = {}; this.o = {}; this.B = {}; this.j = {}; for (a = 0; a < b.length; a++) {
                    c = b[a]; d = $.am(c.Hc, c.lc ? 3 : 1, c.Bc, c.fk); e = $.am(c.Jc, 2, c.Bc, c.fk); var f = c.xc, h; switch (String(f).toLowerCase()) { case "none": h = null; break; case "rect": h = $.gk; break; case "circle": h = $.hk; break; case "ellipse": h = jk; break; default: h = $.kk }this.g[f] || (this.g[f] = [], this.o[f] = [], this.B[f] = 0); this.j[c.name] = {
                        fill: d, stroke: e, zIndex: +c.zIndex, lc: c.lc,
                        W7: h, xc: f
                    }
                }
            }; $.Nx = function (a, b) { if (a.pe != b) { a.pe = b; for (var c in a.g) for (var d = a.g[c], e = 0; e < d.length; e++)d[e].parent(b) } }; Ox = function (a, b, c, d, e, f, h) { b = a.j[b]; var k = b.fill(a.ia, c), l = b.stroke(a.ia, c); f.fill(k); f.stroke(l); f.Qn(!0); f.zIndex(b.zIndex + e); a.K && a.SF(f, b.lc, d); c = !(k || c != $.cm && b.fill(a.ia, $.cm) || 1 != c && b.fill(a.ia, 1) || 2 != c && b.fill(a.ia, 2)); (h ? b.lc && c : b.lc) ? c ? f.parent(null) : f.parent(a.pe) : h && f.parent(a.pe); return f };
            ...
            $.ey = function (a, b, c, d, e, f, h, k, l, m) {
                var p, q; p = k.sa(); h && ((q = a.ub[p]) || (q = a.ub[p] = [])); var r = b[0].call(a.o), t = c ? c[0].call(a.ya.Ob) : null, u; if (k.G("missing")) l = !1, e = u = void 0, c = b = null; else {
                    l = $.bm(l); a.mm() && e ? (e = k.get(d[0]), l != $.cm && (u = (u = 1 == l ? k.get("hovered") : k.get("selected")) ? u[d[0]] : void 0, u = $.so(u, k.get(d[l])))) : e = u = void 0; d = e && $.n(e.enabled) ? e.enabled : null; var v = u && $.n(u.enabled) ? u.enabled : null, w = 0 == l ? a.o : 1 == l ? a.ca : a.ba, x = 0 == l ? a.ya.Ob : 1 == l ? a.ya.rm : a.ya.sm; b = l == $.cm ? null : b[l].call(w); c = l != $.cm && c ?
                        c[l].call(x) : null; l = null === v ? b && null !== b.enabled() && $.n(b.enabled()) ? b.enabled() : c && null !== c.enabled() && $.n(c.enabled()) ? c.enabled() : null === d ? null !== r.enabled() && $.n(r.enabled()) ? r.enabled() : t ? t.enabled() : null : d : v
                } if (l) if (l = f ? a.XR() : null, h) if (k = k.G("x"), a.N("isVertical")) for (p = 0; p < h.length; p++)f = { value: { x: h[p], y: k } }, q[p] = a.wD(r, q[p], f, l, t, b, c, e, u, m).sa(); else for (p = 0; p < h.length; p++)f = { value: { x: k, y: h[p] } }, q[p] = a.wD(r, q[p], f, l, t, b, c, e, u, m).sa(); else {
                    var z, E; f ? (h = u && $.n(u.position) ? u.position : void 0,
                        q = b && $.n(b.Zd("position")) ? b.Zd("position") : void 0, f = c && $.n(c.Zd("position")) ? c.Zd("position") : void 0, k = e && $.n(e.position) ? e.position : void 0, d = r && $.n(r.Zd("position")) ? r.Zd("position") : void 0, v = t && $.n(t.Zd("position")) ? t.Zd("position") : void 0, x = b && $.n(b.Ck("position")) ? b.Ck("position") : void 0, w = c && $.n(c.Ck("position")) ? c.Ck("position") : void 0, z = r && $.n(r.Ck("position")) ? r.Ck("position") : void 0, E = t && $.n(t.Ck("position")) ? t.Ck("position") : void 0, h = $.so(h, q, f, k, d, v, x, w, z, E, "auto")) : (h = u && $.n(u.position) ?
                            u.position : void 0, q = b && $.n(b.position()) ? b.position() : void 0, f = c && $.n(c.position()) ? c.position() : void 0, k = e && $.n(e.position) ? e.position : void 0, d = r && $.n(r.position()) ? r.position() : void 0, h = $.so(h, q, f, k, d, "auto")); f = a.Vo(h, !0); return a.wD(r, p, f, l, t, b, c, e, u, m, h)
                } else if (h) for (p = 0; p < q.length; p++)r.clear(q[p]); else r.clear(p); return null
            }; wba = function (a, b, c) { var d = $.Ek(b, null); d ? a = a.YV(d) : (b = a.yJ(b), a = a.uT(b), a = $.go(a)); return $.ho(a, c) };
            ...
            }; Fw = function (a, b, c) { if (b) { var d = {}, e = -window.Infinity; b = function (a, b) { var c, h = b.data.x; h in d ? (c = a[d[h]], a[d[h]] = b) : (d[h] = a.length, a.push(b), h < e && (f = !0), e = h); return c || null } } else b = function (a, b) { a.push(b); return null }; var f = !1; a = ny(a, [], b, c ? function (a) { return (a = $.hr(a)) ? a.getTime() : window.NaN } : function (a) { return a }, window.isNaN); f && $.wb(a.data, yba); return a };
            ...
            zba = function (a, b, c, d, e) {
                var f = a.la(); f.reset(); for (var h = []; f.advance();) {
                    var k = a, l = f, m = b, p = c, q = d, r = e, t = void 0, u; if ($.J(k.si, $.Qx) && (t = l.G(k.si.F))) a: { u = t; var v = m, w = p, k = q, x = r, z = void 0; for (z in u) { var E = u[z]; if ($.J(E, $.Gg) && (E = E.sb(), E.left <= v + k && v <= E.left + E.width && E.top <= w + x && w <= E.top + E.height)) { u = !0; break a } } u = !1 } else u = l.G(k.aa.kb + "X"), v = l.G(k.aa.kb), k.aa.kb == k.aa.lb ? u = m <= u && u <= m + q && p <= v && v <= p + r : (w = l.G(k.aa.lb + "X"), k = l.G(k.aa.lb), u = $.Wm([u, v, w, k], [m, p, m + q, p, m + q, p + r, m, p + r])); !u && (t = l.G("marker")) &&
                        (u = t.$e().sb().Dk(new $.I(m, p, q, r))); u && h.push(f.sa())
                } return h
            }; sy = function (a, b, c) { if (!a.enabled()) return a; $.y(b) ? (c || a.vd(), a.state.o(2, b, c ? void 0 : 1)) : $.C(b) && a.state.o(2, b, c ? void 0 : 1); return a };
            ...
            $.g.ti = function (a) {
                var b = "mousedown" == a.type; if (!this.ma || this.zp || b && !a.j()) this.dispatchEvent("earlycancel"); else {
                    if (this.R) b && a.preventDefault(); else if (this.dispatchEvent(new Cg("start", this, a.clientX, a.clientY, a))) this.zp = !0, b && a.preventDefault(); else return; var b = this.F, c = b.documentElement, d = !Oz; this.o.pa(b, ["touchmove", "mousemove"], this.M$, d); this.o.pa(b, ["touchend", "mouseup"], this.bE, d); Oz ? (c.setCapture(!1), this.o.pa(c, "losecapture", this.bE)) : this.o.pa($.Ze(b), "blur", this.bE); this.kW && this.o.pa(this.kW,
                        "scroll", this.fca, d); this.clientX = this.Y = a.clientX; this.clientY = this.ba = a.clientY; this.Im(); this.P = $.Ye($.Ne(this.F).b)
                }
            }; $.g.bE = function (a, b) { $.Kf(this.o); Oz && this.F.releaseCapture(); if (this.zp) { this.zp = !1; var c = this.aw(this.g), d = this.qr(this.deltaY); this.dispatchEvent(new Cg("end", this, a.clientX, a.clientY, a, c, d, b || "touchcancel" == a.type)) } else this.dispatchEvent("earlycancel") };
            ...
            $.g.shape = function (a, b, c, d) {
                if (arguments.length) {
                    if ($.J(a, $.Pg)) if (this.b) { var e = !1, f; for (f in Tz) { var h = Tz[f]; if ($.J(this.b, h) && $.J(a, h)) { e = !0; break } } e ? this.b.jd(a.O()) : (this.b.parent(null), this.b = a, this.b.parent(this)) } else this.b = a, this.b.parent(this); else {
                        var k; $.J(a, $.I) ? (e = a.left, f = a.top, h = a.width, k = a.height) : $.y(a) ? (e = null != a[0] ? a[0] : 0, f = null != a[1] ? a[1] : 0, h = null != a[2] ? a[2] : 0, k = null != a[3] ? a[3] : 0) : $.A(a) ? (e = null != a.left ? a.left : 0, f = null != a.top ? a.top : 0, h = null != a.width ? a.width : 0, k = null != a.height ?
                            a.height : 0) : (e = null != a ? a : 0, f = null != b ? b : 0, h = null != c ? c : 0, k = null != d ? d : 0); this.b ? $.J(this.b, Hh) ? this.b.Cl(e).Dl(f).Bl(h).zl(k) : (this.b.parent(null), this.b = $.gk(e, f, h, k), this.b.parent(this)) : (this.b = $.gk(e, f, h, k), this.b.parent(this))
                    } return this
                } return this.b
            }; $.g.id = function (a) { return $.n(a) ? (this.dd = a, this) : this.dd }; $.g.Vb = function () { this.j = !1; if (this.dd) { $.Jg(); var a = this.shape(); if (a.ja()) this.shape().Vb(); else { var b = Wj(this.Ca().j, this); a.Vb(); a = a.ja(); b.appendChild(a) } } }; $.g.O = function () { return this.b.O() };
            ...
            $.Wg.prototype.Jg = function () {
                var a = 0; if (this.gg()) return a; var b = []; this.sK(function (c, d) {
                    if (1 != c) {
                        var e, f = $.pb(b, b.length - 2); 4 == c ? (e = 6, d = $.Yb(f[0] - $.Lb(d[2], d[0]), f[1] - $.Mb(d[2], d[1]), d[0], d[1], d[2], d[3])) : 2 == c ? e = 2 : 3 == c && (e = 6); for (var h = 0, k = d.length - (e - 1); h < k; h += e) {
                            Array.prototype.push.apply(f, $.pb(d, h, h + e)); var l = a, m = f, p = m.length, q = p / 2 - 1, r = [], t; for (t = 0; t < p; t += 2)r.push({ x: m[t], y: m[t + 1] }); m = []; for (p = 0; 100 >= p; p++) {
                                t = p / 100; var u = { x: 0, y: 0 }; if (t) if (1 === t) m.push(r[q]); else {
                                    var v = r, w = 1 - t; if (1 === q) t = {
                                        x: w *
                                            v[0].x + t * v[1].x, y: w * v[0].y + t * v[1].y
                                    }, m.push(t); else if (4 > q) { var x = w * w, z = t * t, E, N, R, P = 0; 2 === q ? (v = [v[0], v[1], v[2], u], E = x, N = w * t * 2, R = z) : 3 === q && (E = x * w, N = x * t * 3, R = w * z * 3, P = t * z); t = { x: E * v[0].x + N * v[1].x + R * v[2].x + P * v[3].x, y: E * v[0].y + N * v[1].y + R * v[2].y + P * v[3].y }; m.push(t) } else { for (v = JSON.parse(JSON.stringify(r)); 1 < v.length;) { for (u = 0; u < v.length - 1; u++)v[u] = { x: v[u].x + (v[u + 1].x - v[u].x) * t, y: v[u].y + (v[u + 1].y - v[u].y) * t }; v.splice(v.length - 1, 1) } m.push(v[0]) }
                                } else m.push(r[0])
                            } for (u = q = 0; u < m.length - 1; u++)p = m[u], t = m[u + 1], r =
                                t.x - p.x, p = t.y - p.y, q += Math.sqrt(r * r + p * p); a = l + (100 * q | 0) / 100; f = $.pb(f, f.length - 2)
                        }
                    } $.id(Array.prototype.push, d, b)
                }); return a
            }; $.Wg.prototype.jd = function (a) { this.jp = a.closePoint; this.ve = a.currentPoint; this.j = a.segments; this.g = a.count; this.J = a.arguments; this.wb(32); $.Wg.I.jd.call(this, a) }; $.Wg.prototype.O = function () { var a = $.Wg.I.O.call(this); a.type = "path"; return a = $.eh(this, a) }; $.Wg.prototype.da = function () { this.ve = this.jp = null; this.od(); this.qn = null; delete this.j; delete this.g; delete this.J; $.Wg.I.da.call(this) }; $.G($.fh, $.Wg); $.g = $.fh.prototype; $.g.clear = function () { return bh(this) }; $.g.moveTo = function (a, b) { return this.XE(a, b) }; $.g.lineTo = function (a, b, c) { return $.Wg.prototype.$m.apply(this, arguments) }; $.g.Bj = function (a, b, c, d, e, f, h) { return $.Wg.prototype.bD.apply(this, arguments) }; $.g.um = function (a, b, c, d, e) { return $.Wg.prototype.Ica.apply(this, arguments) }; $.g.Wc = function (a, b, c, d, e, f, h) { a += $.Lb(e, c); b += $.Mb(e, d); this.ve && this.ve[0] == a && this.ve[1] == b || (h ? this.$m(a, b) : this.XE(a, b)); return ch(this, c, d, e, f) };
            ...
            var lh = {
                Bea: "backward-diagonal", Xfa: "forward-diagonal", sN: "horizontal", JN: "vertical", ofa: "dashed-backward-diagonal", rN: "grid", pfa: "dashed-forward-diagonal", qfa: "dashed-horizontal", rfa: "dashed-vertical", pN: "diagonal-cross", Dfa: "diagonal-brick", Hfa: "divot", cga: "horizontal-brick", Tha: "vertical-brick", efa: "checker-board", ifa: "confetti", Tga: "plaid", Aha: "solid-diamond", gia: "zig-zag", Xha: "weave", Fga: "percent-05", Gga: "percent-10", Hga: "percent-20", Iga: "percent-25", Jga: "percent-30", Kga: "percent-40", Lga: "percent-50",
                Mga: "percent-60", Nga: "percent-70", Oga: "percent-75", Pga: "percent-80", Qga: "percent-90"
            }, mh = function () {
                var a = {
                    "backward-diagonal": function () { Bh(this, [-1, 0, this.size + 1, 0, this.Xe], -45) }, "forward-diagonal": function () { Bh(this, [-1, 0, this.size + 1, 0, this.Xe], 45) }, horizontal: function () { Bh(this, [-1, this.size / 2, this.size + 1, this.size / 2, this.Xe]) }, vertical: function () { Bh(this, [this.size / 2, -1, this.size / 2, this.size + 1, this.Xe]) }, "diagonal-cross": function () {
                        Bh(this, [0, this.size / 2, this.size, this.size / 2, this.Xe, this.size /
                            2, 0, this.size / 2, this.size, this.Xe], 45)
                    }, grid: function () { Bh(this, [-1, this.size / 2, this.size + 1, this.size / 2, this.Xe, this.size / 2, -1, this.size / 2, this.size + 1, this.Xe]) }, "horizontal-brick": function () { Bh(this, [0, 0, 0, this.size / 2 - 1, this.Xe, 0, this.size / 2 - 1, this.size, this.size / 2 - 1, this.Xe, this.size / 2, this.size / 2 - 1, this.size / 2, this.size - 1, this.Xe, 0, this.size - 1, this.size, this.size - 1, this.Xe]) }, "vertical-brick": function () {
                        Bh(this, [0, 0, 0, this.size / 2 - 1, this.Xe, 0, this.size / 2 - 1, this.size, this.size / 2 - 1, this.Xe, this.size /
                            2, this.size / 2 - 1, this.size / 2, this.size - 1, this.Xe, 0, this.size - 1, this.size, this.size - 1, this.Xe], 90)
                    }, "diagonal-brick": function () { Bh(this, [0, 0, 0, this.size / 2 - 1, this.Xe, 0, this.size / 2 - 1, this.size, this.size / 2 - 1, this.Xe, this.size / 2, this.size / 2 - 1, this.size / 2, this.size - 1, this.Xe, 0, this.size - 1, this.size, this.size - 1, this.Xe], 45) }, "checker-board": function () { Ch(this, [0, 0, this.size / 2, this.size / 2, this.size / 2, this.size]) }, confetti: function () {
                        var a = this.size / 8, c = this.size / 4; Ch(this, [0, 2 * a, c, a, 5 * a, c, 2 * a, 0, c, 4 * a, 4 * a,
                            c, 5 * a, a, c, 6 * a, 6 * a, c])
                    }, plaid: function () { xh(this, this.size / 2, this.size / 2); for (var a = this.size / 8, c, d = 0; 2 > d; d++) { c = !1; for (var e = 0; 4 > e; e++) { c = !c; for (var f = 0; 4 > f; f++)c && xh(this, a, a, e * a + d * this.size / 2, f * a + this.size / 2), c = !c } } }, "solid-diamond": function () { Ah(this, [[this.size / 2, 0, 0, this.size / 2, this.size / 2, this.size, this.size, this.size / 2, this.size / 2, 0]], !0, !0) }, "dashed-forward-diagonal": function () { Bh(this, [0, 0, this.size / 2, this.size / 2, this.Xe]) }, "dashed-backward-diagonal": function () {
                        Bh(this, [this.size / 2, 0, 0, this.size /
                            2, this.Xe])
                    }, "dashed-horizontal": function () { Bh(this, [0, 0, this.size / 2, 0, this.Xe, this.size / 2, this.size / 2, this.size, this.size / 2, this.Xe]) }, "dashed-vertical": function () { Bh(this, [0, 0, 0, this.size / 2, this.Xe, this.size / 2, this.size / 2, this.size / 2, this.size, this.Xe]) }, divot: function () { var a = .1 * this.size, c = this.size * (.8 - .2) / 2; Ah(this, [[a + c, a, a, a + c / 2, a + c, a + c], [this.size - a - c, this.size - a - c, this.size - a, this.size - a - c / 2, this.size - a - c, this.size - a]]) }, "zig-zag": function () {
                        Ah(this, [[0, 0, this.size / 2, this.size / 2, this.size,
                            0], [0, this.size / 2, this.size / 2, this.size, this.size, this.size / 2]])
                    }, weave: function () { Ah(this, [[0, 0, this.size / 2, this.size / 2, this.size, 0], [0, this.size / 2, this.size / 2, this.size, this.size, this.size / 2], [this.size / 2, this.size / 2, 3 * this.size / 4, 3 * this.size / 4], [this.size, this.size / 2, 3 * this.size / 4, this.size / 4]]) }
                }; a["percent-05"] = $.va(qh, 8, 8, [0, 0, 4, 4]); a["percent-10"] = $.va(qh, 8, 4, [0, 0, 4, 2]); a["percent-20"] = $.va(qh, 4, 4, [0, 0, 2, 2]); a["percent-25"] = $.va(qh, 4, 2, [0, 0, 2, 1]); a["percent-30"] = $.va(qh, 4, 4, [0, 0, 2, 0, 3, 1, 0,
                    2, 2, 2, 1, 3]); a["percent-40"] = $.va(qh, 4, 8, [0, 0, 2, 0, 3, 1, 0, 2, 2, 2, 1, 3, 3, 3, 0, 4, 2, 4, 1, 5, 3, 5, 0, 6, 2, 6, 1, 7, 3, 7]); a["percent-50"] = $.va(qh, 2, 2, [0, 0, 1, 1]); a["percent-60"] = $.va(qh, 4, 4, [0, 0, 2, 0, 0, 1, 1, 1, 3, 1, 0, 2, 2, 2, 1, 3, 2, 3, 3, 3]); a["percent-70"] = $.va(qh, 4, 4, [0, 0, 2, 0, 3, 0, 0, 1, 1, 1, 2, 1, 0, 2, 2, 2, 3, 2, 0, 3, 1, 3, 2, 3]); a["percent-75"] = $.va(yh, 4, 4, [0, 0, 2, 2]); a["percent-80"] = $.va(yh, 8, 4, [0, 0, 4, 2]); a["percent-90"] = $.va(yh, 8, 8, [7, 7, 4, 3]); return a
            }(); nh.prototype.gj = function () { return "hatch-fill" };
            ...
            $.g.style = function (a) {
                if (a) {
                    $.Hc(a, function (a, b) { var c = b; switch (b) { case "fontDecoration": case "textDecoration": c = "decoration"; break; case "fontColor": c = "color"; break; case "fontOpacity": c = "opacity" }this.Qb[c] = a }, this); this.Pb = (0, window.parseFloat)(this.Qb.width) || 0; this.kc = (0, window.parseFloat)(this.Qb.height) || 0; this.Qb.lineHeight && (this.aa = vi(this.Qb.lineHeight)); var b, c = this.Qb.vAlign; null != c && ("center" == c ? this.Qb.vAlign = "middle" : (b = !1, $.Hc(fA, function (a) { c == a && (b = !0) }), b || (this.Qb.vAlign = "top")));
                    var d = this.Qb.hAlign; null != d && ("middle" == d ? this.Qb.hAlign = "center" : (b = !1, $.Hc(eA, function (a) { d == a && (b = !0) }), b || (this.Qb.hAlign = $.qi))); null != this.Qb.direction && (this.B = "rtl" == this.Qb.direction); null != this.Qb.textOverflow && (this.qa = this.Qb.textOverflow); null != this.Qb.textIndent && (this.J = this.Qb.textIndent); this.B && (this.J = 0); (a = !this.Ca() || this.Ca().Od()) || this.Ca().te(); this.ma = !1; this.wb(1024); this.wb(32); this.wb(16384); this.wb(4); this.mq(); a || this.Ca().me(); return this
                } return this.Qb
            };
            ...
            $.g.ju = function () {
                ...
                if (null != this.ac) {
                    if (this.Sa) {
                        a = ai.uc(); a.o = []; a.ma = []; a.tagName = ""; a.K = ""; a.g = ""; a.P = "'"; a.J = ""; a.B = ""; a.b = ""; a.style = null; a.F = null; a.state = 1; a.aa = !1; a.j = ""; a.R = !0; a.Y = !1; a.F = this; b = this.text(); for (var c = b.length, d = -1, e, f, h, k = !1; ++d < c;)switch (e = b.charAt(d), f = /\xa0|\s/.test(e), h = /[^a-zA-Z]/.test(e), a.state) {
                            case 1: if ("<" == e) { a.state = 2; break } if (a.aa && f) break; if ("&" == e) { a.state = 14; break } if (a.Y && (a.Y = !1, ";" == e)) break; a.b += e; a.aa = f; break; case 14: if (a.R && !a.j && "#" == e) { a.R = !1; break } if ("&" == e) {
                                li(a, 14, "");
                                break
                            } if (/(_|\W)/.test(e)) { li(a, "<" == e ? 2 : 1, e); break } f = /\d/.test(e); if (!a.R && !f) { li(a, 1, e); break } a.j += e; ki[a.j] && (a.Y = !0, li(a, 1, "")); break; case 2: if (k) { if (">" != e) break; "br" == a.tagName && Ai(a.F); a.tagName = ""; k = !1; a.state = 1; break } if (!a.tagName && "<" == e) { a.b += "<"; break } if (!a.tagName && h && "/" != e) { a.b += "<" + e; a.state = 1; break } if (!a.tagName && "/" == e) { a.state = 3; break } if ("br" == a.tagName && ">" == e) { Ai(a.F); a.tagName = ""; a.state = 1; break } if ("br" == a.tagName && ("/" == e || f)) { k = !0; break } a.tagName && fi(a); if (a.tagName && f) {
                                a.state =
                                4; break
                            } if (">" == e) { hi(a); break } a.tagName += e.toLowerCase(); break; case 3: if (k) { if (">" != e) break; gi(a); k = !1; break } if (!a.K && h) { a.b += "</" + e; a.state = 1; break } if (a.K && f) { k = !0; break } if (">" == e) { gi(a); k = !1; break } a.K += e.toLowerCase(); break; case 4: if (k) { if (">" != e) break; hi(a, !0); k = !1; break } if (">" == e) { hi(a, !0); break } if (f) { a.state = 5; break } if ("=" == e) { a.g && (a.state = "style" == a.g ? 6 : 8); break } a.g += e.toLowerCase(); break; case 5: if (">" == e) { hi(a, !0); break } if (f) break; if (a.g && !h) { a.g = e; a.state = 4; break } if ("=" == e) {
                                a.g && (a.state =
                                    "style" == a.g ? 6 : 8); break
                            } a.g += e; a.state = 4; break; case 6: if (f) break; if (">" == e) { hi(a, !0); break } if ("'" == e || '"' == e) { a.P = e; a.state = 9; break } a.J = e; a.state = 10; break; case 8: if (f) break; if (">" == e) { a.g = ""; a.tagName = ""; a.state = 1; break } if ("'" == e || '"' == e) { a.P = e; a.state = 7; break } a.state = 11; break; case 9: if (f) break; if (e == a.P) { k = !0; ii(a, 4, !0); break } if (":" == e) { a.state = 12; break } a.J += e.toLowerCase(); break; case 12: if (f) break; if (e == a.P) { k = !0; ii(a, 4, !0); break } if (";" == e) { ii(a, 9); break } a.B += e.toLowerCase(); break; case 7: e == a.P &&
                                (a.g = "", a.state = 4); break; case 10: if (f) { k = !0; ii(a, 4, !0); break } if (">" == e) { ji(a); break } if (":" == e) { a.state = 13; break } a.J += e; break; case 11: if (f) { ii(a, 4, !0); break } ">" == e && hi(a); break; case 13: if (f) { k = !0; ii(a, 4, !0); break } if (">" == e) { ji(a); break } if (";" == e) { ii(a, 10); break } a.B += e.toLowerCase(); break; default: throw "Error while parsing HTML: Symbol '" + e + "', position: " + (d - 1);
                        }fi(a); zi(a.F)
                    } else if (this.ac = $.Ba(this.ac.replace(/\xa0|[ \t]+/g, " ")), c = this.ac.split(/\n/g), 1 != c.length || $.n(this.Qb.width) || this.path()) for (b =
                        0; b < c.length; b++)a = $.Ca(c[b]), null != a && ("" != a && ei(this, a), Ai(this)); else this.ja() || Og(this, !0), this.fe(1024) && Di(this), a = new mi(this.ac, {}), this.j.push(a), this.g.push(a), a.parent(this), this.fe(32) && this.dk(), b = $.Jg().hT(this.ja(), this.ac, this.Qb), a.j = -b.top, a.height = b.height, a.width = b.width, this.P = b.height, this.F = b.width + this.J, this.R = a.j, this.Gb = !this.ac.length, zi(this), this.Sb++, a = this.j[0] ? this.j[0].height : 0, this.ha += $.B(this.aa) ? (0, window.parseInt)(this.aa, 0) + a : this.aa * a; this.J && 0 < this.Y.length &&
                            (a = this.Y[0][0], this.B ? this.Qb.hAlign && this.Qb.hAlign != $.qi && "right" != this.Qb.hAlign || (a.J -= this.J) : this.Qb.hAlign && this.Qb.hAlign != $.qi && "left" != this.Qb.hAlign || (a.J += this.J)); this.Qb.width || (this.Pb = this.ec); this.Qb.height || (this.kc = this.o); Bi(this); Ci(this); this.Jb = new $.I(this.Ea, this.Ia, this.Pb, this.kc); this.ma = !0
                }
            }; $.g.Ln = function () { return $.Jg().WC() }; $.g.Og = function () { this.ma || this.ju(); this.fe(64) && this.pM(); this.fe(1024) && Di(this); this.fe(32) && this.dk(); this.fe(16384) && this.zF(); $.ri.I.Og.call(this) };
            ...
            $.g.measure = function (a, b) {
                this.mk || this.Mn(); var c = null, d = 0; if (!a.length) return Qh(this, b); if (" " == a) return $.Ph(this, b); $.xa(a, " ") && (d += c = $.Ph(this, b).width); $.ya(a, " ") && (d += c || $.Ph(this, b).width); b.fontStyle ? this.Nb(this.gh, "font-style", b.fontStyle) : this.gh.removeAttribute("font-style"); b.fontVariant ? this.Nb(this.gh, "font-variant", b.fontVariant) : this.gh.removeAttribute("font-variant"); b.fontFamily ? this.Nb(this.gh, "font-family", b.fontFamily) : this.gh.removeAttribute("font-family"); b.fontSize ? this.Nb(this.gh,
                    "font-size", b.fontSize) : this.gh.removeAttribute("font-size"); b.fontWeight ? this.Nb(this.gh, "font-weight", b.fontWeight) : this.gh.removeAttribute("font-weight"); b.letterSpacing ? this.Nb(this.gh, "letter-spacing", b.letterSpacing) : this.gh.removeAttribute("letter-spacing"); b.decoration ? this.Nb(this.gh, "text-decoration", b.decoration) : this.gh.removeAttribute("text-decoration"); this.Kt.nodeValue = a; c = this.gh.getBBox(); this.Kt.nodeValue = ""; b.fontVariant && $.Qf && (this.Kt.nodeValue = a.charAt(0).toUpperCase(), c.height =
                        this.gh.getBBox().height); return new $.I(c.x, c.y, c.width + d, c.height)
            }; $.g.hT = function (a, b, c) { this.mk || this.Mn(); var d = this.o, e = Rh(this, c), f = d[e]; f || (f = d[e] = {}); if (d = f[b]) return d; e = null; d = 0; if (!b.length) return Qh(this, c); if (" " == b) return $.Ph(this, c); $.xa(b, " ") && (d += e = $.Ph(this, c).width); $.ya(b, " ") && (d += e || $.Ph(this, c).width); e = a.parentNode; this.g.appendChild(a); c = a.getBBox(); e && e.appendChild(a); e = a.getAttribute("x") || 0; a = a.getAttribute("y") || 0; return f[b] = new $.I(c.x - e, c.y - a, c.width + d, c.height) };
            ...
            $.g.wW = function (a) {
                var b = a.Ig(); this.TE(a.src(), $.ia); var c = a.src() || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", d = a.ja(), e = b.left, f = b.top, h = b.width, b = b.height, k; switch (a.align()) {
                    case "x-min-y-min": k = "xMinYMin"; break; case "x-mid-y-min": k = "xMidYMin"; break; case "x-max-y-min": k = "xMaxYMin"; break; case "x-min-y-mid": k = "xMinYMid"; break; case "x-mid-y-mid": k = "xMidYMid"; break; case "x-max-y-mid": k = "xMaxYMid"; break; case "x-min-y-max": k = "xMinYMax"; break; case "x-mid-y-max": k =
                        "xMidYMax"; break; case "x-max-y-max": k = "xMaxYMax"; break; default: k = "none"
                }k = k + " " + a.Av(); $.Vh(this, d, { x: e, y: f, width: h, height: b, "image-rendering": "optimizeQuality", preserveAspectRatio: k, opacity: a.opacity() }); d.setAttributeNS("http://www.w3.org/1999/xlink", "href", c)
            }; $.g.sW = function (a, b) { var c = a.ja(); c && (c.style.cursor = b || "") }; $.g.HM = function (a) { var b = a.ja(); this.Nb(b, "x", a.K); this.Nb(b, "y", a.za) };
            $.g.EW = function (a) {
                var b = a.style(), c = a.path(), d = a.ja(); if (c && a.Ca()) { var e = a.Ca().j; c.parent(e); c.Vb(); $.Hg(c, Fg); var f = c.ja(); e.ja().appendChild(f); e = $.Ec($.Bc.uc(), f, "path"); $.Xh(this, f, e); f = mj(); a.ca.setAttributeNS("http://www.w3.org/1999/xlink", "href", f + "#" + e) } if (a.ds()) {
                    if (d.style["-webkit-touch-callout"] = "", d.style["-webkit-user-select"] = "", d.style["-khtml-user-select"] = "", d.style["-moz-user-select"] = "", d.style["-ms-user-select"] = "", d.style["-o-user-select"] = "", d.style["user-select"] = "", $.hd &&
                        9 == dd || $.Qf) d.removeAttribute("unselectable"), d.removeAttribute("onselectstart")
                } else if (d.style["-webkit-touch-callout"] = "none", d.style["-webkit-user-select"] = "none", d.style["-khtml-user-select"] = "none", d.style["-moz-user-select"] = "moz-none", d.style["-ms-user-select"] = "none", d.style["-o-user-select"] = "none", d.style["user-select"] = "none", $.hd && 9 == dd || $.Qf) this.Nb(d, "unselectable", "on"), this.Nb(d, "onselectstart", "return false;"); b.fontStyle ? this.Nb(d, "font-style", b.fontStyle) : d.removeAttribute("font-style");
                b.fontVariant ? $.gd ? d.style["font-variant"] = b.fontVariant : this.Nb(d, "font-variant", b.fontVariant) : $.gd ? d.style["font-variant"] = "" : d.removeAttribute("font-variant"); b.fontFamily ? this.Nb(d, "font-family", b.fontFamily) : d.removeAttribute("font-family"); b.fontSize ? this.Nb(d, "font-size", b.fontSize) : d.removeAttribute("font-size"); b.fontWeight ? this.Nb(d, "font-weight", b.fontWeight) : d.removeAttribute("font-weight"); b.color ? this.Nb(d, "fill", b.color) : d.removeAttribute("fill"); b.letterSpacing ? this.Nb(d, "letter-spacing",
                    b.letterSpacing) : d.removeAttribute("letter-spacing"); b.decoration ? this.Nb(d, "text-decoration", b.decoration) : d.removeAttribute("text-decoration"); b.direction ? this.Nb(d, "direction", b.direction) : d.removeAttribute("direction"); b.hAlign && !c ? this.Nb(d, "text-anchor", "rtl" == b.direction ? $.gd || $.hd ? "end" == b.hAlign || "left" == b.hAlign ? $.qi : b.hAlign == $.qi || "right" == b.hAlign ? "end" : "middle" : "end" == b.hAlign || "left" == b.hAlign ? "end" : b.hAlign == $.qi || "right" == b.hAlign ? $.qi : "middle" : "end" == b.hAlign || "right" == b.hAlign ?
                        "end" : b.hAlign == $.qi || "left" == b.hAlign ? $.qi : "middle") : d.removeAttribute("text-anchor"); d.style.opacity = b.opacity ? b.opacity : "1"
            }; $.g.jO = function (a) { var b = a.ja(), c = a.parent(); (a.o || a.J) && this.Nb(b, "x", c.path() ? a.J : c.K + a.J); this.Nb(b, "dy", a.g) };
            $.g.kO = function (a) {
                var b = a.b, c = a.ja(), d = a.parent(), e = this.ax(a.text); c.appendChild(e); if ($.hd && 9 == dd || $.Qf) d.ds() ? (c.removeAttribute("onselectstart"), c.removeAttribute("unselectable")) : (this.Nb(c, "onselectstart", "return false;"), this.Nb(c, "unselectable", "on")); b.fontStyle && this.Nb(c, "font-style", b.fontStyle); b.fontVariant && this.Nb(c, "font-variant", b.fontVariant); b.fontFamily && this.Nb(c, "font-family", b.fontFamily); b.fontSize && this.Nb(c, "font-size", b.fontSize); b.fontWeight && this.Nb(c, "font-weight",
                    b.fontWeight); b.color && this.Nb(c, "fill", b.color); b.letterSpacing && this.Nb(c, "letter-spacing", b.letterSpacing); b.np && this.Nb(c, "text-decoration", b.np); (a.parent().path() ? a.parent().ca : a.parent().ja()).appendChild(c)
            }; $.g.eR = function (a) { pj(this, a); qj(this, a) }; $.g.lO = function (a) { a.visible() ? a.ja().removeAttribute("visibility") : this.Nb(a.ja(), "visibility", "hidden") }; $.g.bu = function (a) { var b = a.Pc; b && !$.cc(b) ? this.Nb(a.ja(), "transform", b.toString()) : a.ja().removeAttribute("transform") };
            ...
            $.g.fullScreen = function (a) {
                var b = this.fj(); if ($.n(a)) return b && this.gH() && (a = !!a, this.fullScreen() != a && (a ? b.mozRequestFullScreenWithKeys ? b.mozRequestFullScreenWithKeys() : b.webkitRequestFullscreen ? b.webkitRequestFullscreen() : b.webkitRequestFullscreen ? b.webkitRequestFullscreen() : b.mozRequestFullScreen ? b.mozRequestFullScreen() : b.msRequestFullscreen ? b.msRequestFullscreen() : b.requestFullscreen && b.requestFullscreen() : (b = $.Ne().b, b.webkitCancelFullScreen ? b.webkitCancelFullScreen() : b.mozCancelFullScreen ?
                    b.mozCancelFullScreen() : b.msExitFullscreen ? b.msExitFullscreen() : b.exitFullscreen && b.exitFullscreen()))), this; if (!(a = !b)) { a: { a = $.Ne().b; a = [a.webkitFullscreenElement, a.mozFullScreenElement, a.msFullscreenElement, a.fullscreenElement]; for (var c = 0; c < a.length; c++)if (null != a[c]) { a = a[c]; break a } a = null } a = a != b } return !a
            }; $.g.gH = function () { return Oj() }; $.g.gj = function () { return "stage" }; $.g.gA = function (a) { this.g.gA(a) }; $.g.wy = $.ia;
            $.g.Kn = function (a, b) {
                a && !(0, window.isNaN)(this.rv) && (0, window.clearTimeout)(this.rv); this.rv = window.NaN; var c, d; c = (0, window.isNaN)(this.ID); d = (0, window.isNaN)(this.HD); var e = c || d, f; if (e) { var h; h = this.fullScreen() ? $.mg(this.b) : this.lk ? $.mg(this.lk) : new $.Sb(window.NaN, window.NaN); h.width = Math.max(h.width || 0, 0); h.height = Math.max(h.height || 0, 0); f = !h.width && !h.height; c = c ? h.width : this.ID; d = d ? h.height : this.HD } else c = this.ID, d = this.HD, f = !1; c == this.Pb && d == this.kc || f || (this.Pb = c, this.kc = d, b || this.dispatchEvent("stageresize"));
                this.lk && e && !$.fa.isNodeJS && (this.rv = (0, window.setTimeout)(this.Kn, this.SE))
            ...
            $.g.Gp = function (a) {
                var b = new $.xj(a, this); if ($.J(b.target, $.Gg)) {
                    b.target.dispatchEvent(b); var c = b.type; b.R && a.preventDefault(); $.J(b.relatedTarget, $.Gg) && b.relatedTarget.Ca() == this || ("mouseover" == c ? this.J.pa(window.document, "mousemove", this.Gp, !1) : "mouseout" == c && this.J.tc(window.document, "mousemove", this.Gp, !1)); switch (c) {
                        case "mousedown": this.J.pa(window.document, "mouseup", this.Gp, !1); break; case "mouseup": this.J.tc(window.document, "mouseup", this.Gp, !1); break; case "touchstart": this.J.pa(window.document,
            ...
            $.g.Vb = function () {
                var a = this.Kp(); a && $.n(this.ba) && !this.ba && this.D(ll, !1); this.ba = a; if (!this.J || this.xd || !this.g || this.g.Od()) return this; if (!this.enabled() && (this.K || a)) return this.W(ll) && ($.lf(this.Vc), this.U(ll)), this; if (!rA) {
                    var b = "", c = $.bf("STYLE"); c.type = "text/css"; b += '.anychart-credits{position:absolute;overflow:hidden;right:9px;bottom:6px;height:10px;}.anychart-credits a {text-decoration:none;}.anychart-credits-logo{border:none;margin-right:2px;height:10px;width:10px;display:inline-block;vertical-align:top;}.anychart-credits-text{font-size:10px;line-height:9px;display:inline-block;vertical-align:top;text-decoration:none;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;color:#929292;height:10px;}';
                    c.styleSheet ? c.styleSheet.cssText = b : c.appendChild(window.document.createTextNode(String(b))); $.kf($.Re("head")[0], c, 0); rA = !0
                } this.Vc || (this.Vc = $.bf("DIV", "anychart-credits")); this.j || (this.j = $.bf("A"), this.B = $.bf("SPAN", "anychart-credits-text"), this.b = $.bf("IMG", "anychart-credits-logo"), $.hf(this.j, this.B), this.Vc.appendChild(this.j)); b = this.g.fj(); this.W(ll) && (b && b.appendChild(this.Vc), this.U(ll)); this.W(ml) && (b = $.Aa.apply(null, [", v%s.%s.%s.%s"].concat(["8", "0", "1", "1726"])), c = a ? this.AB() : "AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",
                    $.Te(this.j, { href: a ? this.CB() : "https://www.bizpluscrm.com", title: c.replace("{{anychart-version}}", b), target: "_blank" }), $.Te(this.b, { alt: a ? this.BB() : "AnyChart - JavaScript Charts" }), this.U(ml)); this.W(ul) && (a = a ? this.text() : "Bizplus Reports", $.zf(this.B, a), this.U(ul)); if (this.W(vl)) {
                        if (a = this.Kp() ? this.Hx() : xl()) {
                            if (this.ma = a, b = Zh($.Jg())) $.Kd(b, "complete", this.hV, !1, this), $.Kd(b, "load", this.tP, !1, this), $.Kd(b, "error", this.iV, !1, this), this.o && (Lh(b, a), this.o = !1), $.Jh(b, a, a), this.o =
                                !0, b.start()
                        } else $.lf(this.b); this.U(vl)
                    } return this
            }; $.g.Kp = function () { return jp() || this.Y }; $.g.tP = function (a) { var b = this.ma; a.target.id == b && (this.xd || (this.Kp() ? this.Hx() : xl()) != b || this.b.parentNode || $.kf(this.j, this.b, 0), $.Te(this.b, { src: b }), this.o = !1) }; $.g.hV = function (a) { a.target.id == this.ma && (this.o = !1) }; $.g.iV = function (a) { a.target.id == this.ma && $.lf(this.b) };
            ...
            }; var naa, oaa; naa = /#(.)(.)(.)/; $.zl = /^#(?:[0-9a-f]{3}){1,2}$/i; oaa = /^(?:rgb)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2})\)$/i; var paa, qaa, Wl; $.$l = { color: "#fff", opacity: 1E-5 }; paa = /^#(?:[0-9a-f]{3}){1,2}$/i; qaa = /^(?:rgb)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2})\)$/i; Wl = {}; $.F("anychart.color.blend", $.Kl); $.F("anychart.color.lighten", $.Pl); $.F("anychart.color.darken", $.Ql); $.F("anychart.color.setThickness", $.Ul); $.F("anychart.color.setOpacity", $.Tl); $.F("anychart.color.singleHueProgression", Ml);
            $.F("anychart.color.bipolarHueProgression", function (a, b, c) { c = $.n(c) ? c : 7; a = Ml(a || "blue", Math.floor(c / 2) + 1, null, 1); b = Ml(b || "red", Math.floor(c / 2) + 1, 1); c % 2 || $.gb(a, a.length - 1, 1); $.gb(b, 0, 1); return a.concat(b) }); $.F("anychart.color.blendedHueProgression", $.Nl); for (var tA = [{ Eb: "defaultScaleSettings.linear", Cb: [["defaultScaleSettings.", ["log", "dateTime"]]] }, { Eb: "defaultOrdinalColorScale", Cb: ["defaultScaleSettings.ordinalColor"] }, { Eb: "defaultLinearColorScale", Cb: ["defaultScaleSettings.linearColor"] }, {
                Eb: "defaultFontSettings", Cb: [["default", ["Title", "CrosshairLabel", ["Tooltip", ["", ".contentInternal"]], ["Legend", ["", ".paginator"]], ["Label", ["Factory", "Settings"]]]], [["cartesianBase", "scatter", "mekko"], ".defaultTextMarkerSettings"], ["standalones.", ["label", "table",
                    "textAxisMarker"]], [["standalones", "resource"], ".resourceList.baseSettings"]]
            }, { Eb: "defaultLabelSettings", Cb: [["chart.", [[["", "defaultQuarterSettings."], "defaultLabelSettings"]]]] }, {
                Eb: "defaultBackground", Cb: [[[["default", ["Title", ["Tooltip", ["", ".contentInternal"]], "LabelFactory", "CrosshairLabel", ["Legend", ["", ".paginator"]]]], ["chart", ["", [["", ".defaultQuarterSettings"], ".defaultLabelSettings"]]], ["stock.", [[["defaultPlotSettings", "scroller"], ".xAxis"]]], ["resource.", ["grid", "timeLine", "resourceList"]],
                ["standalones", ["", ".label", ".resourceList"]]], ".background"], "chart.defaultQuarterSettings"]
            }, { Eb: "chart.defaultLabelSettings", Cb: ["defaultNoDataLabel"] }, {
                Eb: "defaultLabelFactory", Cb: [["default", [["Axis.", [[["minorL", "l"], "abels"]]], ["Timeline.", [[["", ["header.", [[["top", "mid", "low"], "Level."]]]], "labels"]]], "DataGrid.defaultColumnSettings.cellTextSettings"]], "standalones.labelsFactory", ["map.axesSettings.", [[["l", "minorL"], "abels"]]], [["pert.milestones", ["resource.", ["activities", "conflicts"]]],
                    ".labels"], ["pert.tasks.", [[["upper", "lower"], "Labels"]]], "stock.defaultPlotSettings.defaultPriceIndicatorSettings.label", "treeMap.normal.headers", [["venn", "pieFunnelPyramidBase", [["heat", "tree"], "Map"], [["chart.defaultAnnotation", "linearGauge.defaultPointer", [["chart", "map"], ".defaultSeries"]], "Settings.base"]], ".normal.labels"]]
            }, { Eb: "chart.normal.labels", Cb: ["chart.defaultSeriesSettings.base.normal.labels"] }, {
                Eb: "defaultCrosshairLabel", Cb: [[["cartesianBase", "mekko", "scatter", "map", "stock"], [[".crosshair.",
                    [[["x", "y"], "Label"]]]]]]
            }, { Eb: "defaultMarkerFactory", Cb: ["defaultTimeline.markers", "standalones.markersFactory", [["venn", "pieFunnelPyramidBase", [["heat", "tree"], "Map"], [["chart.defaultAnnotation", [["chart", "map"], ".defaultSeries"]], "Settings.base"]], ".normal.markers"]] }, { Eb: "defaultTitle", Cb: [[[["default", ["Tooltip", "Axis", "Legend", "DataGrid.defaultColumnSettings"]], ["chart", ["", ".defaultQuarterSettings"]], "standalones", "map.axesSettings"], ".title"]] }, {
                Eb: "defaultSeparator", Cb: [["default", [[["Tooltip.s",
                    "Legend.titleS"], "eparator"]]]]
            }, { Eb: "defaultTooltip", Cb: [[[["default", ["Legend", "DataGrid", "Timeline"]], "chart", "pieFunnelPyramidBase", ["pert.", ["milestones", "tasks"]]], ".tooltip"]] }, { Eb: "defaultLegend", Cb: [[["chart", "standalones"], ".legend"]] }, { Eb: "palette", Cb: [[["chart", "stock.scroller"], ".palette"]] }, { Eb: "hatchFillPalette", Cb: [[["chart", "stock.scroller"], ".hatchFillPalette"]] }, { Eb: "hatchFillPaletteFor3D", Cb: ["cartesian3dBase.hatchFillPalette"] }, {
                Eb: "markerPalette", Cb: [[["chart", "stock.defaultPlotSettings"],
                    ".markerPalette"]]
            }, { Eb: "defaultGridSettings", Cb: [[["defaultMinor", ["cartesianBase scatter polar radar heatMap stock.defaultPlotSettings".split(" "), ".default"]], "GridSettings"], "map.gridsSettings", ["standalones.", [[["linear", "radar", "polar"], "Grid"]]]] }, { Eb: "defaultMinorGridSettings", Cb: [[["cartesianBase", "scatter", "polar", "radar", "stock.defaultPlotSettings"], ".defaultMinorGridSettings"]] }, {
                Eb: "defaultLineMarkerSettings", Cb: [[["cartesianBase", "scatter", "mekko", "sparkline", "defaultTimeline"], ".defaultLineMarkerSettings"],
                    "standalones.lineAxisMarker"]
            }, { Eb: "defaultTextMarkerSettings", Cb: [[["cartesianBase", "scatter", "mekko", "sparkline", "defaultTimeline"], ".defaultTextMarkerSettings"], "standalones.textAxisMarker"] }, { Eb: "defaultRangeMarkerSettings", Cb: [[["cartesianBase", "scatter", "mekko", "sparkline", "defaultTimeline"], ".defaultRangeMarkerSettings"], "standalones.rangeAxisMarker"] }, {
                Eb: "defaultAxis", Cb: [[[[["cartesianBase", "heatMap", "scatter", "mekko"], [[".default", ["X", "Y"]]]], [["circular", "linear"], "Gauge.default"]], "AxisSettings"],
                [["radar.", "polar."], [[["x", "y"], "Axis"]]], ["stock.", [["defaultPlotSettings.", ["defaultYAxisSettings", "xAxis"]], "scroller.xAxis"]], "bullet.axis", "defaultColorRange", ["standalones.", [[["linear", "polar", "radar", "radial"], "Axis"]]]]
            }, { Eb: "defaultColorRange", Cb: [[["map", "treeMap", "standalones", "tagCloud"], ".colorRange"]] }, { Eb: "defaultCallout", Cb: ["map.defaultCalloutSettings"] }, {
                Eb: "defaultScroller", Cb: [[["cartesianBase.x", ["heatMap.", ["x", "y"]]], "Scroller"], [["stock", "standalones"], ".scroller"], ["resource.",
                    [[["horizontal", "vertical"], "ScrollBar"]]]]
            }, { Eb: "defaultNoDataLabel", Cb: [[["chart", "stock.defaultPlotSettings"], ".noDataLabel"]] }, { Eb: "chart", Cb: ["tagCloud", "scatter", "radar", "polar", "bullet", "map", "sparkline", [[["cartesian", ["", "3d"]], "pieFunnelPyramid", "gantt"], "Base"], ["stock", ["", ".defaultPlotSettings"]], [["heat", "tree"], "Map"], [["circular", "linear"], "Gauge"], "pert", "resource", "mekko", "venn"] }, { Eb: "chart.defaultSeriesSettings", Cb: ["stock.scroller.defaultSeriesSettings"] }, {
                Eb: "pieFunnelPyramidBase",
                Cb: ["pie", "pyramid", "funnel"]
            }, { Eb: "pie", Cb: ["pie3d"] }, { Eb: "cartesianBase.defaultAnnotationSettings.base", Cb: [["cartesianBase.defaultAnnotationSettings.", ["ray", "line", [["infinite", "vertical", "horizontal"], "Line"], "rectangle", "ellipse", "triangle", "trendChannel", "andrewsPitchfork", ["fibonacci", ["Fan", "Arc", "Retracement", "Timezones"]], "marker", "label"]]] }, {
                Eb: "cartesianBase.defaultSeriesSettings.rangeLike", Cb: [["cartesianBase.defaultSeriesSettings.", [["range", ["Bar", "Column", [["", "Spline", "Step"], "Area"]]],
                    "hilo"]]]
            }, { Eb: "cartesianBase.defaultSeriesSettings.base", Cb: [["cartesianBase.defaultSeriesSettings.", [[["area", "bar", "line"], "Like"], "marker", "bubble"]]] }, { Eb: "cartesianBase.defaultSeriesSettings.areaLike", Cb: [["cartesianBase.defaultSeriesSettings.", [[["a", "splineA", "stepA"], "rea"], ["range", [[["", "Spline", "Step"], "Area"]]]]]] }, { Eb: "cartesianBase.defaultSeriesSettings.barLike", Cb: [["cartesianBase.defaultSeriesSettings.", ["bar", "column", "box", ["range", ["Bar", "Column"]], "candlestick"]]] }, {
                Eb: "cartesianBase.defaultSeriesSettings.lineLike",
                Cb: [["cartesianBase.defaultSeriesSettings.", [[["", "sp"], "line"], [["step", "jump"], "Line"], "ohlc", "stick", "hilo"]]]
            }, { Eb: "cartesianBase", Cb: ["cartesian", "area", ["vertical", ["Area", "Line"]], "bar", "box", "column", "financial", "line", "jumpLine", "stick", "pareto", "waterfall"] }, { Eb: "waterfall.defaultSeriesSettings.barLike", Cb: ["waterfall.defaultSeriesSettings.waterfall"] }, { Eb: "cartesian3dBase.defaultSeriesSettings.base", Cb: [["cartesian3dBase.defaultSeriesSettings.", ["bar", "column", "area", "line", "line2d"]]] },
            { Eb: "cartesian3dBase", Cb: [[["area", "bar", "column", "line", "cartesian"], "3d"]] }, { Eb: "cartesian", Cb: ["cartesian3d"] }, { Eb: "bar", Cb: ["bar3d"] }, { Eb: "column", Cb: ["column3d"] }, { Eb: "area", Cb: [[["area", "line"], "3d"]] }, { Eb: "mekko.defaultSeriesSettings.base", Cb: [["mekko.defaultSeriesSettings.", ["mosaic", [["", "bar"], "mekko"]]]] }, {
                Eb: "scatter.defaultAnnotationSettings.base", Cb: [["scatter.defaultAnnotationSettings.", ["ray", "line", [["infinite", "vertical", "horizontal"], "Line"], "rectangle", "ellipse", "triangle", "trendChannel",
                    "andrewsPitchfork", ["fibonacci", ["Fan", "Arc", "Retracement", "Timezones"]], "marker", "label"]]]
            }, { Eb: "scatter.defaultSeriesSettings.base", Cb: [["scatter.defaultSeriesSettings.", ["bubble", "lineLike", "marker"]]] }, { Eb: "scatter.defaultSeriesSettings.lineLike", Cb: ["scatter.defaultSeriesSettings.line"] }, { Eb: "scatter", Cb: ["marker", "bubble", "quadrant"] }, { Eb: "radar.defaultSeriesSettings.base", Cb: [["radar.defaultSeriesSettings.", [[["area", "line"], "Like"], "marker"]]] }, {
                Eb: "radar.defaultSeriesSettings.areaLike",
                Cb: ["radar.defaultSeriesSettings.area"]
            }, { Eb: "radar.defaultSeriesSettings.lineLike", Cb: ["radar.defaultSeriesSettings.line"] }, { Eb: "polar.defaultSeriesSettings.base", Cb: [["polar.defaultSeriesSettings.", [[["area", "line", "bar"], "Like"], "marker"]]] }, { Eb: "polar.defaultSeriesSettings.rangeLike", Cb: ["polar.defaultSeriesSettings.rangeColumn"] }, { Eb: "polar.defaultSeriesSettings.areaLike", Cb: [["polar.defaultSeriesSettings.", ["area", "polygon"]]] }, {
                Eb: "polar.defaultSeriesSettings.lineLike", Cb: [["polar.defaultSeriesSettings.",
                    [[["", "poly"], "line"]]]]
            }, { Eb: "polar.defaultSeriesSettings.barLike", Cb: [["polar.defaultSeriesSettings.", [[["c", "rangeC"], "olumn"]]]] }, { Eb: "chart.normal.labels", Cb: ["sparkline.labels"] }, { Eb: "chart.normal.markers", Cb: ["sparkline.markers"] }, { Eb: "chart.defaultSeriesSettings.base.normal", Cb: ["sparkline.defaultSeriesSettings.base"] }, { Eb: "chart.defaultSeriesSettings.area.normal", Cb: ["sparkline.defaultSeriesSettings.area"] }, { Eb: "chart.defaultSeriesSettings.line.normal", Cb: ["sparkline.defaultSeriesSettings.line"] },
            { Eb: "chart.defaultSeriesSettings.column.normal", Cb: ["sparkline.defaultSeriesSettings.column"] }, { Eb: "sparkline.defaultSeriesSettings.base", Cb: [["sparkline.defaultSeriesSettings.", ["area", "line", "column", "winLoss"]]] }, { Eb: "circularGauge.defaultPointerSettings.base", Cb: [["circularGauge.defaultPointerSettings.", ["bar", "marker", "needle", "knob"]]] }, { Eb: "map.defaultSeriesSettings.base", Cb: [["map.defaultSeriesSettings.", ["choropleth", "bubble", "marker", "connector"]]] }, {
                Eb: "map", Cb: ["choropleth", "connector",
                    [["bubble", "marker", "seat"], "Map"]]
            }, { Eb: "heatMap.defaultAnnotationSettings.base", Cb: [["heatMap.defaultAnnotationSettings.", ["ray", "line", [["infinite", "vertical", "horizontal"], "Line"], "rectangle", "ellipse", "triangle", "trendChannel", "andrewsPitchfork", ["fibonacci", ["Fan", "Arc", "Retracement", "Timezones"]], "marker", "label"]]] }, {
                Eb: "stock.defaultAnnotationSettings.base", Cb: [["stock.defaultAnnotationSettings.", ["ray", "line", [["infinite", "vertical", "horizontal"], "Line"], "rectangle", "ellipse", "triangle",
                    "trendChannel", "andrewsPitchfork", ["fibonacci", ["Fan", "Arc", "Retracement", "Timezones"]], "marker", "label"]]]
            }, { Eb: "stock.defaultPlotSettings.defaultSeriesSettings.base", Cb: [["stock.defaultPlotSettings.defaultSeriesSettings.", [[["area", "bar", "line"], "Like"], "marker"]]] }, { Eb: "stock.defaultPlotSettings.defaultSeriesSettings.rangeLike", Cb: [["stock.defaultPlotSettings.defaultSeriesSettings.", [["range", ["Column", [["", "Spline", "Step"], "Area"]]], "hilo"]]] }, {
                Eb: "stock.defaultPlotSettings.defaultSeriesSettings.areaLike",
                Cb: [["stock.defaultPlotSettings.defaultSeriesSettings.", [[["a", "splineA", "stepA"], "rea"], ["range", [[["", "Spline", "Step"], "Area"]]]]]]
            }, { Eb: "stock.defaultPlotSettings.defaultSeriesSettings.barLike", Cb: [["stock.defaultPlotSettings.defaultSeriesSettings.", ["column", "rangeColumn", "candlestick"]]] }, { Eb: "stock.defaultPlotSettings.defaultSeriesSettings.lineLike", Cb: [["stock.defaultPlotSettings.defaultSeriesSettings.", [[["", "sp"], "line"], [["step", "jump"], "Line"], "ohlc", "stick", "hilo"]]] }, {
                Eb: "stock.scroller.defaultSeriesSettings.base",
                Cb: [["stock.scroller.defaultSeriesSettings.", [[["area", "bar", "line"], "Like"], "marker"]]]
            }, { Eb: "stock.scroller.defaultSeriesSettings.areaLike", Cb: [["stock.scroller.defaultSeriesSettings.", [[["a", "splineA", "stepA"], "rea"], ["range", [[["", "Spline", "Step"], "Area"]]]]]] }, { Eb: "stock.scroller.defaultSeriesSettings.barLike", Cb: [["stock.scroller.defaultSeriesSettings.", ["column", "rangeColumn", "candlestick"]]] }, {
                Eb: "stock.scroller.defaultSeriesSettings.lineLike", Cb: [["stock.scroller.defaultSeriesSettings.",
                    [[["", "sp"], "line"], [["step", "jump"], "Line"], "ohlc", "stick", "hilo"]]]
            }, { Eb: "stock.scroller.defaultSeriesSettings.rangeLike", Cb: [["stock.scroller.defaultSeriesSettings.", [["range", ["Column", [["", "Spline", "Step"], "Area"]]], "hilo"]]] }, { Eb: "defaultScrollBar", Cb: [[[["default", ["DataGrid", "Timeline"]], "standalones.timeline"], [[[".horizontal", ".vertical"], "ScrollBar"]]]] }, { Eb: "defaultDataGrid", Cb: [[["ganttBase", "standalones"], ".dataGrid"]] }, {
                Eb: "defaultTimeline", Cb: [[["ganttBase.t", ["standalones.", ["projectT",
                    "resourceT"]]], "imeline"]]
            }, { Eb: "ganttBase", Cb: [["gantt", ["Resource", "Project"]]] }, { Eb: "defaultGroupingSettings", Cb: [["stock.", [[["g", "scrollerG"], "rouping"]]]] }, { Eb: "linearGauge.defaultPointerSettings.base", Cb: [["linearGauge.defaultPointerSettings.", "bar rangeBar marker tank thermometer led".split(" ")]] }, { Eb: "linearGauge", Cb: ["thermometer", "tank", "led"] }, { Eb: "standalones.resourceList.baseSettings", Cb: [[["standalones.resourceList."], ["names", "types", "descriptions", "tags"]]] }, {
                Eb: "resource.resourceList.baseSettings",
                Cb: [[["resource.resourceList."], ["names", "types", "descriptions", "tags"]]]
            }, { Eb: "chart.defaultQuarterSettings", Cb: [["chart.quarters.", [[["right", "left"], "Top"], [["right", "left"], "Bottom"]]]] }, { Eb: "mekko", Cb: ["mosaic", "barmekko"] }, {
                Eb: "mekko.defaultAnnotationSettings.base", Cb: [["mekko.defaultAnnotationSettings.", ["ray", "line", [["infinite", "vertical", "horizontal"], "Line"], "rectangle", "ellipse", "triangle", "trendChannel", "andrewsPitchfork", ["fibonacci", ["Fan", "Arc", "Retracement", "Timezones"]], "marker",
                    "label"]]]
            }], uA = 0; uA < tA.length; uA++)tA[uA].Cb = Gb(tA[uA].Cb); for (var vA = {}, wA = 0; wA < tA.length; wA++)for (var xA = tA[wA].Eb, yA = tA[wA].Cb, zA = 0; zA < yA.length; zA++) { var AA = yA[zA], BA = AA.split(".")[0], CA = vA[BA]; CA || (vA[BA] = CA = { qw: [], ru: 0, hA: 0 }); var DA = CA.qw[CA.qw.length - 1]; DA && DA.Eb == xA ? DA.Cb.push(AA) : CA.qw.push({ Eb: xA, Cb: [AA] }) }
            var em = vA, Am = 0, vm = 1, xm = 2, wm = 3, Bm = 4, Cm = 5, ym = 8, om = function () {
                function a(a, d) { for (var c = Fb(a), f = 0; f < c.length; f++)b[c[f]] = d } var b = { padding: ym, margin: ym, scale: 7, palette: Bm, fill: vm, stroke: xm, hatchFill: wm, hatchFillPalette: Cm }; a([["x", "y", "color"], "Scale"], 7); a([["range", "marker"], "Palette"], Bm); a([["negative", "first", "last", "max", "min", "rising", "falling", "background", "progress", "milestone", "parent", "connector", "odd", "even", "title", "slider", "cell", ["row", ["", "Odd", "Even", "Hover", "Selected"]], ["base", ["",
                    "line"]], ["icon", ["", "Marker"]], ["drag", ["Preview", "Area"]], ["hover", ["", "Negative", "Rising", "Falling"]], ["select", " ed edElement Negative Rising Falling Marquee".split(" ")]], "Fill"], vm); a([["negative", "first", "last", "max", "min", "rising", "falling", "icon", ["hover", ["", "Negative", "Rising", "Falling"]], ["select", ["", "ed", "Negative", "Rising", "Falling"]]], "HatchFill"], wm); a([["column", "row", "connector", "median", "stem", "whisker", "negative", "high", "low", "rising", "falling", "progress", "milestone", "parent",
                        "slider", "background", [["", "line"], "base"], ["hover", " Median Stem Whisker Negative High Low Rising Falling".split(" ")], ["icon", ["", "Marker"]], ["drag", ["Preview", "Area"]], [["x", "value"], "Error"], ["select", " ed edElement Low High Negative Rising Falling edRising edFalling Median Stem Whisker Marquee".split(" ")]], "Stroke"], xm); return b
            }(), qm = {
                "chart.chartLabels": "chart.defaultLabelSettings", "chart.grids": "chart.defaultGridSettings", "chart.minorGrids": "chart.defaultMinorGridSettings", "chart.xAxes": "chart.defaultXAxisSettings",
            ...
            EA.columnsSeparator = EA.Ay; EA.ignoreTrailingSpaces = EA.Fz; EA.ignoreFirstRow = EA.Dz; $.I.prototype.O = function () { return { left: this.left, top: this.top, width: this.width, height: this.height } }; $.F("anychart.math.rect", $.bn); var FA = {
            ...
            $.g.handleEvent = function (a) {
                ...
                b = new To(f, d, a, b); b.altKey = e; this.dispatchEvent(b)
            }; $.g.ra = function () { return this.Rb }; $.g.da = function () { $.Ro.I.da.call(this); $.So(this) }; $.G(To, $.td); var Rba = $.kl.acgraph, Vo; $.Sj.prototype.F = !1; $.Sj.prototype.B = function (a) { this.Lc || (this.Lc = new wl(this, this.F), this.Lc.X($.jm("stageCredits"))); return $.n(a) ? (this.Lc.X(a), this) : this.Lc }; $.Uo = 0; Vo = []; $.Yo = {}; $.Zo = {}; $.ap = {}; $.$o = {}; $.kl.anychart = $.kl.anychart || {}; $.kl.anychart.fontSize = "13px"; $.kl.anychart.fontColor = "#7c868e"; $.kl.anychart.fontFamily = "'Verdana', Helvetica, Arial, sans-serif"; $.kl.anychart.textDirection = "ltr"; var fp = !1, hp = null, mp = [], kp = [], lp = [], rp = {}; $.Mo();
            ...
            $.F("anychart.data.mapAsTable", function (a, b, c) {
                if (!a || !$.y(a)) return []; if ($.n(b)) switch (b = String(b).toLowerCase(), b) { case "range": b = 2; break; case "ohlc": b = 4; break; default: b = 1 } else b = 1; var d; if (!$.n(c) || (0, window.isNaN)(d = $.bo(c, window.NaN, !1))) d = $.y(a[0]) ? Math.floor((a[0].length - 1) / b) : 0; if ((0, window.isNaN)(d) || 0 >= d) return []; a = new $.Cq(a); c = []; if (1 == b) for (b = 0; b < d; b++)c.push(a.qe({ x: [0], value: [1 + b] })); else if (2 == b) for (b = 0; b < d; b++)c.push(a.qe({ x: [0], low: [1 + 2 * b], high: [2 * b + 2] })); else if (4 == b) for (b = 0; b <
                    d; b++)c.push(a.qe({ x: [0], open: [1 + 4 * b], high: [4 * b + 2], low: [4 * b + 3], close: [4 * b + 4] })); return c
            }); $.F("anychart.data.buildMapping", Gq); $.F("anychart.data.parseText", Iq); var Jaa = "GyMdkHmsSEDahKzZvQL"; $.F("anychart.format.locales.default.dateTimeLocale", {
                ...
                weekendRange: [5, 6], firstWeekCutOffDay: 3, dateFormat: "y MMM d", timeFormat: "HH:mm:ss", dateTimeFormat: "y MMM d 'at' HH:mm:ss", formats: {
                    full_year: "yyyy", full_year_semester: "MMM yyyy", full_year_quarter: "MMM yyyy", full_year_month: "MMM yyyy", full_year_third_of_month: "dd MMM yyyy", full_year_week: "dd MMM yyyy", full_year_day: "dd MMM yyyy", full_year_hour: "HH dd MMM yyyy", full_year_minute: "dd MMM yyyy, HH:mm", full_year_second: "dd MMM yyyy, HH:mm:ss", full_year_millisecond: "dd MMM yyyy, HH:mm:ss.SSS", timeline_year: ["yyyy",
                    ...
                    timelineHeader_day_hour: "HH:mm", timelineHeader_hour_minute: "H:mm"
                }
            }); $.F("anychart.format.locales.default.numberLocale", { decimalsCount: 1, decimalPoint: ".", groupsSeparator: "", scale: !1, zeroFillDecimals: !1, scaleSuffixSeparator: "", useBracketsForNegative: !1 }); $.F("anychart.format.locales.default.messages", {});
            ...
            $.g.T3 = function (a, b, c, d, e, f) {
                if ($.n(a)) {
                    var h; if (null === a) h = null; else if ($.B(a) && 1 == arguments.length) h = ln(a); else { if ($.B(a)) switch (a = $.Zk(a), b = $.O(b) || 1, a) { case "year": a = "y"; break; case "semester": a = "m"; b *= 6; break; case "quarter": a = "m"; b *= 4; break; case "month": a = "m"; break; case "third-of-month": a = "d"; b *= 10; break; case "week": a = "d"; b *= 7; break; case "day": a = "d"; break; case "hour": a = "h"; break; case "minute": a = "n"; break; case "second": a = "s"; break; case "millisecond": a = "t" }h = new $.kn(a, b, c, d, e, f) } var k; if (k = h &&
                        this.Vk) k = this.Vk, k = h.B == k.B && h.o == k.o && h.b == k.b && h.j == k.j && h.J == k.J && h.g == k.g; k || !h && !this.Vk || (h ? (this.wj = window.NaN, this.Vk = h) : (this.wj = 4, this.Vk = null), this.ap = this.$i = null, this.wa(2)); return this
                } return mn(this.Vk, !1)
            }; $.g.count = function (a) { return $.n(a) ? (this.wj != a && (this.Vk = null, this.wj = (0, window.isNaN)(a) || 2 > a ? 4 : Math.ceil(+a), this.ap = this.$i = null, this.wa(2)), this) : this.wj };
            ...
            $.g.qQ = function () {
                (0, window.isFinite)(this.o) ? (0, window.isFinite)(this.g) ? $.Qm(this.g, this.o, 1E-10) && (this.g -= .5, this.o += .5) : this.g = this.o - 1 : (0, window.isFinite)(this.g) ? this.o = this.g + 1 : (this.g = 0, this.o = 1); var a = (this.K ? (0, window.isNaN)(this.R) ? this.o : Math.max(this.o, this.R) : this.max) - (this.ma ? (0, window.isNaN)(this.P) ? this.g : Math.min(this.g, this.P) : this.min); 1E-4 > Math.abs(a) && !this.ma && !this.K && (this.max += 1E-4); var b, c = "percent" != this.lm(); this.ma && (b = c ? this.ca : 0, this.min = this.g - a * b, (0, window.isNaN)(this.P) ||
                    (this.min = 0 < a ? Math.min(this.min, this.P) : Math.max(this.min, this.P)), this.fa && 0 > this.min && 0 <= this.g && this.min != this.P && (this.min = 0)); this.K && (b = c ? this.ba : 0, this.max = this.o + a * b, (0, window.isNaN)(this.R) || (this.max = 0 < a ? Math.max(this.max, this.R) : Math.min(this.max, this.R)), this.fa && 0 > this.max && 0 <= this.o && this.max != this.R && (this.max = 0))
            }; $.g.Ic = function (a) { this.hh(); a = Dr(this, a); return a * this.Hd + this.min };
            ...
            $.g.hh = function () {
                if (!this.b) {
                    $.Qr.I.hh.call(this); var a = this.Ga(), b = this.min, c = this.max, d = this.ma, e = this.K; a.ap = null; var f = [b, c]; if (!a.$i) { var h = [], k = a.Vk, l = a.wj; k && (c - b) / Ho(k) > a.scale.Rq() && ($.jl(20, null, [c - b, Ho(k)]), k = null, a.wj = 4); k || (k = zr(a, b, c, !1)); d && (f[0] = b = $.oo(b, k, 0)); b = new $.tn(new Date(b)); c = new $.tn(new Date(c)); for (d = 0; 0 >= b.getTime() - c.getTime() && 150 > d; b.add(k), d++)h.push(b.getTime()); e && 0 < b.getTime() - c.getTime() && h.push(f[1] = b.getTime()); a.ap = h; a.wj = l } a = this.ib(); c = this.min; b = this.max;
                    d = f[0]; l = f[1]; a.ap = null; if (!a.$i) { e = []; h = a.Vk; k = a.wj; h && (l - d) / Ho(h) > a.scale.Rq() && ($.jl(20, null, [l - d, Ho(h)]), h = null, a.wj = 4); h || (h = zr(a, c, b, !0)); c = new $.tn(new Date(d)); l = new $.tn(new Date(l)); for (b = 0; 0 >= c.getTime() - l.getTime() && 150 > b; c.add(h), b++)e.push(c.getTime()); a.ap = e; a.wj = k } this.ma && (this.min = f[0]); this.K && (this.max = f[1]); this.Hd = this.max - this.min
                }
            }; $.g.pQ = function (a) { $.U(a, 2) && (this.b = !1, this.wa(2)) };
            ...
            $.g.names = function (a) {
                if ($.n(a)) return this.Ql != a && (this.Ql = a, this.wa(2)), this; a = as(this); var b, c; if (this.Ql && this.Ql.length < a.length || !this.lh) { var d = this.scale.names(); this.lh = []; for (b = 0; b < a.length; b++) { c = $.y(a[b]) ? a[b][0] : a[b]; var e = this.scale.dr(c); (0, window.isNaN)(e) ? this.lh.push(c) : this.lh.push(d[e]) } } if (this.Ql) for (; this.Ql.length < a.length;)this.Ql.push(this.lh[this.Ql.length]); c = this.Ql || this.lh; d = Math.min(c.length, a.length); e = []; for (b = 0; b < d; b++) {
                    var f, h; h = a[b]; $.y(h) ? (f = h[0], h = h[1]) : f = h;
                    f = this.scale.transform(f, 0); h = this.scale.transform(h, 1); 0 > f && 0 > h || 1 < f && 1 < h || e.push(c[b])
                } return e
            }; $.g.get = function () { return (0, $.sf)(as(this), function (a) { var b; $.y(a) ? (b = a[0], a = a[1]) : b = a; b = this.transform(b, 0); a = this.transform(a, 1); return !(0 > b && 0 > a || 1 < b && 1 < a) }, this.scale) }; $.g.yR = function () { var a, b = this.scale.values().length; a = (0, window.isNaN)(this.Qq) ? Math.ceil(b / this.Ns) || 1 : this.Qq; for (var c = [], d = 0; d < b; d += a)c.push(d); return c };
            ...
            $.g.oa = function (a, b, c, d) {
                if ($.n(a)) {
                    var e, f, h, k; null === a ? this.nj && (this.nj = null, this.Ek()) : $.J(a, $.I) ? (e = a.left, f = a.top, h = a.width, k = a.height) : $.A(a) ? (e = a.left, f = a.top, h = a.width, k = a.height) : (e = a, f = b, h = c, k = d); e = $.O(e); f = $.O(f); h = $.O(h); k = $.O(k); (0, window.isNaN)(e) || (0, window.isNaN)(f) || (0, window.isNaN)(h) || (0, window.isNaN)(k) || this.nj && this.nj.left == e && this.nj.top == f && this.nj.width == h && this.nj.height == k || (this.nj ? (this.nj.left = e, this.nj.top = f, this.nj.width = h, this.nj.height = k) : this.nj = $.bn(e, f, h, k),
                        this.Ek()); return this
                } if (this.nj) return this.nj.clone(); var l; return this.Ae && (l = this.Ae.Ca()) ? $.fa.isNodeJS ? $.an($.fa.defaultBounds) : l.sb() : null
            }; $.g.Ek = function () { this.D(4, 9) }; $.g.Vl = function () { return !0 }; $.g.$p = function (a, b, c, d) { var e = $.kl.anychart.exports; e ? e.$p(this, this.Ae, a, b, c, d) : $.hl(4, null, ["Exporting"]) }; $.g.Yp = function (a, b, c, d, e) { var f = $.kl.anychart.exports; f ? f.Yp(this, this.Ae, a, b, c, d, e) : $.hl(4, null, ["Exporting"]) };
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; var a = this.N("fill") || "none", b = this.N("stroke"), c = this.N("topStroke"), d = this.N("rightStroke"), e = this.N("bottomStroke"), f = this.N("leftStroke"), h = !!(c || d || e || f), k = c && d && e && f, l, m, p = this.$() ? this.$().Ca() : null, q = p && !p.Od(); q && p.te(); if (this.W(4)) {
                    this.Ta || (this.Ta = $.ik()); k && this.b ? this.b.clear().parent(null) : (this.b || (this.b = $.kk()), this.b.parent(this.Ta), this.b.clear()); h ? (this.j || (this.j = $.kk()), this.j.parent(this.Ta), this.j.clear()) : this.j && this.j.clear().parent(null);
                    if (this.F) for (k = 0, l = this.F.length; k < l; k++)(m = this.F[k]) && m.clear().parent(null); if (h) for (this.B = [c, d, e, f], this.F || (this.F = []), this.g || (this.g = []), k = 0, l = this.B.length; k < l; k++)c = this.B[k], $.n(c) && !$.to(c) ? (c = this.F[k] ? this.F[k] : this.F[k] = $.kk(), c.parent(this.Ta), c.clear(), this.g[k] = c) : $.n(b) && !$.to(b) && (this.B[k] = b, this.g[k] = this.b); k = this.AK(); l = qs(this, 0); c = qs(this, 1); d = qs(this, 2); e = qs(this, 3); if (h) {
                        f = this.g[0] ? $.Ac($.xc(this.B[0])) / 2 : 0; m = this.g[1] ? $.Ac($.xc(this.B[1])) / 2 : 0; var r = this.g[2] ? $.Ac($.xc(this.B[2])) /
                            2 : 0, t = this.g[3] ? $.Ac($.xc(this.B[3])) / 2 : 0; k.left += t; k.top += f; k.width -= t + m; k.height -= f + r; var c = [k.Ra() - c, k.top, k.Ra(), k.top, k.Ra(), k.top + c, k.Ra() - c + c * Math.cos($.H(315)), k.top + c + c * Math.sin($.H(315)), k.Ra(), k.Ka() - d, k.Ra(), k.Ka(), k.Ra() - d, k.Ka(), k.Ra() - d + d * Math.cos($.H(45)), k.Ka() - d + d * Math.sin($.H(45)), k.left + e, k.Ka(), k.left, k.Ka(), k.left, k.Ka() - e, k.left + e + e * Math.cos($.H(135)), k.Ka() - e + e * Math.sin($.H(135)), k.left, k.top + l, k.left, k.top, k.left + l, k.top, k.left + l + l * Math.cos($.H(225)), k.top + l + l * Math.sin($.H(225))],
                                u, k = 0; for (l = c.length; k < l; k += 8)if (e = k / 8, k || this.j.moveTo(c[c.length - 4], c[c.length - 3]), this.j.lineTo(c[k], c[k + 1]), rs(this, this.j, c[k + 2], c[k + 3], c[k + 4], c[k + 5], qs(this, e)), d = this.g[e]) k ? (u != d && d.moveTo(c[k - 2], c[k - 1]), rs(this, d, c[k - 6], c[k - 5], c[k - 4], c[k - 3], qs(this, e))) : (d.moveTo(c[c.length - 2], c[c.length - 1]), rs(this, d, c[c.length - 6], c[c.length - 5], c[c.length - 4], c[c.length - 3], qs(this, e))), d.lineTo(c[k], c[k + 1]), rs(this, d, c[k + 2], c[k + 3], c[k + 6], c[k + 7], qs(this, e)), u = d
                    } else {
                        u = $.Ac($.xc(b)) / 2; (0, window.isNaN)(u) &&
                            (u = .5); k.left += u; k.top += u; k.width -= u + u; k.height -= u + u; c = [k.Ra() - c, k.top, k.Ra(), k.top, k.Ra(), k.top + c, k.Ra(), k.Ka() - d, k.Ra(), k.Ka(), k.Ra() - d, k.Ka(), k.left + e, k.Ka(), k.left, k.Ka(), k.left, k.Ka() - e, k.left, k.top + l, k.left, k.top, k.left + l, k.top]; k = 0; for (l = c.length; k < l; k += 6)k || this.b.moveTo(c[c.length - 2], c[c.length - 1]), this.b.lineTo(c[k], c[k + 1]), rs(this, this.b, c[k + 2], c[k + 3], c[k + 4], c[k + 5], qs(this, (k / 6 + 1) % 4)); this.b.close()
                    } this.U(4); $.A(a) && ("keys" in a || "src" in a) && this.D(16)
                } if (this.W(16)) {
                    if (h) {
                        k = 0; for (l = this.g.length; k <
                            l; k++)(m = this.g[k]) && m.stroke(this.B[k]); this.j.fill(a); this.j.stroke(null)
                    } else this.b.stroke(b), this.b.fill(a); this.U(16)
                } if (this.W(64)) { a = this.N("disablePointerEvents"); if (h) { k = 0; for (l = this.g.length; k < l; k++)(m = this.g[k]) && m.Xc(a); this.j.Xc(a) } else this.b.Xc(a); this.Ta.Xc(a); this.U(64) } this.W(8) && (this.Ta.zIndex(this.N("zIndex")), this.U(8)); this.W(2) && (this.Ta.parent(this.$()), this.U(2)); q && p.me(); return this
            ...
            $.g.TH = function () {
                var a = this.oa() || $.bn(0, 0, 0, 0), b = a.left, c = a.top, d = a.width, e = a.height, a = new $.I(0, 0, this.Y, this.P), f = new $.Pb(0, 0); if (this.oa()) switch (this.N("position")) {
                    case "left-top": f.x = b; f.y = c; break; case "left-center": f.x = b; f.y = c + e / 2; break; case "left-bottom": f.x = b; f.y = c + e; break; case "center-top": f.x = b + d / 2; f.y = c; break; case "center": f.x = b + d / 2; f.y = c + e / 2; break; case "center-bottom": f.x = b + d / 2; f.y = c + e; break; case "right-top": f.x = b + d; f.y = c; break; case "right-center": f.x = b + d; f.y = c + e / 2; break; case "right-bottom": f.x =
                        b + d, f.y = c + e
                } else f.x = 0, f.y = 0; b = $.co(new $.I(0, 0, this.Y, this.P), Ds(this)); f.x -= b.x; f.y -= b.y; d = $.n(this.N("offsetX")) ? $.M(this.N("offsetX"), d) : 0; e = $.n(this.N("offsetY")) ? $.M(this.N("offsetY"), e) : 0; $.ro(f, Ds(this), d, e); this.F += f.x; this.R += f.y; a.left = f.x; a.top = f.y; this.b.x(this.F).y(this.R); return a
            };
            $.g.ea = function () {
                if (!this.ic()) return this; var a = Gs(this), b = this.$(); this.W(16) && (this.Gg(this.b, a), this.U(16)); this.W(2) && (this.j && this.j.$(this.g).ea(), this.b && this.b.parent(this.g), this.g.parent(b), this.U(2)); this.W(8) && (this.j && this.j.zIndex(0), this.b && this.b.zIndex(1), this.g.zIndex(this.zIndex()), this.U(8)); if (this.W(4)) { Fs(this); var c = this.TH(); this.D(64) } this.W(64) && (this.j && ($.T(this.j), this.j.oa(c), this.j.ea(), this.j.ka(!1)), this.U(64)); if (this.W(4)) {
                    this.g.Wb(1, 0, 0, 1, 0, 0); a = this.N("rotation");
                    a = $.n(a) && !(0, window.isNaN)(a) ? a : this.qa; b = Ds(this); if (!$.n(a) || (0, window.isNaN)(a)) a = 0; c = $.co(c, b); this.g.Zt(a, c.x, c.y); this.U(4)
                } return this
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; $.T(this); var a = $.fd(this.ba); switch (this.b) { case 0: throw Error("Undefined button state."); case 4: Ys(this, a.hover); break; case 8: Ys(this, a.pushed); break; case 16: Ys(this, a.checked); break; case 1: Ys(this, a.disabled); break; default: Ys(this, a.normal) }this.ka(!0); this.W(8) && (a = this.zIndex(), this.Tg && this.Tg.zIndex(a), this.Yf && this.Yf.zIndex(a), this.U(8)); this.W(2) && (a = this.$(), this.Tg && this.Tg.parent(a), this.Yf && this.Yf.parent(a), this.U(2)); this.W(128) && (this.Yf &&
                    this.Yf.cursor(this.cursor()), this.Tg && this.Tg.cursor(this.cursor()), this.U(128)); return this
            }; $.g.remove = function () { this.Yf && this.Yf.parent(null); this.Tg && this.Tg.parent(null) }; $.g.MH = function (a) { this.disabled() || this.j || this.checked() || this.wg(a) && this.Xg(!0) }; $.g.LH = function (a) { this.disabled() || this.j || this.checked() || (this.j = !1, this.wg(a) && this.Za(!0)) }; $.g.KH = function (a) { a.preventDefault(); this.disabled() || (this.j = !0, this.wg(a) && this.Hca(!0)) };
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; var a = this.$(), b = a ? a.Ca() : null, c = b && !b.Od(); c && b.te(); var d; if (d = !this.ac) this.ac = mk(), this.ac.nd("aria-hidden", "true"), $.L(this, this.ac); $.T(this.background()); this.W(4) && it(this); this.W(2) && (this.background().$(a).ea(), this.B && this.B.$(a), this.ac && this.ac.parent(a), this.o && this.o.$(a), this.U(2)); this.W(64) && (this.j.oa(this.F, this.R, this.g, this.b), this.j.ea(), this.U(64)); this.W(8) && (a = this.zIndex(), this.j && this.j.zIndex(a), this.B && this.B.zIndex(a), this.ac &&
                    this.ac.zIndex(a), this.o && this.o.zIndex(a), this.U(8)); this.W(16) && ($.T(this), this.ua.text = ((0, window.isNaN)(this.ba) ? "-" : String(this.ba + 1)) + " / " + ((0, window.isNaN)(this.P) ? "-" : String(this.P)), this.ka(!1), this.Gg(this.ac, d), this.D(4), this.U(16)); if (this.W(4)) {
                        d = this.ac.sb(); var a = d.height, e = this.oa(); this.B.width(a).height(a).oa(e); this.o.width(a).height(a).oa(e); var f, h, k, l, m; k = $.M(this.padding().N("top"), this.b); var e = $.M(this.padding().N("left"), this.g), p = this.padding().mg(this.g), q = this.padding().Bg(this.b);
                    ...
                    } this.background().ka(!1); c && b.me(); return this
            }; $.g.hb = function () { return jt(this) };
            ...
            $.g.parent = function (a) {
                if ($.n(a)) {
                    if (this.na != a) {
                        var b = String($.ra(this)); a ? (this.na && $.jq(this.na, this.EB, this), this.na = a, this.title().parent(this.na.title()), this.Bn().parent(this.na.Bn()), this.background().parent(this.na.background()), this.padding().parent(this.na.padding()), this.Ch().padding().parent(this.na.Ch().padding()), this.na.F[b] = this, $.S(this.na, this.EB, this)) : ($.jq(this.na, this.EB, this), this.title().parent(null), this.Bn().parent(null), this.background().parent(null), this.padding().parent(null),
                            this.Ch().padding().parent(null), delete this.na.F[b], this.na = null)
                    } return this
                } return this.na
            }; $.g.EB = function (a) { var b = 0, c = 0; if ($.U(a, 8) || $.U(a, 1)) b |= Et, c |= 8, this.rw(); $.U(a, 32768) && (b |= 1, c |= 1); this.K = null; this.D(b, c) }; $.g.kf = function (a) { return null != this.ua[a] }; $.g.N = $.gq; $.g.check = function (a) { return $.n(a) ? !!(a & this.Ba) : !0 }; $.g.Sf = function (a) { $.n(a) && (this.K = a); return this.K }; $.g.Ki = $.fq; $.g.ye = function () { var a = [this.Pa]; this.na && (a = $.lb(a, this.na.ye())); return a };
            ...
            $.g.da = function () {
                delete this.ua; delete this.Pa; if (this.na) { var a = String($.ra(this)); $.jq(this.na, this.EB, this); delete this.na.F[a] } for (var b in this.F) (a = this.F[b]) && a.Kc(); this.o && !this.o.At() && this.$(null); $.od(this.Xa, this.ca, this.P, this.j, this.bb, this.g, this.B); delete this.Xa; delete this.ca; delete this.P; delete this.j; delete this.bb; delete this.B; if (this.o && this.o.At() && eu(this)) {
                    a = !0; for (b in Dt) if (Dt.hasOwnProperty(b)) { var c = Dt[b]; if (c != this && this.o == c.o) { a = !1; break } } a && (b = fu(this), delete gu[b],
                        $.K(this.o))
                } delete this.o; delete Dt[String($.ra(this))]; $.Ht.I.da.call(this)
            }; var AB = $.Ht.prototype; AB.title = AB.title; AB.separator = AB.Bn; AB.background = AB.background; AB.padding = AB.padding; AB.hide = AB.cd; AB.hideDelay = AB.Vv; AB.textSettings = AB.ys; $.G($.hu, xs); $.g = $.hu.prototype; $.g.Aa = xs.prototype.Aa; $.g.xa = xs.prototype.xa | 4032; $.g.$H = function (a) { if ($.n(a) && (a = $.wk($.mA, a, "default"), this.Ba != a)) { this.Ba = a; if (this.b) { a = 0; for (var b = this.b.length; a < b; a++)Ms(this.b[a], this.Ba) } this.D(16, 1); return this } return this.Ba }; $.g.tL = function (a) { return $.n(a) ? (a = $.wk(Dba, a, this.P || "vertical"), this.P != a && (this.P = a, this.D(4, 9)), this) : this.P }; $.g.Md = function (a) { return $.n(a) ? (a = !!a, this.Y != a && (this.Y = a, this.D(16, 1)), this) : this.Y };
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; this.Ta || (this.Ta = $.ik(), $.hs(this, this.Ta), $.L(this, this.Ta), this.ha || (this.ha = $.ik(), this.ha.parent(this.Ta).zIndex(20), $.L(this, this.ha))); this.W(8) && (this.Ta.zIndex(this.zIndex()), this.U(8)); var a = this.$(), b = a ? a.Ca() : null; this.W(2) && (this.Ta.parent(a), this.U(2)); (a = b && !b.Od()) && b.te(); this.W(1024) && (this.Ua = !0, this.U(1024)); if (this.W(16)) {
                    var c = this.cI(), d = bba(this); this.Y && (d = d.reverse()); d = $.D(c) ? c(d) : d; this.b && this.b.length != d.length && (this.Ua = !0);
                    c = cba(this, d); dba(this, c); this.U(16)
                } eba(this); if (this.W(4)) { if (this.b && "..." == this.N("textOverflow")) for (c = 0, d = this.b.length; c < d; c++)this.b[c].oa(null), this.b[c].Bk().width(null); ku(this); this.D(3008); this.Ta.Wb(1, 0, 0, 1, this.tb.left, this.tb.top); this.Ta.clip(this.Ja); this.U(4) } this.W(64) && (c = this.background(), $.T(c), c.oa(this.Ja), this.enabled() && c.$(this.Ta), c.ka(!1), c.ea(), this.U(64)); this.W(128) && (c = this.title(), $.T(c), c.oa(this.Uf), this.enabled() && c.$(this.Ta), c.ka(!1), c.ea(), this.U(128)); c = this.Xa ?
                    this.Xa.Sc() : this.Uf; this.W(256) && (d = this.MA(), $.T(d), d.oa(c), this.enabled() && d.$(this.Ta), d.ka(!1), d.ea(), this.U(256)); c = this.Ia ? this.Ia.Sc() : c; this.W(512) && (d = this.oo(), $.T(d), d.oa(c), this.enabled() && d.$(this.Ta), d.ka(!1), d.ea(), this.U(512)); c = ht(this.oo()) ? this.oo().Sc() : c; d = ht(this.oo()) ? this.oo().Ws() - 1 : 0; c.width = Math.max(1, c.width); c.height = Math.max(1, c.height); fba(this, d, c.ceil()); if (this.W(2048)) {
                        !this.zk && this.Ha && (this.zk = this.Ta.rect(), this.zk.fill($.$l).stroke(null).zIndex(0), this.Ta.pa("beforedrag",
                            function () { this.Sa = !0; this.Gd || (this.Gd = !0, this.Wa || (this.Wa = $.gk(), this.Wa.fill($.$l).stroke(null).zIndex(100)), this.Wa.Qe(this.Ja), this.Wa.parent(this.Ta), this.dispatchEvent("dragstart")) }, !1, this), this.Ta.pa("drag", this.z$, !1, this), this.Ta.pa("end", function () {
                                var a = this.Ta.Pc, b = this.hb(), c = this.oa(); this.ud = a.$c; this.ub = a.ad; this.Kf = (this.ud - c.left) / c.width; this.dc = (this.ub - c.top) / c.height; this.Xb = (c.width - (this.ud - c.left + b.width)) / c.width; this.Bf = (c.height - (this.ub - c.top + b.height)) / c.height; this.Gd &&
                                    (this.Gd = !1, this.Wa.parent(null), this.dispatchEvent("dragend"))
                            }, !1, this)); c = !1; if (this.Ha) var e, c = this.margin().wh("inside" == this.Gb ? this.oa() : (e = Wb(this.oa(), this.Sc())).length ? e[0] : $.bn(0, 0, 0, 0)); this.zk && this.zk.Qe(this.Ja); this.Ta.jf(c); this.U(2048)
                    } a && b.me(); return this
            }; $.g.z$ = function (a) { return this.dispatchEvent(a.type) }; $.g.If = function (a) { a = $.hu.I.If.call(this, a); var b = $.Tn(a.domTarget), b = $.O(b && b.index); (0, window.isNaN)(b) || (a.itemIndex = b); return a };
            ...
            $.g.O = function () {
                var a = $.hu.I.O.call(this); a.margin = this.margin().O(); a.padding = this.padding().O(); a.background = this.background().O(); a.title = this.title().O(); a.titleFormat = this.Gx(); a.titleSeparator = this.MA().O(); a.paginator = this.oo().O(); a.tooltip = this.Db().O(); a.itemsLayout = this.tL(); a.itemsSpacing = this.uL(); a.itemsSourceMode = this.Zg(); a.inverted = this.Md(); $.n(this.items()) && (a.items = this.items()); a.iconTextSpacing = this.bI(); a.iconSize = this.aI(); a.width = this.width(); a.height = this.height(); a.maxWidth =
            ...
            $.g.ga = function (a, b) {
                ...
                this.width(a.width); this.height(a.height); this.dI(a.maxWidth); this.maxHeight(a.maxHeight); this.position(a.position); this.yr(a.positionMode); this.align(a.align); this.$H(a.hoverCursor); this.jf(a.drag)
            }; $.g.da = function () { $.hu.I.da.call(this); $.od(this.zk, this.aa, this.Ea, this.fa, this.b); this.Ea = this.aa = this.b = this.fa = this.zk = null }; $.G(nu, $.hu); $.os(nu, $.hu); nu.prototype.Vl = function () { var a = this.width(), b = this.height(); return $.Vn(a) || $.Vn(b) || null === a || null === b };
            ...
            $.g.ga = function (a, b) { $.tu.I.ga.call(this, a, b); $.T(this.na); this.Mc(a.hoverMode); this.De(a.selectionMode); this.Aw(a.spotRadius); this.vO(a.allowMultiSeriesSelection); this.na.ka(!0) }; $.g.O = function () { var a = {}; a.hoverMode = this.Mc(); a.selectionMode = this.De(); a.spotRadius = this.Aw(); a.allowMultiSeriesSelection = this.vO(); return a }; var EB = $.tu.prototype; EB.hoverMode = EB.Mc; EB.selectionMode = EB.De; EB.spotRadius = EB.Aw; $.uu.prototype.o = function (a, b, c) {
                var d; if ($.n(b)) { var e = this.target.la().Ib(), f = !0; if ($.y(b)) for ($.wb(b), d = b.length; d--;) { var h = +b[d]; h < e && ($.xu(this, a, h, c), f = !1) } else +b < e && ($.xu(this, a, +b, c), f = !1); f || this.target.Hi() } else if (!(this.j & a)) {
                    b = $.cm; a == $.cm || 1 == a ? b = 1 : 2 == a && (b = 3); for (d = this.b.length; d--;)$.Au(this, b, d) && (this.target.la().select(this.J[d]) && this.target.jh($.cm), $.gb(this.b, d, 1), $.gb(this.J, d, 1)); this.target.Hi(); if ($.wu(this)) {
                        if ($.kq(this.target)) if (this.target.vf()) for (d = this.target.hc(); d.advance();)b =
                            d.sa(), d.select(b) && $.wu(this, b) && this.target.kh(a); else $.wu(this, window.NaN) && this.target.kh(a); this.j = a
                    }
                }
            }; $.uu.prototype.B = function (a, b) { if (this.target.la().select(b)) { var c = $.ub(this.J, b); a != $.cm && (0 > c ? ($.hb(this.J, b, ~c), $.hb(this.b, a, ~c), this.j == $.cm && this.target.jh(a), $.wu(this, window.NaN) && !this.target.vf() && "single" == this.target.Mc() && this.target.kh(a)) : this.b[c] |= a) } };
            $.uu.prototype.g = function (a, b) {
                var c; if ($.n(b)) { if ($.y(b)) for ($.wb(b), c = b.length; c--;)$.Cu(this, a, +b[c]); else if ((0, window.isNaN)(b)) for (c = this.J.length; c--;)$.vu(this, a, c); else $.Cu(this, a, +b); this.target.Hi(); this.target.vf() || "single" != this.target.Mc() || this.target.kh($.yu(this, 2) ? 2 : $.yu(this, 1) ? 1 : $.cm) } else {
                    for (c = this.b.length; c--;)$.Au(this, a, c) && (this.target.la().select(this.J[c]) && this.target.jh($.cm), $.gb(this.J, c, 1), $.gb(this.b, c, 1)); this.target.Hi(); this.j &= ~a; if ($.kq(this.target)) if (this.target.vf()) for (c =
                        this.target.hc(); c.advance();) { var d = c.sa(); c.select(d) && $.wu(this, d) && this.target.kh(this.j) } else this.target.kh(this.j)
                }
            }; $.uu.prototype.Kg = function () { return this.j }; var GB; $.G($.Gu, $.ns); $.g = $.Gu.prototype; $.g.Aa = $.ns.prototype.Aa; $.g.xa = $.ns.prototype.xa | 3552; $.g.kG = function () { return !0 }; $.g.tU = function () { return !1 }; $.g.VW = function () { return !0 }; $.g.be = function (a) { $.hl(8); return $.n(a) ? this : null }; $.g.je = function () { return null }; $.g.xg = function () { return !1 }; $.g.jo = $.da(4); $.g.dS = function () { var a = $.fk(); a.F = this.bq; a.B(ws(this.Su())); return a };
            ...
            $.g.mda = function (a) {
                if (!a.tK) {
                    var b = []; (0, $.Za)(a.seriesStatus, function (c) { c.points.length ? c.series.enabled() && b.push(c) : ("float" == this.aa.N("positionMode") && this.tc("mousemove", this.RA), this.aa.cd(!1, a)) }, this); if (b.length) if ("float" == this.aa.N("positionMode") && this.pa("mousemove", this.RA), "single" == this.Bd().Mc()) {
                        var c = []; if ("single" == this.aa.N("displayMode")) c = a.seriesStatus; else {
                            var d = a.seriesStatus[0].points[0]; $.n(d.index) && (d = d.index); $.n(this.we()) && (c = (0, $.Eb)(this.we(), function (a) {
                                a.la().select(d);
                                return { series: a, points: [d] }
                            })); c = (0, $.sf)(c, function (a) { a = a.series.la(); return $.n(a.G("missing")) ? !a.G("missing") : !$.ao(a.get("value")) })
                        } $.Vt(this.aa, c, a.originalEvent.clientX, a.originalEvent.clientY, a.seriesStatus[0].series, this.pq())
                    } else {
                        var e = b[0]; b[0].series.la().select(b[0].nearestPointToCursor.index); (0, $.Za)(b, function (a) { e.nearestPointToCursor.distance > a.nearestPointToCursor.distance && (a.series.la().select(a.nearestPointToCursor.index), e = a) }); "single" == this.aa.N("displayMode") ? $.Vt(this.aa,
                            [e], a.originalEvent.clientX, a.originalEvent.clientY, e.series, this.pq()) : $.Vt(this.aa, b, a.originalEvent.clientX, a.originalEvent.clientY, e.series, this.pq())
                    }
                }
            }; $.g.RA = function (a) { $.Xt(this.aa, a.clientX, a.clientY) }; $.g.pq = function () { return !1 }; $.g.Ru = function (a) { !this.Re && (this.Re = $.kl.anychart.ui.contextMenu(!!$.A(a) && a.fromTheme)) && ($.L(this, this.Re), this.Re.itemsProvider(this.i8)); return $.n(a) ? (this.Re && this.Re.setup(a), this) : this.Re };
            ...
            GB = {
                "select-marquee-start": { index: 9.3, text: "Start selection marquee", eventType: "anychart.startSelectMarquee", action: function (a) { a.chart.SW(!1) } }, "save-chart-as": {
                    index: 10, text: "Save chart as...", iconClass: "ac ac-file-image-o", subMenu: {
                        "save-chart-as-png": { index: 10, text: ".png", iconClass: "ac ac-file-image-o", eventType: "anychart.saveAsPng", action: function (a) { a.chart.$p() } }, "save-chart-as-jpg": { index: 20, text: ".jpg", iconClass: "ac ac-file-image-o", eventType: "anychart.saveAsJpg", action: function (a) { a.chart.Yp() } },
                        "save-chart-as-pdf": { index: 30, text: ".pdf", iconClass: "ac ac-file-pdf-o", eventType: "anychart.saveAsPdf", action: function (a) { a.chart.Zp() } }, "save-chart-as-svg": { index: 40, text: ".svg", iconClass: "ac ac-file-code-o", eventType: "anychart.saveAsSvg", action: function (a) { a.chart.aq() } }
                    }
                }, "save-data-as": {
                    index: 20, text: "Save data as...", iconClass: "ac ac-save", subMenu: {
                        "save-data-as-text": { index: 10, text: ".csv", iconClass: "ac ac-file-excel-o", eventType: "anychart.saveAsCsv", action: function (a) { a.chart.uw() } }, "save-data-as-xlsx": {
                            index: 20,
                            text: ".xlsx", iconClass: "ac ac-file-excel-o", eventType: "anychart.saveAsXlsx", action: function (a) { a.chart.vw() }
                        }
                    }
                }, "share-with": {
                    index: 30, text: "Share with...", iconClass: "ac ac-net", subMenu: {
                        "share-with-facebook": { index: 10, text: "Facebook", iconClass: "ac ac-facebook", eventType: "anychart.shareWithFacebook", action: function (a) { a.chart.TF() } }, "share-with-twitter": { index: 20, text: "Twitter", iconClass: "ac ac-twitter", eventType: "anychart.shareWithTwitter", action: function (a) { a.chart.WF() } }, "share-with-linkedin": {
                            index: 30,
                            text: "LinkedIn", iconClass: "ac ac-linkedin", eventType: "anychart.shareWithLinkedIn", action: function (a) { a.chart.UF() }
                        }, "share-with-pinterest": { index: 40, text: "Pinterest", iconClass: "ac ac-pinterest", eventType: "anychart.shareWithPinterest", action: function (a) { a.chart.VF() } }
                    }
                }, "print-chart": { index: 50, text: "Print", iconClass: "ac ac-print", eventType: "anychart.print", action: function (a) { a.chart.print() } }, "full-screen-enter": { index: 60, text: "Enter full screen", action: function (a) { a.chart.fullScreen(!0) } }, "full-screen-exit": {
                    index: 60,
                    text: "Exit full screen", action: function (a) { a.chart.fullScreen(!1) }
                }, about: { index: 80, iconClass: "ac ac-cog", text: "AnyChart " + $.Aa.apply(null, ["v%s.%s.%s.%s"].concat(["8", "0", "1", "1726"])), href: "https://anychart.com" }, "save-config-as": {
                    index: 100, text: "Save config as...", iconClass: "ac ac-save", subMenu: {
                        "save-config-as-json": { index: 10, text: ".json", iconClass: "ac ac-file-code-o", eventType: "anychart.saveAsJson", action: function (a) { a.chart.GF() } }, "save-config-as-xml": {
                            index: 20, text: ".xml", iconClass: "ac ac-file-code-o",
                            eventType: "anychart.saveAsXml", action: function (a) { a.chart.HF() }
                        }
                    }
                }, "link-to-help": { index: 110, iconClass: "ac ac-question", text: "Need help? Go to support center!", href: "https://anychart.com/support" }, "version-history": { index: 120, text: "Version History", href: "" }
            };
            ...
            $.g.yx = function () {
                this.jq || (this.ko ? $.S(this, this.pU, this) : $.jq(this, this.pU, this), this.jq = !0); if (this.ic()) {
                    $.T(this); var a = this.Fq().label(); if (this.UW()) { var b = this.uj(); a.visible() !== b && this.Ta && (b = this.dispatchEvent({ type: "datachanged", chart: this, hasData: !b }) && b); a.visible(b) } this.Ta || (this.Ta = $.ik(), $.hs(this, this.Ta), $.L(this, this.Ta)); var c = (b = this.$() ? this.$().Ca() : null) && !b.Od(); c && b.te(); this.Re && this.Re.attach(this); this.W(8) && (this.Ta.zIndex(this.zIndex()), this.U(8)); this.W(2) && (this.enabled() &&
                        this.Ta.parent(this.$()), $.It(this.Db(), this), this.U(2)); this.W(4) && b && b.pa("stageresize", this.sw, !1, this); this.xx(); var d = this.hb(); this.Aj = this.uy(d); this.$h(this.Aj); this.QW(this.Ne()); var e = this.background(), f = e.N("fill"); e.enabled() && f && "none" != f || (this.wo || (this.wo = this.Ta.rect(), this.wo.fill($.$l).stroke(null)), this.wo.Qe(this.Aj)); if (this.W(260)) {
                            e = 0; for (f = this.kk.length; e < f; e++) { var h = this.kk[e]; h && ($.T(h), !h.$() && h.enabled() && h.$(this.Ta), this.DM(h, d), h.ea(), h.ka(!1)) } $.T(a); a.$(this.Ta);
                            this.DM(a, this.Aj); a.ea(); a.ka(!1); this.U(256)
                        } this.U(4); this.pD(); this.U(2048); this.W(32) && (this.wx().kJ(), this.U(32)); this.ka(!1); a = $.Ec($.Bc.uc(), this, "chart"); this.Ta.id(a); c && b.me(); b && (b.lT()[a] = this); $.lq(this, { type: "chartdraw", chart: this }); this.kG() && this.bF()
                }
            }; $.g.ea = function (a) { a ? (this.Ur || (this.Ur = (0, $.ua)(this.ea, this)), (0, window.setTimeout)(this.Ur, 0)) : this.yx(); return this }; $.g.xx = function () { }; $.g.$h = function () { }; $.g.QW = function () { }; $.g.sw = function () { this.Jb().Vl() && this.D(516, 9) };
            ...
            $.g.O = function () {
                var a = $.Gu.I.O.call(this); a.title = this.title().O(); a.background = this.background().O(); a.margin = this.margin().O(); a.padding = this.padding().O(); a.a11y = this.wx().O(); for (var b = [], c = 0; c < this.kk.length; c++)this.kk[c] && b.push(this.kk[c].O()); 0 < b.length && (a.chartLabels = b); a.bounds = this.Jb().O(); a.animation = this.Jl().O(); a.tooltip = this.Db().O(); a.noDataLabel = this.Fq().label().O(); this.Re && (a.contextMenu = this.Ru().serialize()); a.credits = this.Su().O(); var d; this.Nm && (d = this.jK().O()); d && !$.Nc(d) &&
            ...
            $.g.ga = function (a, b) {
                ...
                this.Jl(a.animation); this.Fq().label().va(!!b, a.noDataLabel); "tooltip" in a && this.Db().va(!!b, a.tooltip); this.wx(a.a11y); $.n(a.contextMenu) && this.Ru(a.contextMenu); this.Su(a.credits); a.exports && this.jK(a.exports); $.Ip(this, HB, a)
            }; $.g.da = function () { $.od(this.Qg, this.Kf, this.aa, this.Gd); this.Gd = this.aa = this.Kf = this.Qg = null; $.Gu.I.da.call(this); this.dd && sp(this, this.dd) };
            ...
            $.g.yn = function (a) {
                var b = this.Bd().Mc(), c = $.Tn(a.domTarget), d = !1, e, f; $.J(a.target, $.Tu) || $.J(a.target, $.qv) ? (f = a.target.tg(), f.xg && f.xg() && (e = f), f = c) : $.J(a.target, $.hu) || this.hp(a.target) ? (c && (c.nc ? (e = c.nc.ia, f = c.nc.qc, $.y(f) && !f.length && (f = window.NaN)) : (e = c.ia, f = c.index)), d = !0) : (e = c && c.ia, f = $.C(c.index) ? c.index : a.pointIndex); if (e && !e.xd && e.enabled() && $.D(e.lf) && (c = e.lf(a))) {
                    var h = $.Tn(a.relatedDomTarget), h = $.O($.A(h) ? h.index : h), k = $.Un(e, a.relatedTarget), l = "vml" == $.ek && e.Db && $.Un(e.Db(), a.relatedTarget);
                    k && h == f || !e.dispatchEvent(c) || l || "single" != b || (0, window.isNaN)(f) && !$.y(f) || (e.Qc(), this.Xs(), this.dispatchEvent(this.th("hovered", a, [{ ia: e, qc: [], fd: { index: $.y(f) ? f[0] : f, Le: 0 } }], !1, d)))
                } "single" == b || $.Un(this, a.relatedTarget) || (this.Qc(), this.Xs(), this.Gb && this.dispatchEvent(this.th("hovered", a, this.Gb, !0, d)), this.Gb = null)
            }; $.g.hp = function () { return !1 }; $.g.Ml = function (a) { this.vr(a) };
            $.g.vr = function (a) {
                if (!this.Ho) {
                    var b = this.Bd(), c, d, e, f, h, k = a.ctrlKey || a.metaKey, l; d = $.Tn(a.domTarget); var m = this.hp(a.target); h = $.J(a.target, $.Tu); f = $.J(a.target, $.qv); var m = $.J(a.target, $.hu) || m, p, q, r; m ? d && ((r = d.nc || d.qc) ? (p = r.ia, c = r.qc) : (p = d.ia, c = d.index)) : h || f ? (h = a.target.tg(), h.xg && h.xg() && (p = h), c = d) : (p = d && d.ia, c = d && $.C(d.index) ? d.index : a.pointIndex); if (p && !p.xd && p.enabled() && $.D(p.lf)) {
                        var t = p.lf(a); if (t && ($.Un(p, a.relatedTarget) || p.dispatchEvent(t)) && (m || (c = t.pointIndex), "single" == b.Mc())) {
                            if ("none" ==
                                b.De() || "none" == p.De()) return; f = $.Du(p.state, 2); l = 1 == f.length && f[0] == c; if (!k && !a.shiftKey && l) return; (f = (k || a.shiftKey) && $.Fu(p.state.Kg(), 2)) || !k && !a.shiftKey || (k || a.shiftKey) && "multi-select" != b.De() ? (this.vd(), this.ec && this.dispatchEvent(this.th("selected", a, this.ec, !0))) : "single-select" == p.De() && (this.ec && this.dispatchEvent(this.th("selected", a, this.ec, !0)), p.vd(), $.y(c) && (c = c[c.length - 1])); $.D(p.jg) && p.jg(c, a); e = this.we(); d = []; for (h = 0; h < e.length; h++)if (q = e[h]) f = $.Du(q.state, 2), f.length && d.push({
                                    ia: q,
                                    qc: f, fd: { index: c, Le: 0 }
                                }); d.length || d.push({ ia: p, qc: [], fd: { index: c, Le: 0 } }); this.dispatchEvent(this.th("selected", t, d)); l ? this.ec = null : this.ec = d
                        }
                    } else "single" == b.Mc() && (m || this.vd(), this.ec && this.dispatchEvent(this.th("selected", a, this.ec, !0)), this.ec = null); if ("single" != b.Mc() && "none" != b.De()) if ((c = this.Um(a)) && c.length) {
                        m = !1; d = []; var u; if ("single-select" == b.De()) {
                            var v; h = 0; for (e = c.length; h < e; h++)u = c[h], p = u.ia, "none" != p.De() && (v || (v = u), v.fd.Le > u.fd.Le && (v = u)); p = v.ia; f = $.Du(p.state, 2); l = 1 == f.length &&
                                f[0] == v.fd.index; m = !l || l && (k || a.shiftKey); f = (k || a.shiftKey) && $.Fu(p.state.Kg(), 2); !f && (k || a.shiftKey) || l || p.vd(); p.jg(v.fd.index, a); f = $.Du(p.state, 2); if (f.length) for (d.push({ ia: p, qc: [v.fd.index], fd: v.fd }), e = this.we(), h = 0; h < e.length; h++)p = e[h], "none" != p.De() && ((t = p == d[0].ia) || p.vd()); else d.push({ ia: p, qc: f, fd: u.fd })
                        } else {
                            v = []; if (!k && !a.shiftKey) for (e = this.we(), h = 0; h < e.length; h++)if (q = e[h], "none" != q.De()) {
                                t = !1; for (b = 0; b < c.length; b++)t = t || q == c[b].ia; !t && $.Du(q.state, 2).length && (v.push({ ia: q, qc: [] }),
                                    q.vd(), m = !0)
                            } h = 0; for (e = c.length; h < e; h++)if (u = c[h], p = u.ia, "none" != p.De()) { "single-select" == p.De() ? r = [u.fd.index] : r = u.qc; f = $.Du(p.state, 2); if (a.shiftKey) { t = !0; for (b = 0; b < r.length; b++)t = t && $.eb(f, r[b]); l = t } else k || (l = $.Bb(r, f)); m = m || !l; l || (((f = (k || a.shiftKey) && $.Fu(p.state.Kg(), 2)) || !k && !a.shiftKey || "single-select" == p.De()) && p.vd(), p.jg(r, a)); f = $.Du(p.state, 2); f.length ? d.push({ ia: p, qc: f, fd: u.fd }) : v.push({ ia: p, qc: f, fd: u.fd }) } for (h = 0; h < v.length; h++)d.push(v[h])
                        } m && (this.dispatchEvent(this.th("selected",
                            a, d)), this.ec = d.length ? d : null)
                    } else m || this.vd(), this.ec && this.dispatchEvent(this.th("selected", a, this.ec, !0)), this.ec = null
                }
            }; $.g.vd = function () { var a, b, c = this.we(); a = 0; for (b = c.length; a < b; a++)c[a] && c[a].vd() }; $.g.Qc = function () { var a, b, c = this.we(); a = 0; for (b = c.length; a < b; a++)c[a] && c[a].Qc() }; $.g.Bd = function (a) { this.td || (this.td = this.KJ(), $.S(this.td, this.bF, this)); return $.n(a) ? ($.A(a) ? this.td.X(a) : this.td.Mc(a), this) : this.td }; $.g.KJ = function () { return new $.tu(this) };
            ...
            $.g.qU = function (a) {
                var b, c = this.$(), d = $.Tj(c.Ca()), e = a.clientX - d.x, d = a.clientY - d.y; "mousedown" == a.type && !a.zi.j() || !(b = Lu(this, a.clientX, a.clientY)) || this.Eo && !1 === this.Eo(b - 1, e, d, 0, 0, a) || (this.Om = b - 1, b = this.Cd[this.Om], this.Uf = e, this.Gl = d, this.Sb.Qe(this.uo ? new $.I(this.Uf, b.top, 0, b.height) : new $.I(this.Uf, this.Gl, 0, 0)), this.Sb.parent(c), this.Nj || (this.Nj = new Mu(this.Sb)), this.Nj.kW = window, b = b.clone(), b.left -= this.Uf, b.top -= this.Gl, this.Nj.yA(b), this.Bf.pa(this.Nj, "drag", this.maa), this.Bf.pa(this.Nj,
                    "end", this.laa), this.qq = !0, this.Nj.ti(a.zi), a.preventDefault(), a.stopPropagation())
            }; $.g.maa = function (a) { var b; this.uo ? (b = this.Cd[this.Om], b = new $.I(this.Uf, b.top, a.left, b.height)) : b = new $.I(this.Uf, this.Gl, a.left, a.top); this.Sb.Qe(b); this.wq && this.wq(this.Om, this.Uf, this.Gl, a.left, a.top, new $.xj(a.g, this.$().Ca())) };
            ...
            $.g.Vs = function (a, b, c, d, e, f, h) {
                b = $.Tj(this.$().Ca()); var k = 0 > e ? c + e : c, l = 0 > f ? d + f : d; return {
                    type: a, offsetX: h.offsetX, offsetY: h.offsetY, clientX: h.clientX, clientY: h.clientY, screenX: h.screenX, screenY: h.screenY, button: h.button, actionButton: h.actionButton, keyCode: h.keyCode, charCode: h.charCode, ctrlKey: h.ctrlKey, altKey: h.altKey, shiftKey: h.shiftKey, metaKey: h.metaKey, platformModifierKey: h.platformModifierKey, clientStartX: c + b.x, clientStartY: d + b.y, clientLeft: k + b.x, clientTop: l + b.y, startX: c, startY: d, left: k, top: l,
                    width: Math.abs(e), height: Math.abs(f)
                }
            ...
            $.g.O = function () { var a = $.Pu.I.O.call(this); a.legend = this.be().O(); a.interactivity = this.Bd().O(); return a }; $.g.ga = function (a, b) { $.Pu.I.ga.call(this, a, b); this.be(a.legend); this.Bd(a.interactivity) }; var JB = $.Pu.prototype; JB.legend = JB.be; JB.interactivity = JB.Bd; JB.noData = JB.Fq; $.KB = {
                s: function (a, b, c) { return (0, window.isNaN)(c) || "" == c || a.length >= Number(c) ? a : a = -1 < b.indexOf("-", 0) ? a + (0, $.Ra)(" ", Number(c) - a.length) : (0, $.Ra)(" ", Number(c) - a.length) + a }, f: function (a, b, c, d, e) {
                    d = a.toString(); (0, window.isNaN)(e) || "" == e || (d = (0, window.parseFloat)(a).toFixed(e)); var f; f = 0 > Number(a) ? "-" : 0 <= b.indexOf("+") ? "+" : 0 <= b.indexOf(" ") ? " " : ""; 0 <= Number(a) && (d = f + d); if ((0, window.isNaN)(c) || d.length >= Number(c)) return d; d = (0, window.isNaN)(e) ? Math.abs(Number(a)).toString() : Math.abs(Number(a)).toFixed(e);
                    a = Number(c) - d.length - f.length; return d = 0 <= b.indexOf("-", 0) ? f + d + (0, $.Ra)(" ", a) : f + (0, $.Ra)(0 <= b.indexOf("0", 0) ? "0" : " ", a) + d
                }, d: function (a, b, c, d, e, f, h, k) { return $.KB.f((0, window.parseInt)(a, 10), b, c, d, 0, f, h, k) }
            ...
            $.g.ea = function () {
                var a = this.Xl, b; this.rb || (this.rb = $.ik()); this.rb.tag = this.fa; b = this.oc("enabled"); if (hv(this, 1)) if (b) this.$() && !this.rb.parent() && this.rb.parent(this.$()), this.U(1); else return this.rb && this.rb.parent(null), this.U(4294967295), this; if (!b) return this; hv(this, 2) && (b && ((!this.Xl.enabled() || $.n(this.enabled()) && !this.enabled()) && this.Xl.$e() && (this.$() || this.$(a.$e()), this.$().parent() || this.$().parent(a.$())), this.$() && this.rb.parent(this.$())), this.U(2)); this.W(8) && (this.$() && this.$().zIndex(a.zIndex()),
                    this.rb.zIndex(this.zIndex()), this.U(8)); this.W(1024) && ($.bv(a, this.sa()), this.U(1024)); if (hv(this, 20)) {
                        this.g = null; b = $.Zu(this); var c = this.Fe(), d = $.$u(a, b.format, c, this.sa()); this.rb.Wb(1, 0, 0, 1, 0, 0); var e, f = b.background; if ($.J(f, $.ps)) { if (f.enabled() || this.o && this.o.enabled()) e = f.O() } else e = f; !$.A(e) || !e || "enabled" in e || (e.enabled = !1); (c = $.B(e) || $.oa(e) || e && e.enabled) || this.o ? (this.o || (this.o = new $.ps, this.o.zIndex(0), this.o.$(this.rb)), this.ba && this.o.X($.J(this.ba, $.ps) ? this.ba.O() : this.ba), this.o.X(e),
                        ...
                        this.U(20)
                    } hv(this, 2048) && (this.mP(this.gc, this.P), c && (this.o.oa(this.gc), this.o.ea()), a = $.co(this.gc, this.g.anchor), this.rb.Zt(this.g.rotation, a.x, a.y), this.D(512), this.U(2048)); this.W(512) && (lba(this), this.U(512)); hv(this, 256) && (this.rb && this.rb.clip(this.g.clip), this.U(256)); return this
            }; $.g.Bk = function () { this.b || (this.b = mk(), this.b.nd("aria-hidden", "true"), this.b.zIndex(1), this.rb || (this.rb = $.ik()), this.b.parent(this.rb), this.b.Xc(!0)); return this.b };
            ...
            $.g.ea = function () {
                if (this.xd) return this; var a = $.tv(this), b = $.uv(this) ? $.uv(this) : a, c = !(a && b), d; b != a && (d = b.j); this.g || (this.g = $.kk()); var e = vv(this, this.enabled(), this.B.enabled, !c && a.enabled(), !c && b.enabled(), null !== (c ? null : b.enabled())); null === e && (e = !0); if (this.W(1) || !c && b.W(1)) if (e) this.$() && this.g.parent(this.$()), this.U(1); else return this.g.parent(null), this.U(4294967295), this; if (this.W(2) || !c && b.W(2)) e && (!c && a.$e() && (this.$() || this.$(a.$e()), this.$().parent() || this.$().parent(a.$())), this.$() &&
                    this.g.parent(this.$())), this.U(2); if (this.W(8) || !c && b.W(8)) this.$() && !c && this.$().zIndex(a.zIndex()), this.g.zIndex(this.zIndex()), this.U(8); if (this.W(16) || !c && b.W(16) || !c && b.W(4)) {
                        var f = "anchor type size offsetY offsetX fill stroke positionFormatter rotation".split(" "), e = {}; c && ($.T(this), $.n(this.zB()) || this.zB($.vo), $.n(this.size()) || this.size(10), $.n(this.Vu()) || this.Vu("center"), $.n(this.offsetX()) || this.offsetX(0), $.n(this.offsetY()) || this.offsetY(0), $.n(this.rotation()) || this.rotation(0), this.ka(!1));
            ...
            $.g.hb = function () {
                if (!this.jm || this.W(4)) {
                    var a = this.oa(); if (a) {
                        var b, c; a.top = Math.round(a.top); a.left = Math.round(a.left); a.width = Math.round(a.width); a.height = Math.round(a.height); this.zb() ? (b = a.width, c = a.height) : (b = a.height, c = a.width); b = this.Jg(b); c = this.UO(c, b, a); var d, e, f = this.padding(), h = $.M(f.N("top"), a.height), k = $.M(f.N("right"), a.width), l = $.M(f.N("bottom"), a.height), f = $.M(f.N("left"), a.width), m, p; switch (this.orientation()) {
                            case "top": e = a.top + h; d = a.left + f; p = c; m = b; break; case "right": e = a.top +
                                h; d = a.left + a.width - c - k; p = b; m = c; break; case "bottom": e = a.top + a.height - c - l; d = a.left + f; p = c; m = b; break; case "left": e = a.top + h, d = a.left + f, p = b, m = c
                        }this.jm = new $.I(Math.round(d), Math.round(e), Math.round(m), Math.round(p))
                    } else this.jm = new $.I(0, 0, 0, 0); this.U(4)
                } return this.jm
            }; $.g.zb = function () { var a = this.orientation(); return "top" == a || "bottom" == a }; $.g.DH = function (a, b, c) { c = a.top + a.height + c / 2; this.Zb.moveTo(a.left + b, c).lineTo(a.left - b + a.width, c) };
            ...
            $.g.EH = function (a, b) {
                var c = this.scale(), d, e, f = "number", h = !0; $.J(c, $.cs) ? (d = c.Ga().names()[a], e = b, f = "string", h = !1) : $.J(c, $.Qr) ? (d = $.pr(b), f = "string", e = b) : (d = (0, window.parseFloat)(b), e = (0, window.parseFloat)(b)); d = { axis: { value: this, type: "" }, index: { value: a, type: "number" }, value: { value: d, type: f }, tickValue: { value: e, type: "number" }, scale: { value: c, type: "" } }; h && (d.max = { value: $.n(c.max) ? c.max : null, type: "number" }, d.min = { value: $.n(c.min) ? c.min : null, type: "number" }); c = {}; c["%AxisName"] = {
                    value: this.title().text(),
                    type: "string"
                }; h = new $.Nt(d); h.pj({ "%AxisScaleMax": "max", "%AxisScaleMin": "min" }); h.Ti(c); return $.Ct(h)
            }; $.g.ic = function () { if ($.kq(this)) return !1; if (!this.enabled()) return this.W(1) && (this.remove(), this.U(1), this.title().D(2), this.Ga().D(2), this.ib().D(2), this.labels().D(2), this.$a().D(2), this.D(450)), !1; this.U(1); return !0 };
            $.g.ea = function () {
                var a = this.scale(); if (!a) return $.hl(2), this; if (!this.ic()) return this; var b, c, d, e, f, h = this.orientation(); $.T(this.title()); $.T(this.labels()); $.T(this.$a()); $.T(this.Ga()); $.T(this.ib()); this.W(16) && (this.VO(), this.U(16)); if (this.W(8)) { var k = this.zIndex(); this.title().zIndex(k); this.Zb.zIndex(k); this.Ga().zIndex(k); this.ib().zIndex(k); this.labels().zIndex(k); this.$a().zIndex(k); this.U(8) } this.W(2) && (k = this.$(), this.title().$(k), this.Zb.parent(k), this.Ga().$(k), this.ib().$(k), this.labels().$(k),
                    this.$a().$(k), this.U(2)); this.W(64) && (k = this.title(), k.oa(this.hb()), $.pt(k, h), k.ea(), this.U(64)); this.W(256) && (e = this.Ga(), e.orientation(h), e.ea(), b = e.kz(), d = this.ib(), d.orientation(h), d.ea(), c = d.kz(), this.U(256)); this.W(128) && (h = this.labels(), h.$() || h.$(this.$()), h.oa(this.oa()), h = this.$a(), h.$() || h.$(this.$()), h.oa(this.oa()), this.U(128)); if ($.n(b) || $.n(c)) {
                        var l, m, p, q, h = a.Ga().get(), k = h.length, r = this.Ga().stroke() && this.Ga().stroke().thickness ? (0, window.parseFloat)(this.fb.stroke().thickness) :
                            1, t, u, v, w, x = this.hb(), z = this.Zb.sb(); f = this.stroke(); f = !f || $.to(f) ? 0 : f.thickness ? (0, window.parseFloat)(f.thickness) : 1; if ($.J(a, $.Pr)) {
                                l = Hv(this); $.A(l) ? (p = l.labels, q = l.$a) : (p = !l, q = !l); var E = a.ib().get(), N = this.mc.stroke() && this.mc.stroke().thickness ? (0, window.parseFloat)(this.mc.stroke().thickness) : 1; m = l = 0; for (var R = E.length, P, aa, X; l < k || m < R;)t = h[l], P = E[m], u = a.transform(t), aa = a.transform(P), u <= aa && l < k || m == R ? (X = r % 2 ? -.5 : 0, v = $.y(p) ? p[l] : p, (w = $.y(p) && p[l] || $.oa(p)) && b && b.call(e, u, x, z, f, X), Jv(this, t, a.transform(t,
                                    .5), l, X, !0, h, v), X = u, l++) : (u = N % 2 ? -.5 : 0, v = $.y(q) ? q[m] : q, (w = $.y(q) && q[m] || $.oa(q)) && c && X != aa && c.call(d, aa, x, z, f, u), Jv(this, P, a.transform(P, .5), m, u, !1, E, v && X != aa), m++); q && this.$a().ea()
                            } else for (c = Hv(this), p = $.A(c) ? c.labels : !c, c = r % 2 ? -.5 : 0, l = 0; l < k; l++)t = h[l], $.y(t) ? (d = t[0], X = t[1], r = (a.transform(t[0], 0) + a.transform(t[1], 1)) / 2) : (d = X = t, r = a.transform(t, .5)), u = a.transform(d, 0), b && (0 <= u && 1 >= u && b.call(e, u, x, z, f, c), l == k - 1 && (u = a.transform(X, 1), 0 <= u && 1 >= u && b.call(e, u, x, z, f, c))), v = $.y(p) ? p[l] : p, Jv(this, d, r, l, c, !0,
                                h, v && 0 <= r && 1 >= r); this.labels().ea()
                    } this.title().ka(!1); this.labels().ka(!1); this.$a().ka(!1); this.Ga().ka(!1); this.ib().ka(!1); return this
            }; $.g.remove = function () { this.Xa && this.Xa.remove(); this.Zb && this.Zb.parent(null); this.Ga().remove(); this.ib().remove(); this.Fa && this.Fa.remove(); this.Mb && this.Mb.remove() };
            ...
            $.g.ea = function () {
                if (!this.scale()) return $.hl(2), this; if (!this.ic()) return this; this.W(16) && (this.Gg(Nv(this), !0), this.U(16)); if (this.W(8)) { var a = this.zIndex(); Nv(this).zIndex(a); this.U(8) } if (this.W(4)) {
                    var b = this.scale().transform(this.g, .5); if ((0, window.isNaN)(b)) return this; a = Nv(this); if (0 <= b && 1 >= b) {
                        var c = this.oa(), c = c.clone().round(), d = this.Bx(); a.Wb(1, 0, 0, 1, 0, 0); a.width(null); a.height(null); a.x(0); a.y(0); var e = null !== this.width(), f = null !== this.height(), h = a.sb(), k = e ? Math.ceil($.M(this.width(),
                            c.width)) : h.width; e && a.width(k); h = a.sb(); c = f ? Math.ceil($.M(this.height(), c.height)) : h.height; f && a.height(c); var l = this.oa(), l = l.clone().round(); if (this.zb()) switch (e = Math.round(l.Hb() + l.height - b * l.height), 1 == b ? e -= -.5 : e += -.5, this.F) { case "left": f = l.gb(); break; case "right": f = l.Ra(); break; default: f = l.gb() + l.width / 2 } else switch (f = Math.round(l.gb() + b * l.width), 1 == b ? f += -.5 : f -= -.5, this.F) { case "top": e = l.Hb(); break; case "bottom": e = l.Ka(); break; default: e = l.Hb() + l.height / 2 }b = new $.Pb(f, e); f = $.O(this.ba); f = (0, window.isNaN)(f) ?
                                this.zb() ? 0 : -90 : f; e = $.mc($.H(f), 0, 0); h = $.ec(h, e); e = $.co($.bn(0, 0, h.width, h.height), d); b.x -= e.x; b.y -= e.y; e = $.M(this.offsetX(), k); l = $.M(this.offsetY(), c); $.ro(b, d, e, l); this.Gg(a, !0); a.x(b.x + h.width / 2 - k / 2).y(b.y + h.height / 2 - c / 2).zA(f, "center"); this.D(2)
                    } else this.remove(), this.U(2); this.U(4)
                } this.W(2) && (a = this.$(), Nv(this).parent(a), this.U(2)); return this
            }; $.g.remove = function () { Nv(this).parent(null) }; $.g.da = function () { $.K(this.b); this.P = this.Oa = this.b = null; $.Lv.I.da.call(this) };
            ...
            $.g.zx = function () {
                var a = this.scale(), b, c, d, e = window.NaN, f = $.J(a, $.cs), h = (f ? a.Ga() : this.N("isMinor") ? a.ib() : a.Ga()).get(); b = this.zb() ? [this.tD, this.rD] : [this.uD, this.sD]; $.Rv(this); this.Mi().clear(); var k = this.oa() || $.bn(0, 0, 0, 0); if (c = this.B && this.B.tU()) { var l = this.B; this.Ea = l.Ea; this.za = l.za; l = $.Ac(this.N("stroke")) / 2; k.top -= this.za + l; k.height += this.za + l; k.width += this.Ea } k = this.Vj().wh(k); this.Mi().clip(k); k = b[1]; b = b[0]; l = -this.Mi().iq() % 2 / 2; c && this.zb() && (d = a.Md() ? 1 : 0, b.call(this, d, l)); for (var m =
                    0, p = h.length; m < p; m++) { var q = h[m]; $.y(q) && (q = q[0]); d = a.transform(q); m && (c = $.Sv(this, m - 1)) && k.call(this, d, e, c, l); m ? m == p - 1 ? (this.N("drawLastLine") || f) && b.call(this, d, l) : b.call(this, d, l) : this.N("drawFirstLine") && b.call(this, d, l); e = d } f && $.n(q) && (d = a.Md() ? 0 : 1, this.N("drawLastLine") && b.call(this, d, l), (c = $.Sv(this, m - 1)) && k.call(this, d, e, c, l))
            }; $.g.aR = function () { this.Mi().stroke(this.N("stroke")) }; $.g.bP = $.ia; $.g.dR = function () { var a = this.$(); this.Mi().parent(a); $.Hc(this.F, function (b) { b.parent(a) }) };
            ...
            $.lw.prototype.ki = function (a, b, c, d) {
                var e, f, h; $.J(a, $.nw) ? (h = (a.rc() ? a.rc().value.angle : 0) || 0, e = a.ot(h), f = a.oc("anchor"), "auto" == f && (f = a.oc("autoRotate") ? "center" : $.go(h)), d = $.n(d) ? d : a.sa()) : (f = ($.n(c) && $.n(c.rotation) ? c.rotation : this.N("rotation")) || 0, e = ($.n(c) && $.n(c.autoRotate) ? c.autoRotate : this.N("autoRotate")) || !1, h = (b ? b.value.angle : 0) || 0, e = e ? 0 < h && 180 > h ? f + h + 270 : f + h + 90 : f, f = $.n(c) && c.anchor || this.N("anchor")); a = $.av(this, a, b, c, d); b = e; c = $.co(a, f); b = $.mc($.H(b), c.x, c.y); a = $.Zm(a) || []; b.transform(a,
                    0, a, 0, 4); return a
            }; $.lw.prototype.VC = function () { return new $.nw }; $.G($.nw, $.Yu); var hca = $.nw.prototype, WB = $.Rc($.Yu.prototype.Uu); $.Q(WB, 0, "autoRotate", $.Cp); hca.Uu = WB; $.Gp($.nw, $.nw.prototype.Uu); $.nw.prototype.ot = function (a) { var b = this.oc("rotation"); return this.oc("autoRotate") ? 0 < a && 180 > a ? b + a + 270 : b + a + 90 : b };
            $.nw.prototype.mP = function (a, b) {
                var c = this.g.positionFormatter, d = Uu(this.g.anchor) || "left-top", e = this.g.offsetX || 0, f = this.g.offsetY || 0, h = this.Xl, k = this.rc(), l = $.Rc(c.call(k, k)), c = l.angle, k = l.radius, l = $.n(l.radiusY) ? l.radiusY : k, m = 0, p = 0, q = h.Dd(), r = h.Ed(), t = h.eh(), h = $.mw(h); if (b || !(0, window.isNaN)(q) && !(0, window.isNaN)(r)) var m = b.left, p = b.top, u = b.width, v = b.height, m = (0, window.isNaN)(q) ? m + u / 2 : q, p = (0, window.isNaN)(r) ? p + v / 2 : r, f = $.n(h) && !(0, window.isNaN)(h) ? $.M(f, h) : b ? $.M(f, Math.min(u, v) / 2) : 0, c = c + $.M(e, null !=
                    t ? t : 360), k = k + f, l = l + f; e = m + $.Lb(c, k); f = p + $.Mb(c, l); d = $.co(new $.I(0, 0, a.width, a.height), d); e -= d.x; f -= d.y; this.F += e; this.R += f; a.left = e; a.top = f; this.g.rotation = this.ot(c); this.b.x(this.F).y(this.R)
            }; $.G($.pw, $.hq); $.g = $.pw.prototype; $.g.D = function (a, b) { return this.b.D(a, b) }; $.g.wa = function (a, b) { return this.b.wa(a, b) }; $.g.N = $.gq; $.g.Ki = $.fq; $.g.ye = function () { var a = [this.Pa], b = this.b.IK(this.R); b && a.push(b.Pa); return a }; $.g.xe = function () { var a = [this.ua], b = this.b.IK(this.R); b && a.push(b.ua); return a }; $.g.Sf = function (a) { $.n(a) && (this.K = a); return this.K }; var ow, XB = {};
            ...
            var ica = {
                bar: ["value"], line: ["value"], polyline: ["value"], area: ["value"], polygon: ["value"], column: ["value"], spline: ["value"], marker: ["value"], "step-area": ["value"], "step-line:": ["value"], "spline-area": ["value"], "jump-line": ["value"], stick: ["value"], mekko: ["value"], bubble: ["value", "size"], "range-bar": ["high", "low"], "range-area": ["high", "low"], "range-column": ["high", "low"], "range-step-area": ["high", "low"], "range-spline-area": ["high", "low"], ohlc: ["open", "high", "low", "close"], candlestick: ["open", "high",
                    "low", "close"], box: ["lowest", "q1", "median", "q3", "highest"], connector: ["points"], choropleth: ["id", "value"], "marker-map": ["id", "long", "lat"], "bubble-map": ["id", "long", "lat", "size"], hilo: ["high", "low"], waterfall: ["value"]
            }; $.g = $.uw.prototype;
            $.g.data = function (a) {
                if ($.n(a)) {
                    var b = null; if (a) { var c = a.title || a.caption; c && this.title(c); a.header && a.header.length && (b = a.header); a.rows ? this.Ia = a.rows : this.Ia = a } else this.Ia = a; a = $.J(a, $.Cq) ? a : Eq(this.Ia); var d = a.Ff(0), c = 1, e = null; $.y(d) ? c = d.length : $.A(d) && (e = $.Kc(d), c = e.length); var f = this.Ya.length, h = 1, d = 0, k, l, m; $.T(this); for (var p = 0; p < f; p++)k = this.Wi(d), l = k.Wg(), m = h + l.length, m <= c ? (h = Gq(a, h, 0, l, e), k.data(h), b && k.name(b[d + 1]), h = m) : (k = k.id(), this.To(k), d--), d++; f = this.N("defaultSeriesType"); l = ica[f];
                    do if (m = h + l.length, m <= c) h = Gq(a, h, 0, l, e), k = this.Rj(h)[0], b && k.name(b[d + 1]), d++, h = m; else break; while (h <= c); this.D(256); this.ka(!0); return this
                } return this.Ia
            }; $.g.zt = function () { }; $.g.xx = function () { if (!$.kq(this) && this.W(28672)) { $.mq(this.Ya); var a = 0; this.W(20480) && (a |= 2048); this.W(8192) && (a |= 128); for (var b = this.Ya.length; b--;) { var c = this.Ya[b], d = c.Hg(); c.yl(this.Sk().pd(d)); $.Zx(c, this.Bi().pd(d)); c.eq(this.Ll().pd(d)); c.D(a) } this.D(32768); this.U(28672); $.oq(this.Ya) } };
            ...
            $.g.bj = function (a, b) {
                var c, d, e = []; this.yc(); if (this.Mo() && "categories" == a && $.J(this.Qa(), $.cs)) { var f = this.Qa().names(); if ($.D(b)) { var h = this.Qa().values(), k; c = 0; for (d = h.length; c < d; c++)k = { value: h[c], name: f[c] }, k = b.call(k, k), $.B(k) || (k = String(f[c])), e.push({ text: k, iconEnabled: !1, sourceUid: $.ra(this), sourceKey: c }) } else for (c = 0, d = f.length; c < d; c++)e.push({ text: String(f[c]), iconEnabled: !1, sourceUid: $.ra(this), sourceKey: c }) } else for (c = 0, d = this.Ya.length; c < d; c++)f = this.Ya[c], h = f.Lv(b), h.sourceUid = $.ra(this),
                    h.sourceKey = f.id(), e.push(h); return e
            }; $.g.DE = function (a) { var b = a.enabled(), c = a.fa || [], d = !0; (a = a.data() ? a.data().Ib() : 0) && a != c.length || (d = !1); return b && d }; $.g.uj = function () { for (var a = 0, b = this.Ya.length, c = 0; c < b && !this.DE(this.Ya[c]); c++)a++; return a == b };
            ...
            $.g.wv = function () {
                this.yc(); if (this.W(524288)) {
                    this.jk = {}; var a = 0, b = 0, c = -window.Infinity, d = window.Infinity, e = -window.Infinity, f = window.Infinity, h, k, l, m, p = 0, q = -window.Infinity, r = window.Infinity, t = -window.Infinity, u = window.Infinity, v, w, x, z, E = 0, N = -window.Infinity, R = window.Infinity, P = !1, aa; for (aa in this.Ja) {
                        var X = this.Ja[aa], ba, Y; if (this.Ha) { ba = X[0].data.length; Y = Array(ba); for (var ja = 0; ja < ba; ja++)Y[ja] = [] } for (var Ja, ha, db, sb, Zb = 0; Zb < X.length; Zb++)if (Ja = X[Zb], (ha = Ja.ia) && ha.enabled()) {
                            var qd = ha.name(),
                            vc = [], Md = [], mf = []; db = ha.check($.cC | $.dC); (sb = ha.Yg()) && (P = !0); for (var $c = 0, Nb = window.Infinity, dc = -window.Infinity, kb = 0, ng = window.Infinity, Ed = -window.Infinity, we = window.Infinity, xd = -window.Infinity, Wf = 0, og = window.Infinity, ph = -window.Infinity, Ef = 0, ja = 0; ja < Ja.data.length; ja++) {
                                var xe = Ja.data[ja], Ob; Iw(xe.G.missing, ry) || $c++; if (!Iw(xe.G.missing, Kw)) {
                                    if (db) {
                                        Ob = $.O(xe.data.open); (0, window.isNaN)(Ob) || (dc = Math.max(Ob, dc), Nb = Math.min(Ob, Nb)); Ob = $.O(xe.data.close); (0, window.isNaN)(Ob) || (dc = Math.max(Ob, dc),
                                            Nb = Math.min(Ob, Nb)); Ob = $.O(xe.data.high); var yd = $.O(xe.data.low), dc = Math.max(Ob, yd, dc), Nb = Math.min(Ob, yd, Nb); Ob -= yd; Ed = Math.max(Ob, Ed); ng = Math.min(Ob, ng)
                                    } else sb && (Ob = $.O(xe.data.size), ph = Math.max(Ob, ph), og = Math.min(Ob, og), Ef += Ob, mf.push(Ob)), Ob = $.O(xe.data.value), dc = Math.max(Ob, dc), Nb = Math.min(Ob, Nb); kb += Ob; vc.push(Ob); this.Ha ? Y[ja].push(Ob) : (Ob = $.O(xe.data.x), xd = Math.max(Ob, xd), we = Math.min(Ob, we), Wf += Ob, Md.push(Ob))
                                }
                            } a += $c; b += kb; dc > c && (c = dc, h = qd); Nb < d && (d = Nb, k = qd); kb > e && (e = kb, l = qd); kb < f && (f = kb,
                            ...
                            this.Ha || (ha.Da("seriesXMax", xd), ha.Da("seriesXMin", we), ha.Da("seriesXSum", Wf), ha.Da("seriesFirstXValue", Md[0]), ha.Da("seriesLastXValue", Md[vc.length - 1]), ha.Da("seriesXAverage", $c ? Wf / $c : 0), ha.Da("seriesXMode", Um(Md)), ha.Da("seriesXMedian", Tm(Md)))
                        } if (this.Ha) {
                            sb = Array(ba); vc = Array(ba); Md = Array(ba); mf = Array(ba); $c = Array(ba); Nb = Array(ba); for (ja = 0; ja < ba; ja++) {
                                ha = Y[ja]; db = 0; Zb = window.Infinity; Ja = -window.Infinity; for (dc = 0; dc < ha.length; dc++)kb = ha[dc], db += kb, Zb = Math.min(Zb, kb), Ja = Math.max(Ja, kb); sb[ja] =
                                    db; vc[ja] = Zb; Md[ja] = Ja; mf[ja] = db / ha.length; $c[ja] = Tm(ha); Nb[ja] = Um(ha)
                            } for (Zb = 0; Zb < X.length; Zb++)Ja = X[Zb], (ha = Ja.ia) && ha.enabled() && ((db = ha.check($.cC | $.dC)) ? (ha.Da("catYRangeSumArr_", sb), ha.Da("catYRangeMinArr_", vc), ha.Da("catYRangeMaxArr_", Md), ha.Da("catYRangeAvgArr_", mf), ha.Da("catYRangeMedianArr_", $c), ha.Da("catYRangeModeArr_", Nb)) : (ha.Da("catYSumArr_", sb), ha.Da("catYMinArr_", vc), ha.Da("catYMaxArr_", Md), ha.Da("catYAvgArr_", mf), ha.Da("catYMedianArr_", $c), ha.Da("catYModeArr_", Nb)))
                        }
                    } this.Da("dataPlotYSum",
                    ...
                    for (var a = this.fr(), b = this.gr(), af, pg, d = 0; d < a.length; d++)c = a[d], $.J(c, $.Pr) && ($.n(af) ? (af =
                        Math.min(c.Rf(), af), pg = Math.max(c.yg(), pg)) : (af = c.Rf(), pg = c.yg())); for (var zd, Tg, d = 0; d < b.length; d++)c = b[d], $.J(c, $.Pr) && ($.n(zd) ? (zd = Math.min(c.Rf(), zd), Tg = Math.max(c.yg(), Tg)) : (zd = c.Rf(), Tg = c.yg())); this.Da("xScalesMin", af); this.Da("xScalesMax", pg); this.Da("yScalesMin", zd); this.Da("yScalesMax", Tg); this.U(1048576)
                }
            }; $.g.yx = function () { $.kq(this, 1572864) || $.Bw.I.yx.call(this) }; $.g.yc = function () { $.T(this); $.Dw(this); this.Ha ? (Mw(this), this.gR(), tba(this)) : (this.tJ(), this.cR()); this.ka(!1) }; $.g.cR = function () { };
            $.g.nz = function (a) { return a.lm() }; $.g.Mm = function (a, b) { a.Nc(b) }; $.g.ET = function (a) { return +a.data.value }; $.g.AV = function () { };
            $.g.tJ = function () {
                if (this.W(327680)) {
                    $.mq(this.Ya); var a, b, c, d, e, f, h = this.Ya.length, k, l; this.Ba.length = 0; this.Ja = {}; for (b in this.qa) e = this.qa[b], e.Ve() && e.mf(); for (b in this.Sa) f = this.Sa[b], f.Ve() && f.mf(); for (a = 0; a < h; a++)if ((d = this.Ya[a]) && d.enabled()) {
                        e = d.Qa(); f = d.ab(); k = $.J(e, $.cs) ? Ew(d, {}, [], !1, !0) : Fw(d, !1, $.J(e, $.Qr)); d = k.ia; var m = d.fa || []; if (m.length) for (b = 0; b < m.length; b++)c = k.data[m[b]].G, c.missing = (Number(c.missing) || 0) | (Number(Hw) || 0); b = Jw(d) && (k.eU || Lw(k.ia.error())); m = d.hc(); for (d = d.Wg(); m.advance();)if (!Iw(m.G("missing"),
                            Kw)) if (l = m.get("x"), e.Nc(l), b) c = k.ia.error().Sm(!0), l = $.O(l), e.Nc(l - c[0], l + c[1]), c = k.ia.error().Sm(!1), l = $.O(m.get("value")), f.Nc(l - c[0], l + c[1]); else for (c = 0; c < d.length; c++)f.Nc(m.get(d[c])); k.Vg = 0; k.lastIndex = k.data.length; b = $.ra(e); (e = this.Ja[b]) || (this.Ja[b] = e = []); e.push(k); this.Ba.push(k)
                    } for (b in this.qa) e = this.qa[b], e.Ve() && e.pf(); for (b in this.Sa) f = this.Sa[b], f.Ve() && f.pf(); this.D(1572864); $.oq(this.Ya); this.U(327680)
                }
            }; $.g.fr = function () { this.yc(); return Nw(this.qa) };
            ...
            $.g.pD = function () {
                if (this.Jl().enabled() && 0 < this.Jl().duration()) if (this.fa && 1 == this.fa.Ud) this.fa.update(); else if (this.W(2048)) {
                    $.K(this.fa); this.fa = new $v; for (var a = this.Jl().duration(), b = 0; b < this.Ya.length; b++) { var c = this.Ya[b]; if (c.enabled() && !c.Br().kf("point")) { var d = UB[c.R]; d && this.fa.add(new d(c, a)) } } this.fa.pa("begin", function () { $.Iu(this, !0); $.lq(this, { type: "animationstart", chart: this }) }, !1, this); this.fa.pa("end", function () { $.Iu(this, !1); $.lq(this, { type: "animationend", chart: this }) }, !1,
                        this); this.fa.Jh(!1)
                }
            };
            $.g.eG = function (a, b, c) {
                b = {}; $.Tc(b, $.Sl(c ? eC["chart-with-series-point"] : eC["chart-with-series-default"]), $.Sl($.FB["select-marquee"]), a); var d = uba(this); a = b["exclude-points-list"]; a.subMenu = {}; a.enabled = !1; if (d.length) {
                    c = {}; for (var e, f = 0; f < d.length; f++) {
                        e = d[f].je().Fc(); var h; "candlestick" == e || "ohlc" == e ? h = "o - " + d[f].get("open") + ", h - " + d[f].get("high") + ", l - " + d[f].get("low") + ", c - " + d[f].get("close") : "box" == e ? h = "high - " + d[f].get("high") + ", low - " + d[f].get("low") : "range-area" == e || "range-bar" ==
                            e || "range-column" == e || "range-spline-area" == e || "range-step-area" == e ? h = "high - " + d[f].get("high") + ", low - " + d[f].get("low") : "bubble" == e ? h = "x - " + d[f].get("x") + ", y - " + d[f].get("value") + ", size - " + d[f].get("size") : h = d[f].get("value"); c["exclude-points-point-" + f] = { index: 10.01, text: d[f].je().name() + ": " + h, eventType: "anychart.include", scrollable: !0, action: (0, $.ua)(d[f].je().qL, d[f].je(), d[f].sa()) }
                    } c["excluded-points-separator"] = { index: 10.01 + 10 }; h = $.Sl(fC["exclude-points-include-all"]); h.index = 10.01 +
            ...
            var fC = {
                ...
                "exclude-points-include-all": { index: 30, text: "Include all", eventType: "anychart.includeAll", action: function (a) { $.T(a.chart); var b, c, d = a.chart.we(); for (c = 0; c < d.length; c++)b = d[c], $.D(b.pL) && b.pL(); a.chart.ka(!0) } }
            }, eC = {
                "chart-with-series-default": { "exclude-points-list": fC["exclude-points-list"], "exclude-points-separator": { index: 8.5 } }, "chart-with-series-point": {
                    "exclude-points-point": fC["exclude-points-point"], "exclude-points-list": fC["exclude-points-list"], "exclude-points-keep-only": fC["exclude-points-keep-only"],
                    "chart-with-series-point-separator": { index: 9.2 }
                }
            }; $.g = $.Bw.prototype;
            $.g.Um = function (a) {
                var b = this.g || $.bn(0, 0, 0, 0), c = a.clientX, d = a.clientY, e, f, h = $.Tj(this.$().Ca()); a = c - h.x; var h = d - h.y, k = b.left, l = b.top, m = b.width, p = b.height; if (a < k || a > k + m || h < l || h > l + p) return null; b = []; e = this.Bd(); var q; if ("by-spot" == e.Mc()) for (c = e.Aw(), this.ba ? (d = (p - (h - c - l)) / p, k = (p - (h + c - l)) / p, l = a, a = h, h = l) : (d = (a - c - k) / m, k = (a + c - k) / m), l = 0, m = this.Ya.length; l < m; l++) {
                    if ((p = this.Ya[l]) && p.enabled()) {
                        e = p.Qa().Ic(d); f = p.Qa().Ic(k); var r = this.Ha ? p.ED(e, f) : p.data().ED(e, f); f = p.hc(); for (var t = [], u = window.Infinity,
                            v, w = 0; w < r.length; w++)if (e = r[w], f.select(e) && !f.G("missing")) { var x = f.G("x"), z = !1; q = p.Wg(); for (var E = 0; E < q.length; E++) { var N = f.G(q[E]), N = $.Ym(x, N, a, h), z = z || N <= c; N < u && (u = N, v = e) } z && t.push(e) } t.length && b.push({ ia: p, qc: t, Kj: t[t.length - 1], fd: { index: v, Le: u } })
                    }
                } else "by-x" == this.Bd().Mc() && (b = Pw(this, c, d)); return b
            }; $.g.bF = function () { };
            ...
            $.g.ga = function (a, b) {
                $.Bw.I.ga.call(this, a, b); $.Ip(this, bC, a); var c = this.Va(), d, e, f, h = a.scales, k = {}; if ($.y(h)) for (d = 0; d < h.length; d++)e = h[d], $.B(e) && (e = { type: e }), e = $.mm(e, d, c), f = $.Ir(e.type, !1), f.X(e), k[d] = f; else if ($.A(h)) for (d in h) h.hasOwnProperty(d) && (e = h[d], $.B(e) && (e = { type: e }), e = $.mm(e, d, c), f = $.Ir(e.type, !1), f.X(e), k[d] = f); e = a.xScale; $.C(e) ? f = k[e] : $.B(e) ? (f = $.Ir(e, null)) || (f = k[e]) : $.A(e) ? (f = $.Ir(e.type, !0), f.X(e)) : f = null; f && this.Qa(f); e = a.yScale; $.C(e) ? f = k[e] : $.B(e) ? (f = $.Ir(e, null)) || (f = k[e]) :
                    $.A(e) ? (f = $.Ir(e.type, !1), f.X(e)) : f = null; f && this.ab(f); this.mn(a, k, b)
            }; $.g.O = function () { var a = $.Bw.I.O.call(this), b = {}, c = []; $.Rp(this, bC, a); $.Sw(a, "xScale", this.Qa(), c, b); $.Sw(a, "yScale", this.ab(), c, b); this.ln(a, c, b); a.scales = c; return a }; $.g.mn = function (a, b, c) { this.MW(a, b, c) }; $.g.ln = function (a, b, c) { this.qW(a, b, c) }; $.g.iD = function () { return 1 };
            ...
            $.g.Ou = function (a, b) {
                var c, d, e, f = $.lb(this.B, this.F), h = 0; c = 0; for (d = this.B.length; c < d; c++)if (e = this.B[c]) $.T(e), e.padding(0); c = 0; for (d = this.F.length; c < d; c++)if (e = this.F[c]) $.T(e), e.padding(0); var k; do {
                    var l, m; d = [0, 0, 0, 0]; e = !0; k = a.clone(); this.Rg = this.Dg = this.ng = this.Rh = window.NaN; var p; for (c = f.length; c--;)(l = f[c]) && l.enabled() && (l.oa(a), m = l.orientation(), p = $.Ac(l.stroke()), "top" == m ? (l.padding().top(d[0]), l.padding().bottom(0), l = l.Sc(), d[0] = a.height - l.height, (0, window.isNaN)(this.Rh) && (this.Rh = p)) :
                        "bottom" == m ? (l.padding().bottom(d[2]), l.padding().top(0), l = l.Sc(), d[2] = a.height - l.height, (0, window.isNaN)(this.ng) && (this.ng = p)) : "left" == m ? (l.padding().left(d[3]), l.padding().right(0), l = l.Sc(), d[3] = a.width - l.width, (0, window.isNaN)(this.Dg) && (this.Dg = p)) : "right" == m && (l.padding().right(d[1]), l.padding().left(0), l = l.Sc(), d[1] = a.width - l.width, (0, window.isNaN)(this.Rg) && (this.Rg = p))); d = this.yC(d, b || 0); k.left += d[3]; k.top += d[0]; k.width -= d[1] + d[3]; k.height -= d[2] + d[0]; for (c = f.length; c--;)(l = f[c]) && l.enabled() &&
                            (p = l.Sc(), l.zb() ? (l.padding().left(d[3]), l.padding().right(d[1]), l = l.Sc(), l.height != p.height && (e = !1)) : (l.padding().top(d[0]), l.padding().bottom(d[2]), l = l.Sc(), l.width != p.width && (e = !1))); h++
                } while (!e && 5 > h); c = 0; for (d = this.B.length; c < d; c++)(e = this.B[c]) && e.ka(!1); c = 0; for (d = this.F.length; c < d; c++)(e = this.F[c]) && e.ka(!1); return k.clone().round()
            }; $.g.yC = function (a) { return a }; $.g.az = function () { return 199262208 };
            $.g.ux = function () {
                var a, b; if (this.W(8388608)) { var c = $.lb(this.ub, this.Ua, this.Xb, this.dc); a = 0; for (b = c.length; a < b; a++) { var d = c[a]; d && ($.T(d), d.scale() || sx(this, d), d.oa(this.g), d.$(this.Ta), d.Vj(this.Rh, this.Rg, this.ng, this.Dg), d.ea(), d.ka(!1)) } this.U(8388608) } if (this.W(2097152)) { c = $.lb(this.B, this.F); a = 0; for (b = c.length; a < b; a++)if (d = c[a]) $.T(d), d.$(this.Ta), d.ea(), d.ka(!1); this.U(2097152) } if (this.W(4194304)) {
                    c = $.lb(this.Rc, this.md, this.Jd); a = 0; for (b = c.length; a < b; a++)if (d = c[a]) $.T(d), d.scale() || sx(this,
                        d), d.oa(this.g), d.$(this.Ta), d.Vj(this.Rh, this.Rg, this.ng, this.Dg), d.ea(), d.ka(!1); this.U(4194304)
                }
            };
            $.g.$h = function (a) {
                this.Oc && (this.wm(), this.vn.No(!0)); var b, c; this.yc(); if (!$.kq(this)) {
                    $.mq(this.B, this.F); if (this.W(2097156)) { var d; b = 0; for (c = this.B.length; b < c; b++)if (d = this.B[b]) $.bv(d.labels()), $.bv(d.$a()), d && !d.scale() && d.scale(this.Qa()); b = 0; for (c = this.F.length; b < c; b++)if (d = this.F[b]) $.bv(d.labels()), $.bv(d.$a()), d && !d.scale() && this.IW(d) } this.W(4) && (this.g = this.Ou(this.mT(a)), this.zt(), this.D(this.az())); this.ux(); $.Aw(this, this.Rh, this.Rg, this.ng, this.Dg); this.W(16777216) && (b = this.Po(),
                        $.T(b), b.oa(this.g), b.$(this.Ta), $.dx(b, this.B[this.Y.Do().Gf()]), $.ex(b, this.F[this.Y.sn().Gf()]), b.ea(), b.ka(!1), this.U(16777216)); this.W(33554432) && (this.Oc && (b = this.wm(), $.T(b), b.oa(this.g), b.$(this.Ta), b.ea(), b.ka(!1)), this.U(33554432)); if (this.W(134217728)) {
                            this.Ef || (this.Ef = this.Ta.path(), this.Ef.zIndex(2)); a = this.YC().stroke(); b = $.Ac(a); if (!$.to(a) && $.n(a)) {
                                var e = this.g.clone(); c = e.top; d = c + e.height; var f = e.left, e = f + e.width, h = $.qo((f + e) / 2, b), k = $.qo((c + d) / 2, b); this.Ef.clear().moveTo(h, c).lineTo(h,
                                    d).moveTo(f, k).lineTo(e, k)
                            } this.Ef && (this.Ef.stroke(a), this.Ef.clip(this.g)); this.bk = []; a = this.g.width / 2; c = this.g.height / 2; this.bk[0] = $.bn(this.g.left + a + b / 2, this.g.top, a - b / 2, c - b / 2); this.bk[1] = $.bn(this.g.left, this.g.top, a - b / 2, c - b / 2); this.bk[2] = $.bn(this.g.left, this.g.top + c + b / 2, a - b / 2, c - b / 2); this.bk[3] = $.bn(this.g.left + a + b / 2, this.g.top + c + b / 2, a - b / 2, c - b / 2); this.D(67108864); this.U(134217728)
                        } if (this.W(67108864)) { a = this.uF().Ji(); for (b = 0; b < a.length; b++)if (c = a[b]) c.$(this.Ta), c.oa(this.bk[b]), c.ea(); this.U(67108864) } $.oq(this.B,
                            this.F)
                }
            ...
            $.g.mn = function (a, b, c) {
                $.rx.I.mn.call(this, a, b, c); "isVertical" in a && (this.ba = !!a.isVertical); this.oS(a.defaultXAxisSettings); this.pS(a.defaultYAxisSettings); tx(this, a.defaultGridSettings); ux(this, a.defaultMinorGridSettings); vx(this, a.defaultLineMarkerSettings); wx(this, a.defaultTextMarkerSettings); xx(this, a.defaultRangeMarkerSettings); this.Ky(a.defaultAnnotationSettings); this.Oc && this.wm(a.annotations); $.Qw(this, a.xGrids, this.us, b); $.Qw(this, a.yGrids, this.vs, b); $.Qw(this, a.xMinorGrids, this.Pu, b); $.Qw(this,
                    a.yMinorGrids, this.Qu, b); $.Qw(this, a.xAxes, this.Cq, b); $.Qw(this, a.yAxes, this.Qo, b); $.Qw(this, a.lineAxesMarkers, this.rs, b); $.Qw(this, a.rangeAxesMarkers, this.ss, b); $.Qw(this, a.textAxesMarkers, this.ts, b); this.Po(a.crosshair)
            }; $.g.O = function () { var a = $.rx.I.O.call(this); a.crossing = this.YC().O(); a.quarters = this.uF().O(); return a };
            $.g.ln = function (a, b, c) {
                $.rx.I.ln.call(this, a, b, c); a.isVertical = this.ba; var d = []; $.Rw(this, a, "xAxes", this.B, this.xM, b, c, d); $.Rw(this, a, "yAxes", this.F, this.xM, b, c, d); $.Rw(this, a, "xGrids", this.Ua, this.sB, b, c, d); $.Rw(this, a, "yGrids", this.ub, this.sB, b, c, d); $.Rw(this, a, "xMinorGrids", this.Xb, this.sB, b, c, d); $.Rw(this, a, "yMinorGrids", this.dc, this.sB, b, c, d); $.Rw(this, a, "lineAxesMarkers", this.Rc, this.yM, b, c, d); $.Rw(this, a, "rangeAxesMarkers", this.md, this.yM, b, c, d); $.Rw(this, a, "textAxesMarkers", this.Jd, this.yM,
                    b, c, d); a.crosshair = this.Po().O()
            }; $.g.xM = function (a, b, c, d) { var e = a.O(); $.Sw(e, "scale", a.scale(), b, c); d.push($.ra(a)); return e }; $.g.sB = function (a, b, c, d) { var e = a.O(); $.Sw(e, "scale", a.scale(), b, c); if (a = a.Eg()) d = (0, $.cb)(d, $.ra(a)), 0 > d ? ("layout" in e || (e.layout = a.zb() ? "horizontal" : "vertical"), "scale" in e || $.Sw(e, "scale", a.scale(), b, c)) : e.axis = d; return e };
            ...
            $.g.ea = function (a, b) {
                var c = a ? this.b.fl() : this.b.ab(), d = this.b.la(), e = d.G("x"), f = d.G("value"), d = $.O(a ? d.get("x") : d.get("value")), h; h = this.b; var k = a ? h.error().WA() : h.error().SA(), l; $.D(k) && (l = h.Yi(), k = $.xc(k.call(l, l))); var m; h.mm() && (m = h.DT(a ? "xErrorStroke" : "valueErrorStroke"), $.D(m) ? (l = h.Yi(k), m = $.xc(m.call(l, l))) : m && (m = $.xc(m))); h = m || k; $.A(h) && "keys" in h && !$.A(h.mode) && (h.mode = this.b.hb()); k = this.b; l = k.la().sa(); m = k.Lc.length ? k.Lc.pop() : $.kk().zIndex(4E-6); k.g.cb(m); k.si.SF(m, k.check(524288), l);
            ...
            $.g.wC = function (a, b) {
                var c = new $.$B[a.ob](this); this.aa && this.g && (!this.check(4) && this.check(4, a, c) ? ($.K(this.g), this.g = null) : this.check(4) && !this.check(4, a, c) && (this.g = null)); this.aa = a; this.td = this.Sa = null; $.K(this.Xd); this.Xd = c; $.T(this); Vx(this); this.Pa = this.qa.Ro()[$.lm(this.R)] || {}; this.o.va(!0, this.Pa); this.o.va(!0, this.Pa.normal); this.ca.va(!0, this.Pa.hovered); this.ba.va(!0, this.Pa.selected); this.nn() ? this.ub = {} : this.ub && delete this.ub; this.Uc.xPointPosition = .5; this.xC(this.Pa, !0, !0, b); this.ka(!1);
                c = this.Ha; c.Pa.needsZero = c.b.check(1); c.Pa.needsWidth = c.b.check(1024); c.Pa.yValues = $.pb(c.b.Xd.Wg(), 0); $.Wx(this)
            }; $.g.xC = function (a, b, c, d) { Jw(this) && this.error().va(!!c, a.error); b && this.Ym().reset(); this.Ym().va(!!c, a.legendItem); "tooltip" in a && this.Db().va(!!c, a.tooltip); $.n(d) || (d = c); d && (this.clip(a.clip), this.zIndex(a.zIndex)); this.Cx().va(!!c, a.a11y || this.qa.Ro().a11y) }; $.g.Sca = function (a) { var b = 1024, c = 1; $.U(a, 4) && (c |= 4); $.U(a, 2) && (b |= 32768); this.D(b, c) };
            ...
            $.g.Lv = function (a) {
                var b = this.Ym(); b.U(b.xa); var c = xs.prototype.O.call(b); $.n(b.Zu()) && (c.iconTextSpacing = b.Zu()); var d = b.N("text"); $.n(d) && (c.text = d); $.n(b.Wu()) && (c.iconEnabled = b.Wu()); $.n(b.$u()) && (c.iconType = b.$u()); $.n(b.Yu()) && (c.iconSize = b.Yu()); $.n(b.ym()) && (c.iconFill = b.ym()); $.n(b.Am()) && (c.iconStroke = b.Am()); $.n(b.zm()) && (c.iconHatchFill = b.zm()); $.n(b.Xu()) && (c.iconMarkerType = b.Xu()); $.n(b.Hs()) && (c.iconMarkerFill = b.Hs()); $.n(b.Is()) && (c.iconMarkerStroke = b.Is()); $.n(b.disabled()) && (c.disabled =
                    b.disabled()); b = this.N("color"); d = this.Ey(); a = c.text || a; $.B(a) && (a = $.Yt($.Zt.uc(), a)); c.text = $.D(a) ? a.call(d, d) : this.zT(d); c.disabled = "disabled" in c ? !!c.disabled : !this.enabled(); c.meta = this.G(); "marker" != c.iconType || this.check(8192) || (c.iconFill = this.o.pb().fill(), c.iconStroke = this.o.pb().stroke()); c.iconType = this.Kv(c.iconType, d); c.iconEnabled = "iconEnabled" in c ? !!c.iconEnabled : !0; c.iconStroke = this.ez(c.iconStroke, 2, b, d); c.iconFill = this.ez(c.iconFill, 1, b, d); c.iconHatchFill = this.ez(c.iconHatchFill,
                        3, this.Ci(), d); this.check(4194304) && this.o.pb().enabled() ? (c.iconMarkerType = c.iconMarkerType || this.o.pb().type(), c.iconMarkerFill = c.iconMarkerFill || this.o.pb().fill(), c.iconMarkerStroke = c.iconMarkerStroke || this.o.pb().stroke()) : (c.iconMarkerType = null, c.iconMarkerFill = null, c.iconMarkerStroke = null); return c
            }; $.g.Kv = function (a) { "marker" == a ? (this.check(8192) ? a = this.N("type") : this.check(4194304) ? a = this.o.pb().type() : a = "square", "line" == a && (a = "v-line")) : $.D(a) || (a = $.Uk(a)); return a };
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; $.T(this); $.n(this.Uc.color) && this.W(16768) && this.yl(this.Uc.color); this.W(32768) && (Vx(this), this.U(32768)); if (this.W(4)) { this.B = this.hb(); this.Cd = this.Y ? this.Y.wh(this.B) : this.B; var a = Math.min(this.B.height, this.B.width); this.PL = $.M(this.md, a); this.MU = $.M(this.Rc, a); this.D(7168) } this.W(512) && (this.hc(), this.fM(), this.D(3104, 2049), this.U(512)); this.W(1024) && this.D(24960); var a = [], b = [], c, d, e, f; d = !1; this.W(1026) && (this.gM(), this.mA()); this.W(1282) && (c = this.o.labels(),
                    f = this.ca.labels().enabled() || this.ba.labels().enabled(), dy(this, c, f, this.lA(), $.iy, 256) && (d = this.zIndex() + this.JG + (this.We() ? 1 : 0), c.pg = d, c.D(8), this.check($.iy) && a.push(this.xm), b.push(c), d = !0), this.U(256)); this.W(1154) && (c = this.o.pb(), f = this.ca.pb().enabled() || this.ba.pb().enabled(), dy(this, c, f, this.lF(), 4194304, 128) && (f = this.zIndex() + 1.2E-5 + (this.We() ? 1 : 0), c.pg = f, this.check(4194304) && a.push(this.Wo), b.push(c)), this.U(128)); if (this.W(9218)) {
                        this.Lc || (this.Lc = []); if (this.Gb) for (; this.Gb.length;)c =
                            this.Gb.pop(), c.clear(), c.parent(null), this.Lc.push(c); else this.Gb = []; Jw(this) && "none" != this.error().mode() && (this.uV() || Lw(this.error())) && a.push(this.f1); this.U(8192)
                    } this.W(17410) && (c = this.o.oi(), f = this.ca.oi().enabled() || this.ba.oi().enabled(), dy(this, c, f, this.aM(), 256, 16384) && (f = this.zIndex() + 1.1E-5, c.pg = f, this.check(256) && a.push(this.vD), b.push(c)), this.U(16384)); c = a.length; if (this.W(1024)) {
                        f = this.qM(); var h; if (f) {
                            var k = this.Wg(); this.mw(f, k); d && this.hH(); this.Dx(); h = this.hc(); if (d = this.SD()) this.Rz(d,
                                k, f), this.Bs(d, this.Tm(d.sa())); for (h.reset(); h.advance();)for (e = this.Tm(h.sa()), this.Rz(h, k, f), this.Bs(h, e), d = 0; d < c; d++)a[d].call(this, h, e, !1); if (d = this.RD()) this.Rz(d, k, f), this.Bs(d, this.Tm(d.sa())); this.IH()
                        } else for (h = this.hc(); h.advance();)this.PE(h, this.Wg(), window.NaN); this.U(2056); this.check(4) && this.D(4096)
                    } else if (c) for (d && this.hH(), h = this.hc(); h.advance();)for (e = this.Tm(h.sa()), d = 0; d < c; d++)a[d].call(this, h, e, !1); for (d = 0; d < b.length; d++)c = b[d], c.ea(), c.ka(!1); this.U(1026); this.W(2048) && (this.Pk(),
                        this.U(2048)); this.W(8) && (this.hP(), this.U(8)); this.W(4096) && (jy(this), this.U(4096)); this.W(32) && (this.Cx().kJ(), this.U(32)); this.U(4); this.ka(!1); return this
            }; $.g.Dx = function () { this.Xd.Be(this.si) }; $.g.Bs = function (a, b) { this.Xd.R(a, b) }; $.g.IH = function () { this.Xd.Hq() }; $.g.gM = function () { this.check(4) ? this.g = this.$() : (this.g || (this.g = $.ik(), this.ER && $.hs(this, this.g)), this.g.zIndex(this.zIndex()), this.g.parent(this.$())); this.W(1024) && this.si.xy(); $.Nx(this.si, this.g) };
            ...
            $.g.mw = function () {
                this.ha.length = 0; this.We() ? this.ha.push(this.Gaa) : (this.ha.push(this.Haa), $.Lx(this) && this.ha.push(this.RE)); if (this.vf() && $.Kx(this) && "percent" != this.ab().lm()) { var a = cy(this, "minPointLength"), b = this.N("isVertical") ? this.B.width : this.B.height; this.Xb = Math.abs($.M(a, b)); this.check($.cC | $.dC) ? this.ha.push(this.Aaa) : this.We() ? this.ha.push(this.Baa) : this.ha.push(this.Caa) } this.Yg() && this.ha.push(this.Faa); this.nn() && this.ha.push(this.Daa); $.Lx(this) && (a = this.ab(), this.Uf = $.Hb(a && a.transform(0,
                    .5) || 0, 0, 1), this.Wf = this.bR(this.Xf(this.Uf, !1)))
            }; $.g.MK = function () { return this.N("xPointPosition") }; $.g.Rz = function (a, b, c) { var d = this.OR() ? 0 : (Number(a.G("missing")) || 0) & -9; this.AE(a) || (d |= 8); var e = this.fl().Fw(a.av(), a.sa(), this.MK()); if (d) this.PE(a, b, e); else for (var f = 0; f < this.ha.length; f++)d = this.ha[f].call(this, a, b, c, d, e); a.G("missing", d) }; $.g.NJ = function (a) { return [this.$d(a.sa()), this, this.Yb()] };
            $.g.CK = function (a) { var b = {}, c = a.get("high") - a.get("low"); b["%Range"] = { value: c, type: "number" }; b["%Name"] = { value: a.get("name"), type: "string" }; return b };
            $.g.it = function (a, b) {
                var c = this.fl(), d = { chart: { value: this.Yb(), type: "" }, series: { value: this, type: "" }, xScale: { value: c, type: "" }, index: { value: b.sa(), type: "number" }, x: { value: b.av(), type: "string" }, seriesName: { value: this.name(), type: "string" } }; c && $.D(c.Va) && (d.xScaleType = { value: c.Va(), type: "string" }); this.Yg() && (d.size = { value: b.get("size"), type: "number" }); if (Jw(this)) {
                    var c = this.error().mode(), e; if ("both" == c || "value" == c) e = this.Sm(!1), d.valueLowerError = { value: e[0], type: "number" }, d.valueUpperError = {
                        value: e[1],
                        type: "number"
                    }; if ("both" == c || "x" == c) e = this.Sm(!0), d.xLowerError = { value: e[0], type: "number" }, d.xUpperError = { value: e[1], type: "number" }
                } c = this.Wg(); for (e = 0; e < c.length; e++) { var f = c[e]; d[f] = { value: b.get(f), type: "number" } } return d
            }; $.g.XR = function () { return $.ky(this, new $.Nt) }; $.g.Dh = function () { this.Sa || (this.Sa = new $.Nt); return $.ky(this, this.Sa) };
            ...
            $.g.ea = function () {
                if (!this.ic()) return this; this.U(256); if (!this.Ac()) return this.remove(), this.D(2), this; if ($.kq(this)) return this; this.g || (this.g = $.ik(), this.F = $.kk(), this.F.zIndex(100), this.j = $.kk(), this.j.zIndex(100), this.Ea = this.g.rect(), this.Ea.zIndex(1), this.ec = $.nk(), this.Ea.clip(this.ec), this.fa = this.g.rect(), this.fa.zIndex(50), this.Ia = $.nk(), this.fa.clip(this.Ia), this.qa = this.g.path(), this.qa.zIndex(99), $.hs(this, this.g, this.D1, this.Yaa), this.ma.pa(this.F, "mouseover", this.$W), this.ma.pa(this.F,
                    "mouseout", this.ZW), this.ma.Pd(this.F, "mousedown", this.Dw), this.ma.Pd(this.F, "touchstart", this.Dw), this.ma.pa(this.j, "mouseover", this.$W), this.ma.pa(this.j, "mouseout", this.ZW), this.ma.Pd(this.j, "mousedown", this.Dw), this.ma.Pd(this.j, "touchstart", this.Dw), this.ma.Pd(this.fa, "mousedown", this.Dw), this.ma.Pd(this.fa, "touchstart", this.Dw), this.ma.pa(this.Ea, "click", this.vba)); this.W(2) && (this.g.parent(this.$()), this.U(2)); this.W(8) && (this.g.zIndex(this.zIndex()), this.U(8)); this.W(128) && (this.F.cursor(vy(this)),
                        this.j.cursor(vy(this)), this.fa.cursor(vy(this)), this.D(84), this.U(128)); this.W(4) && (this.rG(), this.U(4)); if (this.W(64)) {
                            var a = (Math.max($.Ac(this.Ua), 5) - 1) / 2; if (this.zb()) {
                                var b = this.R.top; if (this.Jr().N("enabled")) a = b + this.R.height / 2, this.F.clear().moveTo(-4, a - 6).lineTo(-2, a - 8).lineTo(2, a - 8).lineTo(4, a - 6).lineTo(4, a + 6).lineTo(2, a + 8).lineTo(-2, a + 8).lineTo(-4, a + 6).close().moveTo(-1, a - 5).lineTo(-1, a + 5).moveTo(1, a - 5).lineTo(1, a + 5), this.j.clear().moveTo(-4, a - 6).lineTo(-2, a - 8).lineTo(2, a - 8).lineTo(4,
                                    a - 6).lineTo(4, a + 6).lineTo(2, a + 8).lineTo(-2, a + 8).lineTo(-4, a + 6).close().moveTo(-1, a - 5).lineTo(-1, a + 5).moveTo(1, a - 5).lineTo(1, a + 5); else { var c = b + this.R.height; this.F.clear().moveTo(-a, b).lineTo(a, b).lineTo(a, c).lineTo(-a, c).close(); this.j.clear().moveTo(-a, b).lineTo(a, b).lineTo(a, c).lineTo(-a, c).close() }
                            } else b = this.R.left, this.Jr().N("enabled") ? (a = b + this.R.width / 2, this.F.clear().moveTo(a - 6, -4).lineTo(a - 8, -2).lineTo(a - 8, 2).lineTo(a - 6, 4).lineTo(a + 6, 4).lineTo(a + 8, 2).lineTo(a + 8, -2).lineTo(a + 6, -4).close().moveTo(a -
                            ...
                            this.Ea.Qe(this.R); this.fa.Qe(this.R); this.ec.shape(this.R);
                            this.Ea.fill("none" == this.Na ? $.$l : this.Na).stroke(null); this.fa.fill("none" == this.Lc ? $.$l : this.Lc).stroke(null); this.qa.stroke(this.Ua).fill(null); Ay(this, this.F, this.ub); Ay(this, this.j, this.Gd); switch (this.fc) {
                                case "top": a = this.R; b = this.ca; c = this.ba; this.Y && (b = ty - b, c = ty - c); var b = a.left + b / ty * a.width, d = a.left + c / ty * a.width; this.F.Wb(1, 0, 0, 1, b, 0); this.j.Wb(1, 0, 0, 1, d, 0); c = Math.min(b, d); b = Math.max(b, d); this.Ia.shape(c, a.top, b - c, a.height); this.qa.clear().moveTo(a.left, a.top + a.height).lineTo(c, a.top + a.height).lineTo(c,
                                    ...
                                    c = this.ba; this.Y && (b = ty - b, c = ty - c); b = a.left + b / ty * a.width; d = a.left + c / ty * a.width; this.F.Wb(1, 0, 0, 1, b, 0); this.j.Wb(1, 0, 0, 1, d, 0); c = Math.min(b, d); b = Math.max(b, d); this.Ia.shape(c, a.top, b - c, a.height); this.qa.clear().moveTo(a.left, a.top).lineTo(c, a.top).lineTo(c, a.top + a.height).lineTo(b, a.top + a.height).lineTo(b, a.top).lineTo(a.left + a.width, a.top); break; case "left": a = this.R, b = this.ca, c = this.ba, this.Y && (b = ty - b, c = ty - c), b = a.top + b / ty * a.height, d = a.top + c / ty * a.height, this.F.Wb(1, 0, 0, 1, 0, b), this.j.Wb(1, 0, 0, 1, 0, d),
                                        c = Math.min(b, d), b = Math.max(b, d), this.Ia.shape(a.left, c, a.width, b - c), this.qa.clear().moveTo(a.left + a.width, a.top).lineTo(a.left + a.width, c).lineTo(a.left, c).lineTo(a.left, b).lineTo(a.left + a.width, b).lineTo(a.left + a.width, a.top + a.height)
                            }this.Jr().N("autoHide") || yy(this); this.U(16)
                        } return this
            }; $.g.mH = function (a) { return $.n(a) ? (this.za = !!a, this) : this.za };
            ...
            $.g.vj = function () {
                if (this.K && this.g) {
                    for (var a = this.sc.Dc(this.j), b = a.fill, c = a.hatchFill, a = a.low, d = window.NaN, e = window.NaN, f = !0, h = this.g.length - 1; 0 <= h; h -= 2) {
                        var k = this.g[h - 1], l = this.g[h]; if (f) $.Dx(a, this.b, k, l), f = !1; else switch (this.F) { case "forward": $.Ex(b, this.b, d, l); $.Ex(c, this.b, d, l); $.Ex(a, this.b, d, l); break; case "backward": $.Ex(b, this.b, k, e); $.Ex(c, this.b, k, e); $.Ex(a, this.b, k, e); break; default: d = (k + d) / 2, $.Ex(b, this.b, d, e, d, l), $.Ex(c, this.b, d, e, d, l), $.Ex(a, this.b, d, e, d, l) }$.Ex(b, this.b, k, l); $.Ex(c,
                            this.b, k, l); $.Ex(a, this.b, k, l); d = k; e = l
                    } b.close(); c.close(); this.g = null
                }
            }; $.G(qz, $.Fx); $.$B[31] = qz; $.g = qz.prototype; $.g.type = 31; $.g.Te = $.cC | 295433; $.g.ef = { stroke: "path" }; $.g.Be = function (a) { qz.I.Be.call(this, a); this.mp = 2 < this.o }; $.g.Rk = ["low", "high"]; $.g.Ui = "high"; $.g.Je = function (a, b) { var c = this.sc.Dc(b); rz(this, a, c) }; $.g.zn = function (a) { var b = a.G("shapes"), c; for (c in b) b[c].clear(); rz(this, a, b) }; $.G(sz, $.Fx); $.$B[15] = sz; $.g = sz.prototype; $.g.type = 15; $.g.Te = 32984; $.g.ef = { stroke: "path" }; $.g.Be = function (a) { sz.I.Be.call(this, a); a = this.sc.Dc(this.j); var b = this.b; $.n(b) && (this.g.B = b); b = this.ia.lw(); $.n(b) && (this.g.P = b); this.g.b = [a.stroke] }; $.g.pk = function (a) { var b = this.sc.Dc(this.j), c = a.G("x"); a = a.G("value"); mz(this.g, !1); $.Dx(b.stroke, this.b, c, a); kz(this.g, c, a) }; $.g.Je = function (a) { var b = a.G("x"); a = a.G("value"); kz(this.g, b, a) }; $.g.vj = function () { this.K && lz(this.g) };
            ...
            $.g.vj = function () {
                if (this.K) if (lz(this.J), !(0, window.isNaN)(this.F)) $.Ex(this.B[0], this.b, this.F, this.Wf), this.B[0].close(), $.Ex(this.B[1], this.b, this.F, this.Wf), this.B[1].close(); else if (this.g) {
                    this.J.b = this.B; mz(this.J, !0); for (var a = window.NaN, b = window.NaN, c = !1, d = !0, e = this.g.length - 1; 0 <= e; e -= 3) {
                        var f = this.g[e - 2], h = this.g[e - 1], k = this.g[e]; d ? ($.Ex(this.B[0], this.b, f, h), $.Ex(this.B[1], this.b, f, h), k || kz(this.J, f, h), d = !1) : k && c ? ($.Ex(this.B[0], this.b, f, h), $.Ex(this.B[1], this.b, f, h)) : k ? (lz(this.J), mz(this.J,
                            !0), $.Ex(this.B[0], this.b, a, h, f, h), $.Ex(this.B[1], this.b, a, h, f, h)) : (c && ($.Ex(this.B[0], this.b, f, b, f, h), $.Ex(this.B[1], this.b, f, b, f, h)), kz(this.J, f, h)); a = f; b = h; c = k
                    } lz(this.J); this.g = null
                }
            }; $.g.da = function () { this.J.b = null; tz.I.da.call(this) }; $.G(uz, $.Fx); $.$B[17] = uz; $.g = uz.prototype; $.g.type = 17; $.g.Te = 131313; $.g.ef = { fill: "path", hatchFill: "path", stroke: "path" }; $.g.Be = function (a) { uz.I.Be.call(this, a); this.F = this.ia.N("stepDirection") || "center" };
            ...
            $.g.vj = function () {
                if (this.K) {
                    var a = this.sc.Dc(this.j), b = a.fill, a = a.hatchFill; if (!(0, window.isNaN)(this.P)) $.Ex(b, this.b, this.P, this.Wf), b.close(), $.Ex(a, this.b, this.P, this.Wf), a.close(); else if (this.g) {
                        for (var c = window.NaN, d = window.NaN, e = this.g.length - 1; 0 <= e; e -= 2) {
                            var f = this.g[e - 1], h = this.g[e]; if (!(0, window.isNaN)(d)) switch (this.F) {
                                case "forward": $.Ex(b, this.b, c, h); $.Ex(a, this.b, c, h); break; case "backward": $.Ex(b, this.b, f, d); $.Ex(a, this.b, f, d); break; default: c = (f + c) / 2, $.Ex(b, this.b, c, d, c, h), $.Ex(a,
                                    this.b, c, d, c, h)
                            }$.Ex(b, this.b, f, h); $.Ex(a, this.b, f, h); c = f; d = h
                        } b.close(); a.close(); this.g = null
                    }
                }
            }; $.G(xz, $.Fx); $.$B[18] = xz; $.g = xz.prototype; $.g.type = 18; $.g.Te = 164056; $.g.ef = { stroke: "path" }; $.g.Be = function (a) { xz.I.Be.call(this, a); this.F = this.ia.N("stepDirection") || "center" }; $.g.pk = function (a) { var b = this.sc.Dc(this.j), c = a.G("x"); a = a.G("value"); $.Dx(b.stroke, this.b, c, a); this.B = c; this.J = a };
            $.g.Je = function (a) { var b = this.sc.Dc(this.j), c = a.G("x"); a = a.G("value"); b = b.stroke; switch (this.F) { case "forward": $.Ex(b, this.b, c, this.J); break; case "backward": $.Ex(b, this.b, this.B, a); break; default: var d = (c + this.B) / 2; $.Ex(b, this.b, d, this.J, d, a) }$.Ex(b, this.b, c, a); this.B = c; this.J = a }; $.G(yz, $.Fx); $.$B[20] = yz; $.g = yz.prototype; $.g.type = 20; $.g.Te = 296681; $.g.ef = { stroke: "path" }; $.g.Be = function (a) { yz.I.Be.call(this, a); this.mp = 2 < this.o }; $.g.Je = function (a, b) { var c = this.sc.Dc(b); zz(this, a, c) }; $.g.zn = function (a) { var b = a.G("shapes"), c; for (c in b) b[c].clear(); zz(this, a, b) };
        }).call(this, $)
    }
    if (!_.theme_core) {
        _.theme_core = 1; (function ($) {
            var wG, xG, JG, KG, OG; $.uG = function (a, b) { var c = null === a || "boolean" == typeof a || "" == a ? window.NaN : +a; return (0, window.isNaN)(c) ? a : $.sr(c, b, void 0, void 0, void 0, void 0, void 0, void 0) }; $.vG = function () { return $.uG(this.value) }; wG = function () { return $.uG(this.value, 10) }; xG = function () { return this.x }; $.yG = function () { return this.sourceColor }; $.zG = function () { return $.Tl(this.sourceColor, .7, !0) }; $.AG = function () { return $.Tl(this.sourceColor, .65, !0) }; $.BG = function () { return $.Tl(this.sourceColor, .5, !0) };
            ...
            $.MG = function () {
                for (var a = this.chart, b = $.LG.call(this), c = a.Ya.length, d = {}, e = 0; e < c; e++) { var f = a.Wi(e).Fc(); d.hasOwnProperty(f) ? d[f] += 1 : d[f] = 1 } var b = b + ", with ", h; for (h in d) b += d[h] + " " + h + " series, "; b += ". "; d = a.ab(); a = a.Qa(); c = a.Va(); e = d.Va(); if ("ordinal" == e) { d = d.values(); b += "Y-scale with " + d.length + " categories: "; for (e = 0; e < d.length; e++)b += d[e] + ", "; b += ". " } else f = d.Rf(), d = d.yg(), "date-time" == e && (f = $.or(f), d = $.or(d)), b += "Y-scale minimum value is " + f + " , maximum value is " + d + ". "; if ("ordinal" == c) {
                    a =
                    a.values(); b += "X-scale with " + a.length + " categories: "; for (c = 0; c < a.length; c++)b += a[c] + ", "; b += ". "
                } else f = a.Rf(), d = a.yg(), "date-time" == c && (f = $.or(f), d = $.or(d)), b += "X-scale minimum value is " + f + " , maximum value is " + d + ". "; return b
            };
            $.NG = function () {
                for (var a = this.chart, b = $.LG.call(this), c = a.Ya.length, d = {}, e = 0; e < c; e++) { var f = a.Wi(e).Va(); d.hasOwnProperty(f) ? d[f] += 1 : d[f] = 1 } var b = b + ", with ", h; for (h in d) b += d[h] + " " + h + " series, "; b += ". "; d = a.ab(); a = a.Qa(); c = a.Va(); e = d.Va(); if ("ordinal" == e) { d = d.values(); b += "Y-scale with " + d.length + " categories: "; for (e = 0; e < d.length; e++)b += d[e] + ", "; b += ". " } else f = d.Rf(), d = d.yg(), "date-time" == e && (f = $.or(f), d = $.or(d)), b += "Y-scale minimum value is " + f + ", maximum value is " + d + ". "; if ("ordinal" == c) {
                    a =
                    a.values(); b += "X-scale with " + a.length + " categories: "; for (c = 0; c < a.length; c++)b += a[c] + ", "; b += ". "
                } else f = a.Rf(), d = a.yg(), "date-time" == c && (f = $.or(f), d = $.or(d)), b += "X-scale minimum value is " + f + ", maximum value is " + d + ". "; return b
            }; OG = function (a) { switch (a.xScaleType) { case "date-time": return $.pr(a.x); default: return $.uG(a.x) } };
            $.F("anychart.themes.defaultTheme", {
                ...
                markerPalette: { items: "circle diamond square triangle-down triangle-up diagonal-cross pentagon cross v-line star5 star4 trapezium star7 star6 star10".split(" ") }, defaultScaleSettings: {
                    linear: {
                        maxTicksCount: 1E3, inverted: !1, maximum: null, minimum: null, minimumGap: .1, maximumGap: .1, softMinimum: null, softMaximum: null, ticks: { mode: "linear", base: 0, explicit: null, minCount: 4, maxCount: 6, interval: window.NaN }, minorTicks: { mode: "linear", base: 0, explicit: null, count: 5, interval: window.NaN }, stackMode: "none", stackDirection: "direct",
                        stickToZero: !0
                    }, ordinal: { type: "ordinal", inverted: !1, names: [], ticks: { maxCount: 100 } }, log: { type: "log", logBase: 10, ticks: { mode: "log" }, minorTicks: { mode: "log" } }, dateTime: { type: "date-time", ticks: { count: 4 }, minorTicks: { count: 4 } }
                }, defaultFontSettings: {
                    fontSize: 13, fontFamily: "Verdana, Helvetica, Arial, sans-serif", fontColor: "#7c868e", textDirection: "ltr", fontOpacity: 1, fontDecoration: "none", fontStyle: "normal", fontVariant: "normal", fontWeight: "normal", letterSpacing: "normal", lineHeight: "normal", textIndent: 0, vAlign: "top",
                    hAlign: "start", wordWrap: "normal", wordBreak: "normal", textOverflow: "", selectable: !1, disablePointerEvents: !1, useHtml: !1
                }, defaultBackground: { enabled: !1, fill: "#ffffff", stroke: "none", cornerType: "round", corners: 0 }, defaultSeparator: { enabled: !1, fill: "#CECECE 0.3", width: "100%", height: 1, margin: { top: 5, right: 0, bottom: 5, left: 0 }, orientation: "top", stroke: "none", zIndex: 1 }, defaultLabelFactory: {
                    enabled: !1, offsetX: 0, offsetY: 0, width: null, height: null, clip: null, fontSize: 12, minFontSize: 8, maxFontSize: 72, adjustFontSize: {
                        width: !1,
                        height: !1
                    }, anchor: "center", padding: 4, rotation: 0, format: $.vG, positionFormatter: $.vG
                }, defaultMarkerFactory: { anchor: "center", size: 6, offsetX: 0, offsetY: 0, rotation: 0, positionFormatter: $.vG }, defaultTitle: { enabled: !1, fontSize: 16, text: "Title text", width: null, height: null, align: "center", hAlign: "center", padding: 0, margin: 0 }, defaultTooltip: {
                    enabled: !0, title: { fontColor: "#ffffff", text: "", fontSize: 14, rotation: 0, align: "left", hAlign: "left", orientation: "top", zIndex: 1, background: { fill: "none", stroke: "none" } }, contentInternal: {
                        enabled: !0,
                        fontSize: 12, minFontSize: 9, maxFontSize: 13, fontColor: "#ffffff", hAlign: "left", text: "Tooltip Text", width: "100%", height: "100%", anchor: "left-top", offsetX: 0, offsetY: 0, position: "left-top", adjustFontSize: { width: !1, height: !1 }, padding: 0, rotation: 0, zIndex: 1, background: { disablePointerEvents: !1, fill: "none", stroke: "none" }
                    }, fontSize: 12, minFontSize: 9, maxFontSize: 13, fontColor: "#ffffff", text: "Tooltip Text", width: null, height: null, adjustFontSize: { width: !1, height: !1 }, background: {
                        enabled: !0, fill: "#212121 0.7", corners: 3,
                        zIndex: 0, cornerType: "round"
                    }, offsetX: 10, offsetY: 10, padding: { top: 5, right: 10, bottom: 5, left: 10 }, valuePrefix: "", valuePostfix: "", position: "left-top", anchor: "left-top", hideDelay: 0, titleFormat: $.vG, format: function () { return this.valuePrefix + $.uG(this.value) + this.valuePostfix }, unionFormat: function () { return this.formattedValues.join("\n") }, zIndex: 0, allowLeaveChart: !0, allowLeaveScreen: !1, allowLeaveStage: !1
                }, defaultAxis: {
                    enabled: !0, startAngle: 0, drawLastLabel: !0, drawFirstLabel: !0, staggerMaxLines: 2, staggerMode: !1,
                    ...
                    enabled: !0, isMinor: !1, drawFirstLine: !0, drawLastLine: !0, fill: function () { return this.palette.pd(this.index) },
                    palette: ["none"], stroke: "#CECECE", scale: 1, zIndex: 11
                }, defaultMinorGridSettings: { isMinor: !0, stroke: "#EAEAEA", zIndex: 10 }, defaultLineMarkerSettings: { enabled: !0, value: 0, layout: null, stroke: { color: "#7c868e", thickness: 2, opacity: 1, dash: "", lineJoin: "miter", lineCap: "square" }, zIndex: 25.2, scale: 1 }, defaultTextMarkerSettings: { enabled: !0, fontSize: 12, value: 0, anchor: "center", align: "center", layout: null, offsetX: 0, offsetY: 0, text: "Text marker", width: null, height: null, zIndex: 25.3, scale: 1 }, defaultRangeMarkerSettings: {
                    enabled: !0,
                    from: 0, to: 0, layout: null, fill: "#c1c1c1 0.4", zIndex: 25.1, scale: 1
                }, defaultLegend: {
                    enabled: !1, vAlign: "bottom", fontSize: 12, textOverflow: "...", itemsLayout: "horizontal", positionMode: "outside", itemsSpacing: 15, items: null, itemsFormat: null, itemsSourceMode: "default", inverted: !1, hoverCursor: "pointer", iconTextSpacing: 5, iconSize: 15, width: null, height: null, position: "top", align: "center", padding: { top: 0, right: 10, bottom: 10, left: 10 }, margin: 0, title: { fontSize: 15 }, paginator: {
                        enabled: !0, fontSize: 12, fontColor: "#545f69", orientation: "right",
                        layout: "horizontal", padding: { top: 0, right: 0, bottom: 0, left: 5 }, margin: 0, zIndex: 30, buttonsSettings: { normal: { stroke: "#757575", fill: "#9e9e9e" }, hover: { stroke: "#546e7a", fill: "#7c868e" }, pushed: { stroke: "#7c868e", fill: "#9e9e9e" }, disabled: { stroke: null, fill: "#e0e0e0" } }
                    }, titleFormat: null, tooltip: { enabled: !1, allowLeaveScreen: !0 }, drag: !1, maxWidth: null, maxHeight: null, zIndex: 200
                }, defaultCrosshairLabel: {
                    x: 0, y: 0, axisIndex: 0, anchor: null, format: $.vG, enabled: !0, fontSize: 12, minFontSize: 8, maxFontSize: 16, fontColor: "#ffffff",
                    fontWeight: 400, disablePointerEvents: !0, text: "Label text", background: { enabled: !0, disablePointerEvents: !0, fill: "#212121 0.7", corners: 3, zIndex: 0 }, padding: { top: 5, right: 10, bottom: 5, left: 10 }, width: null, height: null, offsetX: 0, offsetY: 0, adjustFontSize: { width: !1, height: !1 }, rotation: 0
                }, defaultCallout: { enabled: !0, orientation: "left", title: { enabled: !1 }, padding: 0, margin: 0, align: "center", labels: { enabled: !0, vAlign: "middle", hAlign: "center", positionFormatter: $.vG, adjustFontSize: !1, connectorStroke: null } }, defaultScroller: {
                    enabled: !1,
                    fill: "#f7f7f7", selectedFill: "#ddd", outlineStroke: "none", height: 16, minHeight: null, maxHeight: null, autoHide: !1, orientation: "bottom", position: "after-axes", allowRangeChange: !0, thumbs: { enabled: !0, autoHide: !1, normal: { fill: "#E9E9E9", stroke: "#7c868e" }, hovered: { fill: "#ffffff", stroke: "#757575" } }, inverted: !1, zIndex: 35
                }, defaultLabelSettings: {
                    enabled: !0, text: "Chart label", width: null, height: null, anchor: "left-top", position: "left-top", offsetX: 0, offsetY: 0, minFontSize: 8, maxFontSize: 72, adjustFontSize: { width: !1, height: !1 },
                    rotation: 0, zIndex: 50
                }, defaultNoDataLabel: { padding: {}, disablePointerEvents: !1, enabled: !1, background: { zIndex: 0, enabled: !1, visible: !1, disablePointerEvents: !1 }, fontFamily: "Arial", fontColor: "black", fontWeight: "bold", fontSize: 15, position: "center", anchor: "center", zIndex: 999999, text: "No data." }, stageCredits: {
                    text: "AnyChart", url: "https://www.anychart.com/?utm_source=registered", alt: "AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}", imgAlt: "AnyChart - JavaScript Charts",
                    logoSrc: "https://static.anychart.com/logo.png"
                }, chart: {
                    enabled: !0, padding: { top: 10, right: 20, bottom: 15, left: 10 }, margin: 0, background: { enabled: !0, zIndex: 1 }, contextMenu: { fromTheme: !0, enabled: !0 }, title: { text: "Chart Title", padding: { top: 0, right: 0, bottom: 10, left: 0 }, zIndex: 80, background: { zIndex: 0 } }, animation: { enabled: !1, duration: 1E3 }, interactivity: { hoverMode: "single", selectionMode: "multi-select", spotRadius: 2, allowMultiSeriesSelection: !0 }, tooltip: {
                        displayMode: "single", positionMode: "float", title: { enabled: !0 },
                        separator: { enabled: !0 }, titleFormat: function () { return OG(this.points[0]) }, format: function () { return this.formattedValues.join("\n") }
                    }, bounds: { top: null, right: null, bottom: null, left: null, width: null, height: null, minWidth: null, minHeight: null, maxWidth: null, maxHeight: null }, credits: {}, defaultSeriesSettings: {
                        base: {
                            enabled: !0, isVertical: null, background: { enabled: !0 }, tooltip: {
                                titleFormat: function () { return OG(this) }, format: function () { return this.seriesName + ": " + this.valuePrefix + $.uG(this.value) + this.valuePostfix },
                                zIndex: 0
                            }, normal: { fill: $.AG, stroke: $.FG, lowStroke: $.FG, highStroke: $.FG, hatchFill: !1, labels: { enabled: null, anchor: "auto", position: "value" }, markers: { enabled: !1, disablePointerEvents: !1, position: "value", positionFormatter: $.vG, size: 4 } }, hovered: { fill: $.yG, stroke: $.HG, lowStroke: $.HG, highStroke: $.HG, hatchFill: null, labels: { enabled: null }, markers: { enabled: null, size: 6 } }, selected: {
                                fill: "#333 0.85", stroke: "#333 0.85", lowStroke: "#333 0.85", highStroke: "#333 0.85", hatchFill: null, labels: { enabled: null }, markers: {
                                    enabled: null,
                                    fill: "#333 0.85", stroke: "1.5 #212121", size: 6
                                }
                            }, legendItem: { enabled: !0, iconType: "square" }, clip: !0, color: null, xScale: null, yScale: null, error: { mode: "both", xError: null, xUpperError: null, xLowerError: null, valueError: null, valueUpperError: null, valueLowerError: null, xErrorWidth: 10, valueErrorWidth: 10, xErrorStroke: $.DG, valueErrorStroke: $.DG }, pointWidth: null, connectMissingPoints: !1, a11y: { enabled: !1, titleFormat: "Series named {%SeriesName} with {%SeriesPointsCount} points. Min value is {%SeriesYMin}, max value is {%SeriesYMax}" }
                        },
                        marker: { normal: { fill: $.yG, stroke: KG, size: 4, labels: { offsetY: 3 } }, hovered: { fill: $.EG, stroke: KG, size: 6 }, selected: { fill: "#333 0.85", stroke: "1.5 #212121", size: 6 }, legendItem: { iconStroke: "none" } }, bubble: {
                            normal: { fill: $.zG, negativeFill: function () { return $.Ql($.Ql($.Ql(this.sourceColor))) }, negativeStroke: function () { return $.Ql($.Ql($.Ql($.Ql(this.sourceColor)))) }, negativeHatchFill: !1, labels: { anchor: "center" } }, hovered: {
                                fill: $.BG, negativeFill: function () { return $.Ql($.Ql($.Ql($.Ql(this.sourceColor)))) }, negativeStroke: function () { return $.Ql($.Ql($.Ql($.Ql($.Ql(this.sourceColor))))) },
                                negativeHatchFill: null
                            }, selected: { negativeFill: function () { return $.Ql($.Ql($.Ql(this.sourceColor))) }, negativeStroke: function () { return $.Ql($.Ql($.Ql($.Ql(this.sourceColor)))) }, negativeHatchFill: null }, displayNegative: !1, legendItem: { iconStroke: "none" }
                        }, areaLike: { normal: { fill: $.AG }, hovered: { fill: $.AG, markers: { enabled: !0 } }, selected: { markers: { enabled: !0 } }, legendItem: { iconStroke: "none" }, stepDirection: "center" }, barLike: { normal: { fill: $.CG }, hovered: { fill: $.AG }, legendItem: { iconStroke: "none" } }, lineLike: {
                            hovered: { markers: { enabled: !0 } },
                            selected: { markers: { enabled: !0 } }, stepDirection: "center"
                        }, rangeLike: { normal: { labels: { format: function () { return $.uG(this.high) }, position: "high" }, markers: { position: "high" } }, tooltip: { format: $.IG } }, candlestick: {
                            normal: { risingFill: "#64b5f6", risingStroke: "#64b5f6", fallingFill: "#ef6c00", fallingStroke: "#ef6c00", risingHatchFill: !1, fallingHatchFill: !1, markers: { position: "high" }, labels: { position: "high", format: xG } }, hovered: {
                                risingFill: $.EG, risingStroke: $.DG, fallingFill: $.EG, fallingStroke: $.DG, risingHatchFill: null,
                                fallingHatchFill: null
                            }, selected: { risingFill: "#333 0.85", risingStroke: "#333 0.85", fallingFill: "#333 0.85", fallingStroke: "#333 0.85", risingHatchFill: null, fallingHatchFill: null }, tooltip: { format: JG }
                        }, column: { isVertical: !1, normal: { labels: { offsetY: 3 } } }, ohlc: { normal: { risingStroke: "#64b5f6", fallingStroke: "#ef6c00", markers: { position: "high" }, labels: { position: "high", format: xG } }, hovered: { risingStroke: $.DG, fallingStroke: $.DG }, selected: { risingStroke: "3 #333 0.85", fallingStroke: "3 #333 0.85" }, tooltip: { format: JG } },
                        stick: { normal: { stroke: $.GG } }, jumpLine: { pointWidth: "100%" }, hilo: { pointWidth: 1 }
                    }, chartLabels: [], maxBubbleSize: "20%", minBubbleSize: "5%", a11y: { enabled: !0, titleFormat: $.LG, mode: "chart-elements" }, normal: { labels: { enabled: !1 } }, hovered: { labels: { enabled: null } }, selected: { labels: { enabled: null } }, crossing: { stroke: "none" }, defaultQuarterSettings: { enabled: !1, zIndex: 1, fill: "none", stroke: "none", title: { padding: 5 }, defaultLabelSettings: { text: "Quarter label", anchor: "center", position: "center" }, margin: {}, padding: {} }, quarters: {
                        rightTop: {
                            fill: "#e3f2fd",
                            title: { orientation: "top" }
                        }, leftTop: { title: { orientation: "top" } }, leftBottom: { fill: "#e3f2fd", title: { orientation: "bottom" } }, rightBottom: { title: { orientation: "bottom" } }
                    }, selectMarqueeFill: "#d3d3d3 0.4", selectMarqueeStroke: "#d3d3d3", maxPointWidth: "100%", minPointLength: 0
                }, cartesianBase: {
                    defaultSeriesSettings: {
                        base: { normal: { outlierMarkers: { enabled: null }, labels: { format: "{%Value}{decimalsCount:2}" } }, hovered: { outlierMarkers: { enabled: null } }, selected: { outlierMarkers: { enabled: null } } }, bar: {
                            isVertical: !0, normal: { labels: { offsetY: 3 } },
                            tooltip: { anchor: "left-top" }
                        }, column: { tooltip: { anchor: "left-top" } }, rangeColumn: { isVertical: !1, tooltip: { anchor: "left-top", offsetX: 10 } }, rangeBar: { normal: { labels: { offsetY: 3 } }, isVertical: !0 }, box: {
                            normal: {
                                medianStroke: $.DG, stemStroke: $.DG, whiskerStroke: $.DG, whiskerWidth: 0, outlierMarkers: { enabled: !0, disablePointerEvents: !1, position: "center", rotation: 0, anchor: "center", offsetX: 0, offsetY: 0, type: "circle", size: 3, positionFormatter: $.vG }, markers: { position: "median" }, labels: {
                                    position: "highest", format: function () {
                                        return "Highest: " +
                                            $.uG(this.highest) + "\nMedian: " + $.uG(this.median) + "\nLowest: " + $.uG(this.lowest)
                                    }
                                }
                            }, hovered: { medianStroke: $.yG, stemStroke: $.yG, whiskerStroke: $.DG, whiskerWidth: null, outlierMarkers: { enabled: null, size: 4 } }, selected: { medianStroke: "#333 0.85", stemStroke: "#333 0.85", whiskerStroke: "#333 0.85", whiskerWidth: null, outlierMarkers: { enabled: null, size: 4, fill: "#333 0.85", stroke: "1.5 #212121" } }, tooltip: {
                                titleFormat: function () { return this.name || this.x }, format: function () {
                                    return "Lowest: " + this.valuePrefix + $.uG(this.lowest) +
                                        this.valuePostfix + "\nQ1: " + this.valuePrefix + $.uG(this.q1) + this.valuePostfix + "\nMedian: " + this.valuePrefix + $.uG(this.median) + this.valuePostfix + "\nQ3: " + this.valuePrefix + $.uG(this.q3) + this.valuePostfix + "\nHighest: " + this.valuePrefix + $.uG(this.highest) + this.valuePostfix
                                }
                            }
                        }
                    }, defaultXAxisSettings: { orientation: "bottom", title: { text: "X-Axis", padding: { top: 5, right: 0, bottom: 0, left: 0 } }, labels: { format: "{%Value}{decimalsCount:10}" }, scale: 0 }, defaultYAxisSettings: {
                        orientation: "left", title: {
                            text: "Y-Axis", padding: {
                                top: 0,
                                right: 0, bottom: 5, left: 0
                            }
                        }, labels: { format: "{%Value}{decimalsCount:10}" }, scale: 1
                    }, defaultAnnotationSettings: {}, annotations: { annotationsList: [], zIndex: 2E3 }, xAxes: [{}], yAxes: [{}], xGrids: [], yGrids: [], xMinorGrids: [], yMinorGrids: [], series: [], lineAxesMarkers: [], rangeAxesMarkers: [], textAxesMarkers: [], xScale: 0, yScale: 1, barsPadding: .4, barGroupsPadding: .8, maxBubbleSize: "20%", minBubbleSize: "5%", isVertical: !1, scales: [{ type: "ordinal" }, { type: "linear" }], crosshair: {
                        enabled: !1, displayMode: "float", xStroke: "#969EA5",
                        yStroke: "#969EA5", zIndex: 41
                    }, xZoom: { continuous: !0, startRatio: 0, endRatio: 1 }, a11y: { titleFormat: $.MG }
                }, pieFunnelPyramidBase: {
                    mode3d: !1, animation: { duration: 500 }, normal: { fill: $.yG, stroke: "none", hatchFill: null, labels: { enabled: !0, fontColor: null, position: "inside", disablePointerEvents: !1, autoRotate: !1, zIndex: 34, format: function () { return this.name ? this.name : this.x } }, markers: { enabled: !1, position: "center", positionFormatter: $.vG, zIndex: 33 } }, hovered: { fill: $.EG, stroke: $.yG, labels: { enabled: null }, markers: { enabled: null } },
                    selected: { fill: "#333 0.85", stroke: "1.5 #212121", labels: { enabled: null }, markers: { enabled: null } }, connectorStroke: "#CECECE", overlapMode: "no-overlap", connectorLength: 20, baseWidth: "70%", neckWidth: null, neckHeight: null, pointsPadding: 0, forceHoverLabels: !1, outsideLabels: { disablePointerEvents: !1, autoColor: "#545f69" }, insideLabels: { disablePointerEvents: !0, autoColor: "#ffffff" }, legend: { enabled: !0, padding: { top: 10, right: 10, bottom: 0, left: 10 }, position: "bottom" }, tooltip: {
                        title: { enabled: !0 }, separator: { enabled: !0 }, titleFormat: function () {
                            return this.name ||
                                this.x
                        }, format: function () { return "Value: " + $.uG(this.value) + "\nPercent Value: " + (100 * this.value / this.getStat("sum")).toFixed(1) + "%" }
                    }, interactivity: { hoverMode: "single" }
                }, defaultScrollBar: { barSize: 10, backgroundFill: "#e0e0e0", backgroundStroke: "#d5d5d5", sliderFill: "#d5d5d5", sliderStroke: "#656565", mouseOverOpacity: .45, mouseOutOpacity: .25, handlePositionChange: !0, startRatio: "0", endRatio: "1", buttonsVisible: !1, cornersRadius: 5 }, defaultDataGrid: {
                    isStandalone: !0, headerHeight: 25, backgroundFill: "#fff", columnStroke: "#cecece",
                    rowStroke: "#cecece", rowOddFill: "#fff", rowEvenFill: "#fff", rowFill: "#fff", hoverFill: "#F8FAFB", rowSelectedFill: "#ebf1f4", zIndex: 5, editing: !1, editStructurePreviewFill: { color: "#4285F4", opacity: .2 }, editStructurePreviewStroke: { color: "#4285F4", thickness: 2 }, editStructurePreviewDashStroke: { color: "#4285F4", dash: "4 4" }, headerFill: "#f7f7f7", tooltip: {
                        padding: 5, title: { enabled: !0, fontSize: "14px", fontWeight: "normal", fontColor: "#e5e5e5" }, separator: { enabled: !0 }, format: function () {
                            var a = this.name; return void 0 !== a ? a +
                                "" : ""
                        }
                    }, defaultColumnSettings: { width: 90, buttonCursor: "pointer", cellTextSettings: { enabled: !0, wordBreak: "break-all", anchor: "left-top", vAlign: "middle", padding: { top: 0, right: 5, bottom: 0, left: 5 }, background: null, fontSize: 11, disablePointerEvents: !0 }, depthPaddingMultiplier: 0, collapseExpandButtons: !1, title: { enabled: !0, margin: 0, vAlign: "middle", background: { enabled: !1 } }, format: function () { return "" } }, columns: [{ width: 50, format: function () { var a = this.item.meta("index"); return null != a ? a + 1 + "" : "" }, title: { text: "#" } }, {
                        width: 170,
                        collapseExpandButtons: !0, depthPaddingMultiplier: 15, format: function () { var a = this.name; return null != a ? a + "" : "" }, title: { text: "Name" }
                    }]
                }, defaultTimeline: {
                    isStandalone: !0, columnStroke: "#cecece", rowStroke: "#cecece", backgroundFill: "none", rowOddFill: "#fff", rowEvenFill: "#fff", rowFill: "#fff", hoverFill: "#F8FAFB", rowSelectedFill: "#ebf1f4", zIndex: 5, headerHeight: 70, editing: !1, connectorPreviewStroke: { color: "#545f69", dash: "3 3" }, editPreviewFill: { color: "#fff", opacity: 1E-5 }, editPreviewStroke: { color: "#aaa", dash: "3 3" },
                    ...
                    selectedElementStroke: "#bc5704", selectedConnectorStroke: "2 #bc5704", baselineAbove: !1, tooltip: { padding: 5, title: { enabled: !0, fontSize: "14px", fontWeight: "normal", fontColor: "#e5e5e5" }, separator: { enabled: !0 }, zIndex: 100, allowLeaveChart: !1 }, labels: { enabled: !0, anchor: "left-center", position: "right-center", padding: { top: 3, right: 5, bottom: 3, left: 5 }, vAlign: "middle", background: null, fontSize: 11, zIndex: 40, disablePointerEvents: !0 }, markers: { anchor: "center-top", zIndex: 50, type: "star5", fill: "#ff0", stroke: "2 red" }, defaultLineMarkerSettings: {
                        layout: "vertical",
                        zIndex: 1.5
                    }, defaultRangeMarkerSettings: { layout: "vertical", zIndex: 1 }, defaultTextMarkerSettings: { layout: "vertical", zIndex: 2 }, header: {
                        backgroundFill: "#cecece", levelsSeparationStroke: "#cecece", topLevel: { tileFill: "#f7f7f7", tilesSeparationStroke: "#cecece", labels: { enabled: !0, anchor: "left-top", fontSize: 10, vAlign: "middle", padding: { top: 0, right: 5, bottom: 0, left: 5 }, background: null, disablePointerEvents: !0 } }, midLevel: {
                            tileFill: "#f7f7f7", tilesSeparationStroke: "#cecece", labels: {
                                enabled: !0, anchor: "left-top", fontSize: 10,
                                vAlign: "middle", padding: { top: 0, right: 5, bottom: 0, left: 5 }, background: null, disablePointerEvents: !0
                            }
                        }, lowLevel: { tileFill: "#f7f7f7", tilesSeparationStroke: "#cecece", labels: { enabled: !0, anchor: "left-top", fontSize: 10, vAlign: "middle", padding: { top: 0, right: 5, bottom: 0, left: 5 }, background: null, disablePointerEvents: !0 } }
                    }
                }, standalones: {
                    background: { enabled: !0, zIndex: 0 }, label: {
                        enabled: !0, text: "Label text", padding: 0, width: null, height: null, anchor: "left-top", position: "left-top", offsetX: 0, offsetY: 0, minFontSize: 8, maxFontSize: 72,
                        adjustFontSize: { width: !1, height: !1 }, rotation: 0, zIndex: 0
                    }, labelsFactory: { enabled: !0, zIndex: 0 }, legend: { enabled: !0, zIndex: 0 }, markersFactory: { enabled: !0, zIndex: 0 }, title: { enabled: !0, zIndex: 0 }, linearAxis: { enabled: !0, zIndex: 0, ticks: { enabled: !0 }, minorTicks: { enabled: !0 } }, polarAxis: { enabled: !0, startAngle: 0, zIndex: 0, ticks: { enabled: !0 }, minorTicks: { enabled: !0 } }, radarAxis: { enabled: !0, startAngle: 0, zIndex: 0, ticks: { enabled: !0 }, minorTicks: { enabled: !0 } }, radialAxis: {
                        enabled: !0, startAngle: 0, zIndex: 0, ticks: { enabled: !0 },
                        minorTicks: { enabled: !0 }, minorLabels: { padding: { top: 1, right: 1, bottom: 0, left: 1 } }
                    }, linearGrid: { enabled: !0, scale: null, zIndex: 0 }, polarGrid: { enabled: !0, layout: "circuit", zIndex: 0 }, radarGrid: { enabled: !0, layout: "circuit", zIndex: 0 }, lineAxisMarker: { enabled: !0, zIndex: 0 }, textAxisMarker: { enabled: !0, zIndex: 0 }, rangeAxisMarker: { enabled: !0, zIndex: 0 }, scroller: { enabled: !0 }
                }
            });
        }).call(this, $)
    }
