...
{
    [Migration(20251218112100)]
    public class DefaultDB_20251218_112100_KKFinmartInitialProcess : Migration
    {
        public override void Up()
        {
            Create.Table("MISInitialProcess")
                ...
                .WithColumn("ProductId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_ProductId_Id", "dbo", "TypesOfProducts", "Id")
                ...
                .WithColumn("BusinessDetailId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_BusinessDetailId_Id", "dbo", "BusinessDetails", "Id")
                .WithColumn("CompanyTypeId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_CompanytypeId_Id", "dbo", "TypesOfCompanies", "Id")
                .WithColumn("AccountTypeId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_AccountTypeId_Id", "dbo", "TypesOfAccounts", "Id")
                ...
                .WithColumn("MonthId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_MonthId_Id", "dbo", "MonthsInYear", "Id")

                // Bank / Financial
                .WithColumn("BankNameId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_BankNameId_Id", "dbo", "BankName", "Id")
                .WithColumn("LoanAccountNumber").AsString(200).Nullable()
                .WithColumn("PrimeEmergingId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_PrimeEmergingId_Id", "dbo", "PrimeEmerging", "Id")
                .WithColumn("MISDirectIndirectId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_MISDirectIndirectId_Id", "dbo", "MISDirectIndirect", "Id")
                .WithColumn("InhouseBankId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_InhouseBankId_Id", "dbo", "InHouseBank", "Id")
                ...
                // Status / Remarks
                .WithColumn("LogInLoanStatusId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_LogInLoanStatusId_Id", "dbo", "LogInLoanStatus", "Id")
                .WithColumn("SalesLoanStatusId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_SalesLoanStatusId_Id", "dbo", "SalesLoanStatus", "Id")
                .WithColumn("MISDisbursementStatusId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_MISDisbursementStatusId_Id", "dbo", "MISDisbursementStatus", "Id")
            ...
            .WithColumn("OwnerId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_OwnerId_UserId", "dbo", "Users", "UserId")
            .WithColumn("AssignedId").AsInt32().Nullable().ForeignKey("FK_MISInitialProcess_AssignedId_UserId", "dbo", "Users", "UserId");
