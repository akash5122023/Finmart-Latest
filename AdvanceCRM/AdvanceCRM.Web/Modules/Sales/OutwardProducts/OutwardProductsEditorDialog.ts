...
namespace AdvanceCRM.Sales {
    ...
    export class OutwardProductsEditorDialog extends Common.GridEditorDialog<OutwardProductsRow> {
        protected getFormKey() { return OutwardProductsForm.formKey; }
        protected getLocalTextPrefix() { return OutwardProductsRow.localTextPrefix; }
        protected getNameProperty() { return OutwardProductsRow.nameProperty; }

        protected form = new OutwardProductsForm(this.idPrefix);
