...
namespace AdvanceCRM.Sales
{
    ...
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[SalesCharges]")]
    [DisplayName("Sales Charges"), InstanceName("Sales Charges")]
    [ReadPermission("Sales:Read")]
    [ModifyPermission("Sales:Read")]
    public sealed class SalesChargesRow : Row<SalesChargesRow.RowFields>, IIdRow
    {
        ...
        public SalesChargesRow()
            : base(Fields)
        {
        }
        public SalesChargesRow(RowFields fields)
            : base(Fields)
        {
        }
