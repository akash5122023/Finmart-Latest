...
namespace AdvanceCRM.Sales
{
    ...
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[SalesConcession]")]
    [DisplayName("Sales Concession"), InstanceName("Sales Concession")]
    [ReadPermission("Sales:Read")]
    [ModifyPermission("Sales:Read")]
    public sealed class SalesConcessionRow : Row<SalesConcessionRow.RowFields>, IIdRow
    {
        ...
        public SalesConcessionRow()
            : base(Fields)
        {
        }
        
        public SalesConcessionRow(RowFields fields)
            : base(Fields)
        {
        }
