...
namespace AdvanceCRM.Sales
{
    ...
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[InvoiceCharges]")]
    [DisplayName("Invoice Charges"), InstanceName("Invoice Charges")]
    [ReadPermission("Proforma:Read")]
    [ModifyPermission("Proforma:Read")]
    public sealed class InvoiceChargesRow : Row<InvoiceChargesRow.RowFields>, IIdRow
    {
        ...
        public InvoiceChargesRow(RowFields fields)
            : base(Fields)
        {
        }
