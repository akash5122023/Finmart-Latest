...
namespace AdvanceCRM.Sales {
    ...
    export class SalesReturnProductsEditorDialog extends Common.GridEditorDialog<SalesReturnProductsRow> {
        protected getFormKey() { return SalesReturnProductsForm.formKey; }
        protected getLocalTextPrefix() { return SalesReturnProductsRow.localTextPrefix; }
        protected getNameProperty() { return SalesReturnProductsRow.nameProperty; }
        protected form = new SalesReturnProductsForm(this.idPrefix);
