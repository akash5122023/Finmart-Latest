...
namespace AdvanceCRM.Sales
{
    ...
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[InvoiceFollowups]")]
    [DisplayName("Invoice Followups"), InstanceName("Invoice Followups")]
    [ReadPermission("?")]
    [ModifyPermission("Proforma:Followups")]

    public sealed class InvoiceFollowupsRow : Row<InvoiceFollowupsRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [Expression("jInvoice.[ContactsId]")]
        ...
        [LookupEditor(typeof(SubContactsRow))] //added
        ...
        public InvoiceFollowupsRow()
            : base(Fields)
        {
        }

        public InvoiceFollowupsRow(RowFields fields)
            : base(Fields)
        {
        }
