...
{
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[Inward]")]
    [DisplayName("Inward"), InstanceName("Inward")]
    [ReadPermission("Inward:Read")]
    [InsertPermission("Inward:Insert")]
    [UpdatePermission("Inward:Update")]
    [DeletePermission("Inward:Delete")]
    [LookupScript("Sales.Inward", Permission = "?")]
    public sealed class InwardRow : Row<InwardRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Shipping Address"), NameProperty]
        [BooleanSwitchEditor]
        ...
        [MultipleImageUploadEditor(FilenameFormat = "Inward/~", CopyToHistory = true, AllowNonImage = true)]
        ...
        [DisplayName("Outward Id")]
        public Int32? OutwardId
        {
            get { return Fields.OutwardId[this]; }
        ...
        [DisplayName("Products"), MasterDetailRelation(foreignKey: "InwardId", IncludeColumns = "ProductsName"), NotMapped]
        public List<InwardProductsRow> Products { get { return Fields.Products[this]; } set { Fields.Products[this] = value; } }
        ...
        public InwardRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public readonly RowListField<InwardProductsRow> Products;
