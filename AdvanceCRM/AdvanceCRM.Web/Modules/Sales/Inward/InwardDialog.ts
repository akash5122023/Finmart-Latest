...
namespace AdvanceCRM.Sales {
    ...
    export class InwardDialog extends DialogBase<InwardRow, any> {
        protected getFormKey() { return InwardForm.formKey; }
        protected getIdProperty() { return InwardRow.idProperty; }
        protected getLocalTextPrefix() { return InwardRow.localTextPrefix; }
        protected getNameProperty() { return InwardRow.nameProperty; }
        protected getService() { return InwardService.baseUrl; }
        protected getDeletePermission() { return InwardRow.deletePermission; }
        protected getInsertPermission() { return InwardRow.insertPermission; }
        protected getUpdatePermission() { return InwardRow.updatePermission; }

        protected form = new InwardForm(this.idPrefix);
        constructor() {
            super();
            ...
            Common.NavigationService.MultiLocation({},
                response => {
                    if (response.Status != "Remove") {
                        ...
                        if (Authorization.hasPermission("Inward:Change Branch")) {
        ...
        getToolbarButtons() {
            ...
            buttons.push(AdvanceCRM.Common.ReportHelper.createToolButton({
                ...
                reportKey: 'Inward.PrintInward',
                getParams: () => ({ Id: this.get_entityId(), ModType: "Inward" }), //ModType Quotation, Invoice
