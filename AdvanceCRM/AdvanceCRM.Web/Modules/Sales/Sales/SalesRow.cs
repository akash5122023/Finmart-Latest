...
namespace AdvanceCRM.Sales
{
    ...
    [InsertPermission("Sales:Insert")]
    [UpdatePermission("Sales:Update")]
    [DeletePermission("Sales:Delete")]
    [LookupScript("Sales.Sales", Permission = "?")]
    public sealed class SalesRow : Row<SalesRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog, IMultiCompanyRow
    {
        ...
        [DisplayName("Date"), NotNull, LookupInclude]
        ...
        [DisplayName("Quotation N"), Size(100)]
        ...
        [DisplayName("Additional Info"), Size(200), QuickSearch, TextAreaEditor(Rows = 4),NameProperty]
        ...
        [DisplayName("Invoice N"), Size(100), NotNull]
        public String InvoiceN
        {
            get { return Fields.InvoiceN[this]; }
            set { Fields.InvoiceN[this] = value; }
        }
        ...
        [DisplayName("Message"), ForeignKey("[dbo].[MessageMaster]", "Id"), LeftJoin("jMessage"), TextualField("Message"), LookupInclude]
        ...
        [DisplayName("Shipping Address"),Hint("Select Yes to print Shipping Address")]
        [BooleanSwitchEditor]
        ...
        [DisplayName("Shipping Address"), Size(1000), TextAreaEditor(Rows = 4)]
        ...
        [DisplayName("Invoice No"), NotNull, LookupInclude]
        ...
        [DisplayName("Ecom Type"), DefaultValue("2")]
        public Masters.GSTEcomTypeMaster? EcomType
        {
            get { return (Masters.GSTEcomTypeMaster?)Fields.EcomType[this]; }
            set { Fields.EcomType[this] = (Int32?)value; }
        }
        ...
        [DisplayName("Trasportation"), ForeignKey("[dbo].[Transportation]", "Id"), LeftJoin("jTrasportation"), TextualField("TrasportationName")]
        ...
        [DisplayName("P.O No"), Size(1024)]
        public String PurchaseOrderNo
        {
            get { return Fields.PurchaseOrderNo[this]; }
        ...
        [MultipleImageUploadEditor(FilenameFormat = "Sales/~", CopyToHistory = true, AllowNonImage = true)]
        public String Attachments
        {
            get { return Fields.Attachments[this]; }
            set { Fields.Attachments[this] = value; }
        }
        [DisplayName("Billing Address"), Hint("Select Yes to print Billing Address"), DefaultValue(true)]
        [BooleanSwitchEditor]
        public Boolean? BillingAddress
        {
            get { return Fields.BillingAddress[this]; }
        ...
        [DisplayName("Contact Person Name"), Expression("jContactPerson.[Name]"),
            MinSelectLevel(SelectLevel.List), QuickSearch]
        ...
        [DisplayName("Contact Person Address"), Expression("jContactPerson.[Address]"), TextAreaEditor(Rows = 4)]
        ...
        [DisplayName("Trasportation Name"), Expression("jTrasportation.[Name]")]
        public String TrasportationName
        {
            get { return Fields.TrasportationName[this]; }
            set { Fields.TrasportationName[this] = value; }
        }

        [DisplayName("Trasportation Address"), Expression("jTrasportation.[Address]")]
        public String TrasportationAddress
        {
            get { return Fields.TrasportationAddress[this]; }
            set { Fields.TrasportationAddress[this] = value; }
        }

        [DisplayName("Trasportation Phone"), Expression("jTrasportation.[Phone]")]
        public String TrasportationPhone
        {
            get { return Fields.TrasportationPhone[this]; }
            set { Fields.TrasportationPhone[this] = value; }
        }

        [DisplayName("Trasportation Email"), Expression("jTrasportation.[Email]")]
        public String TrasportationEmail
        {
            get { return Fields.TrasportationEmail[this]; }
            set { Fields.TrasportationEmail[this] = value; }
        }

        [DisplayName("Trasportation Contact Person"), Expression("jTrasportation.[ContactPerson]")]
        public String TrasportationContactPerson
        {
            get { return Fields.TrasportationContactPerson[this]; }
            set { Fields.TrasportationContactPerson[this] = value; }
        }

        [DisplayName("Trasportation Contact Person Phone"), Expression("jTrasportation.[ContactPersonPhone]")]
        public String TrasportationContactPersonPhone
        {
            get { return Fields.TrasportationContactPersonPhone[this]; }
            set { Fields.TrasportationContactPersonPhone[this] = value; }
        }

        [DisplayName("Trasportation GSTIN"), Expression("jTrasportation.[GSTIN]")]
        public String TrasportationGstin
        {
            get { return Fields.TrasportationGstin[this]; }
            set { Fields.TrasportationGstin[this] = value; }
        }
        ...
        [DisplayName("Products"), MasterDetailRelation(foreignKey: "SalesId", IncludeColumns = "ProductsName"), NotMapped]
        public List<SalesProductsRow> Products { get { return Fields.Products[this]; } set { Fields.Products[this] = value; } }

        [DisplayName("Terms")]
        [LookupEditor(typeof(QuotationTermsMasterRow), Multiple = true, InplaceAdd = true), NotMapped]
        [LinkingSetRelation(typeof(SalesTermsRow), "SalesId", "TermsId")]
        ...
        [LinkingSetRelation(typeof(SalesChargesRow), "SalesId", "ChargesId")]
        ...
        [LinkingSetRelation(typeof(SalesConcessionRow), "SalesId", "ConcessionId")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public BooleanField BillingAddress;
            ...
            public StringField TrasportationName;
            public StringField TrasportationAddress;
            public StringField TrasportationPhone;
            public StringField TrasportationEmail;
            public StringField TrasportationContactPerson;
            public StringField TrasportationContactPersonPhone;
            public StringField TrasportationGstin;
            ...
            public readonly RowListField<SalesProductsRow> Products;
