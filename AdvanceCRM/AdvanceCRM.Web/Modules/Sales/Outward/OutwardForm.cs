...
{
    [FormScript("Sales.Outward")]
    [BasedOnRow(typeof(OutwardRow), CheckNames = true)]
    public class OutwardForm
    {
        ...
        [OutwardProductsEditor]
        public List<OutwardProductsRow> Products { get; set; }
        [OneThirdWidth]
