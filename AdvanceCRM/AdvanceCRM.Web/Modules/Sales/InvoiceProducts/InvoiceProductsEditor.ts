...
namespace AdvanceCRM.Sales {
    ...
    export class InvoiceProductsEditor extends Common.GridEditorBase<InvoiceProductsRow> {
        protected getColumnsKey() { return 'Sales.InvoiceProducts'; }
        protected getDialogType() { return InvoiceProductsEditorDialog; }
        ...
        validateEntity(row: InvoiceProductsRow, id) {
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as InvoiceProductsEditorDialog).ContactsIdD = this.ContactsId;
        }
