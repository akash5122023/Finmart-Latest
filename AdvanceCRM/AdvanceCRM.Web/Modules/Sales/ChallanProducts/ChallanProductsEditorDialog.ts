...
namespace AdvanceCRM.Sales {
    ...
    export class ChallanProductsEditorDialog extends Common.GridEditorDialog<ChallanProductsRow> {
        protected getFormKey() { return ChallanProductsForm.formKey; }
        protected getLocalTextPrefix() { return ChallanProductsRow.localTextPrefix; }
        protected getNameProperty() { return ChallanProductsRow.nameProperty; }
        protected form = new ChallanProductsForm(this.idPrefix);
