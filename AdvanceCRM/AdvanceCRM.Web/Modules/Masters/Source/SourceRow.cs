...
namespace AdvanceCRM.Masters
{
    ...
    [ConnectionKey("Default"), Module("Masters"), TableName("[dbo].[Source]")]
    [DisplayName("Source"), InstanceName("Source")]
    [ReadPermission("Masters:Read")]
    [ModifyPermission("Masters:Modify")]
    [LookupScript("Masters.Source", Permission = "?")]
    public sealed class SourceRow : Row<SourceRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Source"), Size(200), NotNull, QuickSearch, LookupInclude, Unique,NameProperty]
