...
namespace AdvanceCRM.Masters
{
    ...
    [LookupScript("Masters.Stage", Permission = "?", LookupType = typeof(MultiCompanyRowLookupScript<>))]
    public sealed class StageRow : Row<StageRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog, IMultiCompanyRow
    {
