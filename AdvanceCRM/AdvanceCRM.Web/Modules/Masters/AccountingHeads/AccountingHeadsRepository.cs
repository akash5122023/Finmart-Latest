...
namespace AdvanceCRM.Masters.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = AccountingHeadsRow;

    public class AccountingHeadsRepository : BaseRepository
    {
    public AccountingHeadsRepository(IRequestContext context) : base(context) { }
        ...
        {
            if (request.Entity.Id < 47)
            {
                throw new Exception("Cannot update basic accounting head\nYou can only update heads added manually");
            }
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request)
        {
            if (fld.Id < 100)
            {
                throw new Exception("Cannot delete basic accounting head\nYou can only delete heads added manually");
            }
