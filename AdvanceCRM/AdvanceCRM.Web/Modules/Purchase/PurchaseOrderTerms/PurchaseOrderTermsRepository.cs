...
namespace AdvanceCRM.PurchaseOrder.Repositories
{
    using Serenity;
    ...
    public class PurchaseOrderTermsRepository : BaseRepository
    {
    public PurchaseOrderTermsRepository(IRequestContext context) : base(context) { }
