...
{
    [ConnectionKey("Default"), Module("Purchase"), TableName("[dbo].[GrnTwo]")]
    [DisplayName("GRN"), InstanceName("GRN")]
    [ReadPermission("GrnTwo:Read")]
    [InsertPermission("GrnTwo:Insert")]
    [UpdatePermission("GrnTwo:Update")]
    [DeletePermission("GrnTwo:Delete")]
    [LookupScript("Purchase.GrnTwo", Permission = "?")]
    public sealed class GrnTwoRow : Row<GrnTwoRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Grn Date"), NotNull]
        public DateTime? GrnDate
        {
            get => fields.GrnDate[this];
            set => fields.GrnDate[this] = value;
        }

        [DisplayName("GRN Type"), NotNull]
        [DefaultValue(GrnTypeMaster.WithPO)]
        public GrnTypeMaster? GrnType
        {
            get => (GrnTypeMaster?)Fields.GrnType[this];  
            set => Fields.GrnType[this] = (int?)value;    
        }

        [DisplayName("Po"), Size(255), QuickSearch, NameProperty]
        public String Po
        {
            get => fields.Po[this];
        ...
        {
            get => fields.PoDate[this];
            set => fields.PoDate[this] = value;
        }

        [DisplayName("Owner"), NotNull, ForeignKey("[dbo].[Users]", "UserId"), LeftJoin("jOwner"), TextualField("OwnerUsername"), ReadOnly(true)]
        ...
        [DisplayName("Description"), Size(500), TextAreaEditor(Rows = 4)]
        ...
        [DisplayName("Products"), MasterDetailRelation(foreignKey: "GrnId", IncludeColumns = "ProductsName"), NotMapped]
        public List<GrnProductsTwoRow> Products { get { return Fields.Products[this]; } set { Fields.Products[this] = value; } }
        ...
        public GrnTwoRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field GrnType;
            public StringField Po;
            public DateTimeField PoDate;
            ...
            public readonly RowListField<GrnProductsTwoRow> Products;
