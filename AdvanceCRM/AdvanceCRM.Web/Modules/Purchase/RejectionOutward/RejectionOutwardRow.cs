...
{
    [ConnectionKey("Default"), Module("Purchase"), TableName("[dbo].[RejectionOutward]")]
    [DisplayName("Rejection Outward"), InstanceName("Rejection Outward")]
    [ReadPermission("RejectionOutward:Read")]
    [InsertPermission("RejectionOutward:Insert")]
    [UpdatePermission("RejectionOutward:Update")]
    [DeletePermission("RejectionOutward:Delete")]
    [LookupScript("Purchase.RejectionOutwardRow", Permission = "?")]
    public sealed class RejectionOutwardRow : Row<RejectionOutwardRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Product"), ForeignKey("[dbo].[Products]", "Id"), LeftJoin("jProduct"), TextualField("ProductName"), NameProperty]
        ...
        [DisplayName("Sent To Supplier"), NotNull]
        [BooleanSwitchEditor]
        public Boolean? SentToSupplier
        {
            get => fields.SentToSupplier[this];
            set => fields.SentToSupplier[this] = value;
        }
        ...
        public RejectionOutwardRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public BooleanField SentToSupplier;
