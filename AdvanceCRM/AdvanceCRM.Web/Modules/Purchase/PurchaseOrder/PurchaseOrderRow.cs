...
namespace AdvanceCRM.Purchase
{
    ...
    [LookupScript("Purchase.PurchaseOrderRow", Permission = "?")]
    public sealed class PurchaseOrderRow : Row<PurchaseOrderRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Total"), Expression("IIF([CurrencyConversion] = 1,(SELECT SUM((Price * Quantity) - ((DiscountAmount) + ((Price * Quantity) * (Discount / 100)))) FROM PurchaseOrderProducts WHERE PurchaseOrderId = t0.[Id]),(SELECT SUM((((Price * Quantity) - ((DiscountAmount) + ((Price * Quantity) * (Discount / 100)))) + (((Price * Quantity) - ((DiscountAmount) + ((Price * Quantity) * (Discount / 100)))) * (Percentage1 / 100)) + (((Price * Quantity) - ((DiscountAmount) + ((Price * Quantity) * (Discount / 100)))) * (Percentage2 / 100)))) FROM PurchaseOrderProducts WHERE PurchaseOrderId=t0.[Id])) + COALESCE(t0.[Roundup], 0)")]
        public Double? Total
        {
        ...
        [DisplayName("Terms"), Size(2000), TextAreaEditor(Rows = 4)]
        public String Terms
        {
        ...
        [MultipleImageUploadEditor(FilenameFormat = "PurchaseOrder/~", CopyToHistory = true, AllowNonImage = true)]
        ...
        [MasterDetailRelation(foreignKey: "PurchaseOrderId", IncludeColumns = "ProductsName")]
        [DisplayName("Products"), NotMapped]
        [BooleanSwitchEditor]
        public List<PurchaseOrderProductsRow> Products { get { return Fields.Products[this]; } set { Fields.Products[this] = value; } }


        [DisplayName("Terms")]
        [LookupEditor(typeof(QuotationTermsMasterRow), Multiple = true, InplaceAdd = true), NotMapped]
        [LinkingSetRelation(typeof(PurchaseOrderTermsRow), "PurchaseOrderId", "TermsId")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field PurchaseOrderNo;
            ...
            public readonly RowListField<PurchaseOrderProductsRow> Products;
