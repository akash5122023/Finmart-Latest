...
namespace AdvanceCRM.Purchase
{
    ...
    [LookupScript("Purchase.PurchaseReturnRow", Permission = "?")]
    public sealed class PurchaseReturnRow : Row<PurchaseReturnRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Amount"), Expression("(SELECT SUM((Price * Quantity) + ((Price * Quantity) * (Percentage1 / 100)) + ((Price * Quantity) * (Percentage2 / 100))) FROM PurchaseReturnProducts WHERE PurchaseReturnId=t0.[Id])")]
        ...
        [DisplayName("Lines"), DefaultValue(10)]
        public Int32? Lines
        {
        ...
        [DisplayName("Products"), MasterDetailRelation(foreignKey: "PurchaseReturnId", IncludeColumns = "ProductsId,ProductsName"), NotMapped]
        public List<PurchaseReturnProductsRow> Products { get { return Fields.Products[this]; } set { Fields.Products[this] = value; } }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public readonly RowListField<PurchaseReturnProductsRow> Products;
