...
namespace AdvanceCRM.Purchase {
    ...
    export class PurchaseOrderProductsEditor extends Common.GridEditorBase<PurchaseOrderProductsRow> {
        protected getColumnsKey() { return 'Purchase.PurchaseOrderProducts'; }
        protected getDialogType() { return PurchaseOrderProductsEditorDialog; }
