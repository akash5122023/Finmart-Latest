...
{
    using AdvanceCRM.Purchase.Repositories;
    using Serenity;
    using Serenity.Data;
    ...
    using MyRepository = Repositories.RorderRepository;
    using MyRow = RorderRow;

    [Route("Services/Purchase/Rorder/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class RorderController : ServiceEndpoint
    {
        ...
        public RorderController(ISqlConnections connections, IRequestContext context)
        {
            _connections = connections;
            Context = context;
        }

        public RorderController()
