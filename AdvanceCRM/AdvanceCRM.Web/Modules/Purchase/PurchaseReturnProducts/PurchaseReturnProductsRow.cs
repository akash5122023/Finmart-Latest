...
namespace AdvanceCRM.Purchase
{
    ...
    [ConnectionKey("Default"), Module("Purchase"), TableName("[dbo].[PurchaseReturnProducts]")]
    [DisplayName("Purchase Return Products"), InstanceName("Purchase Return Products")]
    [ReadPermission("PurchaseReturn:Read")]
    [InsertPermission("PurchaseReturn:Insert")]
    [UpdatePermission("PurchaseReturn:Update")]
    [DeletePermission("PurchaseReturn:Delete")]

    public sealed class PurchaseReturnProductsRow : Row<PurchaseReturnProductsRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Purchase Return"), NotNull, ForeignKey("[dbo].[PurchaseReturn]", "Id"), LeftJoin("jPurchaseReturn"), TextualField("PurchaseReturnInvoiceNo")]
        [LookupEditor(typeof(PurchaseReturnRow), InplaceAdd = true)]
        public Int32? PurchaseReturnId
        {
            get { return Fields.PurchaseReturnId[this]; }
        ...
        [DisplayName("Purchase Return Invoice No"), Expression("jPurchaseReturn.[Invoice No]")]
        public String PurchaseReturnInvoiceNo
        {
            get { return Fields.PurchaseReturnInvoiceNo[this]; }
            set { Fields.PurchaseReturnInvoiceNo[this] = value; }
        }

        [DisplayName("Purchase Return Purchase From Id"), Expression("jPurchaseReturn.[PurchaseFromId]")]
        public Int32? PurchaseReturnPurchaseFromId
        {
            get { return Fields.PurchaseReturnPurchaseFromId[this]; }
            set { Fields.PurchaseReturnPurchaseFromId[this] = value; }
        }

        [DisplayName("Purchase Return Invoice Date"), Expression("jPurchaseReturn.[InvoiceDate]")]
        public DateTime? PurchaseReturnInvoiceDate
        {
            get { return Fields.PurchaseReturnInvoiceDate[this]; }
            set { Fields.PurchaseReturnInvoiceDate[this] = value; }
        }

        [DisplayName("Purchase Return Total"), Expression("jPurchaseReturn.[Total]")]
        public Double? PurchaseReturnTotal
        {
            get { return Fields.PurchaseReturnTotal[this]; }
            set { Fields.PurchaseReturnTotal[this] = value; }
        }

        [DisplayName("Purchase Return Status"), Expression("jPurchaseReturn.[Status]")]
        public Int32? PurchaseReturnStatus
        {
            get { return Fields.PurchaseReturnStatus[this]; }
            set { Fields.PurchaseReturnStatus[this] = value; }
        }

        [DisplayName("Purchase Return Type"), Expression("jPurchaseReturn.[Type]")]
        public Int32? PurchaseReturnType
        {
            get { return Fields.PurchaseReturnType[this]; }
            set { Fields.PurchaseReturnType[this] = value; }
        }

        [DisplayName("Purchase Return Additional Info"), Expression("jPurchaseReturn.[AdditionalInfo]")]
        public String PurchaseReturnAdditionalInfo
        {
            get { return Fields.PurchaseReturnAdditionalInfo[this]; }
            set { Fields.PurchaseReturnAdditionalInfo[this] = value; }
        }

        [DisplayName("Purchase Return Branch Id"), Expression("jPurchaseReturn.[BranchId]")]
        public Int32? PurchaseReturnBranchId
        {
            get { return Fields.PurchaseReturnBranchId[this]; }
            set { Fields.PurchaseReturnBranchId[this] = value; }
        }

        [DisplayName("Purchase Return Owner Id"), Expression("jPurchaseReturn.[OwnerId]")]
        public Int32? PurchaseReturnOwnerId
        {
            get { return Fields.PurchaseReturnOwnerId[this]; }
            set { Fields.PurchaseReturnOwnerId[this] = value; }
        }

        [DisplayName("Purchase Return Assigned Id"), Expression("jPurchaseReturn.[AssignedId]")]
        public Int32? PurchaseReturnAssignedId
        {
            get { return Fields.PurchaseReturnAssignedId[this]; }
            set { Fields.PurchaseReturnAssignedId[this] = value; }
        }

        [DisplayName("Purchase Return Reverse Charge"), Expression("jPurchaseReturn.[ReverseCharge]")]
        public Boolean? PurchaseReturnReverseCharge
        {
            get { return Fields.PurchaseReturnReverseCharge[this]; }
            set { Fields.PurchaseReturnReverseCharge[this] = value; }
        }

        [DisplayName("Purchase Return Invoice Type"), Expression("jPurchaseReturn.[InvoiceType]")]
        public Int32? PurchaseReturnInvoiceType
        {
            get { return Fields.PurchaseReturnInvoiceType[this]; }
            set { Fields.PurchaseReturnInvoiceType[this] = value; }
        }

        [DisplayName("Purchase Return Itc Eligibility"), Expression("jPurchaseReturn.[ITCEligibility]")]
        public Int32? PurchaseReturnItcEligibility
        {
            get { return Fields.PurchaseReturnItcEligibility[this]; }
            set { Fields.PurchaseReturnItcEligibility[this] = value; }
        }
        ...
        [DisplayName("TAX1 Amount"), Expression("((t0.[Price])* (t0.[Percentage1] / 100)) * (t0.[Quantity])"), AlignRight, DisplayFormat("#,##0.00"), MinSelectLevel(SelectLevel.List), LookupInclude]
        ...
        [DisplayName("TAX2 Amount"), Expression("((t0.[Price])* (t0.[Percentage2] / 100)) * (t0.[Quantity])"), AlignRight, DisplayFormat("#,##0.00"), MinSelectLevel(SelectLevel.List), LookupInclude]
        ...
        [DisplayName("Line Total"), Expression("(t0.[Price] * (t0.[Quantity]))"), AlignRight, DisplayFormat("#,##0.00"), MinSelectLevel(SelectLevel.List), LookupInclude]
        ...
        [DisplayName("Grand Total"), Expression("((t0.[Price] * t0.[Quantity]) + ((t0.[Price] * t0.[Quantity]) * (t0.[Percentage1] / 100)) + ((t0.[Price] * t0.[Quantity]) * (t0.[Percentage2] / 100)))"), AlignRight, DisplayFormat("#,##0.00"), MinSelectLevel(SelectLevel.List), LookupInclude]
        ...
        public PurchaseReturnProductsRow()
            : base(Fields)
        {
        }
        
        public PurchaseReturnProductsRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField PurchaseReturnInvoiceNo;
            public Int32Field PurchaseReturnPurchaseFromId;
            public DateTimeField PurchaseReturnInvoiceDate;
            public DoubleField PurchaseReturnTotal;
            public Int32Field PurchaseReturnStatus;
            public Int32Field PurchaseReturnType;
            public StringField PurchaseReturnAdditionalInfo;
            public Int32Field PurchaseReturnBranchId;
            public Int32Field PurchaseReturnOwnerId;
            public Int32Field PurchaseReturnAssignedId;
            public BooleanField PurchaseReturnReverseCharge;
            public Int32Field PurchaseReturnInvoiceType;
            public Int32Field PurchaseReturnItcEligibility;
