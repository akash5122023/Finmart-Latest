...
namespace AdvanceCRM.Purchase {
    ...
    export class PurchaseReturnProductsEditor extends Common.GridEditorBase<PurchaseReturnProductsRow> {
        protected getColumnsKey() { return 'Purchase.PurchaseReturnProducts'; }
        protected getDialogType() { return PurchaseReturnProductsEditorDialog; }
