...
namespace AdvanceCRM.Premium.Repositories
{
    using Serenity;
    ...
    public class TargetSettingRepository : BaseRepository
    {
    public TargetSettingRepository(IRequestContext context) : base(context) { }
