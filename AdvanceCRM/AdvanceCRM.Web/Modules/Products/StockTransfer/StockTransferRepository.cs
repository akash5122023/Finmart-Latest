...
namespace AdvanceCRM.Products.Repositories
{
    ...
    {
    public StockTransferRepository(IRequestContext context) : base(context) { }
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void BeforeSave()
            {
                ...
                if (Request.Entity.FromBranchId == Request.Entity.ToBranchId)
                {
                    throw new Exception("From and To Branch cannot be same");
                }
            }
        }
