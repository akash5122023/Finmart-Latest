...
namespace AdvanceCRM.Products {
    ...
    export class BomProductsEditorDialog extends Common.GridEditorDialog<BomProductsRow> {
        protected getFormKey() { return BomProductsForm.formKey; }
        protected getLocalTextPrefix() { return BomProductsRow.localTextPrefix; }
        protected getNameProperty() { return BomProductsRow.nameProperty; }
        protected form = new BomProductsForm(this.idPrefix);
        ...
        constructor() {
            ...
            this.form.ProductsId.changeSelect2(e => {
                ...
                if (PID != null) {
                    ...
                    this.form.Quantity.value = Products.InventoryRow.getLookup().itemById[PID].Quantity;
                    //StockDetails
        ...
        onDialogOpen() {
            ...
            var PID = Q.toId(this.form.ProductsId.value);
            if (PID != null) {
                this.form.Code.value = Products.InventoryRow.getLookup().itemById[PID].Code;
            }
        }
