...
namespace AdvanceCRM.Itinerary.Repositories
{
    using Serenity;
    ...
    public class ItineraryTermRepository : BaseRepository
    {
    public ItineraryTermRepository(IRequestContext context) : base(context) { }
