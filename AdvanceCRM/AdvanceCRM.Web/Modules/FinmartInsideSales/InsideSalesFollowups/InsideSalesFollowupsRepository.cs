namespace AdvanceCRM.FinmartInsideSales.Repositories
{
    using Serenity;
    using Serenity.Data;
    ...
    public class InsideSalesFollowupsRepository : BaseRepository
    {
        public InsideSalesFollowupsRepository(IRequestContext context)
            : base(context)
        {
        }
