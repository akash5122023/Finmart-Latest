...
namespace AdvanceCRM.ThirdParty.Repositories
{
    ...
    public class IndiaMartDetailsRepository : BaseRepository
    {

        public IndiaMartDetailsRepository(IRequestContext context) : base(context) { }

        protected ISqlConnections _connections { get; }

        public IndiaMartDetailsRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
