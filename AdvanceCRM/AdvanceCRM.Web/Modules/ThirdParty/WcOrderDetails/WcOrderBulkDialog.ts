namespace AdvanceCRM.ThirdParty {
    ...
    export class WcOrderBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: WcOrderBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new WcOrderBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        WcOrderDetailsService.BulkMoveToEnquiry({
