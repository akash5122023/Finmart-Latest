namespace AdvanceCRM.ThirdParty {
    ...
    export class TradeIndiaBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: TradeIndiaBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new TradeIndiaBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        TradeIndiaDetailsService.BulkMoveToEnquiry({
