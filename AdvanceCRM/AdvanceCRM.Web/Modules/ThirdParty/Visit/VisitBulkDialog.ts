namespace AdvanceCRM.ThirdParty {
    ...
    export class VisitBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: VisitBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new VisitBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        VisitService.BulkMoveToEnquiry({
