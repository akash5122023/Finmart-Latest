...
namespace AdvanceCRM.ThirdParty.Repositories
{
    ...
    public class VisitRepository : BaseRepository
    {
        ...
        public VisitRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public VisitRepository(IRequestContext context) : base(context) { }
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void BeforeSave()
            {
                ...
                var menq = BizMailVisitRow.Fields;
                ...
                using (var connection1 = _connections.NewFor<BizMailConfigRow>())
                {
                   ...
                   .Where(br.UserId == Context.User.GetIdentifier())
                    ...
                    model.EnqRow = connection1.List<BizMailVisitRow>(q => q
                          .SelectTableFields()
                          .Select(menq.Rule)
       ...
       private class MyRetrieveHandler : RetrieveRequestHandler<MyRow> { public MyRetrieveHandler(IRequestContext context) : base(context) { } }
        ...
        {
            public List<BizMailVisitRow> EnqRow { get; set; }
        }
    }
}