...
public class FacebookDetailsRepository : BaseRepository
{
    protected ISqlConnections _connections { get; }

    public FacebookDetailsRepository(IRequestContext context)
        : base(context)
    {
    }

    public FacebookDetailsRepository(IRequestContext context, ISqlConnections connections)
        : base(context)
    {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void BeforeSave()
            {
                ...
                var menq = BizMailFacebookRow.Fields;
                ...
                using (var connection1 = _connections.NewFor<BizMailConfigRow>())
                {
                   ...
                   .Where(br.UserId == Context.User.GetIdentifier())
                    ...
                    model.EnqRow = connection1.List<BizMailFacebookRow>(q => q
                          .SelectTableFields()
                          .Select(menq.Rule)                      
       ...
       private class MyRetrieveHandler : RetrieveRequestHandler<MyRow> { public MyRetrieveHandler(IRequestContext context) : base(context) { } }
        private class MyListHandler : ListRequestHandler<MyRow>
        {
            ...
            protected override void ApplyFilters(SqlQuery query)
            {
                ...
                //var str = "AdId = '6328307972464'";//6315766909664   //6318836847264 6318836858464  6327270685464
                //query.Where(new Criteria("(" + str + ")"));
            }
        }
        public class MailModel
        {
            public List<BizMailFacebookRow> EnqRow { get; set; }
        }
    }
}