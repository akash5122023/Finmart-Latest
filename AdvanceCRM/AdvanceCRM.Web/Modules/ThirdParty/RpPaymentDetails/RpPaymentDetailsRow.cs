...
namespace AdvanceCRM.ThirdParty
{
    ...
    [ConnectionKey("Default"), Module("ThirdParty"), TableName("[dbo].[RPPaymentDetails]")]
    [DisplayName("Rp Payment Details"), InstanceName("Rp Payment Details")]
    [ReadPermission("RazorPay:Inbox")]
    [ModifyPermission("RazorPay:Inbox")]
    public sealed class RpPaymentDetailsRow : Row<RpPaymentDetailsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Payment Id"), Size(40), NotNull, QuickSearch,NameProperty]
        ...
        [DisplayName("Entity"), Size(20)]
        public String Entity
        {
            get { return Fields.Entity[this]; }
            set { Fields.Entity[this] = value; }
        }

        [DisplayName("Amount"), Size(20)]
        ...
        [DisplayName("Invoice Id"), Size(20)]
        ...
        [DisplayName("International"), Column("international"), Size(20)]
        public String International
        {
            get { return Fields.International[this]; }
            set { Fields.International[this] = value; }
        }

        [DisplayName("Method"), Size(20)]
        ...
        [DisplayName("Refunded Amt"), Size(25)]
        public String RefundedAmt
        {
            get { return Fields.RefundedAmt[this]; }
            set { Fields.RefundedAmt[this] = value; }
        }

        [DisplayName("Refund Status"), Size(20)]
        public String RefundStatus
        {
            get { return Fields.RefundStatus[this]; }
            set { Fields.RefundStatus[this] = value; }
        }

        [DisplayName("Captured"), Column("captured"), Size(20)]
        public String Captured
        {
            get { return Fields.Captured[this]; }
            set { Fields.Captured[this] = value; }
        }

        [DisplayName("Discription"), Size(2000)]
        public String Discription
        {
            get { return Fields.Discription[this]; }
            set { Fields.Discription[this] = value; }
        }

        [DisplayName("Card Id"), Size(50)]
        ...
        public String Bank
        {
            get { return Fields.Bank[this]; }
            set { Fields.Bank[this] = value; }
        }

        [DisplayName("Wallet"), Size(50)]
        public String Wallet
        {
            get { return Fields.Wallet[this]; }
            set { Fields.Wallet[this] = value; }
        }

        [DisplayName("Vpa"), Column("VPA"), Size(50)]
        public String Vpa
        {
            get { return Fields.Vpa[this]; }
            set { Fields.Vpa[this] = value; }
        }
        ...
        public RpPaymentDetailsRow()
            : base(Fields)
        {
        }
        
        public RpPaymentDetailsRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField Entity;
            public StringField Amount;
            public StringField Currency;
            public StringField Status;
            public StringField OrderId;
            public StringField InvoiceId;
            public StringField International;
            public StringField Method;
            public StringField RefundedAmt;
            public StringField RefundStatus;
            public StringField Captured;
            public StringField Discription;
            public StringField CardId;
            public StringField Bank;
            public StringField Wallet;
            public StringField Vpa;
