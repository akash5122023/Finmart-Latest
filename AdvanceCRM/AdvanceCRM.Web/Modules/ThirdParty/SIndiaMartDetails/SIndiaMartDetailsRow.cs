...
namespace AdvanceCRM.ThirdParty
{
    ...
    [ConnectionKey("Default"), Module("ThirdParty"), TableName("[dbo].[SIndiaMartDetails]")]
    [DisplayName("India Mart Details 2"), InstanceName("S India Mart Details")]
    [ReadPermission("IndiaMART:Inbox")]
    [ModifyPermission("IndiaMART:Inbox")]
    public sealed class SIndiaMartDetailsRow : Row<SIndiaMartDetailsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Query Id"), Size(100), QuickSearch,NameProperty]
        ...
        [DisplayName("Sender Name"), Size(200)]
        ...
        [DisplayName("Date Time Re"), Size(100)]
        [DateTimeEditor, SortOrder(1, descending: true)]
        ...
        [DisplayName("Gl User Company Name"), Size(500)]
        ...
        [DisplayName("Country Flag"), Size(500)]
        ...
        [DisplayName("Enq Message"), Size(1000)]
        ...
        [DisplayName("Enq Address"), Size(1000)]
        ...
        [DisplayName("Enq Call Duration"), Size(100)]
        ...
        [DisplayName("Enq Receiver Mob"), Size(100)]
        ...
        [DisplayName("Enq State"), Size(100)]
        ...
        [DisplayName("Email Alt"), Size(100)]
        ...
        [DisplayName("Mobile Alt"), Size(100)]
        ...
        [DisplayName("Phone Alt"), Size(100)]
        ...
        public SIndiaMartDetailsRow()
            : base(Fields)
        {
        }
         
        public SIndiaMartDetailsRow(RowFields fields)
            : base(Fields)
        {
        }
