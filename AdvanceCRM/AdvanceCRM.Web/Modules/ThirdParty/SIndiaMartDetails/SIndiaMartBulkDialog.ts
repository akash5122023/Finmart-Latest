namespace AdvanceCRM.ThirdParty {
    ...
    export class SIndiaMartBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: SIndiaMartBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new SIndiaMartBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        SIndiaMartDetailsService.BulkMoveToEnquiry({
