namespace AdvanceCRM.ThirdParty {
    ...
    export class InteraktUserBulkDialog extends Serenity.PropertyDialog<any, any> {



        private form: InteraktUserBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new InteraktUserBulkForm(this.idPrefix);
        }
            ...
            return [

                {
                    ...
                    click: () => {
                        ...
                        InteraktUserService.BulkMoveToEnquiry({
