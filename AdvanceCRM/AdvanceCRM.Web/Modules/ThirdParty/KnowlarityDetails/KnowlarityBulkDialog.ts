namespace AdvanceCRM.ThirdParty {
    ...
    export class KnowlarityBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: KnowlarityBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new KnowlarityBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        KnowlarityDetailsService.BulkMoveToEnquiry({
