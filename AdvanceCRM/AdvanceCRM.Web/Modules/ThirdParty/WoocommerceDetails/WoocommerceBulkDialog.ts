namespace AdvanceCRM.ThirdParty {
    ...
    export class WoocommerceBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: WoocommerceBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new WoocommerceBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        WoocommerceDetailsService.BulkMoveToEnquiry({
