namespace AdvanceCRM.ThirdParty {
    ...
    export class JustDialBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: JustDialBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new JustDialBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        JustDialDetailsService.BulkMoveToEnquiry({
