...
namespace AdvanceCRM.ThirdParty.Repositories
{
    ...
    public class JustDialDetailsRepository : BaseRepository
    {
        protected ISqlConnections _connections { get; }

        public JustDialDetailsRepository(IRequestContext context) : base(context) { }

        public JustDialDetailsRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow> {
            ...
            protected override void BeforeSave()
            {
                ...
                var menq = BizMailJustDialRow.Fields;
                ...
                using (var connection1 = _connections.NewFor<BizMailConfigRow>())
                {
                   ...
                   .Where(br.UserId == Context.User.GetIdentifier())
                    ...
                    model.EnqRow = connection1.List<BizMailJustDialRow>(q => q
                          .SelectTableFields()
                          .Select(menq.Rule)
       ...
       private class MyRetrieveHandler : RetrieveRequestHandler<MyRow> { public MyRetrieveHandler(IRequestContext context) : base(context) { } }
        ...
        {
            public List<BizMailJustDialRow> EnqRow { get; set; }
        }
    }
}