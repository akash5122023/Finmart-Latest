...
namespace AdvanceCRM.ThirdParty
{
    ...
    [ConnectionKey("Default"), Module("ThirdParty"), TableName("[dbo].[InstamojoDetails]")]
    [DisplayName("Instamojo Details"), InstanceName("Instamojo Details")]
    [ReadPermission("Instamojo:Inbox")]
    [ModifyPermission("Instamojo:Inbox")]
    public sealed class InstamojoDetailsRow : Row<InstamojoDetailsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Payment Mode"), Size(50)]
        public String PaymentMode
        {
            get { return Fields.PaymentMode[this]; }
        ...
        [DisplayName("Payout Date"), NotNull]
        public DateTime? PayoutDate
        {
            get { return Fields.PayoutDate[this]; }
            set { Fields.PayoutDate[this] = value; }
        }
        ...
        [DisplayName("Insta Id"), Column("InstaID"), Size(100)]
        public String InstaId
        {
            get { return Fields.InstaId[this]; }
            set { Fields.InstaId[this] = value; }
        }
        ...
        public InstamojoDetailsRow()
            : base(Fields)
        {
        }
        public InstamojoDetailsRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DateTimeField PayoutDate;
            public BooleanField IsMoved;
            public StringField InstaId;
