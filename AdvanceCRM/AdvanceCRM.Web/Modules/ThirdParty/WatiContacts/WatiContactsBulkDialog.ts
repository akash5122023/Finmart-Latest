namespace AdvanceCRM.ThirdParty {
    ...
    export class WatiContactsBulkDialog extends Serenity.PropertyDialog<any, any> {

       

        private form: WatiContactsBulkForm;
        public MIds: string[];
        ...
        constructor() {
            ...
            this.form = new WatiContactsBulkForm(this.idPrefix);
        }
            ...
            return [
                
                {
                    ...
                    click: () => {
                        ...
                        WatiContactsService.BulkMoveToEnquiry({
