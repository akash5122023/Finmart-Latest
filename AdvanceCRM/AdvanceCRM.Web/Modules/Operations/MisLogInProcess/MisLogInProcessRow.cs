...
{
    [ConnectionKey("Default"), Module("Operations"), TableName("[dbo].[MISLogInProcess]")]
    [DisplayName("Mis Log In Process"), InstanceName("Mis Log In Process")]
    [ReadPermission("MISLogInProcess:Read")]
    [InsertPermission("MISLogInProcess:Insert")]
    [UpdatePermission("MISLogInProcess:Update")]
    [DeletePermission("MISLogInProcess:Delete")]
    [LookupScript("Operations.MISLogInProcess", Permission = "?")]
    public sealed class MisLogInProcessRow : Row<MisLogInProcessRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Product"), ForeignKey("[dbo].[TypesOfProducts]", "Id"), LeftJoin("jTypesOfProducts"), TextualField("ProductTypeName"), QuickFilter]
        ...
        [DisplayName("Prime Emerging"), ForeignKey("[dbo].[PrimeEmerging]", "Id"), LeftJoin("jPrimeEmerging"), TextualField("PrimeEmergingName"), QuickFilter]
        ...
        [DisplayName("Inhouse Bank"), ForeignKey("[dbo].[InHouseBank]", "Id"), LeftJoin("jInhouseBank"), TextualField("InHouseBankType"), QuickFilter]
        ...
        [DisplayName("Loan Status"), ForeignKey("[dbo].[LogInLoanStatus]", "Id"), LeftJoin("jLogInLoanStatus"), TextualField("LogInLoanStatusName"), QuickFilter]
        ...
        [DisplayName("Loan Status Name"), Expression("jLogInLoanStatus.[LogInLoanStatusName]")]
        ...
        public MisLogInProcessRow()
            : base()
        {
        }

        public MisLogInProcessRow(RowFields fields)
            : base(fields)
        {
        }
