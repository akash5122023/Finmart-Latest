...
{
    [ConnectionKey("Default"), Module("Operations"), TableName("[dbo].[MISDisbursementProcess]")]
    [DisplayName("Mis Disbursement Process"), InstanceName("Mis Disbursement Process")]
    [ReadPermission("MISDisbursementProcess:Read")]
    [InsertPermission("MISDisbursementProcess:Insert")]
    [UpdatePermission("MISDisbursementProcess:Update")]
    [DeletePermission("MISDisbursementProcess:Delete")]
    [LookupScript("Operations.MISDisbursementProcess", Permission = "?")]
    public sealed class MisDisbursementProcessRow : Row<MisDisbursementProcessRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Mis Direct Indirect"), ForeignKey("[dbo].[MisDirectIndirect]", "Id"), LeftJoin("jMisDirectIndirect"), TextualField("MisDirectIndirectMisDirectIndirectType")]
        ...
        [DisplayName("Product Product Type Name"), Expression("jProduct.[ProductTypeName]")]
        ...
        [DisplayName("Month Name"), Expression("jMonth.[MonthsName]")]
        ...
        [DisplayName("Prime Emerging Name"), Expression("jPrimeEmerging.[PrimeEmergingName]")]
        ...
        [DisplayName("Mis Direct Indirect Type"), Expression("jMisDirectIndirect.[MISDirectIndirectType]")]
        ...
        [DisplayName("Inhouse Bank Type"), Expression("jInhouseBank.[InHouseBankType]")]
        ...
        [DisplayName("LogIn Loan Status Name"), Expression("jLogInLoanStatus.[LogInLoanStatusName]")]
        ...
        [DisplayName("SalesLoan Status Name"), Expression("jSalesLoanStatus.[SalesLoanStatusName]")]
        ...
        [DisplayName("MisDisbursement Loan Status Type"), Expression("jMisDisbursementStatus.[MISDisbursementStatusType]")]
        ...
        public MisDisbursementProcessRow(RowFields fields)
            : base(fields)
        {
        }
