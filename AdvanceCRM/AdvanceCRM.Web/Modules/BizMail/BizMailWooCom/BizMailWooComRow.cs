...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailWooCom]")]
    [DisplayName("Biz Mail Woo Com"), InstanceName("Biz Mail Woo Com")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailWooComRow : Row<BizMailWooComRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailWooComRow()
            : base(Fields)
        {
        }
        
        public BizMailWooComRow(RowFields fields)
            : base(Fields)
        {
        }
