...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailJustDial]")]
    [DisplayName("Biz Mail Just Dial"), InstanceName("Biz Mail Just Dial")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailJustDialRow : Row<BizMailJustDialRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailJustDialRow()
            : base(Fields)
        {
        }
        
        public BizMailJustDialRow(RowFields fields)
            : base(Fields)
        {
        }
