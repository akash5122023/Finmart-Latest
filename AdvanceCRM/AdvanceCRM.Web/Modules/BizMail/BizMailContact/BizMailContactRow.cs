...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailContact]")]
    [DisplayName("Biz Mail Contact"), InstanceName("Biz Mail Contact")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailContactRow : Row<BizMailContactRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailContactRow()
            : base(Fields)
        {
        }
        
        public BizMailContactRow(RowFields fields)
            : base(Fields)
        {
        }
