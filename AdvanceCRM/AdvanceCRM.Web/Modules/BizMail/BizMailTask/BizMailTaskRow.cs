...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailTask]")]
    [DisplayName("Biz Mail Task"), InstanceName("Biz Mail Task")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailTaskRow : Row<BizMailTaskRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailTaskRow()
            : base(Fields)
        {
        }
        

        public BizMailTaskRow(RowFields fields)
            : base(Fields)
        {
        }
