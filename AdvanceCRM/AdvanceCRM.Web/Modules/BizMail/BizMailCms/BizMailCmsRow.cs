...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailCMS]")]
    [DisplayName("Biz Mail Cms"), InstanceName("Biz Mail Cms")]
    //[ReadPermission("BizMail:General")]
    //[ModifyPermission("BizMail:General")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailCmsRow : Row<BizMailCmsRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailCmsRow()
            : base(Fields)
        {
        }

        public BizMailCmsRow(RowFields fields)
            : base(Fields)
        {
        }
