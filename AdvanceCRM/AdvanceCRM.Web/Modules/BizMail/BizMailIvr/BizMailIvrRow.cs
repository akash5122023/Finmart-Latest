...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailIVR]")]
    [DisplayName("Biz Mail Ivr"), InstanceName("Biz Mail Ivr")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailIvrRow : Row<BizMailIvrRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailIvrRow()
            : base(Fields)
        {
        }
        public BizMailIvrRow(RowFields fields)
            : base(Fields)
        {
        }
