...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailQuotation]")]
    [DisplayName("Biz Mail Quotation"), InstanceName("Biz Mail Quotation")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailQuotationRow : Row<BizMailQuotationRow.RowFields>, IIdRow, INameRow
    {
        ...
        public Masters.MailRuleMaster? Rule
        {
            get { return (Masters.MailRuleMaster?)Fields.Rule[this]; }
        ...
        public Masters.StatusMaster? QuotationStatus
        {
            get { return (Masters.StatusMaster?)Fields.QuotationStatus[this]; }
            set { Fields.QuotationStatus[this] = (Int32?)value; }
        }
        ...
        [LookupEditor(typeof(Masters.SourceRow), InplaceAdd = false)]
        ...
        [LookupEditor(typeof(Masters.StageRow), InplaceAdd = false)]
        ...
        public BizMailQuotationRow()
            : base(Fields)
        {
        }
        public BizMailQuotationRow(RowFields fields)
            : base(Fields)
        {
        }
