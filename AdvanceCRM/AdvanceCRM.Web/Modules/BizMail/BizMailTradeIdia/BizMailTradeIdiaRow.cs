...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailTradeIdia]")]
    [DisplayName("Biz Mail Trade Idia"), InstanceName("Biz Mail Trade Idia")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailTradeIdiaRow : Row<BizMailTradeIdiaRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailTradeIdiaRow()
            : base(Fields)
        {
        }
        
        public BizMailTradeIdiaRow(RowFields fields)
            : base(Fields)
        {
        }
