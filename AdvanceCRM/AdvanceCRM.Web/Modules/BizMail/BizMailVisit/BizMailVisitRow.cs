...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailVisit]")]
    [DisplayName("Biz Mail Visit"), InstanceName("Biz Mail Visit")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailVisitRow : Row<BizMailVisitRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailVisitRow()
            : base(Fields)
        {
        }
        public BizMailVisitRow(RowFields fields)
            : base(Fields)
        {
        }
