...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailWeb]")]
    [DisplayName("Biz Mail Web"), InstanceName("Biz Mail Web")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailWebRow : Row<BizMailWebRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailWebRow()
            : base(Fields)
        {
        }

        public BizMailWebRow(RowFields fields)
            : base(Fields)
        {
        }
