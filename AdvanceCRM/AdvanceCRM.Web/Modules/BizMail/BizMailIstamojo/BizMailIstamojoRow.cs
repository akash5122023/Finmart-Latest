...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailIstamojo]")]
    [DisplayName("Biz Mail Istamojo"), InstanceName("Biz Mail Istamojo")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailIstamojoRow : Row<BizMailIstamojoRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailIstamojoRow()
            : base(Fields)
        {
        }
        
        public BizMailIstamojoRow(RowFields fields)
            : base(Fields)
        {
        }
