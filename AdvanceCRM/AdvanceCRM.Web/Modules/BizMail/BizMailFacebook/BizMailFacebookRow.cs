...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailFacebook]")]
    [DisplayName("Biz Mail Facebook"), InstanceName("Biz Mail Facebook")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailFacebookRow : Row<BizMailFacebookRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailFacebookRow()
            : base(Fields)
        {
        }
        public BizMailFacebookRow(RowFields fields)
            : base(Fields)
        {
        }
