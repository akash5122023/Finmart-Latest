...
namespace AdvanceCRM.BizMail.Repositories
{
    ...
    public class BmTemplateRepository : BaseRepository
    {
        protected ISqlConnections _connections { get; }

        public BmTemplateRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public BmTemplateRepository(IRequestContext context) : base(context) { }
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow> {
            ...
            protected override void BeforeSave()
            {
                ...
                var client = new RestClient(Config.Apiurl + "/templates");
                ...
                string encodedStr = Convert.ToBase64String(Encoding.UTF8.GetBytes(Request.Entity.Content));
             //   var abc = encodedStr;//SGkgaGVsbG8=  SGkgaGVsbG8=
                ...
                request.AddParameter("application/x-www-form-urlencoded", "template%5Bname%5D=" + Request.Entity.Name + "&template%5Bcontent%5D="+encodedStr+"&template%5Binline_css%5D=no", ParameterType.RequestBody);
