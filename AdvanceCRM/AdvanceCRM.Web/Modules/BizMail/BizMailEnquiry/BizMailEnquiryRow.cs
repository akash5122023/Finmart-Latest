...
namespace AdvanceCRM.BizMail
{
    ...
    [ConnectionKey("Default"), Module("BizMail"), TableName("[dbo].[BizMailEnquiry]")]
    [DisplayName("Biz Mail Enquiry"), InstanceName("Biz Mail Enquiry")]
    [ReadPermission("BizMail:Read")]
    [InsertPermission("BizMail:Insert")]
    [UpdatePermission("BizMail:Update")]
    [DeletePermission("BizMail:Delete")]
    public sealed class BizMailEnquiryRow : Row<BizMailEnquiryRow.RowFields>, IIdRow, INameRow
    {
        ...
        public BizMailEnquiryRow()
            : base(Fields)
        {
        }
        

        public BizMailEnquiryRow(RowFields fields)
            : base(Fields)
        {
        }
