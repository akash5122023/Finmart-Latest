            ...
            for (var colNum = 1; colNum <= endCol; colNum++)
            {
                ...
                if (decorator != null)
                {
                    for (var rowNum = 2; rowNum <= endRow; rowNum++)
                    {
                        ...
                        decorator.Background = string.Empty;
                        decorator.Foreground = string.Empty;
                            ...
                            decorator.Format != null)
                        {
                            ...
                            if (!string.IsNullOrEmpty(decorator.Background))
                            {
                                ...
                                cell.Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml(decorator.Background));
                            }

                            if (!string.IsNullOrEmpty(decorator.Foreground))
                                cell.Style.Font.Color.SetColor(ColorTranslator.FromHtml(decorator.Foreground));
