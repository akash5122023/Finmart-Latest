...
namespace AdvanceCRM.Template.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = AppointmentTemplateRow;
    using Serenity.Extensions.DependencyInjection;

    public class AppointmentTemplateRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;

        public AppointmentTemplateRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public AppointmentTemplateRepository(IRequestContext context)
