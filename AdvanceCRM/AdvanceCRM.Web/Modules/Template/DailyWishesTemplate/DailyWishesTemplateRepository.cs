...
namespace AdvanceCRM.Template.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = DailyWishesTemplateRow;
    using Serenity.Extensions.DependencyInjection;

    public class DailyWishesTemplateRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;

        public DailyWishesTemplateRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public DailyWishesTemplateRepository(IRequestContext context)
