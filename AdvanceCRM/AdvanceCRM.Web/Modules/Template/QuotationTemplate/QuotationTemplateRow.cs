...
namespace AdvanceCRM.Template
{
    ...
    [ConnectionKey("Default"), Module("Template"), TableName("[dbo].[QuotationTemplate]")]
    [DisplayName("Quotation Template"), InstanceName("Quotation Template")]
    [ReadPermission("Template:Quotation")]
    [ModifyPermission("Template:Quotation")]
    [LookupScript("Template.QuotationTemplate", Permission = "?")]
    public sealed class QuotationTemplateRow : Row<QuotationTemplateRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        public QuotationTemplateRow()
            : base(Fields)
        {
        }
        
        public QuotationTemplateRow(RowFields fields)
            : base(Fields)
        {
        }
