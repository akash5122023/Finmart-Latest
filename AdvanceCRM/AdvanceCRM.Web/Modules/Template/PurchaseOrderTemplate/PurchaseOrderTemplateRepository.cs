...
namespace AdvanceCRM.Template.Repositories
{
    ...
    using MyRow = PurchaseOrderTemplateRow;

    public class PurchaseOrderTemplateRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;

        public PurchaseOrderTemplateRepository(IRequestContext context, ISqlConnections connections) : base(context)
        {
            _connections = connections;
        }

        public PurchaseOrderTemplateRepository(IRequestContext context) : this(context, Dependency.Resolve<ISqlConnections>())
        {
        }
