...
namespace AdvanceCRM.Template.Repositories
{
    ...
    public class IntractTemplateRepository : BaseRepository
    {
    public IntractTemplateRepository(IRequestContext context) : base(context) { }
        ...
        public bool Exists(IUnitOfWork uow, string Id)
        {
            try
            {
                var existingRecord = uow.Connection.Single<MyRow>(
                    new Criteria(MyRow.Fields.IntractId) == Id
                );
