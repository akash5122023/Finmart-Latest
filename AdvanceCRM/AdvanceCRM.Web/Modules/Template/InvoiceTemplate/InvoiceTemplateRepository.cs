...
namespace AdvanceCRM.Template.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = InvoiceTemplateRow;
    using Serenity.Extensions.DependencyInjection;

    public class InvoiceTemplateRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;

        public InvoiceTemplateRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public InvoiceTemplateRepository(IRequestContext context)
