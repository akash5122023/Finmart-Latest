...
namespace AdvanceCRM.Services
{
    ...
    [ConnectionKey("Default"), Module("Services"), TableName("[dbo].[TeleCallingFollowups]")]
    [DisplayName("Tele Calling Followups"), InstanceName("Tele Calling Followups")]
    [ReadPermission("?")]
    [ModifyPermission("TeleCalling:Followups")]

    public sealed class TeleCallingFollowupsRow : Row<TeleCallingFollowupsRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [LookupEditor(typeof(ContactsRow))] //added
        ...
        public TeleCallingFollowupsRow()
            : base(Fields)
        {
        }
        
        public TeleCallingFollowupsRow(RowFields fields)
            : base(Fields)
        {
        }
