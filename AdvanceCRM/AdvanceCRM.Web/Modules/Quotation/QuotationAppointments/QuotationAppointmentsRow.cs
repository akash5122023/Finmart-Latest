...
namespace AdvanceCRM.Quotation
{
    ...
    [ConnectionKey("Default"), Module("Quotation"), TableName("[dbo].[QuotationAppointments]")]
    [DisplayName("Quotation Appointments"), InstanceName("Quotation Appointments")]
    [ReadPermission("?")]
    [ModifyPermission("Quotation:Appointments")]

    public sealed class QuotationAppointmentsRow : Row<QuotationAppointmentsRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        public QuotationAppointmentsRow()
            : base(Fields)
        {
        }
        
        public QuotationAppointmentsRow(RowFields fields)
            : base(Fields)
        {
        }
