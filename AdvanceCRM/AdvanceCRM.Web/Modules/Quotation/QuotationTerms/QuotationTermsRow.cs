...
namespace AdvanceCRM.Quotation
{
    ...
    [ConnectionKey("Default"), Module("Quotation"), TableName("[dbo].[QuotationTerms]")]
    [DisplayName("Quotation Terms"), InstanceName("Quotation Terms")]
    [ReadPermission("Quotation:Read")]
    [ModifyPermission("Quotation:Read")]
    [LookupScript("Quotation.QuotationTerms", Permission = "?")]
    public sealed class QuotationTermsRow : Row<QuotationTermsRow.RowFields>, IIdRow
    {
        ...
        [LookupEditor(typeof(QuotationTermsMasterRow)/*, Multiple = true*/, InplaceAdd = true)]
        ...
        [LookupEditor(typeof(Quotation.QuotationRow), InplaceAdd = true)]
        ...
        [DisplayName("Terms"), Expression("jTerms.[Terms]"), MinSelectLevel(SelectLevel.List)]
        public String Terms
        {
        ...
        public QuotationTermsRow()
            : base(Fields)
        {
        }
public QuotationTermsRow(RowFields fields)
            : base(Fields)
        {
        }
