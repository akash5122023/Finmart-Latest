...
namespace AdvanceCRM.Enquiry
{
    ...
    [ConnectionKey("Default"), Module("Enquiry"), TableName("[dbo].[Enquiry]")]
    [DisplayName("Enquiry"), InstanceName("Enquiry")]
    [ReadPermission("Enquiry:Read")]
    [InsertPermission("Enquiry:Insert")]
    [UpdatePermission("Enquiry:Update")]
    [DeletePermission("Enquiry:Delete")]
    [LookupScript("Enquiry.Enquiry", Permission = "?")]

    public sealed class EnquiryRow : Row<EnquiryRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog,IMultiCompanyRow
    {
        ...
        [DisplayName("Additional Info"), QuickSearch, TextAreaEditor(Rows = 4)]
        ...
        [LookupEditor(typeof(StageRow), InplaceAdd = true, FilterField = "Type", FilterValue = Masters.StageTypeMaster.Enquiry)]
        ...
        [DisplayName("Created By"), NotNull, ForeignKey("[dbo].[Users]", "UserId"), LeftJoin("jOwner"), TextualField("OwnerDisplayName")]
        ...
        [DisplayName("Assigned To"), NotNull, ForeignKey("[dbo].[Users]", "UserId"), LeftJoin("jAssigned"), TextualField("AssignedDisplayName")]
        [Administration.UserEditor]
        ...
        [DisplayName("EnquiryNo"), Size(100), NotNull]
        ...
        [DisplayName("Closing Type"), Required(true)]
        ...
        [MultipleImageUploadEditor(FilenameFormat = "Enquiry/~", CopyToHistory = true, AllowNonImage = true)]
        ...
        [DisplayName("Last Followup "), Expression("(SELECT Details FROM EnquiryFollowups WHERE EnquiryId=t0.[Id] AND Id=(SELECT MAX(Id) FROM EnquiryFollowups WHERE EnquiryId=t0.[Id]))"), MinSelectLevel(SelectLevel.List)]
        ...
        [DisplayName("Amount"), Expression("(SELECT SUM(Price * Quantity - Discount) FROM EnquiryProducts WHERE EnquiryId=t0.[Id])"), AlignRight]
        public Double? Total
        {
        ...
        [EnquiryProductsEditor, NotMapped]
        [DisplayName("Products"), MasterDetailRelation(foreignKey: "EnquiryId", IncludeColumns = "ProductsName")]
        public List<EnquiryProductsRow> Products
        {
    ...
    //    [LookupEditor(typeof(StageRow), InplaceAdd = true, FilterField = "Type", FilterValue = Masters.StageTypeMaster.Enquiry)]
        ...
        [LookupEditor(typeof(AdditionalInfoRow), Multiple = true, InplaceAdd = true, FilterField = "Type", FilterValue = Masters.AddInfoTypeMaster.Enquiry), NotMapped]
        [LinkingSetRelation(typeof(EnquiryMultiInfoRow), "EnquiryId", "AdditionalInfoId")]
        public List<Int32> EnquiryAddinfoList
        {
            get { return Fields.EnquiryAddinfoList[this]; }
            set { Fields.EnquiryAddinfoList[this] = value; }
        }
        ...
        public EnquiryRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public BooleanField OwnerNonOperational; public Int32Field OwnerTeamsId;
            ...
            public readonly ListField<Int32> EnquiryAddinfoList;
            public readonly RowListField<EnquiryProductsRow> Products;
