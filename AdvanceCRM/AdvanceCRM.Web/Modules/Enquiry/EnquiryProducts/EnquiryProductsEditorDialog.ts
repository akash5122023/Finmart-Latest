...
namespace AdvanceCRM.Enquiry {
    ...
    export class EnquiryProductsEditorDialog extends Common.GridEditorDialog<EnquiryProductsRow> {
        ...
        constructor() {
            ...
            //var cap = Administration.CompanyDetailsRow.getLookup().itemById[1].CapacityInProducts;
            //if (cap == true)
            //{
            ...
            this.form.ProductsId.changeSelect2(e => {
                //Q.notifyInfo("Inside of products change: " + this.form.ChannelType.value);
