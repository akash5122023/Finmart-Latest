...
namespace AdvanceCRM.Enquiry {
    ...
    export class EnquiryProductsEditor extends Common.GridEditorBase<EnquiryProductsRow> {
        protected getColumnsKey() { return 'Enquiry.EnquiryProducts'; }
        protected getDialogType() { return EnquiryProductsEditorDialog; }
        ...
        validateEntity(row: EnquiryProductsRow, id) {
           ...
           /* Purchase.PurchaseRow.getLookup()*/
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as EnquiryProductsEditorDialog).ContactsIdD = this.ContactsId;
        }
