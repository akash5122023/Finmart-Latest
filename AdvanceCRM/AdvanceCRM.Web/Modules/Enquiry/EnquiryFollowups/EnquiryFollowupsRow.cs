...
namespace AdvanceCRM.Enquiry
{
    ...
    [ConnectionKey("Default"), Module("Enquiry"), TableName("[dbo].[EnquiryFollowups]")]
    [DisplayName("Enquiry Followups"), InstanceName("Enquiry Followups")]
    [ReadPermission("?")]
    [ModifyPermission("Enquiry:Followups")]

    public sealed class EnquiryFollowupsRow : Row<EnquiryFollowupsRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Phone"), Expression("jContacts.[Phone]"), MinSelectLevel(SelectLevel.List), QuickSearch,LookupInclude]
        ...
        [DisplayName("Contact Person Name"), Expression("jSubContacts.[Name]"), MinSelectLevel(SelectLevel.List), QuickSearch, LookupInclude]
        ...
        [DisplayName("EnquiryTotal"), Expression("(SELECT SUM(Price * Quantity - Discount) FROM EnquiryProducts WHERE EnquiryId=t0.[EnquiryId])"), AlignRight]
        public Double? EnquiryTotal 
        { 
            get { return Fields.EnquiryTotal[this]; } 
            set { Fields.EnquiryTotal[this] = value; } 
        }
        ...
        public EnquiryFollowupsRow()
            : base(Fields)
        {
        }
        

        public EnquiryFollowupsRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DoubleField EnquiryTotal;
