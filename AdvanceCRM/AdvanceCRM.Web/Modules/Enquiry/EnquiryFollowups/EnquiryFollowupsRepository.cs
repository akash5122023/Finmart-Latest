...
namespace AdvanceCRM.Enquiry.Repositories
{
    ...
    public class EnquiryFollowupsRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;
        private readonly IWebHostEnvironment _hostEnvironment;

        public EnquiryFollowupsRepository(IRequestContext context, ISqlConnections connections, IWebHostEnvironment hostEnvironment)
            : base(context)
        {
        ...
        public EnquiryFollowupsRepository(IRequestContext context)
            : this(context,
        ...
        {
            private readonly EnquiryFollowupsRepository _repository;
            private readonly ISqlConnections _connections;
            private readonly IWebHostEnvironment _hostEnvironment;

            public MySaveHandler(EnquiryFollowupsRepository repository) : base(repository.Context)
            {
            ...
            protected override void AfterSave()
            {
                ...
                notify.Text = Context.User.Identity.Name + " has" + (this.IsUpdate ? " Updated" : " Created") + " an Enquiry Followup";
