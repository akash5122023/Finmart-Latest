...
namespace AdvanceCRM.Feedback.Repositories
{
    using Serenity;
    ...
    public class FeedbackDetailsRepository : BaseRepository
    {
    public FeedbackDetailsRepository(IRequestContext context) : base(context) { }
