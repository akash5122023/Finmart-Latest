/// <reference path="../Common/Extras/SlilerRevealEditor.ts" />

namespace AdvanceCRM.DMS {

    @Serenity.Decorators.registerClass()
    @Serenity.Decorators.responsive()
    export class DMSGrid extends Serenity.EntityGrid<DMSRow, any> {
        protected getColumnsKey() { return 'DMS.DMS'; }
        protected getDialogType() { return DMSDialog; }
        ...
        //private slider: Common.SlilerRevealEditor;
        ...
        constructor(container: JQuery) {
            ...
            //    grid: this,
            //    toggleField: DMSRow.Fields.Title,
         ...
         */
        //private canMoveUnder(item: DMSRow, target: DMSRow) {
        ...
        // */
        //private getChildren(item: DMSRow) {
        ...
        // */
        //private getParents(item: DMSRow): DMSRow[] {
        ...
        //    this.slider = new Common.SlilerRevealEditor($("<div />").insertAfter(this.element), {
        //        initDialog: () => new DMSDialog(),
