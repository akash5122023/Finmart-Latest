...
namespace AdvanceCRM.Employee.Repositories
{
    using Serenity;
    ...
    public class EmployeeAssestsRepository : BaseRepository
    {
    public EmployeeAssestsRepository(IRequestContext context) : base(context) { }
