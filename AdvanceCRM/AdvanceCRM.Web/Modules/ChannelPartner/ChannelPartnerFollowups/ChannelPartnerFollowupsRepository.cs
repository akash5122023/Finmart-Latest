namespace AdvanceCRM.ChannelPartner.Repositories
{
    using Serenity;
    using Serenity.Data;
    ...
    public class ChannelPartnerFollowupsRepository : BaseRepository
    {
        public ChannelPartnerFollowupsRepository(IRequestContext context)
            : base(context)
        {
        }
