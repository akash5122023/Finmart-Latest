...
namespace AdvanceCRM.Reports.Repositories
{
    using Serenity;
    ...
    public class QuotationProductsRepository : BaseRepository
    {
    public QuotationProductsRepository(IRequestContext context) : base(context) { }
