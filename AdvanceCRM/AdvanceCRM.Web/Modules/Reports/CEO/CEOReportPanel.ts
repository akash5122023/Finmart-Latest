...
namespace AdvanceCRM.Reports {
    ...
    export class CEOReportPanel extends _Ext.ReportPanelBase<LeadsReportRequest> {
        protected getReportTitle() { return 'CEO Report'; }
        protected getReportKey() { return 'Reports.CEOReport'; }
