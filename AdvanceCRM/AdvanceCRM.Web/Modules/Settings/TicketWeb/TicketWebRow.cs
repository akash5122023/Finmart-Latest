...
namespace AdvanceCRM.Settings
{
    ...
    [ConnectionKey("Default"), Module("Settings"), TableName("[dbo].[TicketWeb]")]
    [DisplayName("Ticket Web"), InstanceName("Ticket Web")]
    [ReadPermission("Settings:SMS")]
    [ModifyPermission("Settings:SMS")]
    public sealed class TicketWebRow : Row<TicketWebRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Template Id"), Column("TemplateID"), Size(50)]
        ...
        public TicketWebRow(RowFields fields)
            : base(Fields)
        {
        }
