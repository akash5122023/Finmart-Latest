...
namespace AdvanceCRM.Settings.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = RazorPayRow;
    using Serenity.Extensions.DependencyInjection;

    public class RazorPayRepository : BaseRepository
    {
        private readonly ISqlConnections _connections;

        public RazorPayRepository(IRequestContext context, ISqlConnections connections)
            : base(context)
        {
            _connections = connections;
        }

        public RazorPayRepository(IRequestContext context)
