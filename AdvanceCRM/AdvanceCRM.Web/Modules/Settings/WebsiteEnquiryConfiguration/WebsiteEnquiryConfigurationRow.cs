...
namespace AdvanceCRM.Settings
{
    ...
    [ConnectionKey("Default"), Module("Settings"), TableName("[dbo].[WebsiteEnquiry]")]
    [DisplayName("Website Configuration"), InstanceName("Website Configuration")]
    [ReadPermission("Settings:WebsiteEnquiry")]
    [ModifyPermission("Settings:WebsiteEnquiry")]
    public sealed class WebsiteEnquiryConfigurationRow : Row<WebsiteEnquiryConfigurationRow.RowFields>, IIdRow, INameRow
    {
        ...
        public WebsiteEnquiryConfigurationRow()
            : base(Fields)
        {
        }
        
        public WebsiteEnquiryConfigurationRow(RowFields fields)
            : base(Fields)
        {
        }
