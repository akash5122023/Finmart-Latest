...
namespace AdvanceCRM.Settings.Forms
{
    ...
    [FormScript("Settings.WebsiteEnquiryConfiguration")]
    [BasedOnRow(typeof(WebsiteEnquiryConfigurationRow), CheckNames = true)]
    public class WebsiteEnquiryConfigurationForm
    {
        [Category("General")]
