...
namespace AdvanceCRM.Settings
{
    ...
    [ConnectionKey("Default"), Module("Settings"), TableName("[dbo].[TradeIndiaConfiguration]")]
    [DisplayName("Trade India Configuration"), InstanceName("Trade India Configuration")]
    [ReadPermission("Settings:TradeIndia")]
    [ModifyPermission("Settings:TradeIndia")]
    public sealed class TradeIndiaConfigurationRow : Row<TradeIndiaConfigurationRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Userid"), Column("userid"), Size(20), QuickSearch,NameProperty]
        ...
        [DisplayName("Profileid"), Column("profileid"), Size(20), NotNull]
        ...
        [DisplayName("SMS Template Id"), Column("SMSTemplateId"), Size(100)]
        ...
        public TradeIndiaConfigurationRow()
            : base(Fields)
        {
        }
        
       
        public TradeIndiaConfigurationRow(RowFields fields)
            : base(Fields)
        {
        }
