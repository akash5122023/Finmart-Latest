...
namespace AdvanceCRM.Settings.Forms
{
    ...
    [FormScript("Settings.IndiaMartConfiguration")]
    [BasedOnRow(typeof(IndiaMartConfigurationRow), CheckNames = true)]
    public class IndiaMartConfigurationForm
    {
        [Category("General")]
        public String MobileNumber { get; set; }
        public String ApiKey { get; set; }

        //[Category("Second Account")]
