...
namespace AdvanceCRM.Settings
{
    ...
    [ConnectionKey("Default"), Module("Settings"), TableName("[dbo].[Woocommerce]")]
    [DisplayName("Woocommerce"), InstanceName("Woocommerce")]
    [ReadPermission("Settings:Woocommerce")]
    [ModifyPermission("Settings:Woocommerce")]
    public sealed class WoocommerceRow : Row<WoocommerceRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Site Url"), Column("SiteURL"), Size(100), QuickSearch,NameProperty]
        public String SiteUrl
        {
            get { return Fields.SiteUrl[this]; }
            set { Fields.SiteUrl[this] = value; }
        }

        [DisplayName("Consumer Key"), Size(100)]
        public String ConsumerKey
        {
            get { return Fields.ConsumerKey[this]; }
            set { Fields.ConsumerKey[this] = value; }
        }

        [DisplayName("Consumer Secret"), Column("consumerSecret"), Size(1000)]
        public String ConsumerSecret
        {
            get { return Fields.ConsumerSecret[this]; }
            set { Fields.ConsumerSecret[this] = value; }
        }
        ...
        public WoocommerceRow()
            : base(Fields)
        {
        }
        
        public WoocommerceRow(RowFields fields)
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField SiteUrl;
            public StringField ConsumerKey;
            public StringField ConsumerSecret;
