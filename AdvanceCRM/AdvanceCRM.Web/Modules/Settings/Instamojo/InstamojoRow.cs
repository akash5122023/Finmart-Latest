...
namespace AdvanceCRM.Settings
{
    ...
    [ConnectionKey("Default"), Module("Settings"), TableName("[dbo].[Instamojo]")]
    [DisplayName("Instamojo"), InstanceName("Instamojo")]
    [ReadPermission("Settings:Instamojo")]
    [ModifyPermission("Settings:Instamojo")]
    public sealed class InstamojoRow : Row<InstamojoRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Access Token Key"), Size(1000)]
        ...
        public InstamojoRow()
            : base(Fields)
        {
        }public InstamojoRow(RowFields fields)
            : base(Fields)
        {
        }
