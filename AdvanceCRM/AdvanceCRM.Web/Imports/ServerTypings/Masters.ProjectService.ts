namespace AdvanceCRM.Masters {
    export namespace ProjectService {
        export const baseUrl = 'Mastes/Project';
        ...
        export declare const enum Methods {
            Create = "Mastes/Project/Create",
            Update = "Mastes/Project/Update",
            Delete = "Mastes/Project/Delete",
            Retrieve = "Mastes/Project/Retrieve",
            List = "Mastes/Project/List"
        }
