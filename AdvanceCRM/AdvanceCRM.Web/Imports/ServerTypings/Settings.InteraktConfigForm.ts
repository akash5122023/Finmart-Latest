namespace AdvanceCRM.Settings {
    export interface InteraktConfigForm {
    ...
    export class InteraktConfigForm extends Serenity.PrefixedContext {
        static formKey = 'Settings.InteraktConfig';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!InteraktConfigForm.init)  {
                InteraktConfigForm.init = true;
                ...
                Q.initFormType(InteraktConfigForm, [
                    'SecretKey', w0,
                    'AutoEmail', w1,
                    'AutoSms', w1,
                    'Sender', w0,
