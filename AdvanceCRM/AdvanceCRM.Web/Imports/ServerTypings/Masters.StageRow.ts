namespace AdvanceCRM.Masters {
    ...
    export namespace StageRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Stage';
        export const localTextPrefix = 'Masters.Stage';
        export const lookupKey = 'Masters.Stage';

        export function getLookup(): Q.Lookup<StageRow> {
            return Q.getLookup<StageRow>('Masters.Stage');
        }
