namespace AdvanceCRM.Services {
    export interface TeleCallingAppointmentsForm {
    ...
    export class TeleCallingAppointmentsForm extends Serenity.PrefixedContext {
        static formKey = 'Services.TeleCallingAppointments';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!TeleCallingAppointmentsForm.init)  {
                TeleCallingAppointmentsForm.init = true;
                ...
                Q.initFormType(TeleCallingAppointmentsForm, [
                    'Details', w0,
                    'AppointmentDate', w1,
                    'Status', w2,
                    'RepresentativeId', w3,
