namespace AdvanceCRM.Sales {
    export interface ChallanRow {
        ...
        Products?: ChallanProductsRow[];
        NoteList?: Common.NoteRow[];
    }

    export namespace ChallanRow {
        export const idProperty = 'Id';
        export const nameProperty = 'ShippingAddress';
        export const localTextPrefix = 'Sales.Challan';
        export const lookupKey = 'Sales.Challan';

        export function getLookup(): Q.Lookup<ChallanRow> {
            return Q.getLookup<ChallanRow>('Sales.Challan');
        }
        export const deletePermission = 'Challan:Delete';
        export const insertPermission = 'Challan:Insert';
        export const readPermission = 'Challan:Read';
        export const updatePermission = 'Challan:Update';
