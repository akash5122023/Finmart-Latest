namespace AdvanceCRM.Settings {
    ...
    export namespace RazorPayRow {
        export const idProperty = 'Id';
        export const nameProperty = 'AppId';
        export const localTextPrefix = 'Settings.RazorPay';
        export const deletePermission = 'Settings:RazorPay';
        export const insertPermission = 'Settings:RazorPay';
        export const readPermission = 'Settings:RazorPay';
        export const updatePermission = 'Settings:RazorPay';
