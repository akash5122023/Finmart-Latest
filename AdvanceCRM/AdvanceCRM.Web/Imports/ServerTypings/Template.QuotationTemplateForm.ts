namespace AdvanceCRM.Template {
    export interface QuotationTemplateForm {
    ...
    export class QuotationTemplateForm extends Serenity.PrefixedContext {
        static formKey = 'Template.QuotationTemplate';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!QuotationTemplateForm.init)  {
                QuotationTemplateForm.init = true;
                ...
                Q.initFormType(QuotationTemplateForm, [
                    'Sender', w0,
                    'Subject', w0,
                    'EmailTemplate', w1,
                    'Attachment', w2,
