namespace AdvanceCRM.Quotation {
    export interface QuotationAppointmentsRow {
        Id?: number;
        Details?: string;
    ...
    export namespace QuotationAppointmentsRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Details';
        export const localTextPrefix = 'Quotation.QuotationAppointments';
        export const deletePermission = 'Quotation:Appointments';
        export const insertPermission = 'Quotation:Appointments';
        export const readPermission = '?';
        export const updatePermission = 'Quotation:Appointments';
