namespace AdvanceCRM.Quotation {
    export interface QuotationFollowupsForm {
    ...
    export class QuotationFollowupsForm extends Serenity.PrefixedContext {
        static formKey = 'Quotation.QuotationFollowups';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!QuotationFollowupsForm.init)  {
                QuotationFollowupsForm.init = true;
                ...
                Q.initFormType(QuotationFollowupsForm, [
                    'FollowupNote', w0,
                    'Details', w1,
                    'FollowupDate', w2,
                    'Status', w3,
