namespace AdvanceCRM.Settings {
    export interface JustDialConfigurationForm {
    ...
    export class JustDialConfigurationForm extends Serenity.PrefixedContext {
        static formKey = 'Settings.JustDialConfiguration';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!JustDialConfigurationForm.init)  {
                JustDialConfigurationForm.init = true;
                ...
                Q.initFormType(JustDialConfigurationForm, [
                    'API', w0,
                    'PostUrl', w0,
                    'Username', w1,
                    'Password', w1,
