namespace AdvanceCRM.Sales {
    export interface InvoiceFollowupsForm {
    ...
    export class InvoiceFollowupsForm extends Serenity.PrefixedContext {
        static formKey = 'Sales.InvoiceFollowups';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!InvoiceFollowupsForm.init)  {
                InvoiceFollowupsForm.init = true;
                ...
                Q.initFormType(InvoiceFollowupsForm, [
                    'FollowupNote', w0,
                    'Details', w1,
                    'FollowupDate', w2,
                    'Status', w3,
