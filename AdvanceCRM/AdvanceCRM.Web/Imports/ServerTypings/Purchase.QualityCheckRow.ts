namespace AdvanceCRM.Purchase {
    ...
    export namespace QualityCheckRow {
        export const idProperty = 'Id';
        export const nameProperty = 'ProductName';
        export const localTextPrefix = 'Purchase.QualityCheck';
        export const lookupKey = 'Purchase.QualityCheckRow';

        export function getLookup(): Q.Lookup<QualityCheckRow> {
            return Q.getLookup<QualityCheckRow>('Purchase.QualityCheckRow');
        }
        export const deletePermission = 'QualityCheck:Delete';
        export const insertPermission = 'QualityCheck:Insert';
        export const readPermission = 'QualityCheck:Read';
        export const updatePermission = 'QualityCheck:Update';
        ...
        export declare const enum Fields {
            ...
            DepositionAction = "DepositionAction",
