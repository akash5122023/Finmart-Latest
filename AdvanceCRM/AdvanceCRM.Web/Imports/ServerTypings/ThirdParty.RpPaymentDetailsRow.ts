namespace AdvanceCRM.ThirdParty {
    export interface RpPaymentDetailsRow {
        Id?: number;
        PaymentId?: string;
        Name?: string;
        Phone?: string;
    ...
    export namespace RpPaymentDetailsRow {
        export const idProperty = 'Id';
        export const nameProperty = 'PaymentId';
        export const localTextPrefix = 'ThirdParty.RpPaymentDetails';
        export const deletePermission = 'RazorPay:Inbox';
        export const insertPermission = 'RazorPay:Inbox';
        export const readPermission = 'RazorPay:Inbox';
        export const updatePermission = 'RazorPay:Inbox';
