namespace AdvanceCRM.Sales {
    export interface OutwardForm {
        ...
        Products: OutwardProductsEditor;
        ...
        OtherAddress: Serenity.BooleanEditor;
    ...
    export class OutwardForm extends Serenity.PrefixedContext {
        static formKey = 'Sales.Outward';
