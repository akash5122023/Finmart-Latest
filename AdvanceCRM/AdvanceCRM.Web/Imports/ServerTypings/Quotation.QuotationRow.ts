namespace AdvanceCRM.Quotation {
    export interface QuotationRow {
        ...
        Type?: Masters.EnquiryTypeMaster;
        ...
        ClosingType?: Masters.ClosingTypeMaster;
        LostReason?: string;
        Subject?: string;
        Reference?: string;
        Attachment?: string;
        ...
        PerDiscount?: number;
        DiscountAmt?: number;
        DisGrandTotal?: number;
        ProjectId?: number;
        ProjectProjectId?: number;
        ProjectSubContactsId?: number;
        ...
        QuotationAddinfoList?: number[];
        Products?: QuotationProductsRow[];
        ...
        WinPercentage?: Masters.WinPercentageMaster;
    }

    export namespace QuotationRow {
        export const idProperty = 'Id';
        export const nameProperty = 'ContactsName';
        export const localTextPrefix = 'Quotation.Quotation';
        export const lookupKey = 'Quotation.Quotation';

        export function getLookup(): Q.Lookup<QuotationRow> {
            return Q.getLookup<QuotationRow>('Quotation.Quotation');
        }
        ...
        export declare const enum Fields {
            ...
            DisGrandTotal = "DisGrandTotal",
            ProjectId = "ProjectId",
            ProjectProjectId = "ProjectProjectId",
            ProjectSubContactsId = "ProjectSubContactsId",
            ...
            QuotationAddinfoList = "QuotationAddinfoList",
            Products = "Products",
            NoteList = "NoteList",
            Timeline = "Timeline",
