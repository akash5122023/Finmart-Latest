namespace AdvanceCRM.Services {
    ...
    export namespace TicketRow {
        ...
        export const localTextPrefix = 'Services.Ticket';
        export const lookupKey = 'Services.Ticket';

        export function getLookup(): Q.Lookup<TicketRow> {
            return Q.getLookup<TicketRow>('Services.Ticket');
        }
        export const deletePermission = 'Ticket:Delete';
        export const insertPermission = 'Ticket:Insert';
        export const readPermission = 'Ticket:Read';
        export const updatePermission = 'Ticket:Update';
