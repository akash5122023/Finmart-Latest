namespace AdvanceCRM.Enquiry {
    export interface EnquiryRow {
        ...
        EnquiryAddinfoList?: number[];
        Products?: EnquiryProductsRow[];
    ...
    export namespace EnquiryRow {
        export const idProperty = 'Id';
        export const nameProperty = 'ContactsName';
        export const localTextPrefix = 'Enquiry.Enquiry';
        export const lookupKey = 'Enquiry.Enquiry';

        export function getLookup(): Q.Lookup<EnquiryRow> {
            return Q.getLookup<EnquiryRow>('Enquiry.Enquiry');
        }
        ...
        export declare const enum Fields {
            ...
            EnquiryAddinfoList = "EnquiryAddinfoList",
            Products = "Products",
            NoteList = "NoteList",
            Timeline = "Timeline",
