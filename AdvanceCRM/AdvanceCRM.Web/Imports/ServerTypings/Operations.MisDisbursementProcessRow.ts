namespace AdvanceCRM.Operations {
    ...
    export namespace MisDisbursementProcessRow {
        export const idProperty = 'Id';
        export const nameProperty = 'SrNo';
        export const localTextPrefix = 'Operations.MisDisbursementProcess';
        export const lookupKey = 'Operations.MISDisbursementProcess';

        export function getLookup(): Q.Lookup<MisDisbursementProcessRow> {
            return Q.getLookup<MisDisbursementProcessRow>('Operations.MISDisbursementProcess');
        }
        export const deletePermission = 'MISDisbursementProcess:Delete';
        export const insertPermission = 'MISDisbursementProcess:Insert';
        export const readPermission = 'MISDisbursementProcess:Read';
        export const updatePermission = 'MISDisbursementProcess:Update';
