namespace AdvanceCRM.Enquiry {
    export interface EnquiryAppointmentsForm {
    ...
    export class EnquiryAppointmentsForm extends Serenity.PrefixedContext {
        static formKey = 'Enquiry.EnquiryAppointments';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!EnquiryAppointmentsForm.init)  {
                EnquiryAppointmentsForm.init = true;
                ...
                Q.initFormType(EnquiryAppointmentsForm, [
                    'Details', w0,
                    'AppointmentDate', w1,
                    'Status', w2,
                    'RepresentativeId', w3,
