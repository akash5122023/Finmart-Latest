namespace AdvanceCRM.BizMail {
    export interface BizMailQuotationRow {
        Id?: number;
        Rule?: Masters.MailRuleMaster;
        BmListId?: number;
        CompanyId?: number;
        Status?: boolean;
        Description?: string;
        QuotationStatus?: Masters.StatusMaster;
    ...
    export namespace BizMailQuotationRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Description';
        export const localTextPrefix = 'BizMail.BizMailQuotation';
