namespace AdvanceCRM.Settings {
    ...
    export namespace InstamojoRow {
        export const idProperty = 'Id';
        export const nameProperty = 'AppId';
        export const localTextPrefix = 'Settings.Instamojo';
        export const deletePermission = 'Settings:Instamojo';
        export const insertPermission = 'Settings:Instamojo';
        export const readPermission = 'Settings:Instamojo';
        export const updatePermission = 'Settings:Instamojo';
