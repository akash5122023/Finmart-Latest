namespace AdvanceCRM.Masters {
    ...
    export namespace SourceRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Source';
        export const localTextPrefix = 'Masters.Source';
        export const lookupKey = 'Masters.Source';

        export function getLookup(): Q.Lookup<SourceRow> {
            return Q.getLookup<SourceRow>('Masters.Source');
        }
